...
<?php 
 	...
 	$p_title = isset($g_settings->product_title) ? $g_settings->product_title : 'Iron Mountain';
...
<?php $baseUrl=base_url();?>
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
		...
		<script src="../../../assets/vendors/base/arjun_vendors.bundle.js" type="text/javascript"></script>
		<script src="../../../assets/demo/demo12/base/arjun_scripts.bundle.js" type="text/javascript"></script>
