...
<center class="invoice">
    <div
        style="height:566px; width: 797px;font-family: calibri !important;padding: 5px !important;padding-right: 10px !important;">
        ...
        <body>
                ...
                <tr>
                    ...
                    <td style="padding-left:5px;width: 50%;padding-bottom: 15px;">
                        <p style="font-weight:bold;font-size: 16px;">
                            <?php echo $company_info?$company_info->COMPANYNAME:'AKS AYYANAR KARUPATI SAYALKUDI'; ?></p>
                        ...
                        <p style="font-size: 12px;">
                            ...
                            <span
                                style="display: flex !important;align-items: center !important;justify-content: flex-end !important;padding-right: 10px;">St.Code
                                &nbsp; : 33</span>
                        </p>
                    ...
                    <td style="width: 50%;padding-top: 0px;">
                        ...
                        <p style="font-weight: bold; font-size: 16px; text-align: center;">
                            <?php echo ucfirst($sprint['sale_deliverymode']); ?>
                            <?php if ($sprint['delivery_by']!='') {  echo ' - '.$sprint['delivery_by']; }?></p>
                        <p style="font-weight: bold; font-size: 16px;">Billed To</p>
                        <p style="font-size:    14px;padding-left: 30px; font-weight: bold;">
                            <?php echo $party_detail?$party_detail->NAME:'';?>
                            <?php echo $party_detail?$party_detail->FATHERSNAME:'';?></p>
                        ...
                        <p style="padding-left: 30px;font-size: 13px;">
                            <?php echo isset($address) ? $address ? $address :'-' :'-';?></p>
                        <p style="padding-left: 30px;font-size: 12px;"> &nbsp;</p>
                        <p style="padding-left: 30px;font-size: 2px;"> &nbsp;</p>
                        <p style="padding-left: 30px;font-size: 12px;"> &nbsp;</p>
                        <p style="padding-left: 30px;"></p>
                            ...
                            <?php } ?>
                        <p >
                            <span style="Padding-left:0px !important ;font-size: 16px; text-align: left !important;">Landmark &nbsp; - </span>
                            <span><?php echo $party_detail?$party_detail->LANDMARK:''; ?></span>
                        </p>
                            ...
                            <label style="float:right; padding-right: 10px;">
                                ...
                                <span
                                    style="font-weight:bold;font-size: 12px;"><?php echo $party_detail?$party_detail->PHONE:''; ?></span>
                            </label>
                        </p>
                    </td>
                </tr>
            ...
            <table id="particular">
                ...
                <tbody style="font-size:14px !important;">
                    <?php $i=0; $wgtss=0; $count=0; $total_amount_sum=0; foreach($print_cart_view as  $cprint){ 
                                $count = count($cprint);?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:start;border-bottom-style: hidden;"><?php echo $prdname->AKS_PRD_NAME; ?>
                        </td>
                        <td style="text-align:center;border-bottom-style: hidden;" colspan="2">
                            <?php echo $cprint['HSN_CODE']; ?></td>
                        <td style="text-align: center;border-bottom-style: hidden;"><?php echo $cprint['sale_price']; ?>
                            / <?php  
                        ...
                        <td style="text-align:center; border-bottom-style: hidden;">
                            <?php echo number_format($cprint['price'],2,'.',',');  ?></td>
                ...
                <?php $grand_total = floatval($total_amount_sum)+floatval($sprint['shipment_charges']?$sprint['shipment_charges']:0)-floatval($sprint['sale_dis_amt']?$sprint['sale_dis_amt']:0); ; ?>
                </td>
                <tfoot>

                    <tr>
                        <td class="ft_wgt" colspan="5" style="text-align: right;">
                            <h4>Total&emsp;</h4>
                        </td>
                        ...
                        <td class="ft_wgt" style="text-align:center;">
                            <?php echo number_format($total_amount_sum,2,'.',','); ?></td>
                    </tr>
                </tfoot>
                <tfoot>
                    <tr>
                        <td class="ft_wgt" colspan="6" style="text-align: right;">
                            <h4>Delivery Charges (+)&emsp;</h4>
                        </td>


                        <td class="ft_wgt" style="text-align:center;">
                            <?php echo number_format($sprint['shipment_charges'],2,'.',','); ?></td>
                    </tr>
                </tfoot>
                <tfoot>
                    <tr>
                        ...
                        <td class="ft_wgt" style="text-align:center;">
                            <?php echo number_format($sprint['sale_dis_amt'],2,'.',','); ?></td>
                    </tr>
                </tfoot>
            ...
            <table id="charges">
                <tr style="">
                    <td class="ft_wgt" style="border-top-style: hidden;text-align: center;font-weight:bold !important;"
                        rowspan="2"><span>No of Item</span></td>
                    <td class="ft_wgt"
                        style="width: 80px;border-top-style: hidden;text-align: center;font-weight:bold !important;"
                        rowspan="2"><span>Taxable Values</span></td>
                    <td class="ft_wgt" style="border-top-style: hidden;text-align: center;font-weight:bold !important;"
                        colspan="2"><span>CGST</span></td>
                    <td class="ft_wgt" style="border-top-style: hidden;text-align: center;font-weight:bold !important;"
                        colspan="2"><span>SGST</span></td>
                    <td class="ft_wgt" style="border-top-style: hidden;text-align: center;font-weight:bold !important;"
                        colspan="2"><span>IGST</span></td>
                    <td class="ft_wgt"
                        style="width: 100px; border-top-style: hidden;text-align: center;font-weight:bold !important;"
                        rowspan="2"><span>Grand Amount</span></td>
                </tr>
                <tr>
                    <td class="ft_wgt" style="text-align: center;font-weight:bold !important;"><span>Percent(%)</span>
                    </td>
            ...
            <table id="amt_word">
                <tr>
                    <td style="border-top-style: hidden;padding-left:5px;"><span class="ft_wgt">Amount In Words</span>
                        <label> &emsp;<?php echo amt_to_words($grand_total); ?></label></td>
                </tr>
            </table>
            <table id="">
                <tr>
                    <td style="border-top-style: hidden;padding-left:5px;"><span class="ft_wgt">Remarks </span> <label>
                            &emsp;
                            <?php 
            ...
            <table id="decl">
                <tbody>
                    <tr>
                        <td class="ft_wgt"
                            style="border-top-style: hidden; border-right-style: hidden; border-bottom-style: hidden; padding-left:5px;font-size: 14px;font-weight: 600 !important;">
                    ...
                    <tr>
                        ...
                        <td style="border-top-style: hidden;  padding-left:5px;font-size: 13px;" colspan="2">
                            ...
                            <p>3.The Shipment Discount and Product Discount is Valid for the Particular season Only and
                                will not last after season</p>
                            <p>4.We are Available Only in Ayyanar karuppati Sayalkudi Website and the whatsapp,Facebook,
                                We are not available in any other Social Platform</p>
                ...
                <tfoot>
                    <td
                        style="border-top-style: hidden; border-right-style: hidden; padding-left: 15px; padding-bottom: 15px;">
                        <span>
