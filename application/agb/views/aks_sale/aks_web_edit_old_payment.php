										...
										<?php  if(isset($_SESSION['Karupatti SaleEdit'])){ if($_SESSION['Karupatti SaleEdit']==1){?>
											<?php if(isset($edit)){ ?>
												<div class="card-body py-4">
													<div class="row">
														<div class="col-lg-7">
															<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Akssale/web_update" id="submit_form" enctype="multipart/form-data" onsubmit="return submit_validation();">
															<!-- <div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;"> -->
																...
																<label class="col-lg-2 col-form-label fw-semibold fs-6">Type</label>
																	<label class="col-lg-3 col-form-label  fw-bold fs-5"><?php echo 'Website'; ?></label>
																	<label class="col-lg-2 col-form-label fw-semibold fs-6">Website Sale ID</label>
																  <label class="col-lg-4 col-form-label fw-bold fs-6" id=""><?php echo $edit->web_id; ?></label>
																  </div>
																  <div class="row">
									                ...
									                // 				$shipment_address= $ship_add.$ship_cty.$ship_pin;
										              ...
										              <!-- {"cart_total":1030,"billing_email":"drpkm@hotmail.com","billing_company":"","billing_address_1":"KAITHAKKALAM HOUSE, FATHIMAPURAM ","billing_address_2":"","billing_state":"KL","billing_postcode":"686102","order_comments":""} -->

										              <!-- {"wcf_shipping_first_name":"","wcf_shipping_last_name":"","wcf_shipping_company":"","wcf_shipping_country":"IN","wcf_shipping_address_1":"","wcf_shipping_address_2":"","wcf_shipping_city":"","wcf_shipping_state":"TN","wcf_shipping_postcode":""} -->
										              ...
										              ?>
																  ...
																  <label class="col-lg-4 col-form-label fw-bold fs-6" id=""><?php echo $edit->mobile; ?></label>
																  <label class="col-lg-2 col-form-label fw-semibold fs-6">Email</label>
																  <label class="col-lg-3 col-form-label fw-bold fs-6" id=""><?php echo $party->email?:'---'; ?></label>
