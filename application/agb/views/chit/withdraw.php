								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<!--end::Heading-->
											<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Chit/withdraw_chit" enctype="multipart/form-data" onsubmit="return deposit_chit_entry_validation();">
											<div class="row">
												<div class="col-lg-6">
													<div class="row">
												...
												<div class="col-lg-2">
													...
													<div class="image-input image-input-outline" data-kt-image-input="true">
														...
														<div class="image-input-wrapper w-125px h-125px" style="background-image: url(<?php echo base_url(); ?>assets/images/Party.jpg)" id="party_photo" name="party_photo">
														</div>
													</div>
													<!--end::Image input-->
													<!--begin::Hint-->
