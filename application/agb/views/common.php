...
<html lang="en">
	...
	<head>
		...
		<link rel="shortcut icon" href="<?php echo base_url();?>assets/images/fav-icon-1.jpg" />
		<!--begin::Fonts-->
		...
		.loader {
		    ...
		    height: 100%;
		    z-index: 9999;
		    background: url('<?php echo base_url();?>assets/loader/agb_loader.gif') 50% 50% no-repeat rgb(60 60 60 / 75%);
		    /*rgb(249,249,249);*/
		    opacity: 50.8;
		}
		</style>
