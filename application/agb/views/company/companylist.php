											...
											<tr> 
												...
												<td>
													<label class="form-check form-switch form-check-custom form-check-solid">
															<inp0ut class="form-check-input w-35px h-20px" type="checkbox" id="activeunactive_<?php echo $i;?>"  name="activeunactive_<?php echo $i;?>" onchange="activeunactive('<?php echo $company_settings['COMPANYCODE']; ?>',<?php echo $i; ?>)" value=
															<?php 
