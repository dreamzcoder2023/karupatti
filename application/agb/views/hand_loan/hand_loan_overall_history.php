...
<body data-kt-name="metronic" id="kt_body"
							...
							<div class="col-xxl-8">
								...
								<div class="card card-xxl-stretch mb-5 mb-xl-8">
									...
									<!--begin::Card title-->
												...
												<div class="d-flex justify-content-end"
													...
													<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
														<div class="px-7 py-5" data-kt-user-table-filter="form">
															<form method="POST" action="<?php echo base_url(); ?>Handloan/handloanoverallhistory" id="fill_form">	
																<div class="mb-2">
										...
										<!--end::Card title-->
										<div class="row mt-6">
											<table id="handloan_overallhistory_list_table"
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													<tr>
														...
														<td class="ple1"><?php echo ucfirst($hlist['ADDED_USER']); ?></td>
														<td class="ple1">
															<span>
															 	<i class="fa-solid fa-star fs-7" style="<?php 
	...
	<script>
		...
		$(document).ready(function() {
			...
			$(".move_to").on("click", function () {
				value=$(this).val();
				// alert(value);
				$('#filter_form').attr('action', "<?php echo base_url(); ?>Handloan/handloanoverallhistory?page="+value);
				$("#filter_form").submit();
				e.preventDefault();
			});
		});
	...
	<script>
	      $("#handloan_overallhistory_list_table").kendoTooltip({
	        filter: "td",
	        show: function(e){
