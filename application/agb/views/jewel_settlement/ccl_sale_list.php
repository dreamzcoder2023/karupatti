			...
			<div class="modal-dialog modal-xl">
          	...
          	<div class="row">
						...
						<div class="row">
							...
							<div class="col-lg-3">
								<input type="text" class="form-control form-control-lg1 form-control-solid" placeholder="Sales Amount"  name="ccl_sale_amt" id="ccl_sale_amt" onkeyup="calcualte_curr_sale_rate_profit_loss()" >
