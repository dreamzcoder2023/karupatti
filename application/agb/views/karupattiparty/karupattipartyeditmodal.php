...
<style type="text/css">
 /*Auto complete css start*/
			...
			<div class="modal-content rounded">
				...
				<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
					...
					<?php if (isset($edit)){ ?>
						<!--start::Modal body-->
						<!--  -->
						<form action="<?php echo base_url(); ?>Karuppattiparty/update_party" method="POST" onsubmit="return edit_party_validation()">
							<div class="row" >
							...
							<div class="row" id="billing_address_div">
								...
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<input value="<?php echo $edit->PID?$edit->PID:''; ?>" type="hidden" name="edit_id" id="edit_id"   >
									<input value="<?php echo $edit->NAME?$edit->NAME:''; ?>" type="text" name="edit_new_party_name" id="edit_new_party_name" class="form-control form-control-lg form-control-solid me-3" placeholder="Party Name"  >
									<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_name_err" id="edit_new_party_name_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6 ">L.Name</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<input value="<?php echo $edit->FATHERSNAME?$edit->FATHERSNAME:''; ?>" type="text" name="edit_new_party_lname" id="edit_new_party_lname" class="form-control form-control-lg form-control-solid me-3" placeholder="Last Name" >
									<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_lname_err" id="edit_new_party_lname_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6 ">Company Name</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<input value="<?php echo $edit->COMPANY_NAME?$edit->COMPANY_NAME:''; ?>" type="text" name="edit_company_name" id="edit_company_name" class="form-control form-control-lg form-control-solid me-3" placeholder="Company Name" >
									<div class="fv-plugins-message-container invalid-feedback" name="edit_company_name_err" id="edit_company_name_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Country</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select" data-hide-search="false" data-dropdown-parent="#kt_modal_edit_party"  onchange="edit_get_countries()" id="edit_country" name="edit_country">
										<option value="">Select Country</option>
									</select>
									<div class="fv-plugins-message-container invalid-feedback" name="edit_country_err" id="edit_country_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6 required">State</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select" data-dropdown-parent="#kt_modal_edit_party" id="edit_state" name="edit_state">
										<option value="">Select State</option>
									</select>
									<div class="fv-plugins-message-container invalid-feedback" name="edit_state_err" id="edit_state_err"></div>	
								</div>
								...
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									...
									<textarea rows="1" class="form-control form-control-solid" name="edit_new_party_bill_address" id="edit_new_party_bill_address" placeholder="Enter Address" ><?php echo $edit->ADDRESS1?$edit->ADDRESS1:''; ?></textarea>

									<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_bill_address_err" id="edit_new_party_bill_address_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Town/City</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<input value="<?php echo $edit->CITY?$edit->CITY:''; ?>" type="text" name="edit_town_city" id="edit_town_city" class="form-control form-control-lg form-control-solid me-3" placeholder="Town/City" onkeyup="edit_town_cityget()">
									<div class="fv-plugins-message-container invalid-feedback" name="edit_town_city_err" id="edit_town_city_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Pincode</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<input value="<?php echo $edit->PINCODE?$edit->PINCODE:''; ?>" type="text" name="edit_pincode" id="edit_pincode" class="form-control form-control-lg form-control-solid me-3" placeholder="Pincode" onkeyup="edit_pincodeget()">
									<div class="fv-plugins-message-container invalid-feedback" name="edit_pincode_err" id="edit_pincode_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Mobile</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<input value="<?php echo $edit->PHONE?$edit->PHONE:''; ?>" type="text" name="edit_new_party_mobile" id="edit_new_party_mobile" class="form-control form-control-lg form-control-solid me-3" placeholder="Mobile Number"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$" title="Enter Valid mobile number ex.6311111111" onkeyup="karupatti_mobile_uni_chk_edit(this.value)">
									<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_mobile_err" id="edit_new_party_mobile_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6">Alt.Mobile</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<input value="<?php echo $edit->PHONE2?$edit->PHONE2:''; ?>" type="text" name="al_edit_new_party_mobile" id="al_edit_new_party_mobile" class="form-control form-control-lg form-control-solid me-3" placeholder="Mobile Number"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$" title="Enter Valid mobile number ex.6311111111">
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6 ">Email</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<input value="<?php echo $edit->EMAIL?$edit->EMAIL:''; ?>" type="email" name="edit_new_party_email" id="edit_new_party_email" class="form-control form-control-lg form-control-solid me-3" placeholder="Email">
									<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_email_err" id="edit_new_party_email_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6 ">GST No</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<input maxlength="15" value="<?php echo $edit->GST_NO?$edit->GST_NO:''; ?>" type="text" name="edit_new_party_gst_no" id="edit_new_party_gst_no" class="form-control form-control-lg form-control-solid me-3" placeholder="GST No" >
									<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_gst_no_err" id="edit_new_party_gst_no_err"></div>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6">Landmark</label>
								<div class="col-lg-4 fv-row fv-plugins-icon-container ">
									<textarea rows="1" class="form-control form-control-solid" name="edit_new_party_landmark" id="edit_new_party_landmark" placeholder="Enter Landmark"><?php echo $edit->LANDMARK ? $edit->LANDMARK : ''; ?></textarea>
							...
							<div class="row">
								<div class="col-lg-8 col-form-label fw-semibold fs-4" align="left">
									<div class="row">
										<label>
										<input type="checkbox" id="diff_address" name="diff_address" value="1" checked onclick="diff_address2()"> 
										<b class="fs-3">Ship to a different address?</b>
										<input type="hidden" name="edit_shiping_div" id="edit_shiping_div" value="0">
										</label>
									</div>
							    </div>
							</div>							
							<div class="row" id="shiping_address_div"  style="display:none;">
								...
								<div class="row">
								 	<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Name</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<input value="<?php echo $shiping->name?$shiping->name:''; ?>" type="text" name="edit_new_party_name1" id="edit_new_party_name1" class="form-control form-control-lg form-control-solid me-3" placeholder="Party Name" >
											<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_name1_err" id="edit_new_party_name1_err"></div>
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6 ">L.Name</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<input value="<?php echo $shiping->lname?$shiping->lname:''; ?>" type="text" name="edit_new_party_lname1" id="edit_new_party_lname1" class="form-control form-control-lg form-control-solid me-3" placeholder="Last Name" >
											<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_lname1_err" id="edit_new_party_lname1_err"></div>
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6 ">Company Name</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<input value="<?php echo $shiping->company_name?$shiping->company_name:''; ?>" type="text" name="edit_company_name1" id="edit_company_name1" class="form-control form-control-lg form-control-solid me-3" placeholder="Company Name" >
											<div class="fv-plugins-message-container invalid-feedback" name="edit_company_name1_err" id="edit_company_name1_err"></div>
										</div>				
										<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Country</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select"  onchange="edit_get_countries1()" id="edit_country1" name="edit_country1">
											<option Value="">Select Country</option>
											</select>
											<div class="fv-plugins-message-container invalid-feedback" name="edit_country1_err" id="edit_country1_err"></div>
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6 required">State</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select"  id="edit_state1" name="edit_state1">
												<option value="">Select State</option>
											</select>
											<div class="fv-plugins-message-container invalid-feedback" name="edit_state1_err" id="edit_state1_err"></div>
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Address</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<!-- oninput="this.value = this.value.replace(/[^0-9.,&amp;$#@*()+=/\- a-zA-Z]/g, '').replace(/(\..*)\./g, '$1');" -->
											<textarea rows="1" class="form-control form-control-solid" placeholder="Enter Address" name="edit_new_party_bill_address1" id="edit_new_party_bill_address1" ><?php echo $shiping->address?$shiping->address:''; ?></textarea>
											<div class="fv-plugins-message-container invalid-feedback"  id="edit_new_party_bill_address1_err"></div>
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Town/City</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<input value="<?php echo $shiping->city?$shiping->city:''; ?>" type="text" name="edit_town_city1" id="edit_town_city1" class="form-control form-control-lg form-control-solid me-3" placeholder="Town/City" onkeyup="edit_town_cityget2()" >
											<div class="fv-plugins-message-container invalid-feedback" name="edit_town_city1_err" id="edit_town_city1_err"></div>
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Pincode</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<input value="<?php echo $shiping->pincode?$shiping->pincode:''; ?>" type="text" name="edit_pincode1" id="edit_pincode1" class="form-control form-control-lg form-control-solid me-3" placeholder="Pincode" onkeyup="edit_pincode1get()">
											<div class="fv-plugins-message-container invalid-feedback" name="edit_pincode1_err" id="edit_pincode1_err"></div>
											
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Mobile</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<input value="<?php echo $shiping->mobile?$shiping->mobile:''; ?>" type="text" name="edit_new_party_mobile1" id="edit_new_party_mobile1" class="form-control form-control-lg form-control-solid me-3" placeholder="Mobile Number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$" title="Enter Valid mobile number ex.6311111111" >
											<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_mobile1_err" id="edit_new_party_mobile1_err"></div>
											
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6">Alt.Mobile</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<input value="<?php echo $shiping->altermobile?$shiping->altermobile:''; ?>" type="text" name="al_edit_new_party_mobile1" id="al_edit_new_party_mobile1" class="form-control form-control-lg form-control-solid me-3" placeholder="Mobile Number"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$" title="Enter Valid mobile number ex.6311111111">
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6 ">Email</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<input value="<?php echo $shiping->email?$shiping->email:''; ?>" type="email" name="edit_new_party_email1" id="edit_new_party_email1" class="form-control form-control-lg form-control-solid me-3" placeholder="Email" >
											<div class="fv-plugins-message-container invalid-feedback" name="edit_new_party_email1_err" id="edit_new_party_email1_err"></div>
											
										</div>
										<label class="col-lg-2 col-form-label fw-semibold fs-6">Landmark</label>
										<div class="col-lg-4 fv-row fv-plugins-icon-container ">
											<!-- oninput="this.value = this.value.replace(/[^0-9.,&amp;$#@*()+=/\- a-zA-Z]/g, '').replace(/(\..*)\./g, '$1');" -->
											<textarea rows="1" class="form-control form-control-solid" name="edit_new_party_landmark1" id="edit_new_party_landmark1" placeholder="Enter Landmark" ><?php echo $shiping->landmark?$shiping->landmark:''; ?></textarea>
										</div>
							...
							<div class="row">
	  							 <div class="d-flex justify-content-end mt-6 px-9">
									<button type="submit" class="btn btn-primary" id="btn_sub_karedit_modal" >Update</button>
								</div>
							</div>
						</form>
						<!--end::Modal body-->
	...
	<script >
		...
		function karupatti_mobile_uni_chk_edit(val) {
			// alert(val);
			if (val!=""){

				var id = '<?php echo $edit->PID?$edit->PID:''; ?>';
				$.ajax({
				    type: "POST",
				    url: baseurl + 'Karuppattiparty/phone_no_unquie_check_edit',
				    data: {
				       'value': val,
				       'id': id
				    },
				    ...
				    success: function(result) {
				    	// alert(result)
				        if (result > 0) {
				            $('#edit_new_party_mobile_err').html('Mobile Number is already exist!');						            
				            $('#btn_sub_karedit_modal').prop('disabled', true);
				            berr = 1;
				        } else {
				            $('#edit_new_party_mobile_err').html('');
				            $('#btn_sub_karedit_modal').prop('disabled', false);
				            berr = 0;
				        }
				    }
				});
		...
		function edit_pincodeget() {
			// alert("sfsvgd");

			 $("#edit_pincode").autocomplete({ 
					    valueKey:'title',
			            source:[{
			            ...
			            $("#edit_pincode").val(suggestion.edit_pincode);
			            
			    });

			$("#edit_pincode").focus();
		}
		function edit_pincode1get() {
			// alert("sfsvgd");

			 $("#edit_pincode1").autocomplete({ 
			            ...
			            $("#edit_pincode1").val(suggestion.edit_pincode);	
		...
		function edit_town_cityget() {
			// alert("sfsvgd");

			 $("#edit_town_city").autocomplete({ 
			    valueKey:'title',
	            source:[{
	            ...
	            $("#edit_town_city").val(suggestion.citytown);
	            
	    });

			$("#edit_town_city").focus();
		}

		function edit_town_cityget2() {
			// alert("sfsvgd");

			 $("#edit_town_city1").autocomplete({ 
			    valueKey:'title',
	            source:[{
	            url:baseurl+'Karuppattiparty/towncityList?query=%QUERY%',
	            type:'remote',
	            ...
	            $("#edit_town_city1").val(suggestion.citytown);
	            
	    });

			$("#edit_town_city1").focus();
		}
		//
	...
	<script>
		...
		$('#shiping_address_div').css('display','block');
		$('#edit_shiping_div').val(1);


		} else {

		$('#shiping_address_div').css('display','none');
		$('#edit_shiping_div').val(0);
	...
	<script>
		function edit_party_validation()
		{
			var err = 0;

			var party         = $('#edit_new_party_name').val();
			if(party.trim()=='')
			{
			   $('#edit_new_party_name_err').html('Enter Party Name !');
			   err++;
			}
			else
			{
			 $('#edit_new_party_name_err').html('');
			} 

			// var edit_new_party_lname = $('#edit_new_party_lname').val();
			// if(edit_new_party_lname.trim()=='')
			// {
			//    $('#edit_new_party_lname_err').html('Enter Party Last Name !');
			//    err++;
			// }
			// else
			// {
			//  $('#edit_new_party_lname_err').html('');
			// }

			// var edit_company_name = $('#edit_company_name').val();
			// if(edit_company_name.trim()=='')
			// {
			//    $('#edit_company_name_err').html('Enter Company Name !');
			//    err++;
			// }
			// else
			// {
			//  $('#edit_company_name_err').html('');
			// }
			var edit_country = $('#edit_country').val();
			if(edit_country.trim()=='')
			{
			   $('#edit_country_err').html('Select Country !');
			   err++;
			}
			else
			{
			 $('#edit_country_err').html('');
			}
			var edit_state = $('#edit_state').val();
			if(edit_state.trim()=='')
			{
			   $('#edit_state_err').html('Select State  !');
			   err++;
			}
			else
			{
			...
			var edit_new_party_bill_address = $('#edit_new_party_bill_address').val();
			if(edit_new_party_bill_address.trim()=='')
			{
			   $('#edit_new_party_bill_address_err').html('Enter Address Requried!');
			   err++;
			}
			else
			{
			 $('#edit_new_party_bill_address_err').html('');
			}
			var edit_town_city = $('#edit_town_city').val();
			if(edit_town_city.trim()=='')
			{
			   $('#edit_town_city_err').html('Enter Town/City !');
			   err++;
			}
			else
			{
			 $('#edit_town_city_err').html('');
			}
			var edit_pincode = $('#edit_pincode').val();
			if(edit_pincode.trim()=='')
			{
			   $('#edit_pincode_err').html('Enter Pincode !');
			   err++;
			}
			else
			{
			 $('#edit_pincode_err').html('');
			}
			var edit_new_party_mobile = $('#edit_new_party_mobile').val();
			if(edit_new_party_mobile.trim()=='')
			{
			   $('#edit_new_party_mobile_err').html('Enter Mobile Number !');
			   err++;
			}
			else
			{
			...
			var chk = $('#edit_shiping_div').val();
			if(chk==1)
			{

			var party = $('#edit_new_party_name1').val();
			if(party.trim()=='')
			{
			   $('#edit_new_party_name1_err').html('Enter Party Name !');
			   err++;
			}
			else
			{
			 $('#edit_new_party_name1_err').html('');
			} 

			// var edit_new_party_lname1 = $('#edit_new_party_lname1').val();
			// if(edit_new_party_lname1.trim()=='')
			// {
			//    $('#edit_new_party_lname1_err').html('Enter Party Last Name !');
			//    err++;
			// }
			// else
			// {
			//  $('#edit_new_party_lname1_err').html('');
			// }

			// var edit_company_name1 = $('#edit_company_name1').val();
			// if(edit_company_name1.trim()=='')
			// {
			//    $('#edit_company_name1_err').html('Enter Company Name !');
			//    err++;
			// }
			// else
			// {
			//  $('#edit_company_name1_err').html('');
			// }
			var edit_country1 = $('#edit_country1').val();
			if(edit_country1.trim()=='')
			{
			   $('#edit_country1_err').html('Select Country !');
			   err++;
			}
			else
			{
			 $('#edit_country1_err').html('');
			}
			var edit_state1 = $('#edit_state1').val();
			if(edit_state1.trim()=='')
			{
			   $('#edit_state1_err').html('Select State !');
			   err++;
			}
			else
			{
			 $('#edit_state1_err').html('');
			} 
			var edit_new_party_bill_address1 = $('#edit_new_party_bill_address1').val();
			if(edit_new_party_bill_address1.trim()=='')
			{
			   $('#edit_new_party_bill_address1_err').html('Enter Address Requried!');
			   err++;
			}
			else
			{
			 $('#edit_new_party_bill_address1_err').html('');
			}
			var edit_town_city1 = $('#edit_town_city1').val();
			if(edit_town_city1.trim()=='')
			{
			   $('#edit_town_city1_err').html('Enter Town/City !');
			   err++;
			}
			else
			{
			 $('#edit_town_city1_err').html('');
			}
			var edit_pincode1 = $('#edit_pincode1').val();
			if(edit_pincode1.trim()=='')
			{
			   $('#edit_pincode1_err').html('Enter Pincode !');
			   err++;
			}
			else
			{
			 $('#edit_pincode1_err').html('');
			}
			var edit_new_party_mobile1 = $('#edit_new_party_mobile1').val();
			if(edit_new_party_mobile1.trim()=='')
			{
			   $('#edit_new_party_mobile1_err').html('Enter MObile Number !');
			   err++;
			}
			else
			{
			 $('#edit_new_party_mobile1_err').html('');
			}
			// var edit_new_party_email1 = $('#edit_new_party_email1').val();
			// if(edit_new_party_email1.trim()=='')
			// {
			//    $('#edit_new_party_email1_err').html('Enter Email !');
			//    err++;
			// }
			// else
			// {
			//  $('#edit_new_party_email1_err').html('');
			// }
	...
	<script type="text/javascript">
		...
		// 	    valueKey:'title',
	    //         source:[{
	    //         url:baseurl+'Karuppattiparty/edit_pincodeList2?query=%QUERY%',
	    //         type:'remote',
	    //         ajax:{
	    //           dataType : 'json',
	    //         }
	    //     }]}).on('selected.xdsoft',function(e,suggestion,ui){ 
	    //         $("#edit_pincode1").val(suggestion.citytown);
	...
	<script>
					...
					var countryDropdown = document.getElementById("edit_country");
					for (var i = 0; i < data.countries.length; i++) {
					  ...
					  if(data.countries[i].country=='<?php echo $edit->COUNTRY ? $edit->COUNTRY:''; ?>'){
			...
			<script>
				function edit_get_countries(){
				var select_country=$('#edit_country').val();
				$('#edit_state').empty();
				var data ={
				  "countries": [
					{
				...
				var stateDropdown = document.getElementById("edit_state");
					for (var i = 0; i < data.countries.length; i++) {
				if( data.countries[i].country == select_country)
					  ...
					  if(data.countries[i].states[j]=='<?php echo $edit->STATE?$edit->STATE:''; ?>'){
						option.selected = true;
					  }
			...
			<script>
					...
					var countryDropdown = document.getElementById("edit_country1");
					for (var i = 0; i < data.countries.length; i++) {
					  var option = document.createElement("option");
					  option.text = data.countries[i].country;
					  option.value = data.countries[i].country; // You can assign a value to each country if needed
					  if(data.countries[i].country=='<?php echo $shiping->country ? $shiping->country:''; ?>'){
						option.selected = true;
					}
					  countryDropdown.add(option);
					}
			...
			<script>
				function edit_get_countries1(){
				var select_country=$('#edit_country1').val();
				$('#edit_state1').empty();
				var data ={
				  "countries": [
					{
				...
				var stateDropdown = document.getElementById("edit_state1");
					for (var i = 0; i < data.countries.length; i++) {
				if( data.countries[i].country == select_country)
						for (var j = 0; j < data.countries[i].states.length; j++) {
					  var option = document.createElement("option");
					  option.text = data.countries[i].states[j];
					  option.value = data.countries[i].states[j]; // You can assign a value to each country if needed
					  if(data.countries[i].states[j]=='<?php echo $shiping->state?$shiping->state:''; ?>'){
						option.selected = true;
					  }
