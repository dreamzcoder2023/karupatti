...
<style type="text/css">
 /*Auto complete css start*/
		...
		<div class="modal-dialog modal-xl">
			...
			<div class="modal-content rounded">
				...
				<div class="modal-header justify-content-end border-0 pb-0">
					<!--begin::Close-->
					<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal" onclick="colsemodal()">
				...
				<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
					...
					<!--end::Heading-->
					<!-- < ?php //echo base_url(); ?>Akssale/add_party -->
					<form action="<?php echo base_url(); ?>Karuppattiparty/add_party" method="POST" onsubmit="return new_party_validation()">
						<div class="row" >
						 	<label class="col-lg-12 col-form-label fw-semibold fs-6 ">
						 		<center><b><h2>Billing Address</h2></b></center>
						 	</label>
						</div>
						<div class="row" id="billing_address_div">
							...
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								...
								<div class="fv-plugins-message-container invalid-feedback" name="new_party_name_err" id="new_party_name_err"></div>
							</div>
							...
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								...
								<div class="fv-plugins-message-container invalid-feedback" name="new_party_lname_err" id="new_party_lname_err"></div>
							</div>
							...
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								...
								<div class="fv-plugins-message-container invalid-feedback" name="company_name_err" id="company_name_err"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Country</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select" data-hide-search="false" data-dropdown-parent="#kt_modal_add_party"  onchange="get_countries()" id="country" name="country">
									<option value="">Select Country</option>
								</select>
								<div class="fv-plugins-message-container invalid-feedback" name="country_err" id="country_err"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6 required">State</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select" data-dropdown-parent="#kt_modal_add_party" id="state" name="state">
									<option value="">Select State</option>
								</select>
								<div class="fv-plugins-message-container invalid-feedback" name="state_err" id="state_err"></div>	
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Address</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<!-- oninput="this.value = this.value.replace(/[^0-9,&amp;$#@*()+=/\- a-zA-Z]/g, '').replace(/(\..*)\./g, '$1');" -->
								<textarea rows="1" class="form-control form-control-solid" name="new_party_bill_address" id="new_party_bill_address" placeholder="Enter Address" ></textarea>

								<div class="fv-plugins-message-container invalid-feedback" name="new_party_bill_address_err" id="new_party_bill_address_err"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Town/City</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<input type="text" name="town_city" id="town_city" class="form-control form-control-lg form-control-solid me-3" placeholder="Town/City" onkeyup="town_cityget()">
								<div class="fv-plugins-message-container invalid-feedback" name="town_city_err" id="town_city_err"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Pincode</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<input type="text" name="pincode" id="pincode" class="form-control form-control-lg form-control-solid me-3" placeholder="Pincode" onkeyup="pincodeget()" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
								<div class="fv-plugins-message-container invalid-feedback" name="pincode_err" id="pincode_err"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Mobile</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<input type="text" name="new_party_mobile" id="new_party_mobile" class="form-control form-control-lg form-control-solid me-3" placeholder="Mobile Number"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$" title="Enter Valid mobile number ex.6311111111" onkeyup="karupatti_mobile_uni_chk(this.value)">
								<div class="fv-plugins-message-container invalid-feedback" name="new_party_mobile_err" id="new_party_mobile_err"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Alt.Mobile</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<input type="text" name="al_new_party_mobile" id="al_new_party_mobile" class="form-control form-control-lg form-control-solid me-3" placeholder="Mobile Number"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$" title="Enter Valid mobile number ex.6311111111">
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6 ">Email</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<input type="email" name="new_party_email" id="new_party_email" class="form-control form-control-lg form-control-solid me-3" placeholder="Email">
								<div class="fv-plugins-message-container invalid-feedback" name="new_party_email_err" id="new_party_email_err"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6 ">GST No</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<input type="text" name="new_party_gst_no" maxlength="15" id="new_party_gst_no" class="form-control form-control-lg form-control-solid me-3" placeholder="GST No" >
								<div class="fv-plugins-message-container invalid-feedback" name="new_party_gst_no_err" id="new_party_gst_no_err"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Landmark</label>
							<div class="col-lg-4 fv-row fv-plugins-icon-container ">
								<!-- oninput="this.value = this.value.replace(/[^0-9,&amp;$#@*()+=/\- a-zA-Z]/g, '').replace(/(\..*)\./g, '$1');" -->
								<textarea rows="1" class="form-control form-control-solid" name="new_party_landmark" id="new_party_landmark" placeholder="Enter Landmark" ></textarea>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-8 col-form-label fw-semibold fs-4" align="left">
								<div class="row">
									<label>
									<input type="checkbox" id="diff_address" name="diff_address" onclick="diff_address1()"> 
									<b class="fs-3">Ship to a different address?</b>
									<input type="hidden" name="shiping_div" id="shiping_div" value="0">
									</label>
								</div>
						    </div>
						</div>							
						<div class="row" id="shiping_address_div"  style="display:none;">
							<div class="row" >
							 	<label class="col-lg-12 col-form-label fw-semibold fs-6 ">
							 		<center><b><h2>Shipping Address</h2></b></center>
								 </label>
							</div>
							<div class="row">
							 	<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Name</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										...
										<div class="fv-plugins-message-container invalid-feedback" name="new_party_name1_err" id="new_party_name1_err"></div>
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6 ">L.Name</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										...
										<div class="fv-plugins-message-container invalid-feedback" name="new_party_lname1_err" id="new_party_lname1_err"></div>
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6 ">Company Name</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										...
										<div class="fv-plugins-message-container invalid-feedback" name="company_name1_err" id="company_name1_err"></div>
									</div>				
									<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Country</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select"  onchange="get_countries1()" id="country1" name="country1">
										<option Value="">Select Country</option>
										</select>
										<div class="fv-plugins-message-container invalid-feedback" name="country1_err" id="country1_err"></div>
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6 required">State</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select"  id="state1" name="state1">
											<option value="">Select State</option>
										</select>
										<div class="fv-plugins-message-container invalid-feedback" name="state1_err" id="state1_err"></div>
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Address</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										<!-- oninput="this.value = this.value.replace(/[^0-9,&amp;$#@*()+=/\- a-zA-Z]/g, '').replace(/(\..*)\./g, '$1');" -->
										<textarea rows="1" class="form-control form-control-solid" placeholder="Enter Address" name="new_party_bill_address1" id="new_party_bill_address1" ></textarea>
										<div class="fv-plugins-message-container invalid-feedback"  id="new_party_bill_address1_err"></div>
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Town/City</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										<input type="text" name="town_city1" id="town_city1" class="form-control form-control-lg form-control-solid me-3" placeholder="Town/City" onkeyup="town_cityget2()" >
										<div class="fv-plugins-message-container invalid-feedback" name="town_city1_err" id="town_city1_err"></div>
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Pincode</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										<input type="text" name="pincode1" id="pincode1" class="form-control form-control-lg form-control-solid me-3" placeholder="Pincode" onkeyup="pincode2get()">
										<div class="fv-plugins-message-container invalid-feedback" name="pincode1_err" id="pincode1_err"></div>
										
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6 required">Mobile</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										<input type="text" name="new_party_mobile1" id="new_party_mobile1" class="form-control form-control-lg form-control-solid me-3" placeholder="Mobile Number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$" title="Enter Valid mobile number ex.6311111111" >
										<div class="fv-plugins-message-container invalid-feedback" name="new_party_mobile1_err" id="new_party_mobile1_err"></div>
										
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6">Alt.Mobile</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										<input type="text" name="al_new_party_mobile1" id="al_new_party_mobile1" class="form-control form-control-lg form-control-solid me-3" placeholder="Mobile Number"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10" pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$" title="Enter Valid mobile number ex.6311111111">
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6 ">Email</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										<input type="email" name="new_party_email1" id="new_party_email1" class="form-control form-control-lg form-control-solid me-3" placeholder="Email" >
										<div class="fv-plugins-message-container invalid-feedback" name="new_party_email1_err" id="new_party_email1_err"></div>
										
									</div>
									<label class="col-lg-2 col-form-label fw-semibold fs-6">Landmark</label>
									<div class="col-lg-4 fv-row fv-plugins-icon-container ">
										<!-- oninput="this.value = this.value.replace(/[^0-9,&amp;$#@*()+=/\- a-zA-Z]/g, '').replace(/(\..*)\./g, '$1');" -->
										<textarea rows="1" class="form-control form-control-solid" name="new_party_landmark1" id="new_party_landmark1" placeholder="Enter Landmark" ></textarea>
									</div>
						...
						<div class="row">
  							 <div class="d-flex justify-content-end mt-6 px-9">
								<button type="submit" class="btn btn-primary" id="btn_sub_kar_modal" >Add </button>
							</div>
						</div>
					</form>
					<!--end::Modal body-->
	...
	<script >
		...
		function karupatti_mobile_uni_chk(val) {
			// alert(val);
			if (val!=""){
				...
				$.ajax({
				    type: "POST",
				    url: baseurl + 'Karuppattiparty/phone_no_unquie_check',
				    data: {
				       'value': val,
				    },
				    cache: false,
				    ...
				    success: function(result) {
				    	// alert(result)
				        if (result > 0) {
				            $('#new_party_mobile_err').html('Mobile Number is already exist!');						            
				            $('#btn_sub_kar_modal').prop('disabled', true);
				            berr = 1;
				        } else {
				            $('#new_party_mobile_err').html('');
				            $('#btn_sub_kar_modal').prop('disabled', false);
				            berr = 0;
				        }
				    }
				});
		...
		function pincodeget() {
			// alert("sfsvgd");
			 ...
			 $("#pincode").autocomplete({ 
			            ...
			            $("#pincode").val(suggestion.pincode);
			            
			    });

			$("#pincode").focus();
		}
		function pincode2get() {
			// alert("sfsvgd");

			 $("#pincode1").autocomplete({ 
					    valueKey:'title',
			            source:[{
			            url:baseurl+'Karuppattiparty/pincodeList?query=%QUERY%',
			            type:'remote',
			            ...
			            $("#pincode1").val(suggestion.pincode);
		...
		function town_cityget() {
			// alert("sfsvgd");
			 ...
			 $("#town_city").autocomplete({ 
	            ...
	            $("#town_city").val(suggestion.citytown);
		...
		function town_cityget2() {
			// alert("sfsvgd");

			 $("#town_city1").autocomplete({ 
			    valueKey:'title',
	            source:[{
	            url:baseurl+'Karuppattiparty/towncityList?query=%QUERY%',
	            type:'remote',
	            ...
	            $("#town_city1").val(suggestion.citytown);
	...
	<script>
		function new_party_validation()
		{
			var err = 0;

			var party         = $('#new_party_name').val();
			if(party.trim()=='')
			{
			   $('#new_party_name_err').html('Enter Party Name !');
			   err++;
			}
			else
			{
			 $('#new_party_name_err').html('');
			} 

			// var new_party_lname = $('#new_party_lname').val();
			// if(new_party_lname.trim()=='')
			// {
			//    $('#new_party_lname_err').html('Enter Party Last Name !');
			//    err++;
			// }
			// else
			// {
			//  $('#new_party_lname_err').html('');
			// }

			// var company_name = $('#company_name').val();
			// if(company_name.trim()=='')
			// {
			//    $('#company_name_err').html('Enter Company Name !');
			//    err++;
			// }
			// else
			// {
			...
			if(country.trim()=='')
			{
			   $('#country_err').html('Select Country !');
			   err++;
			}
			else
			{
			...
			var new_party_bill_address = $('#new_party_bill_address').val();
			if(new_party_bill_address.trim()=='')
			{
			   $('#new_party_bill_address_err').html('Enter Address Requried!');
			   err++;
			}
			else
			{
			 $('#new_party_bill_address_err').html('');
			}
			var town_city = $('#town_city').val();
			if(town_city.trim()=='')
			{
			   $('#town_city_err').html('Enter Town/City !');
			   err++;
			}
			else
			{
			...
			var new_party_mobile = $('#new_party_mobile').val();
			if(new_party_mobile.trim()=='')
			{
			   $('#new_party_mobile_err').html('Enter Mobile Number !');
			   err++;
			}
			else
			{
			...
			// var new_party_email = $('#new_party_email').val();
			// if(new_party_email.trim()=='')
			// {
			//    $('#new_party_email_err').html('Enter Email !');
			//    err++;
			// }
			// else
			// {
			//  $('#new_party_email_err').html('');
			// }

			// Ship to a different address Validations
			var chk = $('#shiping_div').val();
			if(chk==1)
			{

			var party = $('#new_party_name1').val();
			if(party.trim()=='')
			{
			   $('#new_party_name1_err').html('Enter Party Name !');
			   err++;
			}
			else
			{
			 $('#new_party_name1_err').html('');
			} 

			// var new_party_lname1 = $('#new_party_lname1').val();
			// if(new_party_lname1.trim()=='')
			// {
			//    $('#new_party_lname1_err').html('Enter Party Last Name !');
			//    err++;
			// }
			// else
			// {
			//  $('#new_party_lname1_err').html('');
			// }

			// var company_name1 = $('#company_name1').val();
			// if(company_name1.trim()=='')
			// {
			//    $('#company_name1_err').html('Enter Company Name !');
			//    err++;
			// }
			// else
			// {
			//  $('#company_name1_err').html('');
			// }
			var country1 = $('#country1').val();
			if(country1.trim()=='')
			{
			   $('#country1_err').html('Select Country !');
			   err++;
			}
			else
			{
			...
			var new_party_bill_address1 = $('#new_party_bill_address1').val();
			if(new_party_bill_address1.trim()=='')
			{
			   $('#new_party_bill_address1_err').html('Enter Address Requried!');
			   err++;
			}
			else
			{
			 $('#new_party_bill_address1_err').html('');
			}
			var town_city1 = $('#town_city1').val();
			if(town_city1.trim()=='')
			{
			   $('#town_city1_err').html('Enter Town/City !');
			   err++;
			}
			else
			{
			...
			if(pincode1.trim()=='')
			{
			   $('#pincode1_err').html('Enter Pincode !');
			   err++;
			}
			else
			{
			...
			var new_party_mobile1 = $('#new_party_mobile1').val();
			if(new_party_mobile1.trim()=='')
			{
			   $('#new_party_mobile1_err').html('Enter MObile Number !');
			   err++;
			}
			else
			{
			 $('#new_party_mobile1_err').html('');
			}
			// var new_party_email1 = $('#new_party_email1').val();
			// if(new_party_email1.trim()=='')
			// {
			//    $('#new_party_email1_err').html('Enter Email !');
			//    err++;
			// }
			// else
			// {
			//  $('#new_party_email1_err').html('');
			// }
	...
	<script type="text/javascript">
		...
		// 	    valueKey:'title',
	    //         source:[{
	    //         url:baseurl+'Karuppattiparty/pincodeList2?query=%QUERY%',
	    //         type:'remote',
	    //         ajax:{
	    //           dataType : 'json',
	    //         }
	    //     }]}).on('selected.xdsoft',function(e,suggestion,ui){ 
	    //         $("#pincode1").val(suggestion.citytown);
	...
	<script>
			...
			// 	    valueKey:'title',
		    //         source:[{
		    //         url:baseurl+'Karuppattiparty/towncityList2?query=%QUERY%',
		    //         type:'remote',
		    //         ajax:{
		    //           dataType : 'json',
		    //         }
			...
			<script>
					...
					var countryDropdown = document.getElementById("country1");
					for (var i = 0; i < data.countries.length; i++) {
					  var option = document.createElement("option");
					  option.text = data.countries[i].country;
					  option.value = data.countries[i].country; // You can assign a value to each country if needed
			...
			<script>
				function get_countries1(){
				var select_country=$('#country1').val();
				$('#state1').empty();
				var data ={
				  "countries": [
					{
				...
				var stateDropdown = document.getElementById("state1");
					for (var i = 0; i < data.countries.length; i++) {
				if( data.countries[i].country == select_country)
						for (var j = 0; j < data.countries[i].states.length; j++) {
					  var option = document.createElement("option");
