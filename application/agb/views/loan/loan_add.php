...
<!-- <link href="assets/jquery.autocomplete.css" rel="stylesheet" type="text/css" /> -->
										...
										<!--end::Card header-->
											...
											<div class="card-body py-4">
																...
																<div class="col-lg-6">
																	<div class="row">
																		...
																		<div class="col-lg-8 fv-row fv-plugins-icon-container">
																			<input type="text" name="first_name" class="form-control form-control-lg1 form-control-solid" placeholder="Party Name" id="first_name" oninput="this.value = this.value.replace(/[^A-Za-z. ]/g, '').replace(/(\..*)\./g, '$1');" onkeyup="first_nm_party();" tabindex="1">
																		...
																		<label class="col-lg-6 col-form-label fw-semibold fs-6">Relation
																			<div class="col-lg-12 fv-row fv-plugins-icon-container">
																				...
																				<select class="form-select form-select-solid fs-7" data-control="select2"  id="nom_relation" name="nom_relation" tabindex="4">	
																						<!-- <option value="">Select</option> -->
																						...
																						<option value="Father in Law" id="Father in Law">Father in Law</option>
																						<option value="Mother in Law" id="Mother in Law">Mother in Law</option>
																						<option value="Son in Law" id="Son in Law">Son in Law</option>
																						<option value="Daughter in Law" id="Daughter in Law">Daughter in Law</option>
																						<option value="Grand Father" id="Grand Father">Grand Father</option>
																						<option value="Grand Mother" id="Grand Mother">Grand Mother</option>
																						<option value="Uncle" id="Uncle">Uncle</option>
																						<option value="Aunty" id="Aunty">Aunty</option>
																	...
																	<div class="row">
																		...
																		<label class="col-lg-12 col-form-label fw-bold fs-6" name="" id="">
																			...
																			&emsp;<span name="mobile" id="mobile">9999999999</span> <span data-bs-toggle="modal" data-bs-target="#kt_modal_verify_mobile_no"><!-- <i class="fas fa-square-check" data-bs-toggle="modal" data-bs-target="#kt_modal_verify_mobile_no" ></i> --><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
																				 viewBox="0 0 505 505" xml:space="preserve" height=30 width=25>
																		...
																		<label class="col-lg-7 col-form-label fw-semibold fs-6">Mobile<input type="text" name="nom_mobile" id="nom_mobile" class="form-control form-control-lg1 form-control-solid" placeholder="Mobile No"  oninput="this.value = this.value.replace(/[^0-9 ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="5"></label>
														...
														<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
															...
															<div class="row">
																...
																<div class="col-lg-10 fv-row fv-plugins-icon-container">
																	<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" id="company" name="company" tabindex="6">	
																...
																<div class="col-lg-8">
																	<div class="row">
																		...
																		<div class="col-lg-8 fv-row">
																			<div class="d-flex align-items-center">
																				...
																				<input class="form-control form-control-solid ps-12" name="" placeholder="Date" id="kt_datepicker_new_loan_date" value="<?php echo date("d-m-Y"); ?>" tabindex="7"/>
																			</div>
																		</div>
																	</div>
																	<div class="row">
																		...
																		<div class="col-lg-8 fv-row fv-plugins-icon-container">
																			<select class="form-select form-select-solid" name="jewel_type" id="jewel_type" data-control="select2" data-hide-search="true" tabindex="8">
																			<!-- <option value="">Select</option>	 -->
																				<?php 
																	...
																	<div class="row">
																		...
																		<div class="col-lg-8 fv-row fv-plugins-icon-container">
																			<select class="form-select form-select-solid" name="int_grp" id="int_grp" data-control="select2" data-hide-search="true" onchange="loan_interest()" tabindex="9">	
																				<option value="">Select</option>
																				<?php 
																			...
																			<div class="fv-plugins-message-container invalid-feedback" id="int_grp_err"></div>
																	...
																	<div class="row">
																		...
																		<div class="col-lg-8 fv-row fv-plugins-icon-container">
																			<select class="form-select form-select-solid" name="int_type" id="int_type" data-control="select2" data-hide-search="true" onchange="get_int_due_details()" tabindex="10">	
																				<option value="">Select</option>
																				
																			</select>
																			<div class="fv-plugins-message-container invalid-feedback" id="int_type_err"></div>
																		</div>
																		...
																		<div class="col-lg-8 fv-row">
																			...
																			<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(<?php echo base_url();?>assets/media/svg/avatars/jewel_blank.png)" id="get_capture_sel_image">
																					...
																					<label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-kt-initialized="1" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
																						...
																						<a href="#" class="menu-link flex-stack px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_camera" tabindex="11"><i class="fa fa-camera" aria-hidden="true"></i></a>
												...
												<div class="px-4" style="border-radius: 10px;padding-bottom: 17px;box-shadow: 0 5px 10px #00002947;">
													<div class="row mt-2">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container">
															...
															<input type="text" name="pledge_item" id="pledge_item" class="form-control form-control-lg1 form-control-solid" placeholder="Select Pledge Name" oninput="this.value = this.value.replace(/[^A-Za-z.0-9,- ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="12">
														...
														<div class="col-lg-1 fv-row fv-plugins-icon-container">
															...
															<input type="text" name="pl_description" id="pl_description" class="form-control form-control-lg1 form-control-solid" placeholder="Description" tabindex="13">
															<div class="fv-plugins-message-container invalid-feedback"></div>
														</div>
														<div class="col-lg-1 fv-row fv-plugins-icon-container">
															<label class=" fw-bold fs-7 ">Quality</label>
															<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="add_ptyname_new_loan" id="add_ptyname_new_loan" onchange="purity_percent()" tabindex="14"> 
														...
														<div class="col-lg-1 fv-row fv-plugins-icon-container">
															...
															<input type="text" name="purity_per" id="purity_per" class="form-control form-control-lg1 form-control-solid" placeholder="Purity %" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="15">
															<div class="fv-plugins-message-container invalid-feedback"></div>
														</div>
														<div class="col-lg-1 fv-row fv-plugins-icon-container">
															<label class=" fw-bold fs-7 ">Weight</label>
															<input type="text" name="weight_ple" id="weight_ple" class="form-control form-control-lg1 form-control-solid" placeholder="Weight" value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="16">
															<div class="fv-plugins-message-container invalid-feedback"></div>
														</div>
														<div class="col-lg-1 fv-row fv-plugins-icon-container">
															<label class=" fw-bold fs-7 ">Stone Wt</label>
															<input type="text" name="stone_weight" id="stone_weight" class="form-control form-control-lg1 form-control-solid" placeholder="St.Wgt" value="0" onkeyup="calc_net_wght_display();" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="17">
															<div class="fv-plugins-message-container invalid-feedback"></div>
														</div>
														<div class="col-lg-1 fv-row fv-plugins-icon-container">
															<label class=" fw-bold fs-7 ">Less</label>
															<input type="text" name="less_ple" id="less_ple" class="form-control form-control-lg1 form-control-solid" placeholder="Less" value="0" onkeyup="calc_net_wght_display();" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="18">
															<div class="fv-plugins-message-container invalid-feedback" ></div>
														</div>
														<div class="col-lg-3 fv-row fv-plugins-icon-container">
															<div class="row">
																...
																<div class="col-lg-3 fv-row fv-plugins-icon-container">
																	<label class=" fw-bold fs-7 ">Pur.Wt</label><br><br>
																	<label class=" fw-bold fs-7 " id="lbl_pur_wgt">0.00</label>
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
																<div class="col-lg-3 fv-row fv-plugins-icon-container">
																<!-- <div class="col-lg-1 d-flex align-items-center"> -->
																	<!-- <label class=" fw-bold fs-7 ">Is Damage?</label> -->
																	<label class=" fw-bold fs-7 ">Damage</label><br><br>
																	<label class="form-check form-check-inline form-check-solid is-invalid">
																		<input class="form-check-input" name="is_damage" type="checkbox"  id="is_damage" tabindex="19">
															...
															<div class="col-lg-3">
																<div class="image-input mt-2 me-6" data-kt-image-input="true">
																	<div class="image-input-wrapper w-40px h-40px" style="background-image: url(<?php echo base_url();?>assets/images/jewel.jpg)" id="pl_load_image_selected"></div>
																	<!--end::Preview existing avatar-->
																	<!--begin::Label-->
																	<div class="btn btn-icon btn-active-color-primary" data-kt-image-input-action="change" data-kt-menu-trigger="click" data-kt-menu-placement="top-end">
																		...
																		<a href="#" class="menu-link flex-stack px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_camera_pledge" tabindex="20"><i class="fa fa-camera" aria-hidden="true"></i></a>
														...
														<div class="col-lg-1">	
															<button type="button" class="btn btn-sm btn-success mb-2 mt-2" onclick="add_pledge_it()" style="padding:5px !important;" tabindex="21">
													...
													<table class="table table-striped table-hover table-row-bordered fs-7 gy-1 gs-2" id="kt_datatable_dom_positioning_add_loan">
														<thead>
															<tr class="fw-semibold fs-7 text-gray-800">
													            ...
													            <th class="min-w-40px">Pur. %</th>
													            <th class="min-w-70px">Wght (gms)</th>
													            <th class="min-w-70px">Stone Wgt (gms)</th>
													            <th class="min-w-70px">Less (gms)</th>
													            <th class="min-w-70px">Nt Wgt (gms)</th>
													            <th class="min-w-70px">Pur Wgt (gms)</th>
													            <th class="min-w-40px">Damage</th>
													...
													<div class="row">
														...
														<label class="col-lg-1 col-form-label fw-semibold fs-6" >Pur.Wgt</label>
														<label class="col-lg-1 col-form-label fw-bold fs-6" id="tot_pur_weight">0.000</label>
														...
														<label class="col-lg-1 col-form-label fw-bold fs-7" id="total_purity_percent">0.000</label>
														<!-- <div class="col-lg-1 fv-row fv-plugins-icon-container"> -->
													...
													<div class="row"> -->
														...
														<label class="col-lg-1 col-form-label fw-bold fs-6" id="grm_val">0.00	</label>
															<input type="hidden" name="grm_val_hidden" id="grm_val_hidden" value="0">
													
														<label class="col-lg-1 col-form-label fw-semibold fs-6" >SalesRate</label>
														<label class="col-lg-1 col-form-label fw-bold fs-6"  id="sale_rate">0.00</label>
														<input type="hidden" name="sale_rate_hidden" id="sale_rate_hidden">
														...
														<div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px" id="kt_activities_toggle" data-bs-toggle="modal" data-bs-target="#kt_modal_loan_calculator" tabindex="22">
														...
														<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
															...
															<div class="row">
																...
																<div class="col-lg-6 fv-row fv-plugins-icon-container">
																	<input type="text" name="loan_amount" id="loan_amount" class="form-control form-control-lg1 form-control-solid" style="font-size: 18px !important;font-weight: 700 !important;color: #1B439E !important;" onkeyup="calc_interest();" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');"  tabindex="23">
																	<div class="fv-plugins-message-container invalid-feedback" id="loan_amount_err"></div>
																</div>
																<!--end::Col-->
															</div>
															<div class="row">
															...
															<div class="row">
																...
																<!--begin::Col-->
																<div class="col-lg-3 fv-row fv-plugins-icon-container">
																	<input type="text" name="redemption_period" id="redemption_period" class="form-control form-control-lg1 form-control-solid" value="" oninput="this.value = this.value.replace(/[^0-9 ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="24">
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
																<!--end::Col-->
															...
															<div class="row">
																...
																<div class="col-lg-6 fv-row fv-plugins-icon-container">
																	<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="cust_rating" id="cust_rating" onchange="set_customer_rating()" tabindex="25">
													...
													<div class="col-lg-4">
														<div class="px-4" style="border-radius: 10px;padding-bottom: 15px;box-shadow: 0 5px 10px #00002947;">
															...
															<div class="row">
																...
																<!--begin::Col-->
																<div class="col-lg-6 fv-row fv-plugins-icon-container">
																	<input type="text" name="processing_charge" id="processing_charge" class="form-control form-control-lg1 form-control-solid" placeholder="Processing Charge" value="0" onkeyup="calc_charges();" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="26">
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
																<!--end::Col-->
															</div>
															...
															<div class="row">
																...
																<div class="col-lg-6">
																	<label class="form-check form-check-inline form-check-solid is-invalid mb-1">
																		<input class="form-check-input" name="charges_loan_amt" type="checkbox" value="checked" id="charges_loan_amt" onclick="txt_show_hide()" tabindex="27">
																		<span class="col-form-label fw-semibold fs-6">Loan Amt</span>
																	</label>
																	<label class="form-check form-check-inline form-check-solid is-invalid">
																		<input class="form-check-input" name="charges_pay_separate" type="checkbox" value="checked" id="charges_pay_separate" onclick="txt_show_hide()" tabindex="28">
																		<span class="col-form-label fw-semibold fs-6">Pay Separate</span>
																	</label>
																</div>

																<div class="row">
																	<label class="col-lg-3 col-form-label fw-semibold fs-6" id="lbl_charges_loan_pay_amt" style="display: none"> From loan</label>
																	<div class="col-lg-3 fv-row fv-plugins-icon-container">
																		<input type="text" name="charges_loan_pay_amt" id="charges_loan_pay_amt" class="form-control form-control-lg1 form-control-solid" value="0" style="display: none;" onkeyup="check_charges_less_than_total()" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="29">
																		<div class="fv-plugins-message-container invalid-feedback"></div>
																	</div>
																	<label class="col-lg-3 col-form-label fw-semibold fs-6" id="lbl_charges_pay_separate_amt" style="display: none">Pay Sep</label>
																	<div class="col-lg-3 fv-row fv-plugins-icon-container">
																		<input type="text" name="charges_pay_separate_amt" id="charges_pay_separate_amt" class="form-control form-control-lg1 form-control-solid" value="0" style="display: none;" onkeyup="check_charges_less_than_total()" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="30">
																		<div class="fv-plugins-message-container invalid-feedback"></div>
																	</div>
																</div>
															</div>
															<div class="row">
																...
																<!--begin::Col-->
																<div class="col-lg-6 fv-row fv-plugins-icon-container">
																	<input type="text" name="on_account" id="on_account"  value="0" onkeyup="enable_on_acc_pay();" class="form-control form-control-lg1 form-control-solid" placeholder="" style="background-color: #ff5b5b; color: white" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="31">
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
																<!--end::Col-->
															</div>
															<div id="div_on_account_pay" style="display: none;">
																<div class="row" >
																	...
																	<div class="col-lg-6">
																		<label class="form-check form-check-inline form-check-solid is-invalid mb-1">
																			<input class="form-check-input" name="on_acc_loan_pay" type="checkbox" value="checked" id="on_acc_loan_pay" onclick="txt_show_hide()" tabindex="32">
																			<span class="col-form-label fw-semibold fs-6">Loan Amt</span>
																		</label>
																		<label class="form-check form-check-inline form-check-solid is-invalid">
																			<input class="form-check-input" name="on_acc_pay_separate" type="checkbox" value="checked" id="on_acc_pay_separate" onclick="txt_show_hide()" tabindex="33">
																			<span class="col-form-label fw-semibold fs-6">Pay Separate</span>
																		</label>
																	</div>
																...
																<div class="row">
																	...
																	<div class="col-lg-3 fv-row fv-plugins-icon-container">
																		<input type="text" name="on_acc_loan_pay_amt" id="on_acc_loan_pay_amt" class="form-control form-control-lg1 form-control-solid" value="0" style="display: none;" onkeyup="check_on_acc_less_than_total()" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="34">
																		<div class="fv-plugins-message-container invalid-feedback"></div>
																	</div>
																	<label class="col-lg-3 col-form-label fw-semibold fs-6" id="lbl_on_acc_pay_separate_amt" style="display: none">Pay Sep</label>
																	<div class="col-lg-3 fv-row fv-plugins-icon-container">
																		<input type="text" name="on_acc_pay_separate_amt" id="on_acc_pay_separate_amt" class="form-control form-control-lg1 form-control-solid" value="0" style="display: none;" onkeyup="check_on_acc_less_than_total()" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="35">
																		<div class="fv-plugins-message-container invalid-feedback"></div>
																	</div>
																</div>
															</div><br>
															<div class="row mt-4">
																...
																<div class="col-lg-6 d-flex justify-content-end">
																	<p class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_payment_to_receive" id="btn_receive_payment" tabindex="36" style="display:none;">Receive</p>
																</div>
															</div>
														</div>
													</div>
													<div class="col-lg-4">
														<div class="px-4" style="border-radius: 10px;box-shadow: 0 5px 10px #00002947;">
															...
															<div class="row">
																...
																<div class="col-lg-4">
																	<p class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2" data-bs-toggle="modal" onclick="party_bank_details()" data-bs-target="#kt_modal_view_payment" id="btn_pay_now" tabindex="37">Pay Now</p>
																	<div class="fv-plugins-message-container invalid-feedback" id="to_pay_err" name="to_pay_err"></div>
																</div>
															</div>
															<div class="row">
															...
															<div class="row">
																<div class="col-lg-12 fv-row fv-plugins-icon-container">
																	<textarea class="form-control form-select-solid fw-semibold fs-5" rows="11" id="" tabindex="38"></textarea>
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
															</div>
														</div>
												...
												<div class="row">
													<div class="d-flex align-items-center">
														<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
															<input class="form-check-input" name="check_send_loan" type="checkbox"  id="check_send_loan" onclick="sanction_loan()" tabindex="39">
														</label>
												...
												<div class="d-flex justify-content-end">
													...
													<a href="" class="btn btn-primary" id="sec_disp" style="display: none;" tabindex="40" target="_blank" >Secondary Display</a>
													<button type="submit" class="btn btn-primary" id="save_changes_add_new_loan" tabindex="41" style="display:none">Send to Sanction</button>
												</div>
										  	</div>
											<!--end::Card body-->
										</form>
						...
						<div class="row mb-6">
							<div class="col-lg-3">
								...
								<div class=" fv-row fv-plugins-icon-container">
									<input type="text" name="weight" id="weight" class="form-control form-control-lg form-control-solid" placeholder="(in Gms)" onkeyup="calculate()" value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
							...
							<div class="col-lg-3">
								...
								<div class=" fv-row fv-plugins-icon-container">
									<input type="text" name="stone_less" id="stone_less" class="form-control form-control-lg form-control-solid" placeholder="(in Gms)" onkeyup="calculate()" value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
							...
							<div class="col-lg-3">
								...
								<div class=" fv-row fv-plugins-icon-container">
									<input type="text" name="less" id="less" class="form-control form-control-lg form-control-solid" placeholder="(in Gms)" onkeyup="calculate()" value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
							...
							<div class="col-lg-3">
								...
								<div class=" fv-row fv-plugins-icon-container">
									<input type="text" name="net_wt" id="net_wt" class="form-control form-control-lg form-control-solid" placeholder="(in Gms)" readonly value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
							...
							<div class="col-lg-3">
								...
								<div class=" fv-row fv-plugins-icon-container">
									<input type="text" name="cur_rate" id="cur_rate" class="form-control form-control-lg form-control-solid" placeholder="(in Rs)" onkeyup="calculate1()" value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
							...
							<div class="col-lg-3">
								...
								<div class=" fv-row fv-plugins-icon-container">
									<input type="text" name="quality" id="quality" class="form-control form-control-lg form-control-solid" placeholder="(in %)" onkeyup="calculate1()" value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
							...
							<div class="col-lg-3">
								...
								<div class=" fv-row fv-plugins-icon-container">
									<input type="text" name="grm_value" id="grm_value" class="form-control form-control-lg form-control-solid" placeholder="(in Rs)"  value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
							...
							<div class="col-lg-3">
								...
								<div class=" fv-row fv-plugins-icon-container">
									<input type="text" name="sales_rate" id="sales_rate" class="form-control form-control-lg form-control-solid" placeholder="(in Rs)"  value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
								...
								<!-- <div style="padding: 10px 10px 10px 10px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color:#f5f5f1 !important;"> -->
									...
									<div class="row">
										...
										<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
											<div class="d-flex align-items-center mt-1">
												<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
													<input class="form-check-input" name="chit_loan_paynow_add_radio" type="checkbox" value="1" id="chit_loan_paynow_add_radio" onclick="chit_ln_paynow_add_radio()">
												</label>
									...
									<div class="row">
										...
										<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cash_label_ln_pay_tbox" style="display:none;">
											<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="pay_to_party_calc()" value="0" name="pay_to_party_cash" id="pay_to_party_cash" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
											<div class="fv-plugins-message-container invalid-feedback"></div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-2 fv-row fv-plugins-icon-container"id="cheque_amt_ln_pay_tbox" style="display:none;">
											<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="pay_to_party_calc()" value="0"  name="pay_to_party_cheque_amount" id="pay_to_party_cheque_amount" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
											<div class="fv-plugins-message-container invalid-feedback"></div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rtgs_amt_ln_pay_tbox" style="display:none;">
											<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="pay_to_party_calc()" value="0" name="pay_to_party_rtgs_amount" id="pay_to_party_rtgs_amount" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
											<div class="fv-plugins-message-container invalid-feedback"></div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-2 fv-row fv-plugins-icon-container" id="upi_amt_ln_pay_tbox" style="display:none;">
											<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="pay_to_party_calc()" value="0" name="pay_to_party_upi_amount" id="pay_to_party_upi_amount" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
											<div class="fv-plugins-message-container invalid-feedback"></div>
										</div>
								...
								<!-- <div style="padding: 10px 10px 10px 10px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color:#f5f5f1 !important;"> -->
									...
									<div class="row">
										...
										<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cheque_amt_tbox" style="display:none;">
											<input type="text" name="p_receive_cheque_amount" id="p_receive_cheque_amount" class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="payment_receive_calc()" value="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
											<div class="fv-plugins-message-container invalid-feedback"></div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rtgs_amt_tbox" style="display:none;">
											<input type="text" class="form-control form-control-lg form-control-solid" name="p_receive_rtgs_amount" id="p_receive_rtgs_amount" placeholder="Amount" onkeyup="payment_receive_calc()" value="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
											<div class="fv-plugins-message-container invalid-feedback"></div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-2 fv-row fv-plugins-icon-container" id="upi_amt_tbox" style="display:none;">
											<input type="text" name="p_receive_upi_amount" id="p_receive_upi_amount" class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="payment_receive_calc()" value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');" >
											<div class="fv-plugins-message-container invalid-feedback"></div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-2" id="mem_card_redeem_tbox" style="display:none;">
											<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Redeem Points" name="mem_card_redeem_points" id="mem_card_redeem_points"  onkeyup="payment_receive_calc();" value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
											<div class="fv-plugins-message-container invalid-feedback"></div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_cl_sch_paid_from_pty_tbox" style="display:none;">
											<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Scheme" id="cust_cls_ppchit_scheme" name="cust_cls_ppchit_scheme" data-hide-search="true" onchange="cus_cl_scheme();">
										...
										<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_avai_bal_paid_from_pty" style="display:none;">
											<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Chit ID" data-hide-search="true" name="cust_cls_ppchit_number" id="cust_cls_ppchit_number" onchange="scheme_amount_deduct();">
										...
										<div class="col-lg-2" id="cus_cl_redeem_amt_paid_from_pty_tbox" style="display:none;">
											<input type="hidden" name="cus_cl_chit_amount" id="cus_cl_chit_amount" value="">
											<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Redeem Amount" name="cust_cls_ppchit_red_amount" id="cust_cls_ppchit_red_amount" onkeyup="payment_receive_calc()" value="0" oninput="this.value = this.value.replace(/[^0-9. ]/g, '').replace(/(\..*)\./g, '$1');">
											<div class="fv-plugins-message-container invalid-feedback"></div>
										</div>
									...
									<input type="hidden" id="error_no" name="error_no" value="0">
									<div class="d-flex justify-content-end mt-6 px-9">
										<button type="reset" class="btn btn-secondary me-3" data-bs-dismiss="modal">Cancel</button>
	...
	<div class="modal" id="kt_modal_view_loan_no" tabindex="-1" aria-hidden="true" style="background-color: #0000007a">
		<!--begin::Modal dialog-->
	...
	<script >
		...
		var span = document.querySelector('#last_name');
	        ...
	        $("#first_name").autocomplete({ 
				...
				$("#nom_name").autocomplete({ 
	                valueKey:'title',
	                source:[{
	                url:baseurl+'loan/nomineeList?query=%QUERY%',
	                type:'remote',
	                ajax:{
	                  dataType : 'json',
	                }
	            }]}).on('selected.xdsoft',function(e,suggestion,ui){ 
									$("#nom_id").val(suggestion.nom_id);
	                $("#nom_name").val(suggestion.nom_name);
	                $("#nom_mobile").val(suggestion.nom_mobile);
	                // alert($("#nom_relation").val());
	                // document.getElementById('nom_relation').text(suggestion.nom_relation);
	                // $("#nom_relation").selText val(suggestion.nom_relation);
	                // $("#nom_relation").val(suggestion.nom_relation).attr("selected",true);
	                // $('select[name^="nom_relation"] option:selected').attr("selected",null);
	                $("#nom_relation").val(suggestion.nom_relation);
	                // $('#nom_relation', suggestion.nom_relation).attr('defaultSelected', "selected");
					document.getElementById(suggestion.nom_relation).selected = 'selected';
	                // $('select[name^="nom_relation"] option[value="'+suggestion.nom_relation+'"]').attr("selected",true);
	        });
...
function cus_cl_scheme() 
{
	var pid= $("#first_name_id_hidden").val();
	var sch= $("#cust_cls_ppchit_scheme").val();
	$.ajax({
					type: "POST",
					url: baseurl+'loan/get_chit_list?',
					async: false,
					type: "POST",
					data: "id="+pid+"&sch="+sch,
					dataType: "html",
					success: function(response)
					{
							$('#cust_cls_ppchit_number').empty().append(response);
					}
					});
	
}
function scheme_amount_deduct()
{
		var pid= $("#first_name_id_hidden").val();
		var sch= $("#cust_cls_ppchit_scheme").val();
		var sch_id= $("#cust_cls_ppchit_number").val();
		$.ajax({
					type: "POST",
					url: baseurl+'loan/get_chit_amount?',
					async: false,
					type: "POST",
					data: "id="+pid+"&sch="+sch+"&sch_id="+sch_id,
					dataType: "html",
					success:function(response)
					{
					
							$('#cus_cl_chit_amount').val(response.trim());
					}
					});
}
...
function loan_interest()
{
	...
	if(cmp=='')
	{
			$('#company_err').html('Choose company');
...
function get_int_due_details()
{
	...
	if(cmp=='')
	{
			...
			$('#company_err').html("Choose a Company");
 			$('#int_type').empty();
			$('#int_type').val('');
			$('#int_grp').val('');
			document.getElementById("company").focus();
	...
	else
	{
		...
		// alert(loan_dt);
			...
			if(p_fname!="")
			{
				...
				var nom_relation = $('#nom_relation').val();
				var nom_mobile = $('#nom_mobile').val();
				...
				$.ajax({
						...
						async: false,
						type: "POST",
						data: "int_grp="+int_grp+"&int_type="+int_type+"&cmp="+cmp+"&pid="+pid+"&nid="+nid+"&jtype="+jtype+"&loandate="+loandate+"&p_fname="+p_fname+"&int_sch="+int_sch+"&int_per="+int_per+"&jewel_type="+jeweltype+"&nom_name="+nom_name+"&nom_relation="+nom_relation+"&nom_mobile="+nom_mobile,
						dataType: "html",
						success: function(response)
						{
							if(response==0)
							...
							else
							{
								...
								var bill_rp=$('#bill_no').val();
								var new_bill=bill_rp.replace('/',"_");
								path="<?php echo base_url();?>loan/sd_new_view/"+new_bill;
								// $('#sec_disp').attr=("href",path);
								document.getElementById('sec_disp').setAttribute('href', path);
								document.getElementById('sec_disp').style.display="block";
							}
...
function party_bank_details()
{
	var pid=$('#first_name_id_hidden').val();
	
	 $.ajax({
					type: "POST",
					url: baseurl+'loan/get_party_bank_details',
					async: false,
					type: "POST",
					data: "pid="+pid,
					dataType: "html",
					...
					{
						// alert(response);
		                $('#pay_to_party_cheque_party_bank').empty().append(response);
						$('#pay_to_party_upi_party_bank').empty().append(response);
						$('#pay_to_party_rtgs_party_bank').empty().append(response);
	...
	<script>
		...
		function add_pledge_it()
		{
			...
			var pur_weight=parseFloat(net_weight*(parseFloat(p_pur_per)/100)).toFixed(3);
		    ...
		    else
		    {
		    	...
		    	if(count==0)
			    {
			    	...
			    	$('#net_wt').val(parseFloat(net_weight).toFixed('3'));
						...
						// alert(cr);
						$('#tot_pur_weight').html(parseFloat(pur_weight).toFixed('3'));
						var tot=cr*(p_pur_per/100);
						// alert(tot);
						var tot_wt=parseFloat( tot*net_weight).toFixed(3);
						...
						calculate1();
						// var pl_it=$('#pledge_item_hidde0n'+count).val();
						// alert(pl_it);
			    }
			    else
			    {
				    	...
				    	var t_pl_pw=$('#tot_pur_weight').html();
				    	...
				    	t_pl_pw=parseFloat(t_pl_pw)+ parseFloat(pur_weight);
				    	...
				    	$('#tot_pur_weight').html(parseFloat(t_pl_pw).toFixed('3'));
			    ...
			    $.ajax({
				    	type: "POST",
							url: baseurl+'loan/temp_pledge_info?',
							async: false,
							type: "POST",
							data: "p_item="+p_item+"&p_description="+p_description+"&p_purity="+p_purity+"&p_pur="+p_pur+"&p_pur_per="+p_pur_per+"&p_weight="+p_weight+"&p_st_weight="+p_st_weight+"&p_less="+p_less+"&dmg="+dmg+"&bno="+bill_no,
							dataType: "html",
							success: function(response)
							{	
				                $('#purity_per').val(response.trim());
	...
	<script type="text/javascript">
		function remove_row(t)
		{
			...
			var p_item = $('#td_id_1'+t).text();
			var p_description = $('#td_id_2'+t).text();
			var p_quality = $('#td_id_3'+t).text();
			var p_pur = $('#td_id_4'+t).text();
			var p_pur_per = $('#td_id_4'+t).text();
			var p_weight=$('#td_id_5'+t).text();
			var p_st_weight=$('#td_id_6'+t).text();
			var p_less=$('#td_id_7'+t).text();
			var net_weight=$('#td_id_8'+t).text();
			var pur_weight=$('#td_id_9'+t).text();
			var dmg=$('#td_id_10'+t).text();
	    	...
	    	$('#weight').val(parseFloat(t_pl_w).toFixed('3'));
				...
				$('#less').val(parseFloat(t_pl_lw).toFixed('3'));
				$('#net_wt').val(parseFloat(t_pl_nw).toFixed('3'));
				// $('#pur_wt').val(parseFloat(t_pl_pw).toFixed('3'));
			...
			$.ajax({
				    	type: "POST",
							url: baseurl+'loan/temp_pledge_info_delete',
							async: false,
							type: "POST",
							data: "p_item="+p_item+"&p_description="+p_description+"&p_purity="+p_quality+"&p_pur="+p_pur+"&p_pur_per="+p_pur_per+"&p_weight="+p_weight+"&p_st_weight="+p_st_weight+"&p_less="+p_less+"&dmg="+dmg+"&bno="+bill_no,
							dataType: "html",
							success: function(response)
							{	
	...
	<script type="text/javascript">
		function edit_row(t,p)
		{
			...
			var p_less=$('#td_id_7'+t).text();
			var net_weight=$('#td_id_8'+t).text();
			var purity_weight=$('#td_id_9'+t).text();
			var is_dam=$('#td_id_10'+t).text();
	    	...
	    	t_pl_lw=parseFloat(t_pl_lw)- parseFloat(p_less);
	    	t_pl_nw=parseFloat(t_pl_nw)- parseFloat(net_weight);
			t_pl_pw=parseFloat(t_pl_pw)- parseFloat(purity_weight);
			...
			$.ajax({
							...
							async: false,
							type: "POST",
							data: "p_item="+p_name+"&p_description="+p_desc+"&p_purity="+p_qlty+"&p_pur_per="+p_pur+"&p_weight="+p_weight+"&p_st_weight="+p_st_weight+"&p_less="+p_less+"&bno="+bill_no,
							dataType: "html",
							success: function(response)
							{	
								//alert(response);
	...
	{
		var err=0;
		var receive_payment_balance= $('#lbl_ptr_bal_amt').html();
		var to_pay_balance =$('#lbl_bal_amt').html();
		var span_net_apy =$('#span_net_pay').html();
		var lbl_paid_amt =$('#lbl_paid_amt').html();
		// alert(receive_payment_balance);
		var fn= $('#first_name').val();
		var int_grp=$('#int_grp').val();
		var int_type=$('#int_type').val();
		
		if(int_grp ==""){
			$('#int_grp_err').html('Select Interest Scheme');
			err++;
		}
		else{
			$('#int_grp_err').html('');
		...
		else
		{
			...
			else
			{
				...
				if(loan_amt<=0)
				{
						$('#loan_amount_err').html("Enter Loan Amount ");
				...
				var charges_pay_separate_amt=$('#charges_pay_separate_amt').val();
				var span_net_pay =$('#span_net_pay').html();
				if(charges_pay_separate_amt >0){
					if(receive_payment_balance > 0){
						
						alert('Balance amount is Exists for payment to receive');
						err++;
					}
			}
			if(span_net_pay > 0){
				if(to_pay_balance > 0){
					...
					alert('Balance amount is Exists to pay');
					$('#to_pay_err').html('Balance amount is Exists to pay');
					err++;
				}
				
				if(span_net_pay < lbl_paid_amt){
					alert('Loan Net Pay is less than Paid Amount, Check Payment and Transaction Details');
					$('#to_pay_err').html('Loan Net Pay is less than Paid Amount');
					err++;
				}
			}
		...
		if(err>0){
			$('#kt_modal_view_loan_no').hide();
			return false;
		}else{
			$('#kt_modal_view_loan_no').show();
			return true;
		}
	}
	</script>
	<script>
			...
			{
				var chit_loan_received_add_radio = document.getElementById("chit_loan_received_add_radio");
				...
				if (chit_loan_received_add_radio.checked == true)
				{
		...
		<script>
			...
			function cheque_ln_paynow_add_radio()
			{
				...
				if (cheque_loan_paynow_add_radio.checked)
				{
			  	...
			  	else 
			  	{
				    ...
				    $('#pay_to_party_cheque_amount').val(0);
			...
			function rtgs_ln_paynow_add_radio()
			{
				...
				if (rtgs_loan_paynow_add_radio.checked == true)
				{
			  	...
			  	} else 
			  	{
				    ...
				    $('#pay_to_party_rtgs_amount').val(0);
			...
			function chit_ln_paynow_add_radio()
			{
				var chit_loan_paynow_add_radio = document.getElementById("chit_loan_paynow_add_radio");

				var chit_label_ln_pay = document.getElementById("chit_label_ln_pay");
				var chit_amt_ln_pay_tbox = document.getElementById("chit_amt_ln_pay_tbox");
				var chit_ref_ln_pay_tbox = document.getElementById("chit_ref_ln_pay_tbox");
				var chit_com_bank_ln_pay_tbox = document.getElementById("chit_com_bank_ln_pay_tbox");
				var chit_par_bank_ln_pay_tbox = document.getElementById("chit_par_bank_ln_pay_tbox");
				var chit_detail_ln_pay_tbox = document.getElementById("chit_detail_ln_pay_tbox");

				if (chit_loan_paynow_add_radio.checked == true)
				{
				    chit_label_ln_pay.style.display = "block";
				    chit_amt_ln_pay_tbox.style.display = "block";
				    chit_ref_ln_pay_tbox.style.display = "block";
				    chit_com_bank_ln_pay_tbox.style.display = "block";
				    chit_par_bank_ln_pay_tbox.style.display = "block";
				    chit_detail_ln_pay_tbox.style.display = "block";
			  	} else 
			  	{
			     	chit_label_ln_pay.style.display = "none";
				    chit_amt_ln_pay_tbox.style.display = "none";
				    $('#pay_to_party_chit_amount').val(0);
				    chit_ref_ln_pay_tbox.style.display = "none";
				    chit_com_bank_ln_pay_tbox.style.display = "none";
				    chit_par_bank_ln_pay_tbox.style.display = "none";
				    chit_detail_ln_pay_tbox.style.display = "none";
			  	}
			};
		</script>
		<script>
						...
						else
						{
							...
							else
							{
								...
								else
								{
										...
										//Begin - Add for processing charge
										var ch_fl=parseFloat($('#charges_loan_pay_amt').val());
										var fl= parseFloat($('#on_acc_loan_pay_amt').val());
										var ln_tot=fl+ch_fl;
										var ln_diff=d_l_amt-ln_tot;

										// alert(ln_diff);
										$('#span_net_pay').html(ln_diff);
										$('#lbl_net_pay').html(ln_diff);
										// $('#lbl_bal_amt').html(ln_diff);

										//end -Add for processing charge
		...
		{
			var p_per=parseFloat($('#purity_per').val());
			var wght=parseFloat($('#weight_ple').val());
			var st_wght=parseFloat($('#stone_weight').val());
			var le_wght=parseFloat($('#less_ple').val());
			// alert(wght);
			var res=parseFloat(wght-st_wght-le_wght).toFixed(3);
			$('#lbl_nt_wgt').html(res);
			var cal=(res*(p_per/100)).toFixed(3);
			$('#lbl_pur_wgt').html(cal);
			// lbl_pur_wgt
		}
		...
		function receive_from_party1()
		{
			...
			if(bal==0)
			{
				if(cash_loan_received_add_radio.checked)
				{
					...
					var pay_amt5=parseFloat($('#cust_cls_ppchit_red_amount').val());
					...
					var p_pid=$('#p_pid').val();
	     			...
	     			var tot=pay_amt+pay_amt1+pay_amt2+pay_amt3+pay_amt4+pay_amt5;
				...
				if(chit_loan_received_add_radio.checked)
				{
					var pay_type='Chit';
					var pay_amt=parseFloat($('#cust_cls_ppchit_red_amount').val());
					var pay_details=$('#cust_cls_ppchit_details').val();
					var pay_amt1=parseFloat($('#p_receive_cash').val());
					var pay_amt2=parseFloat($('#p_receive_cheque_amount').val());
					var pay_amt3=parseFloat($('#p_receive_rtgs_amount').val());
					var pay_amt4=parseFloat($('#p_receive_upi_amount').val());
					var pay_amt5=parseFloat($('#mem_card_redeem_points').val());

					var sch_type=$('#cust_cls_ppchit_scheme').val();
					var p_bank='';
					var ref_no=$('#cust_cls_ppchit_number').val();
					var c_bank='';
					var p_bill_no=$('#p_bill_no').val();
					var p_pid=$('#p_pid').val();
	     			
	     			var datastring="pay_type="+pay_type+"&pay_amt="+pay_amt+"&pay_details="+pay_details+"&p_bank="+p_bank+"&ref_no="+ref_no+"&c_bank="+c_bank+"&p_bill_no="+p_bill_no+"&p_pid="+p_pid+"&sch_type="+sch_type;
	     			var tot=pay_amt+pay_amt1+pay_amt2+pay_amt3+pay_amt4+pay_amt5;
	     			...
	     			else
	     			{
						$.ajax({
							...
							{	
								 ...
								 $.ajax({
									type: "POST",
									url: baseurl+'loan/chit_points?',
									async: false,
									type: "POST",
									data: "pid="+p_pid+"&points="+pay_amt+"&chit_no="+ref_no+"&bill_no="+p_bill_no,
									dataType: "html",
									success: function(response)
									{
										alert("Chit amount Deducted");
									}
								});
							}	
						});
		...
		function payment_receive_calc()
		{
			...
			var ct=parseFloat($('#cust_cls_ppchit_red_amount').val());

			var chit_check=document.getElementById('chit_loan_received_add_radio');
			var mem_card_check=document.getElementById('mem_card_loan_received_add_radio');
			...
			if (mem_card_check.checked == true){
				if(mc>0)
				{
			...
			if (chit_check.checked == true){
				if(ct>0)
				{
						var cus_cl_chit_amount=$('#cus_cl_chit_amount').val();
						var ent_val=$('#cust_cls_ppchit_red_amount').val();
						
						if(ent_val>cus_cl_chit_amount)
						{
								alert("Enter value less than "+cus_cl_chit_amount);
						}
				}
				else
				{
						alert("AMount not available in Chit. Could not deduct from chit");
						$('#cust_cls_ppchit_red_amount').val('0');
				}
		}
			// alert(c);
			var tot= c+ch+rt+up+mc+ct;
		...
		<script type="text/javascript">
			function txt_show_hide()
			{
				...
				else
				{
					...
					// document.getElementById('btn_receive_payment').style.display="none";
					$('#charges_pay_separate_amt').val(0);
				}
		...
		<script type="text/javascript">
			function check_charges_less_than_total()
			{
				...
				var ch_fl=parseFloat($('#charges_loan_pay_amt').val());
				var ch_ps=parseFloat($('#charges_pay_separate_amt').val());
				var lbl_paid_amt=parseFloat($('#lbl_paid_amt').html());
				...
				else
				{
					...
					$('#span_net_pay').html(ln_diff);
					$('#lbl_net_pay').html(ln_diff);
					final_bal_amt=ln_diff-lbl_paid_amt;
					$('#lbl_bal_amt').html(final_bal_amt);
				}				
			}
		</script>
		<script type="text/javascript">
		...
		<script >
			...
			$( "#popup_close" ).on('click',function() {
				// alert("hi");
	  				...
	  				$( "#frm_loan_submit" ).attr('action',"<?php echo base_url();?>loan/loan_save");
