								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6"  href="<?php echo base_url(); ?>Lock_in_lock_out/lock_out">Lock Out</a>
															</li>
															<li class="nav-item">
															...
															<div class="col-lg-4">
																<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
																	...
																	<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                                                        ...
                                                                        <form method="post" action="<?php echo base_url(); ?>Lock_in_lock_out/lock_out_history" >
																			<div class="mb-2">
                                     ...
                                     <th class="min-w-50px">Action</th>
												            ...
												            <td><?php 
												          			echo (is_null($hlist['weight'])?'0':$hlist['weight']); ?></td>
																		<td>
																			
 																			<?php 
 																					if($hlist['lock_reason']=='For BJ')
 																					{ ?>
 																					...
 																					<?php }
 																					else if($hlist['lock_reason']=='CCL')
 																					{?>
 																						<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="background-color:#b0dfff;border-radius: 8px;padding: 5px 15px 5px 15px;;border-radius: 8px;padding: 5px 15px 5px 15px;">CCL</span>
																						</label>
 																					<?php }
 																					else if($hlist['lock_reason']=='Renewal')
 																					{ ?>
 																					...
 																					<?php }
 																					else if($hlist['lock_reason']=='Customer Close')
 																					{ ?>
 																		...
 																		<td>
																			<span class="text-end">
																				<a href="<?php echo base_url(); ?>Lock_in_lock_out/lockout_view_history/<?php echo $hlist['id'];  ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
