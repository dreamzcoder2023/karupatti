										...
										<div class="card-header1 border-0 pt-6">
											<div class="row">
												...
												<!-- 	<div class="col-lg-3 d-flex justify-content-end">
														<a href="<?php echo base_url(); ?>Lotentry/Lotentry_add">
														<button type="button" data-bs-toggle="modal" data-bs-target="#" class="btn btn-primary my-10">New Loan Receipts</button></a>
													</div> -->
                                        ...
                                        <div class="row">
											...
											<div class="col-lg-2 fv-row">
												<div class="d-flex align-items-center">
													...
													<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->lot_date;?></label>
												</div>
											...
											<div class="col-lg-3 fv-row fv-plugins-icon-container">
												...
												<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->supplier;?></label>
											...
											<div class="col-lg-2 fv-row fv-plugins-icon-container">
												...
												<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->metal_type;?></label>
									...
									<!--<div class="row">
										...
										<div class="row mb-6" id="lot_gold">
											<table class="table table-striped border rounded table-hover fs-7 gs-2 gy-1" id="" >
															    ...
															    <tbody>
<?php 
foreach($lotentry_details as $llist){
?>
																<tr style="border: 1px solid #606060;">
														            <td>
														            	<?php echo $llist['lot_id'];?>
														            </td>
													            <td>
													            	
														         <?php echo $llist['item_name'];?>
													            </td>
													            <td>
												...
												<div class="row">
													...
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
														<!-- <input type="text" name="other_charges" id="other_charges" class="form-control form-control-lg form-control-solid" placeholder="charges" value="<?php echo $purchaseentry_view_list->CHARGES;?>" readonly> -->
															...
															<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php //echo $lotentry->charges;?></label>
													...
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
														...
														<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php // echo $lotentry->amount;?></label>
													...
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
														...
														<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->item_count;?></label>
													...
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
														<!-- <input type="text" name="total_weight" id="total_weight" class="form-control form-control-lg form-control-solid" placeholder="Weight" value="<?php echo $purchaseentry_view_list->TOTAL_WEIGHT;?>" readonly> -->
															<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->item_weight;?></label>
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
									...
									<div style="padding: 5px 5px 5px 5px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color: #f5f5f1;">
												<label class="col-form-label fw-bold fs-6">Payments Details</label>
                                                <div class="row">
												...
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cash_lt_ey_tbox">
														...
														<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->cash;?></label> 
												...
												<div class="row">
													...
													<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->cheque_amt;?></label> 
												...
												<div class="col-lg-2 fv-row fv-plugins-icon-container">
													...
													<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->cheque_bank;?></label> 

													<div class="fv-plugins-message-container invalid-feedback"></div>
												</div>
													<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cheque_lt_ey_label">Cheq.no: </label>
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cheque_lt_ey_tbox" >
														<!-- <input type="text" name="cheq_no" id="cheq_no" class="form-control form-control-lg form-control-solid" placeholder="Cheque Number" value="<?php echo $lotentry->cheque_number;?>" readonly> -->

														<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->cheque_number;?></label>
												...
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rtgs_lt_ey_tbox">
														...
														<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->rtgs_amt;?></label>
													...
													<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->rtgs_bank;?></label>
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rtgs_lt_ey_tbox">
														...
														<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->rtgs_number;?></label>
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
												</div>
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="purity_lt_ey_tbox">
														...
														<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->metal_purity;?></label>
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rate_lt_ey_tbox">
														...
														<label class="col-lg-8 col-form-label fw-semibold fs-6"><?php echo $lotentry->metal_amount;?></label>
												...
												<div class="row">
													...
													<label class="col-lg-1 col-form-label fw-bold fs-2" id="total_amount"><?php echo $lotentry->amount_to_pay;?></label>

													<!-- <input type="hidden" id="total_amount1" name="total_amount" value="<?php //echo $lotentry->TOTAL_AMOUNT;?>" readonly> -->
													<label class="col-lg-2 col-form-label fw-semibold fs-6">Paid Amount :</label>
													<label class="col-lg-1 col-form-label fw-bold fs-2" id="paid_amount_pay"><?php echo $lotentry->paid_amount;?></label>
													<!-- <input type="hidden" id="paid_amount_pay1" name="paid_amount_pay" value="<?php echo $lotentry->paid_amouont;?>" readonly> -->
													<label class="col-lg-2 col-form-label fw-semibold fs-6">Balance Amount :</label>
													<label class="col-lg-1 col-form-label fw-bold fs-2" id="bal_amount"><?php echo $lotentry->balance_amount;?></label>
	...
	<!--begin::Modal - New Lot Entry-->
	<div class="modal fade" id="kt_modal_add_lot_entry" tabindex="-1" aria-hidden="true">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-13 text-center">
							<h1 class="mb-3">New Lot Entry</h1>	
						</div>
						<!--end::Heading-->
						<div class="row">
							...
							<div class="col-lg-2 fv-row">
								<div class="d-flex align-items-center">
									...
									<!--end::Svg Icon-->
									<input class="form-control form-control-solid ps-12" name="date" placeholder="Date" id="kt_daterangepicker_lot_entry_add_date" value=""/>
								</div>
							</div>
							...
							<div class="col-lg-2 fv-row">
								<select class="form-select form-select-solid" name="" data-control="select2" data-hide-search="true">
									...
									<option value="0">Gopi</option>
									<option value="1">Arun</option>
									<option value="1">Vimal</option>
								</select>
							</div>
								<div class="col-lg-1 fv-row fv-plugins-icon-container">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Cr/Dr">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
							<label class="col-lg-1 col-form-label required fw-semibold fs-6">Type</label>
							<div class="col-lg-2 fv-row">
								<select class="form-select form-select-solid" name="" data-control="select2" data-hide-search="true" id="item_type" onchange="itm_ty();">
						...
						<div class="row">
							...
							<div class="row">
									<label class="col-lg-2 col-form-label fw-semibold fs-6 text-underlined">Current Rate  </label>
									<label class="col-lg-1 col-form-label fw-semibold fs-6">Gold : </label>
									<label class="col-lg-2 col-form-label fw-semibold fs-6">4563.00 </label>
									<label class="col-lg-1 col-form-label fw-semibold fs-6">Silver : </label>
									<label class="col-lg-2 col-form-label fw-semibold fs-6">57.53</label>			

							</div>

						</div>
						<div class="row mb-6" id="lot_gold" style="display: none;">
							<div class="accordion" id="kt_accordion_1">
							    <div class="accordion-item">
							        <h2 class="accordion-header" id="kt_accordion_1_header_1">
							            <button class="accordion-button fw-semibold fs-6 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#kt_accordion_1_body_1" aria-expanded="false" aria-controls="kt_accordion_1_body_1">
							                Gold Items
							            </button>
							        </h2>
							        <div id="kt_accordion_1_body_1" class="accordion-collapse collapse" aria-labelledby="kt_accordion_1_header_1" data-bs-parent="#kt_accordion_1" style="overflow: scroll !important;">
								            	...
								            	<div class="row">
													<div class="col-lg-12">
																...
																<div data-repeater-list="kt_docs_repeater_basic">
																	<div data-repeater-item="">
																		<div class="row">
																			...
																			<div class="col-lg-2 fv-row fv-plugins-icon-container">
																				<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Item Name">
																				<div class="fv-plugins-message-container invalid-feedback"></div>
																			</div>
																			<label class="col-lg-1 col-form-label fw-semibold fs-6">Purity</label>
																			<div class="col-lg-2 fv-row fv-plugins-icon-container">
																				<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Purity">
																				<div class="fv-plugins-message-container invalid-feedback"></div>
																			</div>
																			<label class="col-lg-1 col-form-label fw-semibold fs-6">Count</label>
																			<div class="col-lg-1 fv-row fv-plugins-icon-container">
															...
															<div class="row">
																...
																<label class="col-lg-2 col-form-label fw-semibold fs-6">Total Count</label>
							        ...
							        <div id="kt_accordion_1_body_2" class="accordion-collapse collapse" aria-labelledby="kt_accordion_1_header_2" data-bs-parent="#kt_accordion_1_header_2" style="overflow: scroll !important;">
							            <div class="accordion-body" style="height: 300px !important;overflow: show;">
							                <div style="padding: 5px 5px 5px 5px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color: #f5f5f1;">
								            	<div class="row">
													<div class="col-lg-12">
														<div id="kt_docs_repeater_basic_silver_add">
															<div class="form-group">
																<div data-repeater-list="kt_docs_repeater_basic_sl_add">
																	<div data-repeater-item="">
																		<div class="row">
																			<label class="col-lg-1 col-form-label fw-semibold fs-6">Name</label>
																			<div class="col-lg-2 fv-row fv-plugins-icon-container">
											...
											<div data-repeater-list="kt_docs_repeater_basic">
												<div data-repeater-item="">
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container">
															<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Item Type">
															<div class="fv-plugins-message-container invalid-feedback"></div>
														</div>
														<label class="col-lg-1 col-form-label fw-semibold fs-6">Name</label>
														<div class="col-lg-2 fv-row fv-plugins-icon-container">
						...
						<div style="padding: 5px 5px 5px 5px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color: #f5f5f1;">
							<label class="col-form-label fw-bold fs-6"><u>GOLD PAYMENT DETAILS</u></label>
							<div class="row">
								<label class="col-lg-1 col-form-label required fw-semibold fs-6">Charges</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Hallmark Charges" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
									<div class="d-flex align-items-center mt-1">
										<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
											<input class="form-check-input" name="" type="checkbox" value="1" id="cash_lot_entry_radio" onclick="cash_lt_ey_radio()">
										</label>
								...
								<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
									<div class="d-flex align-items-center mt-1">
										<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
											<input class="form-check-input" name="" type="checkbox" value="1" id="cheque_lot_entry_radio" onclick="cheque_lt_ey_radio()">
										</label>
								...
								<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
									<div class="d-flex align-items-center mt-1">
										<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
											<input class="form-check-input" name="" type="checkbox" value="1" id="rtgs_lot_entry_radio" onclick="rtgs_lt_ey_radio()">
										</label>
								...
								<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
									<div class="d-flex align-items-center mt-1">
										<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
											<input class="form-check-input" name="" type="checkbox" value="1" id="metal_lot_entry_radio" onclick="metal_lt_ey_radio()">
										</label>
							...
							<div class="row">
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cash_lt_ey_label" style="display: none;">Cash</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cash_lt_ey_tbox" style="display: none;">
									<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Cash" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cheque_lt_ey_label" style="display: none;">Cheque</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cheque_lt_ey_tbox" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Cheque" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="rtgs_lt_ey_label" style="display: none;">RTGS</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rtgs_lt_ey_tbox" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="RTGS Amount" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="bank_lt_ey_label" style="display: none;">Bank</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="bank_lt_ey_tbox" style="display: none;">
									<select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-allow-clear="true" data-placeholder="Select Bank Accounts">	
							...
							<div class="row">
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="metal_lt_ey_label" style="display: none;">Metal</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="metal_lt_ey_tbox" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Metal" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="purity_lt_ey_label" style="display: none;">Purity</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="purity_lt_ey_tbox" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Purity" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="rate_lt_ey_label" style="display: none;">Rate</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rate_lt_ey_tbox" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Pure Rate" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="mtamt_lt_ey_label" style="display: none;">Mt Amt</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="mtamt_lt_ey_tbox" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Metal Amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
							</div>
							<div class="row">
								<label class="col-lg-1 col-form-label required fw-semibold fs-6">Attd By</label>
								<div class="col-lg-2 fv-row">
									<select class="form-select form-select-solid" name="" data-control="select2" data-hide-search="true">
										<option value="">Select</option>
										<option value="0">Esakki</option>
										<option value="1">Priya</option>
										<option value="2">Roshan</option>
									</select>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6">Paid Amount</label>
								<label class="col-lg-2 col-form-label fw-bold fs-2" id="">10000</label>
							</div>
						</div>		
						<div class="row">
	...
	<!--end::Modal - New Lot Entry-->

	<!--begin::Modal - Modify Lot Entry-->
	<div class="modal fade" id="kt_modal_edit_lot_entry" tabindex="-1" aria-hidden="true">
		<!-- <form id="kt_add_product_form" class="form"> -->
			<!--begin::Modal dialog-->
			<div class="modal-dialog modal-xl">
				<!--begin::Modal content-->
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						<!--begin::Heading-->
						<div class="mb-13 text-center">
							<h1 class="mb-3">Modify Lot Entry</h1>	
						</div>
						<!--end::Heading-->
						<div class="row">
							<label class="col-lg-1 col-form-label fw-semibold fs-6">Lot No</label>
							<label class="col-lg-2 col-form-label fw-bold fs-6" id="">LN001/22</label>
							<label class="col-lg-1 col-form-label required fw-semibold fs-6">Date</label>
							<div class="col-lg-2 fv-row">
								<div class="d-flex align-items-center">
									<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
									...
									<!--end::Svg Icon-->
									<input class="form-control form-control-solid ps-12" name="date" placeholder="Date" id="kt_daterangepicker_lot_entry_edit_date" value="<?php echo date("d m Y"); ?>" />
								</div>
							</div>
							<label class="col-lg-1 col-form-label required fw-semibold fs-6">Supplier</label>
							<div class="col-lg-2 fv-row">
								<select class="form-select form-select-solid" name="" data-control="select2" data-hide-search="true">
									<option value="">Select</option>
									<option value="0">Gopi</option>
									<option value="1" selected="selected">Arun</option>
									<option value="1">Vimal</option>
								</select>
							</div>
							<label class="col-lg-1 col-form-label required fw-semibold fs-6">Type</label>
							<div class="col-lg-2 fv-row">
								<select class="form-select form-select-solid" name="" data-control="select2" data-hide-search="true" id="item_type_edit" onchange="itm_ty_edit();">
									<option value="">Select Type</option>
									<option value="gold">Gold</option>
									<option value="silver">Silver</option>
								</select>
						...
						<div class="row mb-6" id="lot_gold_edit" style="display: none;">
							<div class="accordion" id="kt_accordion_1">
							    <div class="accordion-item">
							        <h2 class="accordion-header" id="kt_accordion_1_header_1">
							            <button class="accordion-button fw-semibold fs-6 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#kt_accordion_1_body_1" aria-expanded="false" aria-controls="kt_accordion_1_body_1">
							        ...
							        <div id="kt_accordion_1_body_1" class="accordion-collapse collapse" aria-labelledby="kt_accordion_1_header_1" data-bs-parent="#kt_accordion_1" style="overflow: scroll !important;">
							            <div class="accordion-body" style="height: 300px !important;overflow: show;">
							            	<div style="padding: 5px 5px 5px 5px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color: #f5f5f1;">
								            	<div class="row">
													<div class="col-lg-12">
														<div id="kt_docs_repeater_basic_gold_edit">
															<div class="form-group">
																<div data-repeater-list="kt_docs_repeater_basic">
																	<div data-repeater-item="">
																		<div class="row">
																			<label class="col-lg-1 col-form-label fw-semibold fs-6">Name</label>
																			<div class="col-lg-2 fv-row fv-plugins-icon-container">
																				<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Item Name" value="Chain">
																				<div class="fv-plugins-message-container invalid-feedback"></div>
																			</div>
																			<label class="col-lg-1 col-form-label fw-semibold fs-6">Purity</label>
																			<div class="col-lg-2 fv-row fv-plugins-icon-container">
																				<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Purity" value="91">
																				<div class="fv-plugins-message-container invalid-feedback"></div>
																			</div>
																			<label class="col-lg-1 col-form-label fw-semibold fs-6">Count</label>
																			<div class="col-lg-1 fv-row fv-plugins-icon-container">
																				<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Count" value="2">
																				<div class="fv-plugins-message-container invalid-feedback"></div>
																			</div>
																			<label class="col-lg-1 col-form-label fw-semibold fs-6">Weight</label>
																			<div class="col-lg-2 fv-row fv-plugins-icon-container">
																				<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Weight" value="6.400">
																				<div class="fv-plugins-message-container invalid-feedback"></div>
																			</div>
																			<div class="col-lg-1">
																				<a href="javascript:;" data-repeater-delete="" class="btn btn-sm btn-danger mt-md-3 ">
															...
															<div class="row">
																...
																<label class="col-lg-2 col-form-label fw-semibold fs-6">Total Count</label>
																<label class="col-lg-1 col-form-label fw-bold fs-4">2</label>
																<label class="col-lg-2 col-form-label fw-semibold fs-6">Total Weight</label>
																<label class="col-lg-1 col-form-label fw-bold fs-4">6.400</label>
															</div>
														</div>
													</div>
												</div>
						...
						<div class="row mb-6" id="lot_silver_edit" style="display: none;">
							<div class="accordion" id="kt_accordion_1">
							    <div class="accordion-item">
							        <h2 class="accordion-header" id="kt_accordion_1_header_2">
							            <button class="accordion-button fw-semibold fs-6 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#kt_accordion_1_body_2" aria-expanded="false" aria-controls="kt_accordion_1_body_2">
							        ...
							        <div id="kt_accordion_1_body_2" class="accordion-collapse collapse" aria-labelledby="kt_accordion_1_header_2" data-bs-parent="#kt_accordion_1_header_2" style="overflow: scroll !important;">
							            <div class="accordion-body" style="height: 300px !important;overflow: show;">
							                <div style="padding: 5px 5px 5px 5px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color: #f5f5f1;">
								            	<div class="row">
													<div class="col-lg-12">
														<div id="kt_docs_repeater_basic_silver_edit">
															<div class="form-group">
																<div data-repeater-list="kt_docs_repeater_basic_sl_add">
																	<div data-repeater-item="">
																		<div class="row">
																			<label class="col-lg-1 col-form-label fw-semibold fs-6">Name</label>
																			<div class="col-lg-2 fv-row fv-plugins-icon-container">
																				<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Item Name" value="Hand Chain">
																				<div class="fv-plugins-message-container invalid-feedback"></div>
																			</div>
																			<label class="col-lg-1 col-form-label fw-semibold fs-6">Count</label>
																			<div class="col-lg-1 fv-row fv-plugins-icon-container">
						...
						<div style="padding: 5px 5px 5px 5px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color: #f5f5f1;">
							...
							<div class="row">
								<label class="col-lg-1 col-form-label required fw-semibold fs-6">Charges</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Hallmark Charges" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="120">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
									<div class="d-flex align-items-center mt-1">
										<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
											<input class="form-check-input" name="" type="checkbox" value="1" id="cash_lot_entry_radio_edit" onclick="cash_lt_ey_radio_edit()">
										</label>
										<label class="col-form-label fw-semibold fs-6 me-5">Cash</label>
									</div>
								</div>
								<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
									<div class="d-flex align-items-center mt-1">
										<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
											<input class="form-check-input" name="" type="checkbox" value="1" id="cheque_lot_entry_radio_edit" onclick="cheque_lt_ey_radio_edit()">
										</label>
										<label class="col-form-label fw-semibold fs-6">Cheque</label>
									</div>
								</div>
								<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
									<div class="d-flex align-items-center mt-1">
										<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
											<input class="form-check-input" name="" type="checkbox" value="1" id="rtgs_lot_entry_radio_edit" onclick="rtgs_lt_ey_radio_edit()">
										</label>
										<label class="col-form-label fw-semibold fs-6">RTGS</label>
									</div>
								</div>
								<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
									<div class="d-flex align-items-center mt-1">
										<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
											<input class="form-check-input" name="" type="checkbox" value="1" id="metal_lot_entry_radio_edit" onclick="metal_lt_ey_radio_edit()">
										</label>
										<label class="col-form-label fw-semibold fs-6">Metal</label>
									</div>
								</div>
							...
							<div class="row">
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cash_lt_ey_label_edit" style="display: none;">Cash</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cash_lt_ey_tbox_edit" style="display: none;">
									<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Cash" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="165000">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cheque_lt_ey_label_edit" style="display: none;">Cheque</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cheque_lt_ey_tbox_edit" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Cheque" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="rtgs_lt_ey_label_edit" style="display: none;">RTGS</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rtgs_lt_ey_tbox_edit" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="RTGS Amount" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="bank_lt_ey_label_edit" style="display: none;">Bank</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="bank_lt_ey_tbox_edit" style="display: none;">
									<select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-allow-clear="true" data-placeholder="Select Bank Accounts">	
										<option value="1">SBI</option>				
										<option value="2">TMB</option>
										<option value="3">IOB</option>
							...
							<div class="row">
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="metal_lt_ey_label_edit" style="display: none;">Metal</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="metal_lt_ey_tbox_edit" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Metal" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="purity_lt_ey_label_edit" style="display: none;">Purity</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="purity_lt_ey_tbox_edit" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Purity" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="rate_lt_ey_label_edit" style="display: none;">Rate</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rate_lt_ey_tbox_edit" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Pure Rate" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
								<label class="col-lg-1 col-form-label fw-semibold fs-6" id="mtamt_lt_ey_label_edit" style="display: none;">Mt Amt</label>
								<div class="col-lg-2 fv-row fv-plugins-icon-container" id="mtamt_lt_ey_tbox_edit" style="display: none;">
									<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Metal Amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-lg-2 fv-row">
									<select class="form-select form-select-solid" name="" data-control="select2" data-hide-search="true">
										<option value="">Select</option>
										<option value="0" selected="selected">Esakki</option>
										<option value="1">Priya</option>
										<option value="2">Roshan</option>
									</select>
								</div>
								<label class="col-lg-2 col-form-label fw-semibold fs-6">Paid Amount</label>
								<label class="col-lg-2 col-form-label fw-bold fs-2" id="">165120</label>
							</div>
						</div>		
						<div class="row">
							<div class="col-lg-9"></div>
	...
	<!--end::Modal - Modify Lot Entry-->

	<!--begin::Modal - View Lot Entry-->
	<div class="modal fade" id="kt_modal_view_lot_entry" tabindex="-1" aria-hidden="true">
...
function purchaseentry_view(val)
	{
		var baseurl= $("#baseurl").val();
		// alert(baseurl);
		$.ajax({
		type: "POST",
		url: baseurl+'Purchase_entry/purchaseentry_view',
		async: false,
		type: "POST",
		data: "id="+val,
		dataType: "html",
		...
		{
		$('#kt_modal_view_lot_entry').empty().append(response);
		$('#kt_modal_view_lot_entry').addClass('show');
		}
		});
	}
function CloseViewModallotentry()
	{
		var baseurl= $("#baseurl").val();
		$('#kt_modal_view_lot_entry').removeClass('show');
