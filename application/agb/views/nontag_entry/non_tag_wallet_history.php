						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Non Tagged Wallet
									<!--begin::Separator-->
									<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>Company &emsp;-</span>
										<span>&emsp;<?php if($company_id=='') { echo "All";  } else {  echo $company_id; } ?></span>
									</label>
									<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>Type &emsp;-</span>
									...
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>Date &emsp;-</span>
										<span>&emsp;<?php if(isset($dt_fill)) { echo $dt_fill; } else { echo "All"; } ?></span>
									</label>
									<!--end::Separator-->
									<!--begin::Description-->
									<!--end::Description--></h1>
											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link  btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" href="<?php echo base_url(); ?>Nontag_entry/nontag_wallet_view/<?php echo $item_name; ?>">Current Wallet</a>
															</li>
															<li class="nav-item">
																<a class="nav-link  active btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" data-bs-toggle="tab" href="#kt_tab_pane_2">Wallet History</a>
															</li>
														</ul>
													</div>
												</div>
														...
														<div class="row">
															<div class="col-lg-4">
																<div class="text-center">
																	<label class="form-label fs-2 fw-bold">Item</label>
																</div>
																<div class="text-center">
																	<label class="text-success fs-2 fw-bold"><?php $item = $this->db->query("SELECT * FROM ITEMS  WHERE SNO ='".$item_name ."'  ")->row(); echo $item->ITEMNAME; ?>  </label>
																</div>
															</div>
															<div class="col-lg-4">
																<div class="text-center">
																...
																<div class="text-center">
																	<label class="text-success fs-2 fw-bold"><?php $item_wallet = $this->db->query("SELECT SUM(COUNT) as tot_cnt,SUM(WEIGHT) as tot_wgt FROM ITEMS    ")->row(); echo $item_wallet->tot_cnt; ?></label>
																</div>
															</div>
															<div class="col-lg-4">
																<div class="text-center">
																...
																<div class="text-center">
																	<label class="text-success fs-2 fw-bold"><?php echo $item_wallet->tot_wgt; ?></label>
																</div>
															</div>
														</div>
														<div class="row">
															<table id="kt_datatable_non_tagged_wallet_current" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
																<thead>
																  <tr class="text-start text-muted fw-bold fs-7 gs-0">
																  	<th class="min-w-25px">Sno</th>
																   	<th class="min-w-100px">Date</th>
																   	<th class="min-w-150px">Company</th>
																    <th class="min-w-100px">Lot No</th>
																		<th class="min-w-50px">Count</th>
																		<th class="min-w-80px">Net Wgt(gms)</th>
																  </tr>
																</thead>
																<tbody class="text-gray-600 fw-semibold">
																<?php $i=1;  foreach($get_lot_no as $get_lot){
												            ...
												            <td>12-02-2023</td>
												            <td class="ple1"><?php
															 $company  = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='". $get_status->company_id."' ")->row();
															 echo $company->COMPANYNAME;
															 ?></td>
												            <td><?php echo $get_status->lot_no; ?></td>
												            <td><?php echo $get_lot['non_tagged']; ?></td>
												            <td><?php echo $get_lot['non_tagged_weight']; ?></td>
												       	  </tr>
														  <?php $i++; } } } ?>
													...
													<div class="tab-pane fade show active" id="kt_tab_pane_2" role="tabpanel">
															...
															<div class="col-lg-8">
																<div class="row">
																	<div class="col-lg-4">
																		...
																		<div class="text-center">
																			<label class="text-success fs-2 fw-bold"><?php echo $item->ITEMNAME; ?></label>
																		</div>
																	</div>
																	<div class="col-lg-4">
																		<div class="text-center">
																		...
																		<div class="text-center">
																			<label class="text-success fs-2 fw-bold"><?php if(isset($item->COUNT)){ echo $item->COUNT; }else{ echo "0"; }; ?></label>
																		</div>
																	</div>
																	<div class="col-lg-4">
																		<div class="text-center">
																		...
																		<div class="text-center">
																			<label class="text-success fs-2 fw-bold"><?php if(isset($item->WEIGHT)){ echo number_format($item->WEIGHT,3); }else{ echo "0"; }; ?></label>
																		</div>
																	</div>
																</div>
															</div>
															<div class="col-lg-4">
															<form method="POST" action="<?php echo base_url(); ?>Nontag_entry/nontag_wallet_view/<?php echo $item_name; ?>">
																	...
																	<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
																		<div class="px-7 py-5" data-kt-user-table-filter="form">
																			<div class="mb-2">
																				...
																				<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true" data-allow-clear="true" multiple="multiple" name="company_id" id="company_id">	
																...
																<option value="<?php echo $company_list['COMPANYCODE'] ;?>"><?php echo $company_list['COMPANYNAME'];?></option><?php
																			...
																			<input type="hidden" name="wallet_view" id="wallet_view" value="1">
																			<div class="mb-2">
																			...
																			<div class="mb-2 fv-row" id="from_dt_nontag_wallet_history" style="display:none;">
																				...
																				<div class="d-flex align-items-center">
																					...
																					<!--end::Svg Icon-->
																					<input class="form-control form-control-solid ps-12"  placeholder="From Date" id="from_date_fillter_nontag_wallet_history" name="from_date_fillter_nontag_wallet_history" value="<?php echo date("d-m-Y"); ?>" />
																				</div>
																			</div>
																			<div class="mb-2 fv-row" id="to_dt_nontag_wallet_history" style="display:none;">
																				...
																				<div class="d-flex align-items-center">
																					...
																					<!--end::Svg Icon-->
																					<input class="form-control form-control-solid ps-12"  placeholder="To Date" id="to_date_fillter_nontag_wallet_history" name="to_date_fillter_nontag_wallet_history" value="<?php echo date("d-m-Y"); ?>"/>
																				</div>
																			</div>
														...
														<div class="row">
															<table  class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
																...
																<tbody class="text-gray-600 fw-semibold">
																<?php $i=1; foreach($nontag_history as $nhlist){  ?>
																	<tr>
																		<td><?php echo $i; ?></td>
												            <td><?php 
															$date_format  = $this->db->query("SELECT * FROM general_settings  ")->row();
															$format= $date_format->date_format;
															echo date("$format", strtotime($nhlist['date']));
															//echo $nhlist['date'];	 ?></td>
												            <td class="ple1"><?php
															 $company  = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='". $nhlist['company']."' ")->row();
															 echo $company->COMPANYNAME;
															//echo $nhlist['company'];	 ?></td>
												            <td><?php  echo $nhlist['type'];	 ?></td>
												            <td><?php  echo $nhlist['id_no'];	 ?></td>
												            <td><?php  echo $nhlist['count'];	 ?></td>
												            <td><?php  echo $nhlist['purity'];	 ?></td>
												            <td><?php  echo number_format($nhlist['weight'],3);	 ?></td>
												            <td><?php  echo number_format($nhlist['stone_weight'],3);	 ?></td>
												            <td><?php  echo number_format($nhlist['net_weight'],3);	 ?></td>
												            <td class="">   <?php  if($nhlist['status']=="IN"){ ?>
																			...
																			<?php }  else{ ?>
																				<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="background-color:#46dcf9;border-radius: 8px;padding: 5px 15px 5px 15px;">Out</span>
																			</label>
																			<?php } ?>
																		</td>
												       	  </tr>
...
<form id="general_validate" style="width: 100%;" method="POST" action="<?php echo base_url(); ?>schedulereport/" enctype="multipart/form-data" onsubmit="return sort_pagination();">
...
<?php if($paging_info['curr_page'] > 1) : ?>
   ...
   <li class='paginate_button page-item ' > <a aria-controls='kt_roles_view_table' data-dt-idx='1' tabindex='0' class='page-link' href='' title='Page <?php echo ($paging_info['curr_page'] - 1); ?>'><</a></li>
<?php endif; ?>
...
<?php if($paging_info['curr_page'] >= $max) : ?>
   ...
   <li class='paginate_button page-item '><a aria-controls='kt_roles_view_table' data-dt-idx='1' tabindex='0' class='page-link' href='/agb/Nontag_entry/nontag_wallet_view/<?php echo $item_name; ?>?page=1' title='Page 1'>1</a></li>
    ..
...
<?php for($i = $sp; $i <= ($sp + $max -1);$i++) : ?>
    ...
    <?php if($paging_info['curr_page'] == $i) : ?>
        ...
        <li class='paginate_button page-item active'> <a aria-controls='kt_roles_view_table' data-dt-idx='1' tabindex='0' class='page-link' href='/agb/Nontag_entry/nontag_wallet_view/<?php echo $item_name; ?>?page=<?php echo $i; ?>' 
    ...
    <?php else : ?>
       ...
       <li class='paginate_button page-item '> <a aria-controls='kt_roles_view_table' data-dt-idx='1' tabindex='0' class='page-link' href='/agb/Nontag_entry/nontag_wallet_view/<?php echo $item_name; ?>?page=<?php echo $i; ?>' title='Page <?php echo $i; ?>'><?php echo $i; ?></a></li>
...
<?php if($paging_info['curr_page'] < ($paging_info['pages'] - floor($max / 2))) : ?>
    ...
    ..
    <li class='paginate_button page-item '><a  aria-controls='kt_roles_view_table' data-dt-idx='1' tabindex='0' class='page-link' href='/agb/Nontag_entry/nontag_wallet_view/<?php echo $item_name; ?>?page=<?php echo $coun; ?>'  title='Page <?php echo $paging_info['pages']; ?>'><?php echo $paging_info['pages']; ?></a></li>
...
<?php if($paging_info['curr_page'] < $paging_info['pages']) : ?>
  	...
  	<li class='paginate_button page-item '>  <a aria-controls='kt_roles_view_table' data-dt-idx='1' tabindex='0' class='page-link' href='/agb/Nontag_entry/nontag_wallet_view/<?php echo $item_name; ?>?page=<?php echo $c_page+1; ?>' title='Page <?php echo ($paging_info['curr_page'] + 1); ?>'>></a></li>
...
function get_paging_info($tot_rows,$pp,$curr_page)
{
    ...
    return $data; //return the paging data
		...
		<script>
			      $("#kt_datatable_non_tagged_wallet_current").kendoTooltip({
			        filter: "td",
			        show: function(e){
	   		...
	   		<script>
			      $("#kt_datatable_non_tagged_wallet_history").kendoTooltip({
			        filter: "td",
			        show: function(e){
			          if(this.content.text() !=""){
			            $('[role="tooltip"]').css("visibility", "visible");
		...
		<script>
			$("#kt_datatable_non_tagged_wallet_current").DataTable({
				"aaSorting":[],
				// "sorting":false,
				// "paging": false,
				// "responsive": true,
