...
<style>
	.dataTables_scroll
    {
        ...
        overflow: auto;
        min-height: 253px;
        max-height: 253px;/*the maximum height you want to achieve*/
        width: 100%;
    }
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
								...
								<div class="col-xxl-8">
														...
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item" style="display:none;">
																...
																<?php 
																		...
																		?>
																<a class="nav-link  btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" data-bs-toggle="tab" href="#kt_tab_pane_loan">Loan 
																	<?php if ($loan_count>0){?>
																				<span class="badge badge-danger  badge-circle badge-m text-light ms-1 <?php if ($loan_count>0){ echo 'animation-blink';}else{echo ''; } ?>"><?php echo (is_null($loan_count))?'0':$loan_count;
						                        	?></span>
			                            <?php } ?>
			                          </a>
																
															</li>
															<li class="nav-item" style="display:none;"><?php 
																	$user=$this->db->query("select * from USERLIST where USERNAME='".$_SESSION['username']."'")->row();
																	...
																	?>
																<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" data-bs-toggle="tab" href="#kt_tab_pane_inventory">Inventory
																	<?php if ($jewel_count>0){?>
																				<span class="badge badge-danger  badge-circle badge-m text-light ms-1 <?php if ($jewel_count>0){ echo 'animation-blink';}else{echo ''; } ?>"><?php echo (is_null($jewel_count))?'0':$jewel_count;
						                        	?></span>
			                            <?php } ?>
																</a>
															...
															<li class="nav-item">
																<?php 
																	...
																	?>
																<a class="nav-link active btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" data-bs-toggle="tab" href="#kt_tab_pane_others">Others
																	<?php if ($other_count>0){?>
																				<span class="badge badge-danger  badge-circle badge-m text-light ms-1 <?php if ($other_count>0){ echo 'animation-blink';}else{echo ''; } ?>"><?php echo (is_null($other_count))?'0':$other_count;
						                        	?></span>
			                            <?php } ?>
																</a>
									...
									<!--end::Toolbar-->
										...
										<div class="card-body py-4">
											...
											$user=$this->db->query("select * from USERLIST where USERNAME='".$_SESSION['username']."'")->row();
											$res=$this->db->query("select count(*) as not_count from notification where receiver_user_id='".$user->USERID."' AND Process='Others' AND  receiver_view_read_status='0'")->row();
											// echo (is_null($res->not_count))?'0':$res->not_count;
											?>
											<?php 
											$not_loan=$this->db->query("select * from notification where receiver_user_id='".$user->USERID."' AND  Process='Loan'   order by created_on desc")->result_array();
											$not_jewellery=$this->db->query("select * from notification where receiver_user_id='".$user->USERID."' AND Process='Inventory'  order by created_on desc")->result_array();
											$not_others=$this->db->query("select * from notification where receiver_user_id='".$user->USERID."' AND Process='Others'  order by created_on desc")->result_array();
											// print_r($not_loan);
											// print_r($not_jewellery);
											// print_r($not_others);exit;
											?>
											<div class="tab-content" id="myTabContent">
												<div class="tab-pane " id="kt_tab_pane_loan" role="tabpanel">
													<div class="d-flex justify-content-center">
														<div class="card w-lg-900px px-4 py-4">
															...
															<?php foreach($not_loan as $loan) { ?>
															<div class="d-flex flex-stack px-2 py-2 mb-1" <?php if($loan['receiver_view_read_status']=='0'){ ?>style="background-color:#e8f2ff;border-radius: 10px;" <?php } ?>>
																<div class="d-flex align-items-center">
																	...
																	<div class="mb-0 me-2">
																		<a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-bold" onclick="notification_read('<?php echo $loan['notification_id'];?>')"><label class="cursor-pointer"><?php echo $loan['header'];?></label></a>
																		<!-- <label><?php // echo $loan['process'];?></label>- -->
																		<div class="text-gray-400 fs-7"><label><?php echo $loan['message']; ?></label></div>
																	</div>
																</div>
																<span class="badge badge-light-success fs-8 me-1">
																	<?php echo get_time_ago(strtotime($loan['notification_date'])); ?>
																</span>
															</div>
															<?php } ?>
															<?php 
												...
												// print_r($not_others);exit;
												?>
												<div class="tab-pane fade" id="kt_tab_pane_inventory" role="tabpanel">
													<div class="d-flex justify-content-center">
														<div class="card w-lg-900px px-4 py-4">
															<div class="d-flex align-items-center justify-content-end px-2 py-2">
																<!-- <?php foreach($not_jewellery as $ipro) ?> -->
																<a href="javascript:;" onclick="mark_all('Inventory')" class="fs-6 text-gray-600 text-hover-primary fw-semibold">
																	<span>Mark all as read</span>
																</a>
															</div>
															<?php foreach($not_jewellery as $invent) { ?>
															<div class="d-flex flex-stack px-2 py-2 mb-1" <?php if($invent['receiver_view_read_status']=='0'){ ?>style="background-color:#e8f2ff;border-radius: 10px;" <?php } ?>>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-35px me-4">
																		<div class="image-input image-input-circle" data-kt-image-input="true" style="background-image: url(assets/images/staff_1.png)">
																		    <div class="image-input-wrapper w-50px h-50px" style="background-image: url(assets/images/Staff.jpg)"></div>
																	...
																	<div class="mb-0 me-2">
																		<a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-bold" onclick="notification_read('<?php echo $invent['notification_id'];?>')"><label><?php echo $invent['process'];?></label>-<label class="cursor-pointer"><?php echo $invent['header'];?></label></a>
																		<div class="text-gray-400 fs-7"><label><?php echo $invent['message']; ?></label></div>
																	</div>
																</div>
																<span class="badge badge-light-success fs-8 me-1">
																	<?php echo get_time_ago(strtotime($invent['notification_date'])); ?>
																</span>
															</div>
															<?php } ?>
															<?php 
												...
												$not_loan = $this->db->query("SELECT * FROM notification 
												                              WHERE receiver_user_id='".$user->USERID."' 
												                              AND Process='Loan' 
												                              AND created_on >= '".$three_months_ago."' 
												                              AND created_on <= '".$today."' 
												                              ORDER BY created_on DESC")->result_array();

												$not_jewellery = $this->db->query("SELECT * FROM notification 
												                                   WHERE receiver_user_id='".$user->USERID."' 
												...
												$not_others = $this->db->query($query)->result_array();
												...
												?>
												<div class="tab-pane fade show active" id="kt_tab_pane_others" role="tabpanel">
													<div class="d-flex justify-content-center">
														<div class="card w-lg-900px px-4 py-4">
															<div class="d-flex align-items-center justify-content-end px-2 py-2">
															...
															<?php foreach($not_others as $others) { ?>
															<div class="d-flex flex-stack px-2 py-2 mb-1" <?php if($others['receiver_view_read_status']=='0'){ ?>style="background-color:#e8f2ff;border-radius: 10px;" <?php } ?>>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-35px me-4">
																		<div class="image-input image-input-circle" data-kt-image-input="true" style="background-image: url(assets/images/staff_1.png)">
																		    <div class="image-input-wrapper w-50px h-50px" style="background-image: url(assets/images/Staff.jpg)"></div>
																	...
																	<div class="mb-0 me-2">
																		<a href="javascript:;" class="fs-6 text-gray-800 text-hover-primary fw-bold" onclick="notification_read('<?php echo $others['notification_id'];?>')"><label class="cursor-pointer">
																					<?php
																					echo str_replace("<br>"," - ",$others['header']);
																					?>
																			</a>
																		<div class="text-gray-400 fs-7"><label><?php echo $others['message']; ?></label></div>
																	</div>
																</div>
																<span class="badge badge-light-success fs-8 me-1">
																	<?php echo get_time_ago(strtotime($others['notification_date'])); ?>
																</span>
															</div>
															<?php } ?>
															<?php 
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-13 text-center">
							...
							<a href="javascript:;" class="link-primary fw-bold">Pricing Guidelines</a>.</div>
						</div>
						<!--end::Heading-->
						<!--begin::Plans-->
						<div class="d-flex flex-column">
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											...
											<a href="javascript:;" class="link-primary fw-bold">Help Page</a>.</div>
											<!--end::Notice-->
										</div>
										<!--end::Heading-->
										<!--begin::Input group-->
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-12">
											...
											<a href="javascript:;" class="link-primary">Campaign Guidelines</a></div>
											<!--end::Description-->
										</div>
										<!--end::Heading-->
										<!--begin::Input group-->
											...
											<div class="mh-300px scroll-y me-n7 pe-7">
												...
												<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
													<div class="d-flex align-items-center">
														...
														<!--begin::Details-->
														<div class="ms-6">
															<a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Product Specifications</a>
												...
												<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
													<div class="d-flex align-items-center">
														...
														<!--begin::Details-->
														<div class="ms-6">
															<a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Campaign Creative Poster</a>
												...
												<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
													<div class="d-flex align-items-center">
														...
														<!--begin::Details-->
														<div class="ms-6">
															<a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Campaign Landing Page Source</a>
												...
												<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
													<div class="d-flex align-items-center">
														...
														<!--begin::Details-->
														<div class="ms-6">
															<a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Landing Page Styling</a>
												...
												<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
													<div class="d-flex align-items-center">
														...
														<!--begin::Details-->
														<div class="ms-6">
															<a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Design Source Files</a>
												...
												<div class="d-flex flex-stack py-4">
													<div class="d-flex align-items-center">
														...
														<!--begin::Details-->
														<div class="ms-6">
															<a href="javascript:;" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Campaign Plan Document</a>
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div class="text-center mb-13">
							...
							<a href="javascript:;" class="link-primary fw-bold">FAQ Page</a>.</div>
							<!--end::Description-->
						</div>
						<!--end::Heading-->
		...
		<script>
			function notification_read(val){
				...
				var baseurl= $("#baseurl").val();
				$.ajax({		
						url: baseurl+'Notifications/notification_update',
						async: false,
						type: "POST",
						data: "id="+val,
						dataType: "html",
		...
		<script>
			...
			// $('#cash_in_hand_cmy').wrap('<div class="dataTables_scroll" />');
		</script>
		<script>
			...
			// $('#highest_amt_party').wrap('<div class="dataTables_scroll" />');
		</script>
