						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Old Gold List
									<!--begin::Separator-->
									...
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>Type &emsp;-</span>
										<span>&emsp;<?php if($type_fill==''){ echo "All"; }else{ echo $type_fill; } ?></span>
									</label>
									<!--<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
												...
												<div class="col-lg-2">
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
															...
															<form method="POST" action="<?php echo base_url(); ?>Old_gold">	
																<div class="mb-2">
																	<label class="form-label fs-6 fw-semibold">Company</label>
																	<select class="form-select form-select-solid" data-control="select2" data-close-on-select="true" data-allow-clear="true" multiple="multiple" name="company_fill" id="company_fill">
																...
																<div class="mb-2">
																	...
																	<select class="form-select form-select-solid" data-control="select2" data-close-on-select="true" data-allow-clear="true" multiple="multiple" name="type_fill" id="type_fill"> 
																		<option value="" >All</option>
																		<option value="Loan" <?php if($type_fill=='Loan'){ echo "selected"; } ?>>Loan</option>
																		<option value="Sales" <?php if($type_fill=='Sales'){ echo "selected"; } ?>>Sales</option>
																	</select>
																</div>
															<!--	<div class="mb-2">
										...
										<div class="card-body py-4">
											<table  class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
												...
												<?php $i=1; foreach($old_gold_list as $oglist){ ?>
											        <tr>
											        	<td><?php echo $i; ?></td>
											        	<td><?php
														 $date_format  = $this->db->query("SELECT * FROM general_settings  ")->row();
														 $format= $date_format->date_format;
														 echo date("$format", strtotime($oglist['date']));
														// echo $oglist['date'];  ?></td>
											        	<td class="ple1"><?php
														 $company  = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='". $oglist['company']."' ")->row();
														 echo $company->COMPANYNAME;
														// echo $oglist['company'];  ?></td>
											          <td><?php echo $oglist['type'];  ?></td>
											          <td><?php echo $oglist['ref_no'];  ?></td>
											        	<!--<td class="ple1">Gold</td>-->
											            <td><?php echo $oglist['item_count'];  ?></td>
											            <td><?php echo $oglist['item_weight'];  ?></td>
											            <!-- <td>
											            ...
											            <td>
																		<span class="text-end">
																			<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_view_pure_gold_wallet" onclick="old_gold_list_view('<?php  echo $oglist['ref_no']; ?>')">
...
function get_paging_info1($tot_rows,$pp,$curr_page)
{
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-5 px-5 px-xl-20">
						...
						<div class="row">
							...
							<label class="col-lg-2 col-form-label fw-bold fs-5" id="old_gold_date" name="old_gold_date" > </label>
							<label class="col-lg-1 col-form-label fw-semibold fs-6">Company</label>
							<label class="col-lg-3 col-form-label fw-bold fs-5" id="old_gold_company" name="old_gold_company"></label>
							<label class="col-lg-1 col-form-label fw-semibold fs-6">Type</label>
							<label class="col-lg-1 col-form-label fw-bold fs-5" id="old_gold_type" name="old_gold_type"></label>
							<div class="col-lg-3">
								<label class="col-form-label fw-semibold fs-6">By &emsp;</label>
								<label class="col-form-label fw-bold fs-5" id="old_gold_created_by" name="old_gold_created_by"></label>
							</div>
						</div>
						<div class="row">
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Total No of Item</label>
							<label class="col-lg-1 col-form-label fw-bold fs-5" id="old_gold_item_count" name="old_gold_item_count"></label>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Total Net Weight</label>
							<label class="col-lg-2 col-form-label fw-bold fs-5" id="old_gold_item_weight" name="old_gold_item_weight"> </label>
						...
						<table id="view_pure_gold_wallet_table" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable">
							...
							<tbody class="text-gray-600 fw-semibold" id="old_gold_table_rows" name="old_gold_table_rows">
	...
	$(document).ready(function() {
        ...
        $(".move_to").on("click", function () {
			value=$(this).val();
			// alert(value);
            $('#filter_form').attr('action', "<?php echo base_url(); ?>Old_gold?page="+value);
            $("#filter_form").submit();
            e.preventDefault();
        });
    });
...
<script>
function old_gold_list_view(val){
//  alert(val);
...
var baseurl= $("#baseurl").val();
				...
				$.ajax({
				type: "POST",
				url: baseurl+'Old_gold/old_gold_list_view',
				async: false,
				type: "POST",
				data: "id="+val,
				dataType: "html",
				...
				{
					res=response.split('||');
					$('#old_gold_date').html(res[1]);
					$('#old_gold_company').html(res[2]);
					$('#old_gold_type').html(res[3]);
					$('#old_gold_item_count').html(res[4]);
