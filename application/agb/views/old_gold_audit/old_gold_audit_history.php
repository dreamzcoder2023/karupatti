											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link  btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6"  href="<?php echo base_url(); ?>Old_gold_audit">Audit</a>
															</li>
															<li class="nav-item">
															...
															<div class="col-lg-4">
																<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
																	...
																	<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                                                        ...
                                                                        <form action="<?php echo base_url(); ?>Old_gold_audit/audit_history" method="POST">
																			<div class="mb-2">
                                                           ...
                                                           <?php  }  else{  ?>
                                                            ...
                                                            <?php if( $alist['additional_status']=='Mismatched'){ ?>
                                                                <?php if( $alist['status']=='Y'){ ?>
                                                                            ...
                                                                            <span class="text-end">
																				<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#kt_modal_tagged_audit_history_view" onclick="old_gold_audit_view(<?php  echo $alist['id']; ?>)">
				...
				<div class="modal-dialog modal-md">
					...
					<div class="modal-content rounded">
						...
						<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
							...
							<form action="<?php echo base_url(); ?>old_gold_audit/update_resolve" method="POST">
							<div class="row mt-4">
								<div class="d-flex justify-content-center align-items-center">
...
$(document).ready(function() {
    ...
    $(".move_to").on("click", function () {
        value=$(this).val();
        // alert(value);
        $('#filter_form').attr('action', "<?php echo base_url(); ?>Old_gold_audit/audit_history?page="+value);
        $("#filter_form").submit();
        e.preventDefault();
    });
});
...
<script>
        ...
        function old_gold_audit_view(val)
			{
                var baseurl= $("#baseurl").val();
                $.ajax({
				type: "POST",
				url: baseurl+'Old_gold_audit/old_gold_audit_view',
				async: false,
				type: "POST",
				data: "id="+val,
				dataType: "html",
