							...
							<div class="row gy-5 g-xl-8">
								...
								<div class="card-body py-4">
									...
									<div class="row mb-6">
										...
										<!--begin::Col-->
										<div class="col-lg-3 fv-row fv-plugins-icon-container">
											<input type="text" name="phone2" id="phone2" class="form-control form-control-lg form-control-solid" placeholder="Alt. Mobile" >
								...
								<div class="row">
									...
									<div class="col-lg-4 d-flex justify-content-center">
										<button class="btn btn-outline btn-sm btn-outline-solid btn-outline-warning btn-active-light-primary me-15" id="take_party_photo" onclick="take_party()">Take Photo</button>

										<button class="btn btn-outline btn-sm btn-outline-solid btn-outline-warning btn-active-light-primary me-15" id="p_snap" onclick="party_snapshot()" style="display: none;">Capture</button>
										
										<textarea hidden="hidden" id="party_photo_data" name="party_photo_data"></textarea>
									</div>
									<div class="col-lg-4 d-flex justify-content-center">
										<button class="btn btn-outline btn-sm btn-outline-solid btn-outline-warning btn-active-light-primary me-15" id="take_sign_photo" onclick="take_sign()">Take Signature</button>

										<button class="btn btn-outline btn-sm btn-outline-solid btn-outline-warning btn-active-light-primary me-15" id="s_snap" onclick="sign_snapshot()" style="display: none;">Capture</button>

										<textarea hidden="hidden" id="sign_photo_data" name="sign_photo_data"></textarea>
									</div>
									<div class="col-lg-4 d-flex justify-content-center">

										<button class="btn btn-outline btn-sm btn-outline-solid btn-outline-warning btn-active-light-primary me-15"  id="take_other_photo" onclick="take_other()">Take ID Photo</button>

										<button class="btn btn-outline btn-sm btn-outline-solid btn-outline-warning btn-active-light-primary me-15" id="o_snap" onclick="other_snapshot()" style="display: none;">Capture</button>
													...
													<div id="mcontent10">
														<div class="row" id="mid0">
															<div class="col-lg-1 fv-row">
																<select class="form-select form-select-solid" placeholder="Type" name="add_type[]" id="add_type0" onchange="show_hide_bank(0)">
															...
															<div class="col-lg-2 fv-row">
																<input type="text" class="form-control mb-2 mb-md-0" placeholder="Branch Name" name="add_branch_name[]" id="add_branch_name0" style="display: none;">
															</div>
															<div class="col-lg-2 fv-row">
																<input type="text" class="form-control mb-2 mb-md-0" placeholder="IFSC Code" name="add_ifsc_code[]" id="add_ifsc_code0" style="display: none;">
															</div>
															<!-- <div class="col-lg-2 fv-row">
