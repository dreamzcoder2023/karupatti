						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">New Purchase Entry
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Purchase_entry/puchase_entry_save" enctype="multipart/form-data" onsubmit="purchase_entry_validation();">
											<!--begin::Heading-->
											...
											<div class="row">
												...
												<!--begin::Select-->
													<select class="form-select form-select-solid" data-control="select2" name="supplier_list_newpurchase"  id="supplier_list_newpurchase" data-hide-search="true">
														...
														{?>
														<option value="<?php echo $supplierslist['LEDGER_NAME'] ;?>"><?php echo $supplierslist['LEDGER_NAME'].'-'.$supplierslist['OP_SIDE'].'-'.$supplierslist['OP_BALANCE'];?></option><?php
														 }?>
													</select>
													<!--end::Select-->
												        ...
												        <div id="kt_accordion_1_body_1" class="accordion-collapse collapse" aria-labelledby="kt_accordion_1_header_1" data-bs-parent="#kt_accordion_1" style="overflow: scroll !important;">
															...
															?>
																<tr>
														            ...
														            <td><input type="text" class="form-control_tex form-control-lg_tex form-control-solid_tex autocomplete" name="subitem_gold[]" id="<?php echo $sb;?>" onclick="sub_item_name(event);">
														            </td>
