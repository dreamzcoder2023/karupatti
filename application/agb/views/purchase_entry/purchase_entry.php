						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Purchase Entry List
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-header1 border-0 pt-6">
											<div class="row">
												...
												<!-- 	<div class="col-lg-3 d-flex justify-content-end">
														<a href="<?php echo base_url(); ?>Purchase_entry/add_purchase_entry">
														<button type="button" data-bs-toggle="modal" data-bs-target="#" class="btn btn-primary my-10">New Loan Receipts</button>
													</div> -->
													<div class="col-lg-auto pt-9">
														<a href="<?php echo base_url(); ?>Purchase_entry/add_purchase_entry">
													<!--begin::Add user-->
													<button type="button" class="btn btn-primary">New Purchase Entry</button>
													<!--end::Add user-->
														</div>
										...
										<div class="card-body py-4">
											<form method="POST" action="<?php echo base_url(); ?>Purchase_entry" enctype="multipart/form-data">
											<!--begin::Table-->
											<table id="kt_datatable_responsive" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable">
												<thead>
												   <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
													...
													<th class="min-w-80px">No.of Products</th>
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													$i=1; foreach($Lotentry_list as $lotentrylist){?>
													<tr>
														<td class="cy"><?php echo $lotentrylist['ENTRY_DATE'];?></td>
														<td><?php echo $lotentrylist['LOT_ID'];?></td>
														<td><?php echo $lotentrylist['METAL_TYPE'];?></td>
														<td><?php echo $lotentrylist['TOTAL_COUNT'];?></td>
														<td><?php echo $lotentrylist['SUPPLIER'];?></td>
														<td><?php echo $lotentrylist['PAID_AMOUNT'];?></td>
														<td><?php echo $lotentrylist['BALANCE_AMT'];?></td>
														<td>
															<span class="text-end">
																<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_view_lot_entry"
																onclick="purchaseentry_view('<?php echo $lotentrylist['LOT_ID'];?>')">
												...
												<tfoot>
												   <tr class="text-start text-muted fw-bold fs-4 text-uppercase gs-0">
														...
														<th class="min-w-50px"></th>
														<th class="min-w-50px"></th>
														<th class="min-w-125px" style="width: 10%;"><span class="text-end"></span></th>
												    </tr>
												</tfoot>
												<?php $i++;}?>
											</table>
...
function CloseViewModallotentry()
	{
		...
		window.location.href = baseurl+'Purchase_entry';
	}
</script>
	</body>
	<!--end::Body-->
