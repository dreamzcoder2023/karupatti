											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6"  href="<?php echo base_url(); ?>Purchase_return/nontag_return">Return</a>
															</li>
															<li class="nav-item">
													...
													<div class="tab-pane fade " id="kt_tab_pane_1" role="tabpanel">
													    ...
													    <tbody class="text-gray-600 fw-semibold">
													        ...
													        <tr>
													          ...
													          <td>22.300</td>
													          <td>
													          	<input type="text" class="form-control form-control-lg form-control-solid fs-7" value="1">
													          </td>
													          <td>
													          	<input type="text" class="form-control form-control-lg form-control-solid fs-7" value="2.300">
													          </td>
													        </tr>
													        <tr>
													        	<td>2</td>
													          ...
													          <td>
													          	<input type="text" class="form-control form-control-lg form-control-solid fs-7" value="3.200">
													          </td>
													        </tr>
													        <tr>
													        	<td>3</td>
													          ...
													          <td>15.500</td>
													          <td>
													          	<input type="text" class="form-control form-control-lg form-control-solid fs-7" value="2">
													          </td>
													          <td>
													          	<input type="text" class="form-control form-control-lg form-control-solid fs-7" value="7.500">
													          </td>
													        </tr>
													        <tr>
													        	<td>4</td>
													          ...
													          <td>
													          	<input type="text" class="form-control form-control-lg form-control-solid fs-7" value="4.500">
													          </td>
													        </tr>
													    </tbody>
														</table>
													...
													<div class="tab-pane fade show active" id="kt_tab_pane_2" role="tabpanel">
															...
															<div class="col-lg-4">
																<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
																	...
																	<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
																		...
																		<form action="<?php echo base_url(); ?>Purchase_return/nontag_return_history" method="POST">
																			<div class="mb-2">
														...
														<div class="row">
												            ...
												            <td><?php echo $nlist['weight']; ?></td>
																		<td>
																			<span class="text-end">
																				<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_view_purchase_retn_tag_history" onclick="nontag_history_view(<?php echo $nlist['id']; ?>)">
					...
					<div class="modal-body pt-0 pb-5 px-5 px-xl-20">
						...
						<div class="row">
							<div class="col-lg-2">
								...
								<label class="col-form-label fw-bold fs-6" id="view_date" name="view_date">02-03-2023</label>
							</div>
							<div class="col-lg-3">
								<label class="col-form-label fw-semibold fs-6">User &emsp;</label>
								<label class="col-form-label fw-bold fs-6" id="view_user" name="view_user">Roshan</label>
							</div>
							<div class="col-lg-2">
								<label class="col-form-label fw-semibold fs-6">Count &emsp;</label>
								<label class="col-form-label fw-bold fs-6" id="view_count" name="view_count">5</label>
							</div>
							<div class="col-lg-4">
								<label class="col-form-label fw-semibold fs-6">Net Weight(gms) &emsp;</label>
								<label class="col-form-label fw-bold fs-6" id="view_weight" name="view_date">17.500</label>
							</div>
...
$(document).ready(function() {
    ...
    $(".move_to").on("click", function () {
        value=$(this).val();
        // alert(1);
        $('#filter_form').attr('action', "<?php echo base_url(); ?>Purchase_return/nontag_return_history?page="+value);
        $("#filter_form").submit();
        e.preventDefault();
    });
});
        ...
        <script>
		function nontag_history_view(val){
//  alert(val);
...
var baseurl= $("#baseurl").val();
				...
				$.ajax({
				type: "POST",
				url: baseurl+'Purchase_return/nontag_history_view',
				async: false,
				type: "POST",
				data: "id="+val,
				dataType: "html",
				success: function(response)
				{
					...
					$('#view_count').html(res[3]);
					$('#view_weight').html(res[4]);
				    $('#view_row').empty().append(res[5]);
