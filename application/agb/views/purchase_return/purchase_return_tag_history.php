											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link  btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6"  href="<?php echo base_url(); ?>Purchase_return">Return</a>
															</li>
															<li class="nav-item">
												...
												<div class="tab-content" id="myTabContent">
													<div class="tab-pane " id="kt_tab_pane_1" role="tabpanel">
														<div class="row">
														...
														<div class="row">
															<div class="d-flex justify-content-center align-items-center">
																<div class="col-lg-2">
																	...
																	<label class="col-form-label fw-bold fs-4">3</label>
																</div>
																<div class="col-lg-3">
																	<label class="col-form-label fw-bold fs-4">Net Weight(gms) &emsp;</label>
																	<label class="col-form-label fw-bold fs-4">8.000</label>
																</div>
															</div>
														</div>
													...
													<div class="tab-pane fade show active" id="kt_tab_pane_2" role="tabpanel">
															...
															<div class="col-lg-4">
																<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
																	...
																	<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
																		...
																		<form action="<?php echo base_url(); ?>Purchase_return/tag_return_history" method="POST">
																			<div class="mb-2">
														...
														<div class="row">
															<table id="kt_datatable_non_tagged_wallet_history" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
																...
																<tbody class="text-gray-600 fw-semibold">
                                                                <?php $i=0; foreach($nontag_return_list as $nlist){ ?>
																	<tr>
																		<td><?php echo $i+1; ?></td>
												            <td><?php
															 $date_format  = $this->db->query("SELECT * FROM general_settings  ")->row();
															 $format= $date_format->date_format;
															 echo date("$format", strtotime($nlist['date']));
															// echo $nlist['date']; ?></td>
												            <!--<td><?php echo $nlist['created_on']; ?></td>-->
												            <td><?php echo $nlist['created_by']; ?></td>
												            <td><?php echo $nlist['count']; ?></td>
												            <td><?php echo $nlist['weight']; ?></td>
																		<td>
																			<span class="text-end">
																				<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_view_purchase_retn_tag_history" onclick="tag_history_view(<?php echo $nlist['id']; ?>)">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-5 px-5 px-xl-20">
						...
						<div class="row">
							...
							<label class="col-lg-3 col-form-label fw-bold fs-6" id="view_date" date="view_date">02-03-2023</label>
							<!--<label class="col-lg-1 col-form-label fw-semibold fs-6">Company</label>
							<label class="col-lg-4 col-form-label fw-bold fs-6" id="view_company" date="view_company">AGB - Main Branch Sayalkudi</label>-->
							<label class="col-lg-1 col-form-label fw-semibold fs-6">User</label>
							<label class="col-lg-2 col-form-label fw-bold fs-6" id="view_user" date="view_user">Roshan</label>
							<label class="col-lg-1 col-form-label fw-semibold fs-6">Count</label>
							<label class="col-lg-2 col-form-label fw-bold fs-6" id="view_count" date="view_count">3</label>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Net Weight(gms)</label>
							<label class="col-lg-2 col-form-label fw-bold fs-6" id="view_weight" date="view_weight">8.000</label>
							...
							<table id="kt_datatable_purchase_return_tagged_history_view_table" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
								...
								<tbody class="text-gray-600 fw-semibold" id="view_row" name="view_row">
			...
			<div class="modal-dialog modal-xl">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-5 px-5 px-xl-20">
						...
						<div class="row">
							<label class="col-lg-1 col-form-label fw-semibold fs-6">Count</label>
							<label class="col-lg-1 col-form-label fw-bold fs-4">5</label>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Weight(gms)</label>
							<label class="col-lg-1 col-form-label fw-bold fs-4">17.500</label>
							<div class="col-lg-3">
							...
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Based on Purity(%)</label>
							<div class="col-lg-1 fv-row fv-plugins-icon-container">
								<input type="text" name="" class="form-control form-control-lg1 form-control-solid">
								<div class="fv-plugins-message-container invalid-feedback"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Pure Metal(gms)</label>
							<label class="col-lg-1 col-form-label fw-bold fs-4">0.00</label>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Pure Metal Purity(%)</label>
							<div class="col-lg-1 fv-row fv-plugins-icon-container">
								<input type="text" name="" class="form-control form-control-lg1 form-control-solid">
								<div class="fv-plugins-message-container invalid-feedback"></div>
							</div>
							<div class="col-lg-3">
								<label class="col-form-label fw-semibold fs-6">Actual Pure &emsp;</label>
								<label class="col-form-label fw-bold fs-4">0.000</label>
							</div>
						</div>
						<div class="row">
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Based on Pure Metal Weight(gms)</label>
							<div class="col-lg-1 fv-row fv-plugins-icon-container">
								<input type="text" name="" class="form-control form-control-lg1 form-control-solid">
								<div class="fv-plugins-message-container invalid-feedback"></div>
							</div>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Purity (%)</label>
							<label class="col-lg-1 col-form-label fw-bold fs-4">0.00</label>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Pure Metal Purity(%)</label>
							<div class="col-lg-1 fv-row fv-plugins-icon-container">
								<input type="text" name="" class="form-control form-control-lg1 form-control-solid">
...
$(document).ready(function() {
    ...
    $(".move_to").on("click", function () {
        value=$(this).val();
        // alert(1);
        $('#filter_form').attr('action', "<?php echo base_url(); ?>Purchase_return/tag_return_history?page="+value);
        $("#filter_form").submit();
        e.preventDefault();
    });
});
...
var baseurl= $("#baseurl").val();
				...
				$.ajax({
				type: "POST",
				url: baseurl+'Purchase_return/tag_history_view',
				async: false,
				type: "POST",
				data: "id="+val,
				dataType: "html",
				success: function(response)
				{
					...
					$('#view_user').html(res[2]);
					$('#view_company').html(res[3]);
					$('#view_count').html(res[4]);
					$('#view_weight').html(res[5]);
				    $('#view_row').empty().append(res[6]);
