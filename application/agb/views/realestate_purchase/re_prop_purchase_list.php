	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
												...
												<div class="col-lg-4">
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<button type="button" class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
															...
															Filter</button>
														<div class="menu menu-sub menu-sub-dropdown w-200px w-md-325px" data-kt-menu="true">
															<div class="px-7 py-5" data-kt-user-table-filter="form">
																<form method="POST" action="<?php echo base_url(); ?>Realestatepurchase" id="fill_form">
																	<div class="scroll-y mh-325px my-1 px-1">
																		...
																		<div class="mb-2">
																			...
																			<select class="form-select form-select-solid" data-control="select2" data-hide-search="false" name="dt_fill_pur_list" id="dt_fill_pur_list" onchange="date_fill_pur_list();">	
																		...
																		<div class="mb-2 fv-row" id="today_dt_repor_pur_list" style="display:none;">
																		...
																		<div class="mb-2 fv-row" id="week_from_dt_repor_pur_list" style="display:none;">
																			...
																			<div class="d-flex align-items-center">
																				...
																				<!--end::Svg Icon-->
																				<input class="form-control form-control-solid ps-12" name="" placeholder="Date" id="week_from_date_fillter_repor_pur_list" value="" disabled />
																			</div>
																		</div>
																		<div class="mb-2 fv-row" id="week_to_dt_repor_pur_list" style="display:none;">
																			...
																			<div class="d-flex align-items-center">
																				...
																				<!--end::Svg Icon-->
																				<input class="form-control form-control-solid ps-12" name="" placeholder="Date" id="week_to_date_fillter_repor_pur_list" value="<?php echo date("d-m-Y"); ?>" disabled />
																			</div>
																		</div>
																		<div class="mb-2 fv-row" id="monthly_dt_repor_pur_list" style="display:none;">
																			...
																			<div class="d-flex align-items-center">
																				...
																				<!--end::Svg Icon-->
																				<input class="form-control form-control-solid ps-12" name="monthly_date_fillter_repor_pur_list" placeholder="Month" id="monthly_date_fillter_repor_pur_list" value="<?php echo date("m-Y"); ?>" />
																			</div>
																		</div>
																		<div class="mb-2 fv-row" id="from_dt_repor_pur_list" style="display:none;">
																			<label class="form-label">From</label>
																			<div class="d-flex align-items-center">
																				<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
																				<span class="svg-icon position-absolute ms-4 svg-icon-2 dt">
																				...
																				<!--end::Svg Icon-->
																				<input class="form-control form-control-solid ps-12" name="from_date_fillter_repor_pur_list" placeholder="From Date" id="from_date_fillter_repor_pur_list" value="<?php echo date("d-m-Y"); ?>" />
																			</div>
																		</div>
																		<div class="mb-2 fv-row" id="to_dt_repor_pur_list" style="display:none;">
																			<label class="form-label">To</label>
																			<div class="d-flex align-items-center">
																				<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
																				<span class="svg-icon position-absolute ms-4 svg-icon-2 dt">
																				...
																				<!--end::Svg Icon-->
																				<input class="form-control form-control-solid ps-12" name="to_date_fillter_repor_pur_list" placeholder="To Date" id="to_date_fillter_repor_pur_list" value="<?php echo date("d-m-Y"); ?>"/>
																			</div>
																		</div>
														...
														<a href="<?php echo base_url();?>Realestatepurchase/realestate_property_purchase_entry" target="_blank">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<table id="realestate_purchase_table" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable no-footer">
												<thead>
												...
												<tbody class="text-gray-600 fw-semibold">
													<?php if(isset($pro_pur_list)){  foreach($pro_pur_list as $i=> $purlist){ 
													...
													<tr>
														...
														<td><?php $date_format  = $this->db->query("SELECT * FROM general_settings ")->row();
																 ...
																 echo date("$format", strtotime($purlist['date']));
															?></td>
														<td class="ple1">
															<?php echo $purlist['land_name'];?><br> <?php echo $purlist['land_lord']?$purlist['land_lord']:'-';?></td>
														<td class="ple1">
															<i class="fa fa-copy fs-4" title="Copy Bill No" style="cursor: pointer;" onclick="copiedclipboardagno('<?php echo $purlist['property_id']?$purlist['property_id']:'-';?>', '<?php echo $i; ?>');"></i>											

															<?php echo $purlist['property_id']?$purlist['property_id']:'-';?>
														...
														<td class="ple1">
															<span class="align-items-center"><?php echo $purlist['party_name']?$purlist['party_name']:'-' ;?></span>
														</td>
														<td class="ple1">
																<span class="align-items-center"><?php echo $purlist['ref_name']?$purlist['ref_name']:'-' ;?><br><?php echo $purlist['property_type']?$purlist['property_type']:'-' ;?></span>
														</td>
														<td class="ple1">
															<span class="align-items-center">
																	<?php echo $purlist['vao_group']?$purlist['vao_group']:'-' ;?> <br> <?php

																		$amenities = isset($purlist['amenities']) ? json_decode($purlist['amenities']) : [];
																		$amen = [];
														...
														<td>
															...
															<?php echo $purlist['ploat_no'];?> / <?php echo $purlist['ploat_type'];?>
														</td>
														<td align="end"><i class="fa-solid fa-indian-rupee-sign fs-7 text-dark"></i>&nbsp;<?php $prop_amt = $purlist['total_property_amount']?$purlist['total_property_amount']:0; echo number_format($prop_amt,2,'.',',');?></td>
														<td>
														...
														<td>
															<span class="text-end">	
																...
																>
																<i class="bi bi-eye-fill eyc fs-3"></i></i>
														        </a>
														        <button class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
																		<i class="fas fa-ellipsis-v eyc"></i>
																</button>
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true" style="">
																	<?php if(isset($_SESSION['Property Purchase ListEdit'])){ if($_SESSION['Property Purchase ListEdit']==1){?>
																	<?php if($purlist['ploat_no'] == $purlist['prop_sts_update']){ ?>
																	<div class="menu-item px-3">
																		<a href="<?php echo base_url();?>Realestatepurchase/realestate_purchase_edit/<?php echo $purlist['id']; ?>" target="_blank" class="menu-link flex-stack px-3">Edit</a>
																	</div>
																	<?php } }}?>
																	<div class="menu-item px-3">
																		 <a href="<?php echo base_url();?>Realestatepurchase/re_purchase_history/<?php echo $purlist['id']; ?>" target="_blank" class="menu-link flex-stack px-3">History</a>
																	</div>
																	<?php if(isset($_SESSION['Property Purchase ListDelete'])){ if($_SESSION['Property Purchase ListDelete']==1){?>
																	 <?php if($purlist['ploat_no'] == $purlist['prop_sts_update']){ ?> 
																		<div class="menu-item px-3">
																			<a href="#"  data-bs-toggle="modal" data-bs-target="#kt_modal_delete_re_purchase"
																					onclick="property_del('<?php echo $purlist['id'];?>')"class="menu-link flex-stack px-3">Delete</a>
																		</div>
																	<?php } }}?>
																</div>
															</span>
				...
				<!--end::Wrapper-->
					...
					<div class="modal fade" id="kt_modal_delete_re_purchase" tabindex="-1" aria-hidden="true">
						<!--begin::Modal dialog-->
		...
		<script type="text/javascript">
			...
			function export_list() {
			    ...
			    var value = <?php echo $exportrepurchase; ?>;
			    var values = [];
			    // console.log(value[0]);
			    value.map((data, i) => {	
			    ...
			    var filename = 'REPurchaseList.xlsx';
		...
		<script>
			...
			$.ajax({
			type: "POST",
			url: baseurl+'Realestatepurchase/property_delete',
			async: false,
			type: "POST",
			data: "id="+val,
			...
			{
			$('#kt_modal_delete_re_purchase').empty().append(response);
			$('#kt_modal_delete_re_purchase').addClass('show');
			...
			$.ajax({
			type: "POST",
			url: baseurl+'Realestatepurchase/delete',
			async: false,
			data:"field="+val,
			success: function(response)
			{
			window.location.href = baseurl+'Realestatepurchase';
			}
			});
			}
			...
			{
				var baseurl= $("#baseurl").val();
				$('#kt_modal_delete_re_purchase').removeClass('show');
				$('.modal-backdrop').removeClass('show');
				window.location.href = baseurl+'Realestatepurchase';
			}
		</script>
		<script>
	      $("#realestate_purchase_table").kendoTooltip({
	        filter: "td",
	        show: function(e){
		...
		<script>
			$("#realestate_purchase_table").DataTable({
				    "sorting":false,
				    // "info":true,
				    "responsive": true,
		...
		$(document).ready(function() {
			...
			$(".move_to").on("click", function () {
				value=$(this).val();
				// alert(value);
				$('#filter_form').attr('action', "<?php echo base_url(); ?>Realestatepurchase?page="+value);
				$("#filter_form").submit();
				e.preventDefault();
			});
		});
        ...
        <script>
          ...
          <script>
			function date_fill_pur_list()
			{
				...
				var today_dt_repor_pur_list = document.getElementById('today_dt_repor_pur_list');
				var week_from_dt_repor_pur_list = document.getElementById('week_from_dt_repor_pur_list');
				var week_to_dt_repor_pur_list = document.getElementById('week_to_dt_repor_pur_list');
				var monthly_dt_repor_pur_list = document.getElementById('monthly_dt_repor_pur_list');
				var from_dt_repor_pur_list = document.getElementById('from_dt_repor_pur_list');
				var to_dt_repor_pur_list = document.getElementById('to_dt_repor_pur_list');
				var from_date_fillter_repor_pur_list = document.getElementById('from_date_fillter_repor_pur_list');
				var to_date_fillter_repor_pur_list = document.getElementById('to_date_fillter_repor_pur_list');

				if (dt_fill_pur_list == "today") 
				{
					today_dt_repor_pur_list.style.display = "block";
					monthly_dt_repor_pur_list.style.display = "none";
					from_dt_repor_pur_list.style.display = "none";
					to_dt_repor_pur_list.style.display = "none";
					week_from_dt_repor_pur_list.style.display = "none";
					week_to_dt_repor_pur_list.style.display = "none";
				...
				{
					today_dt_repor_pur_list.style.display = "none";
					week_from_dt_repor_pur_list.style.display = "block";
					week_to_dt_repor_pur_list.style.display = "block";
					monthly_dt_repor_pur_list.style.display = "none";
					from_dt_repor_pur_list.style.display = "none";
					to_dt_repor_pur_list.style.display = "none";
					...
					$('#week_from_date_fillter_repor_pur_list').val(firstday);
					$('#week_to_date_fillter_repor_pur_list').val(lastday);
					
				}
				else if (dt_fill_pur_list == "monthly")
				{
					today_dt_repor_pur_list.style.display = "none";
					monthly_dt_repor_pur_list.style.display = "block";
					from_dt_repor_pur_list.style.display = "none";
					to_dt_repor_pur_list.style.display = "none";
					week_from_dt_repor_pur_list.style.display = "none";
					week_to_dt_repor_pur_list.style.display = "none";
					$("#monthly_date_fillter_repor_pur_list").flatpickr({
								dateFormat: "m-Y",
							});
				}
				else if (dt_fill_pur_list == "custom Date")
				{
					today_dt_repor_pur_list.style.display = "none";
					monthly_dt_repor_pur_list.style.display = "none";
					from_dt_repor_pur_list.style.display = "block";
					to_dt_repor_pur_list.style.display = "block";
					week_from_dt_repor_pur_list.style.display = "none";
					week_to_dt_repor_pur_list.style.display = "none";

					$("#from_date_fillter_repor_pur_list").flatpickr({
								dateFormat: "d-m-Y",
							});
					$("#to_date_fillter_repor_pur_list").flatpickr({
								dateFormat: "d-m-Y",
							});
				}
				else
