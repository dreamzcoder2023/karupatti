...
<div class="modal-dialog modal-lg">
			...
			<div class="modal-content rounded">
				...
				<div class="modal-header justify-content-end border-0 pb-0">
					<!--begin::Close-->
					<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal" onclick="closeOnAccountModal('<?php echo $val; ?>');">
				...
				<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
					...
					<div style="padding:10px 10px 10px 10px !important;box-shadow: 0 3px 6px #00002947; border-radius: 5px; background-color: #f5f5f1 !important;">
						...
						<div class="card-footer d-flex justify-content-end py-6 px-9">
							<button class="btn btn-secondary" id="btn_cancel" name="btn_cancel" tabindex="0" data-bs-dismiss="modal" onclick="closeOnAccountModal('<?php echo $val; ?>');">Cancel</button>
						</div>
					</div>
				</div>
			</div>
