							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										...
										<span><?php echo isset($repledge_master->RP_BILLNO) ? $repledge_master->RP_BILLNO : "-"; ?></span>
									</label>
									<!--end::Separator-->
									<!--begin::Description-->
									<!--end::Description--></h1>
										...
										<div class="card-body py-4">
											<div class="row">
												...
												<label class="col-lg-2 col-form-label fw-bold fs-5"><?php 
													...
													$date = isset($repledge_master->ENDATE) ? $repledge_master->ENDATE : "";
													if($date !=""){
														echo date_format(date_create($repledge_master->ENDATE),'d-m-Y'); 
													}
													else{
														echo "-";
													}
											...
											?></label>
												...
												$companycode = isset($repledge_master->COMPANYCODE) ? $repledge_master->COMPANYCODE : "-";
												$cmp=$this->db->query("select * from COMPANY where COMPANYCODE='".$companycode."'")->row(); echo isset($cmp->COMPANYNAME) ? $cmp->COMPANYNAME : "-"; ?></label>
												<label class="col-lg-1 col-form-label fw-semibold fs-6">Type</label>
												<label class="col-lg-2 col-form-label fw-bold fs-5"><?php 

												$mixed =isset($repledge_master->MIXED) ? $repledge_master->MIXED : "";
										
												if($mixed!= "")
												{
														echo ($repledge_master->MIXED=='Y') ? 'MIXED' : 'INDIVIDUAL'; 
											...
											?></label>
												...
												<label class="col-lg-2 col-form-label fw-bold fs-5"><?php echo isset($repledge_master->BANK) ? $repledge_master->BANK : "-"; ?></label>
												<label class="col-lg-1 col-form-label fw-semibold fs-6">Bank No</label>
												<label class="col-lg-2 col-form-label fw-bold fs-5"><?php echo isset($repledge_master->BANKNO) ? $repledge_master->BANKNO : "-"; ?></label>
												<div class="col-lg-6 d-flex justify-content-end align-items-center">
													<label class="col-form-label text-center fw-semibold fs-3 me-3">
															<?php  
																$Active = isset($repledge_master->ACTIVE) ? $repledge_master->ACTIVE : "";
																if($Active !="")
																{
																	?>
																		<?php

																				if($repledge_master->ACTIVE=='Y')
																				{
																			?>
																	...
																	?>
																		<span style="background-color:#ff5b5b;border-radius: 8px;padding: 5px 15px 5px 15px;">-</span>
																	<?php
											...
											<div class="row mt-2">
												...
												<table id="rp_view_table" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
													...
													<tbody class="text-gray-600 fw-semibold">
														...
														<tr>
															<td><?php echo $i+1;?></td>
									            <td><?php echo isset($r_det['BILLNO']) ? $r_det['BILLNO'] : "-";?></td>
									            <td class="ple1"><?php echo isset($cmp->COMPANYNAME) ? $cmp->COMPANYNAME : "-";?></td>
									            <td class="ple1">Gold</td>
									            <td class="ple1"><?php echo isset($r_det['PLEDGES']) ? $r_det['PLEDGES'] : "-"; ?></td>
									            <!-- <td class="ple1">Ladies Ring</td> -->
															<td><?php echo isset($r_det['QTY']) ? $r_det['QTY'] : "-"; ?></td>
									            <td><?php echo isset($r_det['WEIGHT']) ? $r_det['WEIGHT'] : "-"; ?></td>
									            <td><?php echo isset($r_det['LOANAMOUNT']) ? $r_det['LOANAMOUNT'] : "-"; ?></td>
									            <td>
											...
											<div class="d-flex justify-content-end">
												...
												<label class="col-lg-1 col-form-label fw-bold fs-4 text-center"><?php echo isset($repledge_master->NETQTY) ? $repledge_master->NETQTY : "-"; ?></label>
												<label class="col-lg-1 col-form-label fw-bold fs-4 text-end"><?php echo isset($repledge_master->NETWEIGHT) ? $repledge_master->NETWEIGHT : "-"; ?></label>
												<label class="col-lg-2 col-form-label fw-bold fs-4 text-center"><?php echo isset($repledge_master->NETLOANAMOUNT) ? $repledge_master->NETLOANAMOUNT : "-"; ?></label>
											...
											<div class="row">
												...
												<label class="col-lg-2 col-form-label fw-bold fs-5"><?php echo isset($repledge_master->AMOUNT) ? $repledge_master->AMOUNT : "-"; ?></label>
												<label class="col-lg-1 col-form-label fw-semibold fs-6">Others</label>
												<label class="col-lg-2 col-form-label fw-bold fs-5"><?php echo isset($repledge_master->OTHERS) ? $repledge_master->OTHERS : "-"; ?></label>
												<div class="col-lg-1">
													<label class="col-form-label fw-semibold fs-6">Appr.Charge</label>
												</div>
												<div class="col-lg-2">
													<label class="col-form-label fw-bold fs-5 ms-2"><?php echo isset($repledge_master->APP_CHARGE) ? $repledge_master->APP_CHARGE : "-"; ?></label>
												</div>
												<div class="col-lg-3">
													<label class="col-form-label fw-bold fs-3">NetAmount</label>&emsp;
													<label class="col-form-label fw-bold fs-3"><?php echo isset($repledge_master->NETAMOUNT) ? $repledge_master->NETAMOUNT : "-"; ?></label>
												</div>
											</div>
											<div class="row">
												<div class="col-lg-6">
													<div class="row">
														...
														<label class="col-lg-4 col-form-label fw-bold fs-5"><?php echo isset($repledge_master->INTEREST) ? $repledge_master->INTEREST : "-"; ?></label>
														<label class="col-lg-2 col-form-label fw-semibold fs-6">Months</label>
														<label class="col-lg-4 col-form-label fw-bold fs-5"><?php echo isset($repledge_master->MONTHS) ? $repledge_master->MONTHS : "-"; ?></label>
													</div>
													<div class="row">
														<div class="col-lg-2">
															<label class="col-form-label fw-semibold fs-6">Iter.Month</label>
														</div>
														<label class="col-lg-4 col-form-label fw-bold fs-5"><?php echo isset($repledge_master->ITERATION) ? $repledge_master->ITERATION : "-"; ?></label>
														<label class="col-lg-2 col-form-label fw-semibold fs-6">(+)Int</label>
														<label class="col-lg-4 col-form-label fw-bold fs-5"><?php echo isset($repledge_master->PLUSINT) ? $repledge_master->PLUSINT : "-"; ?></label>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="row">
														...
														<?php
														$descriptionval = isset($repledge_master->DESCRIPTION) ? $repledge_master->DESCRIPTION :"";
															...
															{
																$description = $repledge_master->DESCRIPTION;
															}
														?>
														<label class="col-lg-9 col-form-label fw-bold fs-5"><?php echo $description; ?></label>
													</div>
												</div>
											</div>
