...
<style>
  ...
  .dataTables_scroll thead{
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Chit - Agent - Total Sum of Amount
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											        ...
											        <div id="kt_accordion_item_list_body_1" class="accordion-collapse collapse" aria-labelledby="kt_accordion_item_list_header_1" data-bs-parent="#kt_accordion_item_list">
											            <div class="accordion-body">
											            	<div class="row">
																				...
																				<div class="row">
																					...
																					<div class="col-lg-8">
																						<select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-allow-clear="true" multiple="multiple">
																							...
																							<option value="2">Selvamagal</option>
																							<option value="3">Thangamagal</option>
																						</select>
																					</div>
																				</div>
																			</div>
																			<div class="col-lg-3">
																				<div class="row">
																					...
																					<div class="col-lg-8">
																						<select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-allow-clear="true" multiple="multiple">
																							<option value="1" selected>All</option>
																							<option value="2">Thirumalai</option>
																							<option value="3">Selvam</option>
																							<option value="4">Vasan</option>
																							<option value="5">Hariharan</option>
																						</select>
																					</div>
																				</div>
																			</div>
																			<div class="col-lg-3">
																				<div class="row">
																					<label class="col-lg-4 col-form-label fw-semibold fs-6">Collection Type</label>
																					<div class="col-lg-8">
																						<select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-allow-clear="true" multiple="multiple">
																							<option value="1" selected>All</option>
																			...
																			<div class="col-lg-3">
																				<div class="row">
																					<label class="col-lg-4 col-form-label fw-semibold fs-6">Payment Mode</label>
																					<div class="col-lg-8">
																						<select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-allow-clear="true" multiple="multiple">
																							<option value="1" selected>All</option>
											...
											<!--begin::Table-->
											<div class="row mt-2">
												<table class="table align-middle table-row-dashed table-striped fs-7 gy-2 gs-2" id="kt_datatable_chit_agent_total_amt_report">
							            		...
							            		<th class="min-w-80px">Scheme</th>
							            		<th class="min-w-100px">Agent</th>
											        <th class="min-w-80px">Collection Type</th>
							            		<th class="min-w-100px">Party Info</th>
											        <th class="min-w-80px">Payment Mode</th>
											        <th class="min-w-100px">Collection Amt</th>
							            		<th class="min-w-80px"><span class="text-end">Actions</span></th>
													...
													<tbody class="text-gray-600 fw-semibold">
														<?php 
															$i=1;
															foreach($chittotsumofamt as $chitamtvalue)
															{
														?>
														<tr>
															<td><?php echo $i; ?></td>
	...
	<?php $this->load->view("script");?>
		...
		<script>
			$("#kt_datatable_chit_agent_total_amt_report").DataTable({
							"ordering": false,
							// "aaSorting":[],
							// "responsive":true,
			 "language": {
		...
		<script>
			      $("#kt_datatable_chit_agent_total_amt_report").kendoTooltip({
			        filter: "td",
			        show: function(e){
