...
<style>
  ...
  .dataTables_scroll thead{
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Customer - Non Tagged Item Sales
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											            	...
											            	<div class="row">
																			<div class="col-lg-3">
																				<div class="row">
																					...
																					<label class="col-lg-4 col-form-label fw-semibold fs-6">Sub Items</label>
																					<div class="col-lg-8">
																						<select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-allow-clear="true" multiple="multiple">
																							<option value="1" selected>All</option>
																							<option value="2">MATTAL,DESIGN RING,MATTAL</option>
											...
											<!--begin::Table-->
											<div class="row mt-2">
												<table class="table align-middle table-row-dashed table-striped fs-7 gy-0 gs-2" id="kt_datatable_nontagged_item_sales_to_customer_report">
													<thead>
							            		...
							            		<th rowspan="3" class="min-w-80px" style="border-bottom-style: hidden;">Bill No</th>
											        <th rowspan="3" class="min-w-80px" style="border-bottom-style: hidden;">Party Info</th>
							            		<th class="min-w-80px">Jewel Type</th>
											        <th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">Pledge Info</th>
							            		<th class="min-w-50px">Wgt(gms)</th>
							            		<th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">HallMark Charges</th>
							            		<th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">Making Charges</th>
							            		<th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">Wastage (%)</th>
							            		<th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">Metal Wgt(gms)</th>
							            		...
							            		<th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;"><span class="text-end">Actions</span></th>
					    							...
					    							<tr class="text-muted fw-bold fs-7 gs-0 align-items-center">
							            		<th class="min-w-50px" style="border-bottom-style: hidden;">Purity(%)</th>
											        <th class="min-w-50px" style="border-bottom-style: hidden;">Nt.Wgt(gms)</th>
					    							</tr>
													</thead>
													<tbody class="text-gray-600 fw-semibold">
														<?php 
														$i=1;
														foreach($sales_entry_detail_nontag as $notaggeddetails)
														{
														?>
														<tr>
									            <td >-</td>
									            <td  class="ple1"><?php echo $notaggeddetails['COMPANYNAME']; ?></td>
									            <td class="ple1"><?php echo $notaggeddetails['sales_id']; ?></td>
									            <td  class="ple1">
									            ...
									            <td ><?php echo $notaggeddetails['hc_amount']; ?></td>
									            <td ><?php echo $notaggeddetails['mc_amount']; ?></td>
									            <td >5</td>
									            <td ><?php echo $notaggeddetails['metal_weight']; ?></td>
									            <td >85,000.00</td>
									            <td >
																<span class="text-end">
		...
		<script>
			$("#kt_datatable_nontagged_item_sales_to_customer_report").DataTable({
							"ordering": false,
							// "aaSorting":[],
							// "responsive":true,
			 "language": {
		...
		<script>
			      $("#kt_datatable_nontagged_item_sales_to_customer_report").kendoTooltip({
			        filter: "td",
			        show: function(e){
