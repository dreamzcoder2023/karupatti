...
<style>
  ...
  .dataTables_scroll thead{
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Customer - Old Gold
									<!--begin::Separator-->
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
																			...
																			<div class="col-lg-3">
																				<div class="row">
																					...
																					<div class="col-lg-8">
																						<select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-allow-clear="true" multiple="multiple">
																							<option value="1" selected>All</option>
																							<option value="2">MATTAL,DESIGN RING,MATTAL</option>
																							<option value="3">1 KAL LADIES RING</option>
																							<option value="4">123 KAMMAL</option>
																							<option value="5">2 SARAM MALAI</option>
																							<option value="6">22 CT RING SATHA,KAL KAMMAL-SEEL ILLAI SATHA</option>
																							<option value="7">3 ADUKKU KAMMAL</option>
																							<option value="8">3KAL JAIN TONGAL KAMMAL</option>
																							<option value="9">4-KAL RING 1 KAL ILLAI</option>
																							<option value="10">916 MATTAL</option>
																							<option value="11">925 CHAIN</option>
																							<option value="12">925 HAND CHAIN</option>
																							<option value="13">ADAMAN KADAN</option>
																							<option value="14">ALUKATH</option>
																						</select>
																					</div>
																			...
																			<div class="col-lg-6">
																				...
																				<div class="row">
																					<div class="col-lg-4 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
																						<div class="d-flex align-items-center">
																							<label class="form-check form-check-inline form-check-solid me-2 is-invalid">
																								<input class="form-check-input" name="communication[]" type="checkbox" value="1" id="net_weight_radio" onclick="nt_wgt_radio()">
																							</label>
																							<span class="col-form-label fw-semibold fs-6">Net Weight(gms)</span>
																						</div>
																					</div>
																					<div class="col-lg-2" id="net_weight_radio_tbox" style="display: none;">
																						<select class="form-select form-select-solid" data-control="select2"data-hide-search="true" onchange="nt_wgt_tbox()" id="nt_wgt_radio_tbox">
																							<option value="equal">=</option>
																							<option value="greaterthan">></option>
																							<option value="lessthan"><</option>
																							<option value="greaterequal">>=</option>
																					...
																					<div class="col-lg-3" id="net_weight_radio_tf1" style="display: none;">
																						<input type="text" name="" class="form-control form-control-lg form-control-solid">
																						<div class="fv-plugins-message-container invalid-feedback"></div>
																					</div>
																					<div class="col-lg-3" id="net_weight_radio_tf2" style="display: none;">
																						<input type="text" name="" class="form-control form-control-lg form-control-solid">
																						<div class="fv-plugins-message-container invalid-feedback"></div>
																					</div>
																				</div>
																				<div class="row">
																					...
																					<div class="col-lg-2" id="amount_radio_tbox" style="display: none;">
																						<select class="form-select form-select-solid" data-control="select2"data-hide-search="true" onchange="amt_tbox()" id="amt_radio_tbox">
																							<option value="equal">=</option>
																							<option value="greaterthan">></option>
																							<option value="lessthan"><</option>
																							<option value="greaterequal">>=</option>
																					...
																					<div class="col-lg-3" id="amount_radio_tf2" style="display: none;">
																						<input type="text" name="" class="form-control form-control-lg form-control-solid">
																						<div class="fv-plugins-message-container invalid-feedback"></div>
																					</div>
																				</div>
											...
											<div class="d-flex align-items-center justify-content-end mt-3">
												...
												<div class="me-2 fw-bold fs-6">
													<span class="btn btn-icon btn-circle fs-8 fw-bold shadow text-black" style="background:#ff8639;width: 20px !important;height: 20px !important;">PR</span>
													<span class="me-1">-</span>
											...
											<!--begin::Table-->
											<div class="row mt-1">
												<table class="table align-middle table-row-dashed table-striped fs-7 gy-0 gs-2" id="kt_datatable_og_from_customer_report">
													<thead>
					    							<tr class="text-muted fw-bold fs-7 gs-0 align-items-center">
							            		<th rowspan="3" class="min-w-100px" style="border-bottom-style: hidden;">Date</th>
							            		...
							            		<th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">Jewel Type</th>
											        <th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">Items</th>
											        <th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">Quality</th>
							            		<th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">Purity(%)</th>
							            		<th class="min-w-50px">Wgt(gms)</th>
											        <th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;">Nt Wgt(gms)</th>
							            		<th rowspan="3" class="min-w-80px" style="border-bottom-style: hidden;">Amount</th>
							            		<th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;"><span class="text-end">Actions</span></th>
					    							...
					    							<tr class="text-muted fw-bold fs-7 gs-0 align-items-center">
							            		<th class="min-w-50px" style="border-bottom-style: hidden;">Less Wgt(gms)</th>
					    							</tr>
													</thead>
									            ...
									            <td rowspan="3" class="ple1">
																...
																<span class="btn btn-icon btn-circle fs-8 fw-bold shadow text-black mb-1" style="background:#81cbff;width: 20px !important;height: 20px !important;float: right;">EX</span>
															</td>
									            <td rowspan="3" class="ple1">
																<span><i class="fa-solid fa-star fs-7" style="color:#50cd89;"></i></span>
																<span class="align-items-center">Abishek</span>
															</td>
									            <td rowspan="3" class="ple1">Gold</td>
															<td rowspan="3" class="ple1">B KOLUSU-2(N HRS SEAL ULLATHU), B KOLUSU-2(R HRS  SEAL </td>
									            <td rowspan="3" class="ple1">916</td>
									            <td rowspan="3">95</td>
									            <td style="border-bottom-color: black;">8.000</td>
									            <td rowspan="3">7.600</td>
									            <td rowspan="3">95,000.00</td>
									            <td rowspan="3">
																<span class="text-end">
										       	...
										       	<tr>
									            <td style="border-bottom-color: black;">0.200</td>
										       	</tr>
										       	<tr>
									            <td style="border-bottom-color: black;">0.200</td>
										       	</tr>
	...
	<?php $this->load->view("script");?>
		...
		<script>
			$("#kt_datatable_og_from_customer_report").DataTable({
							"ordering": false,
							// "aaSorting":[],
							// "responsive":true,
			 "language": {
		...
		<script>
			      $("#kt_datatable_og_from_customer_report").kendoTooltip({
			        filter: "td",
			        show: function(e){
	  ...
	  <script>
			function nt_wgt_tbox()
			{
				var nt_wgt_radio_tbox = document.getElementById("nt_wgt_radio_tbox").value;

				 if (nt_wgt_radio_tbox=="between") 
				  {
				  	$("#net_weight_radio_tf2").show();
				  }
				  else
				  {
				  	$("#net_weight_radio_tf2").hide();
				  }
			}
		</script>
		<script>
			function nt_wgt_radio()
			{
				var net_weight_radio = document.getElementById("net_weight_radio");
				var net_weight_radio_tbox = document.getElementById("net_weight_radio_tbox");
				var net_weight_radio_tf1 = document.getElementById("net_weight_radio_tf1");
				var net_weight_radio_tf2 = document.getElementById("net_weight_radio_tf2");

				if (net_weight_radio.checked == true)
				{
				    net_weight_radio_tbox.style.display = "block";
				    net_weight_radio_tf1.style.display = "block";
			  	} else 
			  	{
			     	net_weight_radio_tbox.style.display = "none";
			     	net_weight_radio_tf1.style.display = "none";
			     	net_weight_radio_tf2.style.display = "none";
			  	}
			}
		</script>
		<script>
