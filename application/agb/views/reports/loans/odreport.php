...
<style>
  ...
  .dataTables_scroll thead{
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">OverDue Report
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											...
											<!--begin::Table-->
											<div class="row mt-2">
												<table class="table align-middle table-row-dashed table-striped fs-7 gy-0 gs-2" id="kt_datatable_dom_positioning_od_report">
													<thead>
					    							...
					    							<tr class="text-muted fw-bold fs-7 gs-0 align-items-center">
					    								<th class="min-w-25px" style="border-bottom-style: hidden;">Pur(%)</th>
													...
													<tbody class="text-gray-600 fw-semibold">
															...
															<?php
														  $i=1; 
															foreach($getodloandetails as $loanvalues)
															{
							                    ...
							                    $days1         = $days;
							           				...
							           				<td>
							           					<div class="tablevalue">
																				<table>
																					...
																					<tr  class="ple1" style="border-bottom-color: black;" >
																						<td class="ple1"><?php echo $loanvalues['INTERESTTYPE']; ?></td>
							            			...
							            			<td  class="ple1">
																...
																<td  class="ple1"><?php echo $loanvalues['PLEDGEINFO']; ?> </td>
							            			<td class="ple1" >
										            		<div class="tablevalue">
																			<table>
																				<tr class="ple1" style="border-bottom-color: black;" >
												...
												<!-- <table class="table align-middle table-row-dashed table-striped fs-7 gy-2 gs-2" id="kt_datatable_dom_positioning_od_report">
													<thead>
						    							<tr class="text-muted fw-bold fs-7 gs-0 align-items-center">
										            		<th rowspan="3" class="min-w-80px" style="border-bottom-style: hidden;">Company</th>
										            		<th rowspan="3" class="min-w-80px" style="border-bottom-style: hidden;">Bill No</th>
											...
											<!-- <table class="table align-middle table-row-dashed table-striped fs-7 gy-4 gs-2" id="kt_datatable_dom_positioning_od_report">
												<thead>
					    							<tr class="text-muted fw-bold fs-7 gs-0 align-items-center">
											            ...
											            <th class="min-w-25px">Wgt(gms)</th>
							    						<th class="min-w-25px">Nt Wgt(gms)</th>
							    						<th class="min-w-25px">Pure Wgt(gms)</th>
											            <th class="min-w-25px">Loan Amt</th>
													    <th class="min-w-25px">Int Amt</th>
													    <th class="min-w-25px">Recpt Amt</th>
											            <th class="min-w-25px">OD Days</th>
											            <th class="min-w-50px">OD Amt</th>
											            <th class="min-w-50px">Action Value</th>
					    							</tr>
												</thead>
												<tbody class="text-gray-600 fw-semibold">
													<tr>
											            ...
											            <td>225.00</td>
											            <td>0.00</td>
											            <td class="ple1">2 Month 3 Days</td>
											            <td>9225.00</td>
											            <td>4881.00</td>
											        </tr>
											  	</tbody>
											</table> -->
											<!-- <table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="kt_datatable_dom_positioning_od_report">
												<thead>
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
														<th class="min-w-50px cy">Sno</th>
														<th class="min-w-25px">Date</th>
														<th class="min-w-25px">Bill No</th>
														<th class="min-w-25px">Name</th>
														<th class="min-w-25px">Address</th>
														<th class="min-w-25px">Pledges</th>
														<th class="min-w-25px">Net Wgt</th>
														<th class="min-w-25px">Amount</th>
														<th class="min-w-25px">Int %</th>
														<th class="min-w-25px">Months</th>
														<th class="min-w-25px">OD Period</th>
														<th class="min-w-25px">OD Amt</th>
												...
												<tbody class="text-gray-600 fw-semibold">
													<tr>
														<td class="cy">1</td>
														<td class="ple1">16/04/2021</td>
														<td class="ple1">TIP-814/21</td>
														<td class="ple1">John Josep<br>9895989598</td>
														<td class="ple1">7 TH STREET DURAISAMYPURAM,SAYALGUDI,SAYALGUDI</td>
														<td class="ple1">KAMMAL THONGAL-2(916 KDM SEAL ULLATHU AJ SEAL </td>
														<td class="ple1">4300</td>
														<td class="ple1">8000</td>
														<td class="ple1">2.50</td>
														<td class="ple1">3</td>
														<td class="ple1">16 Month 6 days</td>
														<td class="ple1">13202</td>
														<td class="ple1">3070</td>
													</tr>
													<tr>
														<td class="cy">2</td>
														<td class="ple1">12/01/2022</td>
														<td class="ple1">KPS-8/22</td>
														<td class="ple1">Rathima<br>8608781448</td>
														<td class="ple1">KATARKARAI STREET,ROCHMANAGAR,KANNIRAJAPURAM</td>
														<td class="ple1">KOLUSU-2(MADURAI ATK SEAL ULLATHU .ORU MUTHU ILLAAI.)</td>
														<td class="ple1">92100</td>
														<td class="ple1">2000</td>
														<td class="ple1">2.50</td>
														<td class="ple1">3</td>
														<td class="ple1">7 Month 10 days</td>
														<td class="ple1">2467</td>
														<td class="ple1">27</td>
													</tr>
													<tr>
														<td class="cy">3</td>
														<td class="ple1">24/03/2022</td>
														<td class="ple1">TIP-77/22</td>
														<td class="ple1">Amaravathi<br>9626977898</td>
														<td class="ple1"> SOUTH STREET,MANIVALAI,PILLAIYARKULAM</td>
														<td class="ple1">MADAKKU KASU-2(SEELILAI ORU STONE ILLAI ORU STONE IRUKKU</td>
														<td class="ple1">3400</td>
														<td class="ple1">7000</td>
														<td class="ple1">2.50</td>
														<td class="ple1">3</td>
														<td class="ple1">4 Month 29 days</td>
														<td class="ple1">7977</td>
														<td class="ple1">2346</td>
													</tr>
													<tr>
														<td class="cy">4</td>
														<td class="ple1">30/06/2021</td>
														<td class="ple1">TIP-1145/21(R)LW-712/20</td>
														<td class="ple1">Kottai Selvi<br>8098606010</td>
														<td class="ple1">NIL,KATTALANKULAM,VEPPANKULAM</td>
														<td class="ple1">RAIG-1(SRI 22 CT SEAL ULLA NELINTHANILAI)</td>
														<td class="ple1">1800</td>
														<td class="ple1">3500</td>
														<td class="ple1">2.50</td>
														<td class="ple1">3</td>
														<td class="ple1">13 Month 23 days</td>
														<td class="ple1">5315</td>
														<td class="ple1">2953</td>
													</tr>
													
												</tbody>
												<tfoot>
													<tr class="text-start text-muted fw-bold fs-5 text-uppercase gs-0">
														<th class="min-w-50px cy"></th>
														<th class="min-w-25px"></th>
														<th class="min-w-25px"></th>
														<th class="min-w-25px"></th>
														<th class="min-w-25px"></th>
														<th class="min-w-25px">Total</th>
														<th class="min-w-25px">101600</th>
														<th class="min-w-25px">20500</th>
														<th class="min-w-25px"></th>
														<th class="min-w-25px"></th>
														<th class="min-w-25px"></th>
														<th class="min-w-25px">28961</th>
														<th class="min-w-25px">8369</th>
													</tr>
												</tfoot>
											</table> -->
											<!--end::Table-->
		...
		<script>
			$("#kt_datatable_dom_positioning_od_report").DataTable({
							"ordering": false,
							// "aaSorting":[],
							// "responsive":true,
			 "language": {
		...
		<script>
			      $("#kt_datatable_dom_positioning_od_report").kendoTooltip({
			        filter: "td",
			        show: function(e){
