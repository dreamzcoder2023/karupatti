...
<style>
  ...
  .dataTables_scroll thead{
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Outstanding Report
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
															...
															<div class="row">
																<div class="col-lg-7">
																	<div class="row">
																		<div class="col-lg-3 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
																			<div class="d-flex align-items-center">
																				<label class="form-check form-check-inline form-check-solid me-2 is-invalid">
																					<input class="form-check-input" name="communication[]" type="checkbox" value="1" id="issue_radio" onclick="iss_radio()">
																				</label>
																				<span class="col-form-label fw-semibold fs-6">Issue Value</span>
																			</div>
																		</div>
																		<div class="col-lg-2" id="issue_radio_tbox" style="display: none;">
																			<select class="form-select form-select-solid" data-control="select2"data-hide-search="true" onchange="iss_tbox()" id="iss_radio_tbox">
																		...
																		<div class="col-lg-3" id="issue_radio_tf1" style="display: none;">
																			<input type="text" name="" class="form-control form-control-lg form-control-solid">
																			<div class="fv-plugins-message-container invalid-feedback"></div>
																		</div>
																		<div class="col-lg-3" id="issue_radio_tf2" style="display: none;">
																			<input type="text" name="" class="form-control form-control-lg form-control-solid">
																			<div class="fv-plugins-message-container invalid-feedback"></div>
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-lg-3 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
																			<div class="d-flex align-items-center">
																				<label class="form-check form-check-inline form-check-solid me-2 is-invalid">
																					<input class="form-check-input" name="communication[]" type="checkbox" value="1" id="current_radio" onclick="cur_radio()">
																				</label>
																				<span class="col-form-label fw-semibold fs-6">Current Value</span>
																			</div>
																		</div>
																		<div class="col-lg-2" id="current_radio_tbox" style="display: none;">
																			<select class="form-select form-select-solid" data-control="select2"data-hide-search="true" onchange="cur_tbox()" id="cur_radio_tbox">
																				<option value="equal">=</option>
																				<option value="greaterthan">></option>
																				<option value="lessthan"><</option>
																				<option value="greaterequal">>=</option>
																		...
																		<div class="col-lg-3" id="current_radio_tf1" style="display: none;">
																			<input type="text" name="" class="form-control form-control-lg form-control-solid">
																			<div class="fv-plugins-message-container invalid-feedback"></div>
																		</div>
																		<div class="col-lg-3" id="current_radio_tf2" style="display: none;">
																			<input type="text" name="" class="form-control form-control-lg form-control-solid">
																			<div class="fv-plugins-message-container invalid-feedback"></div>
																		</div>
																	</div>
											...
											<!--begin::Table-->
											<div class="row mt-2">
												<table class="table align-middle table-row-dashed table-striped fs-7 gy-0 gs-2" id="kt_datatable_dom_positioning_outstanding_report">
													<thead>
							            		...
							            		<th rowspan="3" class="min-w-50px" style="border-bottom-style: hidden;"><span class="text-end">Actions</span></th>
													...
													<tbody class="text-gray-600 fw-semibold">
														<?php
														 	 		$i=1; 
																	foreach($getoutstandingloandetails as $loanvalues)
																	{
												...
												<!-- <table class="table align-middle table-row-dashed table-striped fs-7 gy-2 gs-2" id="kt_datatable_dom_positioning_outstanding_report">
													<thead>
					    							<tr class="text-muted fw-bold fs-7 gs-0 align-items-center">
							            		<th rowspan="3" class="min-w-80px" style="border-bottom-style: hidden;">Company</th>
							            		<th rowspan="3" class="min-w-80px" style="border-bottom-style: hidden;">Bill No</th>
	...
	<?php $this->load->view("script");?>
		...
		<script>
			$("#kt_datatable_dom_positioning_outstanding_report").DataTable({
							"ordering": false,
							// "aaSorting":[],
							// "responsive":true,
			 "language": {
		...
		<script>
			      $("#kt_datatable_dom_positioning_outstanding_report").kendoTooltip({
			        filter: "td",
			        show: function(e){
	  ...
	  <script>
			function iss_tbox()
			{
				var iss_radio_tbox = document.getElementById("iss_radio_tbox").value;

				 if (iss_radio_tbox=="between") 
				  {
				  	$("#issue_radio_tf2").show();
				  }
				  else
				  {
				  	$("#issue_radio_tf2").hide();
				  }
			}
		</script>
		<script>
			function iss_radio()
			{
				var issue_radio = document.getElementById("issue_radio");
				var issue_radio_tbox = document.getElementById("issue_radio_tbox");
				var issue_radio_tf1 = document.getElementById("issue_radio_tf1");
				var issue_radio_tf2 = document.getElementById("issue_radio_tf2");

				if (issue_radio.checked == true)
				{
				    issue_radio_tbox.style.display = "block";
				    issue_radio_tf1.style.display = "block";
			  	} else 
			  	{
			     	issue_radio_tbox.style.display = "none";
			     	issue_radio_tf1.style.display = "none";
			     	issue_radio_tf2.style.display = "none";
			  	}
			}
		</script>
		<script>
			function cur_tbox()
			{
				var cur_radio_tbox = document.getElementById("cur_radio_tbox").value;

				 if (cur_radio_tbox=="between") 
				  {
				  	$("#current_radio_tf2").show();
				  }
				  else
				  {
				  	$("#current_radio_tf2").hide();
				  }
			}
		</script>
		<script>
			function cur_radio()
			{
				var current_radio = document.getElementById("current_radio");
				var current_radio_tbox = document.getElementById("current_radio_tbox");
				var current_radio_tf1 = document.getElementById("current_radio_tf1");
				var current_radio_tf2 = document.getElementById("current_radio_tf2");

				if (current_radio.checked == true)
				{
				    current_radio_tbox.style.display = "block";
				    current_radio_tf1.style.display = "block";
			  	} else 
			  	{
			     	current_radio_tbox.style.display = "none";
			     	current_radio_tf1.style.display = "none";
			     	current_radio_tf2.style.display = "none";
			  	}
			}
		</script>
		<script>
