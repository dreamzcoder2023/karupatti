			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<!--begin::Toolbar-->
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Update Role 
									<!--begin::Separator-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                       ...
                       <form name="role_add_form" id="role_add_form" method="POST" action="<?php echo base_url(); ?>role/role_update" enctype="multipart/form-data" onsubmit="return role_validation();">
                       			<input type="hidden" name="role_id" id="role_id" value="<?php echo $role_details->ROLEID; ?>">
								...
								<div class="card-body py-4">
									<div class="row ">
										<label class="col-lg-2 col-form-label required fw-semibold fs-6">Role Name</label>
													...
													<div class="col-lg-4 fv-row fv-plugins-icon-container">
														<input type="text" id="role" name="role" class="form-control form-control-lg form-control-solid" placeholder="Role Name" onkeyup="role_unique(this.value);" value="<?php echo $role_details->ROLENAME; ?>">
									...
									<div class="row">
										<div class="col-lg-3 fv-row fv-plugins-icon-container">
											<div class="form-check">
							                    ...
							                    <input class="form-check-input" type="checkbox" value="<?php echo (isset($role_per_list)>0)?'1':'0';?>" id="<?php echo 'menuid_'.$mlist['MENU_ID'];?>" name="menu_id[<?php echo $mlist['MENU_ID']; ?>]" <?php echo (isset($role_per_list)>0)?'checked':''; ?> onclick="select_permission(this.id);">
									...
									<?php 
										...
										<div class="col-lg-3 fv-row fv-plugins-icon-container">
											...
											<input class="form-check-input" type="checkbox" value="<?php echo (isset($role_per_list)>0)?'1':'0';?>" id="<?php echo 'menuid_'.$smlist['MENU_ID'];?>" name="menu_id[<?php echo $smlist['MENU_ID']; ?>]" <?php echo (isset($role_per_list)>0)?'checked':''; ?> onclick="select_single_permission(this.id);">
