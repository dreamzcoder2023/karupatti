						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">New Sales Entry
									<!--begin::Separator-->
										...
										<div class="card-body py-4">
											...
											<div class="row">
												<label class="col-lg-1 col-form-label fw-semibold fs-6"> Bill No :</label>
													<label class="col-lg-2 col-form-label fw-semibold fs-6">A1000</label>	

													<!-- <div class="col-lg-2 fv-row fv-plugins-icon-container">
														<input type="text" name="party_address" class="form-control form-control-lg form-control-solid" placeholder="Party Address" >
												...
												<div class="col-lg-2 fv-row">
													<div class="d-flex align-items-center">
														...
														<!--end::Svg Icon-->
														<input class="form-control form-control-solid ps-12" name="entry_date" placeholder="Date" id="kt_daterangepicker_sales_entry" />
													</div>
												</div>
												<label class="col-lg-1 col-form-label fw-semibold fs-6">Party :</label>
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container">
														<input type="text" name="party_sales" id="party_sales" class="form-control form-control-lg form-control-solid" placeholder="Party Name" >
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
												...
												<label class="col-lg-1 col-form-label fw-semibold fs-6">Mobile :</label>
													<!-- <label class="col-lg-2 col-form-label fw-semibold fs-6">9854554524</label>	 -->
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container">
														<input type="text" name="party_mobile" class="form-control form-control-lg form-control-solid" placeholder="Party Mobile" >
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
											</div><br>
											<div class="row">
											...
											<div style="padding: 5px 5px 5px 5px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color: #f5f5f1;">
												...
												<div class="row">
													...
													<label class="col-lg-1 col-form-label fw-semibold fs-6">Stone Less</label>
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
														<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Stone">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
													<label class="col-lg-1 col-form-label fw-semibold fs-6"> Less</label>
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
														<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Less">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
													<label class="col-lg-1 col-form-label fw-semibold fs-6"> Gram Rate</label>
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
														<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Gram Rate">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
													<label class="col-lg-1 col-form-label fw-semibold fs-6">Estimated Amount</label>
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
											...
											<div style="padding: 5px 5px 5px 5px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color: #f5f5f1;">
												...
												<div class="row">
													...
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
														<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="charges">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
													...
													<label class="col-lg-1 col-form-label fw-semibold fs-6">Final Pay</label>
													<div class="col-lg-1 fv-row fv-plugins-icon-container">
														<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Amount">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
											...
											<div style="padding: 5px 5px 5px 5px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color: #f5f5f1;">
												...
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cash_lt_ey_tbox">
														<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Cash Amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
												</div>
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cheque_lt_ey_tbox" >
														<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Cheque Amount" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="bank_lt_ey_tbox" >
														<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Bank">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cheque_lt_ey_tbox" >
														<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="Cheque Number" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
												...
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rtgs_lt_ey_tbox">
														<input type="text" name="" class="form-control form-control-lg form-control-solid" placeholder="RTGS Trans No" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
												</div>
												<div class="row">
...
<!-- <script src="js/products-list.js"></script> -->
		...
		<script>
				...
				$("#kt_daterangepicker_sales_entry").flatpickr({
								dateFormat: "d-m-Y",
							});
