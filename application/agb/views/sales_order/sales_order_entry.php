				...
				<!--begin::Toolbar-->
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Sales Order List
									<!--begin::Separator-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="text-center">
																<label class="form-label fs-3 fw-bold">Sales Order</label>
															</div>
															<div class="text-center">
																<label class="text-success fs-2 fw-bold"><?php echo $sales_order_total->tot_count; ?></label>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="text-center">
															...
															<div class="text-center">
																<label class="text-success fs-2 fw-bold"><?php echo $sales_order_total->tot_paid; ?></label>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="text-center">
															...
															<div class="text-center">
																<label class="text-success fs-2 fw-bold"><?php echo $sales_order_total->tot_bal; ?></label>
															</div>
														</div><!-- 
														<div class="col-lg-3">
															<div class="text-center">
												...
												<div class="col-lg-4">
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
															...
															<form method="POST" action="<?php echo base_url(); ?>Sales_order">	
																<div class="mb-2">
																...
																<!-- <div class="mb-2">
																	...
																	<select class="form-select form-select-solid fw-semibold" data-control="select2" data-hide-search="true">	
																		...
																		<option value="">Updation Pending</option>
																		<option value="">Jewel Not Submitted</option>
																		<option value="">Waiting to Locker</option>
																		<option value="">Lock In</option>
																		<option value="">Lock Out</option>
																		<option value="">Partially Repledge</option>
																		<option value="">Repledge</option>
																		<option value="">Jewel Settleted</option>
																	</select>
																</div> -->
																<div class="mb-2">
														...
														<a href="<?php echo base_url(); ?>Sales_order/new_sales_order">
										...
										<div class="card-body py-4">
											...
											<table id="kt_datatable_responsive" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
												<thead>
												  <tr class="text-start text-muted fw-bold fs-7 gs-0">
												    ...
												    <th class="min-w-50px">Company</th>
														...
														<th class="min-w-25px">Remain.Days</th>
														<th class="min-w-80px">Stage</th>
														<th class="min-w-150px" style="width: 10%;"><span class="text-end">Actions</span></th>
												  </tr>
												</thead>
												...
												<tr>
														<td><?php echo $i; ?></td>
														<td><?php echo $slist['sales_order_date'] ?></td>
														<td><?php echo $slist['sales_order_id'] ?></td>
														<td class="ple1"><?php 
					   ...
					   <?php      }  ?>
														...
														<td><?php echo $slist['paid_amount'] ?></td>
														<td><?php echo $slist['balance_amount'] ?></td>
														...
														<td>
															<span class="text-end">
																...
																<a href="<?php echo base_url(); ?>Sales_order/sales_order_print/<?php echo $slist['id'] ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
																...
																<?php if( $slist['status']!='M' && $slist['status']!='T') { ?>
																<div class="menu-item px-3">
																		<a href="<?php echo base_url(); ?>Sales_order/sales_order_maker_process/<?php echo $slist['id']; ?>" class="menu-link px-3">Given to Maker</a>
																	</div>
																<?php } ?>
																<?php if(  $slist['status']!='T') { ?>
																	<div class="menu-item px-3">
																		<a href="<?php echo base_url(); ?>Sales_order/sales_order_tagged_process/<?php echo $slist['id']; ?>" class="menu-link flex-stack px-3">Tagged</a>
																	</div>
																	<?php } ?>
																	<div class="menu-item px-3">
																		<a href="<?php echo base_url(); ?>Sales_order/sales_order_delivered_process/<?php echo $slist['id']; ?>" class="menu-link flex-stack px-3">Delivered</a>
																	</div>
																</div>
																<!-- <a href="new_sales_order_process.php">
																	<span class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" title="Sales Order Process">
													...
													<!--<tr>
														...
														<td>10000.00</td>
														<td>156065.00</td>
														<td class="fs-4 text-end" style="color: #FF553B;font-weight: 700;">5</td>
														<td>
															<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="background-color:#46dcf9;border-radius: 8px;padding: 5px 15px 5px 15px;">Given to Maker</span>
															</label>
														</td>
														<td>
															<span class="text-end">
																<a href="new_sales_order_view.php" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
																<i class="bi bi-eye-fill eyc" title="View"></i>
																</a>
																<button class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
																	<i class="fas fa-ellipsis-v eyc"></i>
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true" style="">
																	<div class="menu-item px-3">
																		<a href="#" class="menu-link flex-stack px-3">Received from Maker</a>
																	</div>
																	<div class="menu-item px-3">
																		<a href="new_sales_order_process.php" class="menu-link flex-stack px-3">Tagged</a>
																	</div>
																	<div class="menu-item px-3">
																		<a href="#" class="menu-link flex-stack px-3">Delivered</a>
																	</div>
																</div>
															</span>
														</td>
													...
													<tr>
														...
														<td class="ple1"><span>Gold</span> - <span>Ring</span></td>
														<td class="ple1">Hand Ring</td>
														<td>12000.00</td>
														<td>163000.00</td>
														<td class="fs-4 text-end" style="color: #FF553B;font-weight: 700;">2</td>
														<td>
															<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="background-color:#C8C7C3;border-radius: 8px;padding: 5px 15px 5px 15px;">Received from Maker</span>
															</label>
														</td>
														<td>
															<span class="text-end">
													...
													<tr>
														...
														<td class="ple1">
															<span><i class="fa-solid fa-star fs-7" style="color:#50cd89;"></i></span>
															<span class="align-items-center">Guna</span>
														</td>
														<td class="ple1"><span>Gold</span> - <span>Chain</span></td>
														<td class="ple1">Hand Chain</td>
														<td>14000.00</td>
														<td>141926.00</td>
														<td class="fs-4 text-end" style="color: #FF553B;font-weight: 700;">22</td>
														<td>
															<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="background-color:#FFAC1C;border-radius: 8px;padding: 5px 15px 5px 15px;">Tagged</span>
															</label>
														</td>
													...
													<tr>
														...
														<td class="ple1">
															<span><i class="fa-solid fa-star fs-7" style="color:#ffc700;"></i></span>
															<span class="align-items-center">Rajan</span>
														</td>
														<td class="ple1"><span>Gold</span> - <span>Ring</span></td>
														<td class="ple1">Hand Ring</td>
														<td>123605.00</td>
...
$(document).ready(function() {
	...
	$(".move_to").on("click", function () {
		value=$(this).val();
		// alert(value);
		$('#filter_form').attr('action', "<?php echo base_url(); ?>Sales_order?page="+value);
		$("#filter_form").submit();
		e.preventDefault();
	});
});
