											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link  btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" href="<?php echo base_url(); ?>Tagged_audit">Audit</a>
															</li>
															<li class="nav-item">
																<a class="nav-link active btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" >History</a>
															</li>
														</ul>
													</div>
												</div>
													...
													<div class="tab-pane fade " id="kt_tab_pane_1" role="tabpanel">
														<!-- <div class="row">
															<div class="col-lg-4">
																...
																<div class="text-center">
																	<label class="text-success fs-2 fw-bold">Chain</label>
																</div>
															</div>
															<div class="col-lg-4">
																<div class="text-center">
															...
															<div class="col-lg-4">
																...
																<div class="text-center">
																	<label class="text-success fs-2 fw-bold">22.300</label>
																</div>
															</div>
														</div> -->
														<!-- <div class="row">
															<table id="kt_datatable_non_tagged_wallet_current" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-4 gs-2">
																<thead>
												            ...
												            <td>10.300</td>
																	...
																	<tr>
																		<td>2</td>
												            <td>14-02-2023</td>
												            <td class="ple1">AGB - Pernali Branch</td>
												            <td>LT-0002/23</td>
												            <td>6</td>
												            <td>10.000</td>
												        	</tr>
														...
														<div class="row">
															<div class="col-lg-6">
																...
																<div class="d-flex justify-content-end mt-4">
																	...
																	<button class="btn btn-sm btn-primary me-2">Complete</button>
																</div>
															</div>
															<div class="col-lg-6">
																<div class="row">
															...
															<div class="col-lg-4">
																<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
																	...
																	<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
																		...
																		<form action="<?php echo base_url(); ?>Tagged_audit/audit_history" method="POST">
																			<div class="mb-2">
														...
														<div class="row">
															<table  class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
																...
																<?php $i=1; foreach($tagged_audit_list as $tlist){ ?>
																	<tr>
																		<td><?php echo $i; ?></td>
												            <td><?php echo $tlist['date'] ?></td>
												            <td><?php echo date("h:i A",strtotime($tlist['created_on'])); ?></td>
												            <td><?php echo $tlist['created_by'] ?></td>
												            <td><?php echo $tlist['scanned_count'] ?></td>
												            <td><?php echo $tlist['scanned_weight'] ?></td>
												            <td><?php echo $tlist['bal_count'] ?></td>
												            <td><?php echo $tlist['bal_weight'] ?></td>
												            <td>
															<?php if($tlist['bal_count'] > 0){ ?>
																<?php if($tlist['status'] == 'Y'){ ?>
																		...
																		<td>
																			<span class="text-end">
																				<a href="<?php echo base_url(); ?>Tagged_audit/tagged_audit_view/<?php echo $tlist['id'] ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
$(document).ready(function() {
    ...
    $(".move_to").on("click", function () {
        value=$(this).val();
        // alert(1);
        $('#filter_form').attr('action', "<?php echo base_url(); ?>Tagged_audit/audit_history?page="+value);
        $("#filter_form").submit();
        e.preventDefault();
    });
});
