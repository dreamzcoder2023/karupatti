						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Zone List
									<!--begin::Separator-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <?php } ?>
													...
													<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
														...
														<form id="kt_modal_export_users_form" class="form" action="#">
															...
															<div class="fv-row mb-10">
																<!--begin::Label-->
																<label class="fs-6 fw-semibold form-label mb-2">Select Zone:</label>
																<!--end::Label-->
																<!--begin::Input-->
																<select name="role" data-control="select2" data-placeholder="Select Company" data-hide-search="true" class="form-select form-select-solid fw-bold">
																	<option></option>
																	<option value="Zone Details">Zone Details</option>
								...
								<div class="card-body py-4">
									<!--begin::Table-->
									<table class="table align-middle table-row-dashed table-striped table-hover fs-6 gy-1 gs-2" id="kt_datatable_zone_list">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
											<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
												...
												<th class="min-w-125px" style="width: 60%;" >Zone Name</th>
										...
										<tbody class="text-gray-600 fw-semibold">
											<!--begin::Table row-->
											<?php $i=1; foreach($zone_list as $dlist){?>
											<tr>
												...
												<td>
													...
													<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_editdept" onclick="zone_edit('<?php echo $dlist['SNO'];?>')">
													...
													<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_zone" onclick="zone_delete('<?php echo $dlist['SNO'];?>')">
		...
		<div class="modal fade" id="kt_modal_adddept" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-dialog modal-m">
				...
				<div class="modal-content rounded">
					...
					<!--end::Modal header-->
					<!--begin::Modal body-->
					<form name="zone_add_form" id="zone_add_form" method="POST" action="<?php echo base_url(); ?>Zone/zone_save" enctype="multipart/form-data" onsubmit="return zone_validation();">
						<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
							<!--begin::Heading-->
							<div class="mb-13 text-center">
								<h1 class="mb-3">New Zone</h1>
							</div>
								<div class="row mb-6">
									<!--begin::Label-->
													<label class="col-lg-4 col-form-label required fw-semibold fs-6">Zone</label>
													<!--end::Label-->
													<!--begin::Col-->
													<div class="col-lg-8 fv-row fv-plugins-icon-container">
														<input type="text" id="zone" name="zone" class="form-control form-control-lg form-control-solid" placeholder="Enter Zone Name" onkeyup="zone_unique(this.value);">
...
<div class="modal fade" id="kt_modal_viewdept" tabindex="-1" aria-hidden="true">
						...
						<div class="row mb-6">
							...
							<div class="row mb-6">
								<!--begin::Label-->
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row fv-plugins-icon-container">
													<input type="text" name="company" class="form-control form-control-lg form-control-solid" placeholder="Zone Name" Value="Accounts" disabled>
		...
		<div class="modal fade" id="kt_modal_delete_zone" tabindex="-1" aria-hidden="true">
...
var title = $('title').text() + ' | ' + 'Zone';
    $(document).attr("title", title);

function zone_edit(val){
var baseurl= $("#baseurl").val();
//alert(val);
$.ajax({
type: "POST",
url: baseurl+'Zone/zone_edit',
async: false,
type: "POST",
data: "id="+val,
dataType: "html",
...
function closeEditModal()
{
	...
	window.location.href = baseurl+'Zone';
}


var berr=0;
function zone_unique(val)
{
	var baseurl= $("#baseurl").val();
	$.ajax({
		type:"POST",
		url:baseurl+'Zone/zone_unique',
		data:{'value':val},
		cache: false,
		dataType: "html",
			...
			if(result>0)
			{
				$('#zone_err').html('Zone already exist!');
				berr=1;
			}
			else
			{
...
var berre=0;
function zone_unique_edit(val,dcid)
{
	var baseurl= $("#baseurl").val();
	$.ajax({
		type:"POST",
		url:baseurl+'Zone/zone_unique_edit',
		...
		dataType: "html",
			...
			if(result>0)
			{
				$('#zone_edit_err').html('Zone already exist!');
				berre=1;
			}
			else
			{
...
function zone_edit_validation()
{
	var erre = 0;
	var zone = $('#zone_edit').val();

    if(zone.trim()==''){
        $('#zone_edit_err').html('Enter Zone Name!');
        erre++;
    }else{
        //$('#zone_err').html('');
        if(berre>0)
...
function zone_delete(val){
var baseurl= $("#baseurl").val();
//alert(val);
$.ajax({
type: "POST",
url: baseurl+'Zone/zone_delete',
async: false,
type: "POST",
data: "id="+val,
dataType: "html",
success: function(response)
{
$('#kt_modal_delete_zone').empty().append(response);
$('#kt_modal_delete_zone').addClass('show');
...
{
	var baseurl= $("#baseurl").val();
	$('#kt_modal_delete_zone').removeClass('show');
	$('.modal-backdrop').removeClass('show');
	window.location.href = baseurl+'Zone';
}
...
$('#kt_datatable_zone_list').DataTable( {
	"aaSorting": [],
        dom: 'Bfrtip',
        buttons: [
	    			{
