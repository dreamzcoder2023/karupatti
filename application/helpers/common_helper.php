...
// GET COMPANY INFO BY ID PASS LIKE $company_info = company_info('003'); // vasanth

function get_party_details_id($id)
{
  $ci=& get_instance();
  $ci->load->database();
...
function webside_db_connect()
{

    $config_app['hostname'] = '192.243.110.16';
    $config_app['username'] = 'ayyanark_wp514';
    $config_app['password'] = '2S08p.@5R1';
    $config_app['database'] = 'ayyanark_wp514';
