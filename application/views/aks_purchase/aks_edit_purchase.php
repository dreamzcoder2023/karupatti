...
<link href="<?php echo base_url();?>assets/jquery.autocomplete.css" rel="stylesheet" type="text/css" />
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Update Product Purchase
									<!--begin::Separator-->
									<span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
									<!--end::Separator-->
									<span><?php echo $edit->pur_id??'' ?></span>
									<!--begin::Description-->
									<!--end::Description--></h1>
									<!--end::Title-->
								</div>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div id="kt_content_container" class="container-xxl">
							...
							<div class="row gy-5 g-xl-8">
								...
								<div class="col-xxl-8">
									<?php if(isset($edit)){ ?>
										<?php if(isset($_SESSION['Karupatti PurchaseEdit'])){ if($_SESSION['Karupatti PurchaseEdit']==1){?>
											...
											<div class="card card-xxl-stretch mb-5 mb-xl-8">
												...
												<div class="card-body py-4">
													<form method="POST" action="<?php echo base_url(); ?>Akspurchase/purchase_update" enctype="multipart/form-data" onsubmit="return new_purchace_validation();">
													  <div class="row">
														  <div class="col-lg-7">
																<div class="row">
																	<!--begin::Col-->															
																	<div class="col-lg-4 fv-row">
																		<div class="d-flex align-items-center">
																			...
																			<!--end::Svg Icon-->
																			<?php $date = date('d-m-Y',strtotime($edit->pur_date??data('Y-m-d'))); ?>
																			<input class="form-control form-control-solid ps-12" name="pur_date" placeholder="Date" id="purchase_entry_add_date"  value="<?php echo $date; ?>"/>
																		</div>
																	...
																	<div class="col-lg-6  fv-row fv-plugins-icon-container">
																		<label class="col-form-label fw-semibold fs-5"><?php echo $edit->pur_sup??'-'; ?></label>
																		<input type="hidden" name="sup_id" id="sup_id" value="<?php echo $edit->supplier_id??''; ?>">
																		<input type="hidden" name="edit_id" id="edit_id" value="<?php echo $edit->pid??''; ?>">
																		<input type="hidden" name="purchase_id_hidden" id="purchase_id_hidden" value="<?php echo $edit->pur_id??''; ?>">
																...
																<div class="row mt-2">	
																	<div class="col-lg-4">
																		<label class="form-check form-check-inline form-check-solid me-2 is-invalid mt-6">
																			<input class="form-check-input" name="production_chk" type="checkbox" id="production_chk" onclick="production_chk_func()" <?php if($edit->production_chk){ echo 'checked';} ?> value="1">
																...
																<div class="col-lg-7">
																	...
																	<div class="row mt-2">
																		...
																		<div class="col-lg-3 fv-row fv-plugins-icon-container">
																			<input type="text" name="mackingcharges" id="mackingcharges" onkeyup="cart_prd_totcal_pro()" class="form-control form-control-lg form-control-solid fs-5" value="<?php echo $edit->mackingcharges??0 ?>" oninput="this.value = this.value.replace(/[^/0-9.]/g, '').replace(/(\..*)\./g, '$1');" style="width:100px !important;">
															...
															<div class="d-flex align-items-center justify-content-end mt-2">
																...
																<button class="btn btn-sm btn-primary" name="new_purchase" id="new_purchase"style="display: none;">Update Purchase</button>
															</div>
														</div>
													</form>
											</div>
			...
			<div class="modal-dialog modal-xl">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Akspurchase/purchase_update" enctype="multipart/form-data" onsubmit="return (false);">
						...
						<!--end::Heading-->
								<div class="row">
									...
									<label class="col-lg-2 col-form-label fw-bold fs-3"id="lbl_net_pay1"><?php echo isset($edit->pur_cash) ? number_format($edit->pur_cash,2,'.',',') : ''; ?>
									</label>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
										<div class="d-flex align-items-center mt-1">
											<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
												<input class="form-check-input" name="upi_received_add_radio" type="checkbox" value="UPI" id="upi_received_add_radio" onclick="upi_ln_recev_add_radio()" <?php if(isset($upi_detail)){ echo 'checked';} ?>>
											</label>
									...
									<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
										<div class="d-flex align-items-center mt-1">
											<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
												<input class="form-check-input" name="cheque_received_add_radio" type="checkbox" value="Cheque" id="cheque_received_add_radio" onclick="cheque_ln_recev_add_radio()" <?php if(isset($cheque_detail)){ echo 'checked'; }?>>
											</label>
									...
									<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
										<div class="d-flex align-items-center mt-1">
											<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
												<input class="form-check-input" name="cash_received_add_radio" value="Cash" type="checkbox" value="Cash" id="cash_received_add_radio" onclick="cash_ln_recev_add_radio()" <?php if(isset($cash_detail)){ echo 'checked'; }?>>
											</label>
								...
								<div class="row">
									...
									<div class="col-lg-2 fv-row fv-plugins-icon-container" id="upi_amt_tbox" style="display:none;">
										<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" oninput="this.value = this.value.replace(/[^/0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeyup="pay_to_purchase_calc()" value="<?php echo isset($upi_detail->amount) ? $upi_detail->amount : 0; ?>" name="upi_amount" id="upi_amount">
									...
									<div class="col-lg-3 fv-row fv-plugins-icon-container" id="upi_trans_no_tbox" style="display:none;">
										<input type="text" name="upi_ref_no" id="upi_ref_no" value="<?php echo isset($upi_detail->cheque_ref_no) ? $upi_detail->cheque_ref_no:''; ?>" class="form-control form-control-lg form-control-solid" placeholder="Trans/Ref Number">
									...
									<div class="col-lg-3 fv-row fv-plugins-icon-container" id="upi_bank_tbox" style="display:none;">
										<select class="form-select form-select-solid"  data-dropdown-parent="#kt_modal_purchase_payment" data-control="select2"  data-hide-search="false" id="upi_bank_id" name="upi_bank_id">
											<option value="">Select</option>
											<?php
												$cmb = isset($upi_detail->company_bank) ? $upi_detail->company_bank:'';
												$bnk_det=$this->db->query("SELECT * FROM BANKS WHERE ACTIVE='Y' AND COMPANYCODE='003'")->result_array();
												foreach ($bnk_det as $blist) {
												?>
												<option value="<?php echo $blist['SNO'];?>" <?php if ($blist['SNO']==$cmb ){echo 'selected';} ?>> 
									...
									<div class="col-lg-3 fv-row fv-plugins-icon-container" id="upi_detail_tbox" style="display:none;">
										<textarea class="form-control form-control-solid" rows="1" placeholder="Details" name="upi_details" id="upi_details"><?php echo isset($upi_detail->remarks) ? $upi_detail->remarks:''; ?></textarea>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cheque_amt_tbox" style="display:none;">
										<input type="text"  class="form-control form-control-lg form-control-solid" placeholder="Amount"oninput="this.value = this.value.replace(/[^/0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeyup="pay_to_purchase_calc()"  value="<?php echo isset($cheque_detail->amount) ? $cheque_detail->amount:0; ?>" name="cheque_amount" id="cheque_amount" >
									</div>
									<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cheque_chq_no_tbox" style="display:none;">
										<input type="text" name="cheque_ref_no" id="cheque_ref_no" class="form-control form-control-lg form-control-solid" placeholder="Trans/Ref Number" value="<?php echo isset($cheque_detail->cheque_ref_no)?$cheque_detail->cheque_ref_no:''; ?>" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');">
								...
								<div class="row">
									...
									<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cash_label_tbox" style="display:none;">
										<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeyup="pay_to_purchase_calc()"  name="cash_amount" id="cash_amount" value="<?php echo isset($cash_detail->amount)?$cash_detail->amount:0; ?>">
									...
									<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cash_detail_tbox" style="display:none;">
										<textarea class="form-control form-control-solid" rows="1" placeholder="Details"  name="cash_detail" id="cash_detail"><?php echo isset($cash_detail->remarks)?$cash_detail->remarks:''; ?></textarea>
									</div>
								</div>
    ...
    <script>
		...
		<script>
				...
				function cart_get() {
				    var baseurl = $("#baseurl").val();
				    var val = $('#purchase_id_hidden').val();

				    if (val !== '') {
				        $.ajax({
				            type: "POST",
				            url: baseurl + 'Akspurchase/add_edit_cart_list',
				            async: false,
				            data: "id=" + val,
				            dataType: "html",
				            success: function (response) {
				...
				function add_cart(ind) {
				    var baseurl = $("#baseurl").val();
				    var count = $(".btnDelete").length || 0;

				    var j = 0;
				    if (count > 0) {
				        let element = { id: ind };
				        j = arr.some(it => it.id == element.id) ? 1 : 0;
				    }
				...
				function price_update(ind) {
				    var prd_wgt = parseFloat($('#prd_wgt' + ind).val()) || 0;
				    var prd_unit = parseFloat($('#prd_unit' + ind).val()) || 0;
				    var prd_prc = parseFloat($('#lb_prd_price' + ind).val()) || 0;

				    var total = (prd_wgt / prd_unit) * prd_prc || 0;
		...
		<script>
				...
				function cart_get_pro() {
				    ...
				    if (val !== '') {
				        $.ajax({
				            type: "POST",
				            url: baseurl + 'Akspurchase/add_edit_pro_cart_list',
				            async: false,
				            data: "id=" + val,
				            dataType: "html",
				            success: function (response) {
				                var res = response.split('||');
				                if (res[1]) {
				                    $("#table_row_pro").empty().append(res[1]);
				                    arr_pro = JSON.parse(res[2]);
				...
				function add_cart_pro(ind) {
				    var baseurl = $("#baseurl").val();
				    var count = $(".btnDeletepro").length || 0;
				    var j = 0;

				    if (count > 0) {
				        let element = { id: ind };
				        j = arr_pro.some(it => it.id == element.id) ? 1 : 0;
				    }
				...
				function price_update_pro(ind) {
				    ...
				    if (val > 0) {
				        var prd_wgt = parseFloat($('#prd_wgt_pro' + ind).val()) || 0;
				        var prd_unit = parseFloat($('#prd_unit_pro' + ind).val()) || 0;
				        var prd_prc = parseFloat($('#lb_prd_price_pro' + ind).val()) || 0;

				        var total = parseFloat((prd_wgt / prd_unit) * prd_prc) || 0;
				...
				$("#table_row_pro").on('click', '.btnDeletepro', function () {
				    $(this).closest('tr').remove();
				    let id = $(this).attr("name");
				    arr_pro = arr_pro.filter(e => e.id != id);
