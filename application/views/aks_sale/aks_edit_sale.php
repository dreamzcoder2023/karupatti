...
<link href="<?php echo base_url(); ?>assets/jquery.autocomplete.css" rel="stylesheet" type="text/css" />
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Sale Edit
									<!--begin::Separator-->
										...
										<?php  if(isset($_SESSION['Karupatti SaleEdit'])){ if($_SESSION['Karupatti SaleEdit']==1){?>
											<?php if(isset($edit)){ ?>
												<div class="card-body py-4">
													<div class="row">
														<div class="col-lg-7">
															<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Akssale/update" id="submit_form" enctype="multipart/form-data" onsubmit="return submit_validation();">
															<!-- <div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;"> -->
																...
																<label class="col-lg-2 col-form-label fw-semibold fs-6">Type</label>
																	<label class="col-lg-3 col-form-label  fw-bold fs-5"><?php echo $edit->sale_type; ?></label>
																	<label class="col-lg-2 col-form-label fw-semibold fs-6">Sale ID</label>
																  <label class="col-lg-4 col-form-label fw-bold fs-6" id=""><?php echo $edit->sale_id; ?></label>
																  </div>
																  <div class="row">
												              ...
												              $address=$ADDRESS1.', '.$CITY.$pin;


												              $shipping = $this->db->query("SELECT * FROM AKS_SHIPPING_ADDRESS WHERE party_id='".$party_data->PID."'")->row();
												              if(isset($shipping)){
										              ...
										              ?>
										              <?php if(isset($party_data)){ ?>
																  <label class="col-lg-2 col-form-label fw-semibold fs-6">Party</label>
																  <label class="col-lg-4 col-form-label fw-bold fs-6" id=""><?php echo $party_data->NAME; ?></label>
																  <label class="col-lg-2 col-form-label fw-semibold fs-6">Phone</label>
																  <label class="col-lg-4 col-form-label fw-bold fs-6" id=""><?php echo $party_data->PHONE; ?></label>
																  <label class="col-lg-2 col-form-label fw-semibold fs-6">Email</label>
																  <label class="col-lg-3 col-form-label fw-bold fs-6" id=""><?php echo $party_data->EMAIL?:'---'; ?></label>
																  <label class="col-lg-2 col-form-label fw-semibold fs-6">Bill.Address</label>
																  <label class="col-lg-4 col-form-label fw-bold fs-6" id=""><?php echo $address; ?></label>
																  <label class="col-lg-2 col-form-label fw-semibold fs-6">Ship.Address</label>
																  <label class="col-lg-4 col-form-label fw-bold fs-6" id=""><?php echo $shipment_address; ?></label>
																	<?php 	}else{ ?>
																			<label class="col-lg-2 col-form-label fw-semibold fs-6">Party</label>
																		  <label class="col-lg-4 col-form-label fw-bold fs-6" id="">XXXXX</label>
																		  <label class="col-lg-2 col-form-label fw-semibold fs-6">Phone</label>
																		  <label class="col-lg-4 col-form-label fw-bold fs-6" id="">999999999</label>
																		  <label class="col-lg-2 col-form-label fw-semibold fs-6">Email</label>
																		  <label class="col-lg-3 col-form-label fw-bold fs-6" id="">XXXXXXXXXX</label>
																		  <label class="col-lg-2 col-form-label fw-semibold fs-6">Bill.Address</label>
																		  <label class="col-lg-4 col-form-label fw-bold fs-6" id="">XXXXXXXXXXXX</label>
																		  <label class="col-lg-2 col-form-label fw-semibold fs-6">Ship.Address</label>
																		  <label class="col-lg-4 col-form-label fw-bold fs-6" id="">XXXXXXXXXXXXXXX</label>
																	<?php 	} ?>
																  </div>
																	...
																	<div class="col-lg-12">
																		...
																		<div class="col-lg-2 d-flex align-items-center">
																				<div class="form-check form-check-custom">
																					<input class="form-check-input2" type="radio" value="courier" name="delivery_add_mode_courier" id="delivery_add_mode_courier" onclick="delivery_mode_courier_radio(1)" <?php if($edit->sale_deliverymode!='Direct'){echo 'checked';} ?>  />
																				</div>
																			...
																			<div class="col-lg-2 d-flex align-items-center">
																				<div class="form-check form-check-custom">
																					<input class="form-check-input2" type="radio" id="select_int" name="delivery_add_mode_courier" value="Direct" onclick="delivery_mode_courier_radio(0)" <?php if($edit->sale_deliverymode=='Direct'){echo 'checked';} ?> />
																				</div>
																				<div class="d-flex flex-column">
		...
		<script>
			var dby = '<?php echo $edit->sale_deliverymode; ?>';
			if (dby == 'Direct') {	
			...
			<script> 
				...
				function cart_get(){
						...
						if (val !== '') {							
								...
								$.ajax({
									type: "POST",
									url: baseurl+'Akssale/add_edit_cart_list',
									async: false,
									type: "POST",
									data: "id="+val,
									dataType: "html",
