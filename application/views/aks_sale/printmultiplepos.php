            ...
            $print  = 1; ?>
                <?php if ($print) { ?>
                    <center class="printpos">
                        <div style="height:570px;width: 381px;font-family: calibri;">
                            <table width="100%"  style="padding: 5px;padding-top: 5px !important;padding-bottom: 0px !important;padding-left: 0px !important;line-height: 1.5rem !important;">
                                <thead>
                                    <?php $sale_pos = $this->db->query("SELECT * FROM AKS_SALE_ENTRY WHERE sale_id='".$val."'  ")->result_array(); ?>
                            ...
                            <div style="padding: 10px !important;padding-top: 0px !important;">
                                <table id="tab" width="100%"  style="line-height: 1.5rem !important;">
                                    ...
                                    <tbody>
                                        ...
                                        $print_cart_view_pos = $this->db->query("SELECT * FROM AKS_SALE_CART WHERE sale_id  = '".$val."' AND status=0 ")->result_array();
                                ...
                                <img src="" id="barcode<?php echo $prc; ?>" height="50" width="250" style="padding-right: 50px;padding-top: 5px;">
                            </div>
                        </div>
                    </center>
                    ...
                    <script>
                        ...
                        JsBarcode("#barcode<?php echo $prc; ?>", "<?php echo $spos['sale_id']; ?>", {
                              displayValue: false
                            });
                    </script>
