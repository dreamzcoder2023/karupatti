	...
	<tbody class="text-gray-600 fw-bold fs-6">
		<?php foreach ($cart_view as $i => $view){   
			 ...
			 if (isset($view["create_on"])) {
                ...
                $c_time = date_format(date_create($view["create_on"]),'H:i A');

                $billed_date = $c_date.' & '.$c_time;
            ...
            if (isset($view["packed_on"])) {
                ...
                $p_time = date_format(date_create($view["packed_on"]),'H:i A');

                $packed_date = $p_date.' & '.$p_time;
            ...
            if(isset($view["shiped_on"])) {
                ...
                $s_time = date_format(date_create($view["shiped_on"]),'H:i A');


                $shiped_date = $s_date.' & '.$s_time;
