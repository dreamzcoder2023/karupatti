	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Withdraw Chit</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
							</div>
							...
							<div class="row gy-5 g-xl-8">
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<!--end::Card header-->
										<!--begin::Card body-->
										<?php if(isset($_SESSION['Chit withdrawAdd'])){ if($_SESSION['Chit withdrawAdd']==1){?>
											<?php if(isset($chit)){ ?>
											<div class="card-body py-4">

													<!--begin::Table-->
													<!--end::Heading-->
													<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Chit/withdraw_chit_id/<?php echo $chit->sno?$chit->sno:''; ?>" enctype="multipart/form-data" onsubmit="return deposit_chit_entry_validation();">
													<div class="row">
														<div class="col-lg-6">
															<div class="row">
													...
													<?php if($chit->scheme_type=='1'){ ?>
													  ...
													  <div class="row">
														...
														<div class="d-flex justify-content-end mt-4">
															<button type="reset" class="btn btn-secondary me-3" data-bs-dismiss="modal" onclick="closeadd()">Cancel</button>
		...
		<script>
			function net_amt_cal(id){			
				...
				var available   = $('#ava_balance').val();



					if(id=='1'){
						if (parseFloat(sm_cash_box)>parseFloat(available)) {
						...
						if (parseFloat(tm_cash_box)>parseFloat(available)) {
