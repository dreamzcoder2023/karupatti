...
<style>
  ...
  .dataTables_scroll thead{
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
												...
												<div class="col-lg-4">
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
															<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Chit/chitlist_transaction_history" enctype="multipart/form-data" id="fill_form">
															...
															<div class="scroll-y mh-325px my-1 px-1">	
																...
																<div class="mb-2">
																<label class="form-label fs-6 fw-semibold">Chit ID</label>
																	<div class="col-lg-12 fv-row fv-plugins-icon-container">
																		<input type="text" name="chit_id_fill" id="chit_id_fill" class="form-control form-control-lg form-control-solid" placeholder="Chit ID" value="<?php echo $chit_id_fill?$chit_id_fill:''; ?>">
																		<div class="fv-plugins-message-container invalid-feedback"></div>
																	</div>
																</div>											
																<div class="mb-2">
														...
														<form id="list_export1" method="POST" action="<?php echo base_url();?>Chit/chit_transaction_export">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<table class="table align-middle table-striped table-hover fs-7 gy-1 gs-2" id="chit_overall_trans_table">
												<thead>
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													<tr>
														...
														<td><?php echo $catlist['chit_id']; ?> / <br>
															 ...
															 <?php if($catlist['type']==2) { echo '&nbsp;&nbsp;<i class="fa-solid fa-circle-xmark fs-4 text-danger mt-2" title="closed"></i></td>'; } 
															 ?>
														<td><?php 
                            ...
                            <td>
											...
											<?php $paging_info = get_paging_info1($count,10,$c_page); ?>
														...
														<form   method="POST" id="filter_form" action="" enctype="multipart/form-data" >
															...
															<input type="hidden" id="sch_cashgold" name="sch_cashgold"  value="<?php echo $sch_cashgold; ?>">
															<input type="hidden" id="party_fil" name="party_fil"  value="<?php echo $party_fil; ?>">
															<input type="hidden" name="chit_id_fill" id="chit_id_fill" value="<?php echo $chit_id_fill?$chit_id_fill:''; ?>">
		...
		<script>
	      $("#chit_overall_trans_table").kendoTooltip({
	        filter: "td",
	        show: function(e){
