											...
											<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="kt_datatable_raise_complaint">
												...
												?>
													<tr>
														...
														<td>
															<label class="badge badge-info"><?php echo $complaint['nos_updation']; ?></label>
														</td>
															...
															<span class="text-end">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-250px py-3" data-kt-menu="true" style="">
																	<div class="menu-item px-3">
																		<a href="javascript:;" onclick="updatecomplaintdescriptionfunc('<?php echo $complaint['billno']; ?>');"  class="menu-link px-3">Update Remarks</a>
																	</div>
																	<div class="menu-item px-3">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-3 text-center">
							<h1 class="mb-3">
								...
								<span class="text-primary" id="complaintbillno">001-MIP-2569/22</span>
								...
								<div class="px-4" style="border-radius: 10px;padding-bottom: 2px;box-shadow: 0 5px 10px #00002947;">
									<div class="row">
										...
										<div class="col-lg-4 d-flex justify-content-center align-items-center" id="status">
											<label class="col-form-label fw-bold fs-5 text-white" style="background-color: red;border-radius: 8px;padding: 5px 10px 5px 10px;display:none;" >-</label>
										</div>
										<div class="col-lg-9">
											<div class="row">
						...
						<div class="row mt-4">
							...
							<div class="col-lg-6">
								<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="kt_datatable_raise_complaint_view">
									...
									<tbody class="text-gray-600 fw-semibold">
										<tr>
											<td id="updateremark_date">-</td>
											<td class="ple1" id="updateremarksBy">-</td>
											<td class="ple1" id="update_remarks">-</td>
										</tr>
									</tbody>
								</table>
							</div>
	...
	function viewcomplaintfunc(id)
	{
		...
		$.ajax(
		{
			...
			success: function(response) 
			{
				...
				$('#nos_updation').html(returnedData.rasicomplaintdata[0].nos_updation);
				...
				var rating = returnedData.partydetails[0].RATING;
				if(rating==1){
