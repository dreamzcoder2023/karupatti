											...
											<div class="col-lg-8">
												<div class="row">
													<div class="col-lg-6">
														...
														<div class="text-center">
															<label class="text-success fs-2 fw-bold">3000.00</label>
														</div>
													</div>
													<div class="col-lg-6">
														<div class="text-center">
														...
														<div class="text-center">
															<label class="text-success fs-2 fw-bold">2000.00</label>
														</div>
													</div>
												</div>
											</div>
											...
											<table id="kt_datatable_non_tagged_wallet_history"
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													<tr>
														...
														<td class="ple1">
															<span><i class="fa-solid fa-star fs-7" style="color:#50cd89;"></i></span>
															<span class="align-items-center">Selvam</span>
														</td>
														<td>Receipt</td>
														<td>
													...
													<tr>
														...
														<td>
															<label class="col-form-label fw-semibold fs-7">
																<span style="background-color:#46dcf9;border-radius: 8px;padding: 5px 15px 5px 15px;">On A/c
																</span>
															</label>
														</td>
														<td>500.00</td>
													...
													<tr>
														...
														<td>
															<label class="col-form-label fw-semibold fs-7">
																<span style="background-color:#B6BD4F;border-radius: 8px;padding: 5px 15px 5px 15px;">H/L
																</span>
															</label>
														</td>
														<td>2000.00</td>
													...
													<tr>
														...
														<td>Redemption</td>
														<td>
															<label class="col-form-label fw-semibold fs-7"><span style="background-color:#46dcf9;border-radius: 8px;padding: 5px 15px 5px 15px;">On A/c</span>
															</label>
														</td>
														<td>1000.00</td>
													</tr>
