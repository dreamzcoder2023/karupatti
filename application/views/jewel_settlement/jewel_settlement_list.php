								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										<?php if($this->session->flashdata('g_success')){?>
											...
											<?php }
											if($this->session->flashdata('g_error')){ ?>		
											<div class="menu-item px-3">
													...
													<tr class="<?php echo ($jlist['CHK_RETURNED']=='Y')?'bg-success':''; ?>">
														...
														<?php 
															...
															<span class="text-end">
																...
																<a href="<?php echo base_url();?>jewelsettlement/fsd_view/<?php echo $bno;?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" title="View">
