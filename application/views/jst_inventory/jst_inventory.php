...
<style>
  ...
  #tolltiphideshow #tolltiphideshow_tltip {
		  display: none;
			}
	#tolltiphideshow:hover #tolltiphideshow_tltip {
	  /*display: block;*/
	  display: flex;
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>User &emsp;-</span>
										<span>&emsp;<?php if($jst_user==''){ echo "All"; }else{ echo $jst_user; } ?></span>
									</label>
									<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
									
										<div  id="tolltiphideshow">
												<span>From &emsp;-</span>
											<?php if($from_company==''){ echo "All"; }
												else{ 
															$company_get  = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='". $from_company."' ")->row();

																if(isset($company_get)){
																 	$company = $company_get->COMPANYNAME;
																}else{
																	$company ='All';
																}
								                ...
								                $companyhide = substr($company, 0, 10) ."...";
								            } else{
								            	$companyhide = $company;	
								            }
						          ...
						          ?>
											...
											<span id="tolltiphideshow_tltip"><?php echo $company; ?></span>
										<?php } ?>
										</div>
									</label>
									<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<div  id="tolltiphideshow">
												<span>To &emsp;-</span>
											<?php if($to_company==''){ echo "All"; }
												else{ 
															$tocompany_get  = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='". $to_company."' ")->row();

																if(isset($tocompany_get)){
																 	$tocompany = $tocompany_get->COMPANYNAME;
																}else{
																	$tocompany ='All';
																}


														if (strlen($tocompany) > 10) {
								                $tocompanyhide = substr($tocompany, 0, 10) ."...";
								            } else{
								            	$tocompanyhide = $tocompany;	
								            }
						          ...
						          ?>
											...
											<span id="tolltiphideshow_tltip"><?php echo $tocompany; ?></span>
										<?php } ?>
										</div>
								...
								<!--	<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>Send By &emsp;-</span>
										<span>&emsp;All</span>
									</label>-->
									<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>Status &emsp;-</span>
										<span>&emsp;<?php if($jst_status==''){ echo "All"; }elseif($jst_status=='Y'){ echo 'Waiting Approval'; }elseif($jst_status=='M'){ echo 'Missed Some'; }elseif($jst_status=='R'){ echo 'Received'; } ?></span>
									</label>
									<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>Date &emsp;-</span>
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
													...
													<!-- <div class="row">
														<div class="col-lg-3">
															<div class="text-center">
																<label class="form-label fs-3 fw-bold">Total Sales</label>
															</div>
															<div class="text-center">
														...
														<div class="col-lg-3">
															<div class="text-center">
																<label class="form-label fs-3 fw-bold">Total Weight(gms)</label>
															</div>
															<div class="text-center">
														...
														<div class="col-lg-3">
															<div class="text-center">
																<label class="form-label fs-3 fw-bold">Total Sales Amount</label>
															</div>
															<div class="text-center">
													...
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
															<div class="px-7 py-5" data-kt-user-table-filter="form">
																<form method="POST" action="<?php echo base_url(); ?>Jst_inventory">	
																	<div class="scroll-y mh-300px my-5 px-5" data-kt-user-table-filter="form">
																		<div class="mb-2">
																			<label class="form-label fs-6 fw-semibold">User</label>
																			<div class="fv-row fv-plugins-icon-container">
																				<input type="text" name="jst_user" id="jst_user" class="form-control form-control-lg1 form-control-solid" placeholder="Enter User" value="<?php echo $jst_user; ?>">
																				<div class="fv-plugins-message-container invalid-feedback"></div>
																			</div>
																		</div>
																		<div class="mb-2">
																			<label class="form-label fs-6 fw-semibold">From</label>
																			<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true" id="from_company" name="from_company" >	
																				
																				<option value="" >All</option>
																				<?php foreach($company_list as $clist){ ?>
																					 <option value="<?php echo $clist['COMPANYCODE']; ?>" <?php if($from_company==$clist['COMPANYCODE']){ echo "selected"; } ?> ><?php echo $clist['COMPANYNAME']; ?></option>
																		...
																		<div class="mb-2">
																			...
																			<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true"  id="to_company" name="to_company">	
																			<option value="" >All</option>
																				<?php foreach($company_list as $clist){ ?>
																					 <option value="<?php echo $clist['COMPANYCODE']; ?>" <?php if($to_company==$clist['COMPANYCODE']){ echo "selected"; } ?> ><?php echo $clist['COMPANYNAME']; ?></option>
																		...
																		<div class="mb-2">
																			...
																			<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true" id="jst_status" name="jst_status" >	
																				<option value="" selected>All</option>
																				<option value="Y" <?php if($jst_status=='Y'){ echo "selected"; } ?>>Waiting Approval</option>
																				<option value="M" <?php if($jst_status=='M'){ echo "selected"; } ?>>Missed Some</option>
																				<option value="R" <?php if($jst_status=='R'){ echo "selected"; } ?>>Received</option>
																			</select>
																		</div>
																		<div class="mb-2">
																		...
																		<div class="mb-2 fv-row" id="from_dt_sales_list" style="display:none;">
																			...
																			<div class="d-flex align-items-center">
																				...
																				<!--end::Svg Icon-->
																				<input class="form-control form-control-solid ps-12"  placeholder="From Date" id="from_date_fillter_sales_list" name="from_date_fillter_sales_list" value="<?php echo date("d-m-Y"); ?>" />
																			</div>
																		</div>
																		<div class="mb-2 fv-row" id="to_dt_sales_list" style="display:none;">
																			...
																			<div class="d-flex align-items-center">
																				...
																				<!--end::Svg Icon-->
																				<input class="form-control form-control-solid ps-12"  placeholder="To Date" id="to_date_fillter_sales_list" name="to_date_fillter_sales_list" value="<?php echo date("d-m-Y"); ?>"/>
																			</div>
																		</div>
																		<div class="d-flex justify-content-end">
																			<a href="<?php echo base_url(); ?>Jst_inventory"  class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="reset">Reset</a>
														...
														<a href="<?php echo base_url(); ?>Jst_inventory/jst_add" target="_blank">
															<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="javascript:;">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<table id="kt_datatable_jst_inventry" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
												<thead>
												  <tr class="text-start text-muted fw-bold fs-7 gs-0">
												    <th class="min-w-50px">Date & Time</th>
												    <th class="min-w-100px">JST ID</th>
												    <th class="min-w-100px">User</th>
												    <th class="min-w-100px">From</th>
												    <th class="min-w-100px">To</th>
												    <th class="min-w-80px">Send Via</th>
												    <th class="min-w-80px">Count</th>
												    <th class="min-w-80px">Wgt (gms)</th>
												    <th class="min-w-100px">Cash</th>
												    <th class="min-w-150px">Status</th>
														<th class="min-w-80px" style="width: 10%;"><span class="text-end">Actions</span></th>
												  </tr>
												</thead>
												<tbody class="text-gray-600 fw-semibold">
												<?php foreach($jst_list as $i => $jlist){ ?>
													<tr>
														<td>
															<?php
														 $date_format  = $this->db->query("SELECT * FROM general_settings  ")->row();
														 $format= $date_format->date_format;
														 echo date("$format", strtotime($jlist['date'])).'<br>';?>
														 <?php echo date("h:i A",strtotime($jlist['created_on'])); ?>
														</td>
														
														<td class="ple1"><i class="fa fa-copy fs-4" title="Copy Bill No" style="cursor: pointer;" onclick="copiedclipboardagno('<?php echo $jlist['jst_id'] ? $jlist['jst_id']:'';?>', '<?php echo $i; ?>');"></i>
															

															<?php echo $jlist['jst_id'] ?$jlist['jst_id']:'-';?>
															
															<span style="display: none;" class="ms-2 tooltipcopie" id="tooltipcopie<?php echo $i;?>"></span>
														</td>
														<td class="ple1"><?php echo $jlist['created_by'] ?></td>
														<td class="ple1"><?php
														 $fromcompany  = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='".$jlist['from_company']."' ")->row();
														 echo $fromcompany?$fromcompany->COMPANYNAME:'-';
														// echo $jlist['from_company']; ?></td>
														<td class="ple1"><?php 
														 $company  = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='".$jlist['to_company']."' ")->row();
														 echo $company?$company->COMPANYNAME:'-';
														// echo $jlist['to_company']; ?></td>
														<td class="ple1"><?php
														 $staff  = $this->db->query("SELECT * FROM STAFFS WHERE  SNO='". $jlist['send_via']."' ")->row();
														 echo $staff->STAFFNAME;
														// echo $jlist['send_via'] ?></td>
													
														
														<td><?php echo $jlist['tagged_item_gold_count']+$jlist['tagged_item_silver_count']+$jlist['old_metal_count']; ?></td>
														<td><?php echo $jlist['tagged_item_gold_weight']+$jlist['tagged_item_silver_weight']+$jlist['old_metal_weight']; ?></td>
														<td>
																<i class="fa-solid fa-indian-rupee-sign fs-7 text-dark"></i>&nbsp;
																<?php echo number_format($jlist['cash']?$jlist['cash']:0,2,'.',','); ?> 
														</td>
														<td>
															<label class="col-form-label fw-semibold fs-7">
															
															<?php if($jlist['status']=='Y'){ ?>
																	<span style="background-color:#ffc700;border-radius: 8px;padding: 5px 15px 5px 15px;">Action Required</span>
															<?php } ?>
															<?php if($jlist['status']=='M'){ ?>
																	<span style="background-color:#308ecf;border-radius: 8px;padding: 5px 15px 5px 15px;">Missed some</span>
															<?php } ?>
															<?php if($jlist['status']=='R'){ ?>
														...
														<td>
															<span class="text-end">
																<a href="<?php echo base_url(); ?>Jst_inventory/jst_view/<?php echo $jlist['id']; ?>" target="_blank" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
											...
											<?php $paging_info = get_paging_info1($count,10,$c_page); ?>
														...
														<form   method="POST" id="filter_form" action="" enctype="multipart/form-data" >
														  ...
														  <input type="hidden" id="from_date_fillter_sales_list" name="from_date_fillter_sales_list" value="<?php echo $from_date_fillter; ?>">
															...
															<input type="hidden" id="jst_user" name="jst_user"  value="<?php echo $jst_user; ?>">
															<input type="hidden" id="from_company" name="from_company"  value="<?php echo $from_company; ?>">
															<input type="hidden" id="to_company" name="to_company"  value="<?php echo $to_company; ?>">
															<input type="hidden" id="jst_status" name="jst_status"  value="<?php echo $jst_status; ?>">
		...
		<script>
		      $("#kt_datatable_jst_inventry").kendoTooltip({
		        filter: "td",
		        show: function(e){
        ...
        $(".move_to").on("click", function () {
			value=$(this).val();
			// alert(value);
            $('#filter_form').attr('action', "<?php echo base_url(); ?>Jst_inventory?page="+value);
            $("#filter_form").submit();
            e.preventDefault();
        });
    });
