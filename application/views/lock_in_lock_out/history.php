						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Lock In Lock Out History
									<!--begin::Separator-->
											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6"  href="<?php echo base_url(); ?>Lock_in_lock_out">Lock In</a>
															</li>
															<li class="nav-item">
												...
												<div class="tab-content" id="myTabContent">
													<div class="tab-pane fade " id="kt_tab_pane_1" role="tabpanel">
														<div class="row">
															...
															<div class="col-lg-2">
																<select class="form-select form-select-solid" data-control="select2"
																	...
																	<?php foreach($company_list as $company_list1)
																{?>
															...
															<div class="col-lg-3 fv-row fv-plugins-icon-container">
																<input type="text" name="scan_item" id="scan_item" class="form-control form-control-lg form-control-solid" placeholder="Scan Loan No" >
														...
														<form action="<?php echo base_url();  ?>Lock_in_lock_out/lock_in" method="post" >
														...
														<div class="row mt-4">
															...
															<div class="d-flex align-items-center justify-content-end">
																<button class="btn btn-primary me-2">Lock In</button>
															</div>
															</form>
															...
															<div class="col-lg-4">
																<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
																	...
																	<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                                                        ...
                                                                        <form method="post" action="<?php echo base_url(); ?>Lock_in_lock_out/history" >
																			<div class="mb-2">
																				<label class="form-label fs-6 fw-semibold">Company</label>
																				<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true" name="company">	
                                                                                <option value="">Select Company</option>
																	<?php foreach($company_list as $clist){?>
                                                                <option value="<?php echo $clist['COMPANYCODE'];?>" <?php if($clist['COMPANYCODE']==$company ){ echo "selected"; } ?>><?php echo $clist['COMPANYNAME'];?></option><?php
																 }?>
																				</select>
																			</div>
																			<div class="mb-2">
																				<label class="form-label fs-6 fw-semibold">User</label>
																				<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true"  name="username">	
																  ...
																  <tr class="text-start text-muted fw-bold fs-7 gs-0">
																  	<th class="min-w-25px">Sno</th>
																   	...
																   	<th class="min-w-100px">User</th>
																		...
																		<th class="min-w-80px">Item Weight(gms)</th>
																		<th class="min-w-50px">Status</th>
                                    <th class="min-w-50px">Action</th>
																  </tr>
																</thead>
																<tbody class="text-gray-600 fw-semibold">
                                                                <?php $i=0; foreach($history_list as $hlist){ ?>
																	<tr>
																		<td><?php echo $i+1; ?></td>
												            <td><?php echo date('d-m-Y',strtotime($hlist['created_on'])); ?></td>
												            <td><?php echo date('H:i A',strtotime($hlist['created_on'])); ?></td>
												            <td class="ple1"><?php
                                                            $company_id = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='".$hlist['company']."' ")->row();
                                                            echo $company_id->COMPANYNAME; ?></td>
												            <td><?php echo $hlist['created_by']; ?></td>
												            <td><?php echo $hlist['item_count']; ?></td>
                                                            <!-- <td><?php //echo $hlist['locked_status']; 
                                                            if($hlist['locked_status']=='in'){ ?>
														<label class="col-form-label fw-semibold fs-7"><span style="background-color:#00B050;border-radius: 8px;padding: 5px 10px 5px 10px;" >In</span></label>

                                                          <?php   }else{
                                                            ?>
														<label class="col-form-label fw-semibold fs-7"><span style="background-color:#eb5d14;border-radius: 8px;padding: 5px 10px 5px 10px;" >Out</span></label>
                                                        
                                                        <?php } ?>
                                                            </td> -->

												            <td><?php echo (is_null($hlist['weight'])?'0':$hlist['weight']); ?></td>
												            <td>
 																			<?php 
 																					if($hlist['lock_reason']=='From BJ')
 																					{ ?>
 																						<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="color:  white;background-color:red;border-radius: 8px;padding: 5px 15px 5px 15px;">From BJ</span>
																						</label>
 																					<?php }
 																					else if($hlist['lock_reason']=='New Loan')
 																					{?>
 																						<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="color:  white;background-color:#B6BD4F;border-radius: 8px;padding: 5px 15px 5px 15px;">New Loan</span>
																						</label>
 																					<?php }
 																					else if($hlist['lock_reason']=='From Renewal')
 																					{ ?>
 																						<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="color:  white;background-color:#46dcf9;border-radius: 8px;padding: 5px 15px 5px 15px;">From Renewal</span>
																						</label>
 																					<?php }
 																					else
 																					{
																		...
																		<td>
																			<span class="text-end">
																				<a href="<?php echo base_url(); ?>Lock_in_lock_out/view_history/<?php echo $hlist['id'];  ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
$(document).ready(function() {
    ...
    $(".move_to").on("click", function () {
        value=$(this).val();
        // alert(1);
        $('#filter_form').attr('action', "<?php echo base_url(); ?>Lock_in_lock_out/history?page="+value);
        $("#filter_form").submit();
        e.preventDefault();
    });
});
    ...
    $(this).closest('tr').remove();
		...
		<script>
			function scanned_item(){
				...
				$.ajax({
				type: "POST",
				url: baseurl+'Lock_in_lock_out/scanned_item',
				async: false,
				type: "POST",
				data: "id="+val,
				dataType: "html",
