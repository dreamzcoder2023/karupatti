   ...
   background-color: #ec9629;
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Lock Out View
									<!--begin::Separator-->
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<div class="row">
												...
												<label class="col-lg-2 col-form-label fw-bold fs-5">18-03-2023</label>
												...
												<label class="col-lg-3 col-form-label fw-bold fs-5">Roshan</label>
												<label class="col-lg-1 col-form-label fw-semibold fs-6">Count</label>
												<label class="col-lg-2 col-form-label fw-bold fs-5">7</label>
												<div class="col-lg-4">
													<label class="col-form-label fw-semibold fs-6">Nt.Wgt(gms) &emsp;</label>
													<label class="col-form-label fw-bold fs-5">14.400</label>
												</div>
											</div>
											<div class="row">
									            ...
									            <td>3.200</td>
									            <td>
																<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_view_individual_pledge_item">
									            ...
									            <td class="ple1">AGB - Main Branch Sayalkudi</td>
									            <td>MIP-296/23</td>
									            <td class="ple1">Chain - Hand Chain,Baby Chain,Hand Chain</td>
															<td>3</td>
									            <td>4.600</td>
									            <td>4.200</td>
									            <td>
			...
			<div class="modal-dialog modal-xl">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="row mt-4">
							<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="view_loan_pledge_item_lockout">
								<thead>
									<tr class="text-start text-muted fw-bold fs-7 gs-0">
		...
		<script>
			      ...
			      $("#view_loan_pledge_item_lockout").kendoTooltip({
			        filter: "td",
			        show: function(e){
			...
			$("#view_loan_pledge_item_lockout").DataTable({
				"aaSorting":[],
				"iDisplayLength": "25",
				 "language": {
		 		...
		 		$('#view_loan_pledge_item_lockout').wrap('<div class="dataTables_scroll" />');
	   		</script>
		<script>
