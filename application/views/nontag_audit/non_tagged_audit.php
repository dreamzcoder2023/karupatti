											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															...
															<li class="nav-item">
																<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6"  href="<?php echo base_url(); ?>Nontag_audit/audit_history">History</a>
															</li>
														</ul>
													</div>
												</div>
												<div class="tab-content" id="myTabContent">
													<div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
														...
														<form method="POST" action="<?php echo base_url(); ?>Nontag_audit/update_description" enctype="multipart/form-data"  >
														<div id="description">
...
if(err==0){
	$.ajax({
				type: "POST",
				url: baseurl+'Nontag_audit/audit_check?',
				async: false,
				type: "POST",
				...
				{
					if(response==''){
						window.open(baseurl+"Nontag_audit/audit_history");
					}else{
