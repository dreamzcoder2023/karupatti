...
/*   background-color: #ec9629;*/
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>Date &emsp;-</span>
										<span>&emsp;<?php if(isset($dt_fill)) { echo ucfirst($dt_fill); } else { echo "All"; } ?></span>
									</label>
									<!--end::Separator-->
									<!--begin::Description-->
									<!--end::Description--></h1>
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link  active btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" data-bs-toggle="tab" href="#kt_tab_pane_1">List</a>
															</li>
															<li class="nav-item">
																<a class="nav-link  btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" href="<?php echo base_url(); ?>Nontag_entry/non_tag_entry_wallet">Wallet</a>
															</li>
														</ul>
													</div>
												</div>
															...
															<div class="col-lg-8">
																<div class="row">
																	<div class="col-lg-6">
																		...
																		<div class="text-center">
																			<label class="text-success fs-2 fw-bold"><?php   $item_total=$this->db->query("SELECT SUM(COUNT) AS tot_count ,SUM(WEIGHT) AS tot_weight FROM ITEMS   ")->row();
                                       if(isset($item_total->tot_count)){
															...
															<div class="col-lg-4">
																...
																<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
																	...
																	<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
																		<form method="POST" action="<?php echo base_url(); ?>Nontag_entry" id="fill_form">
																		<div class="scroll-y mh-325px my-1 px-3">
																		<div class="px-7 py-5" data-kt-user-table-filter="form">
																			<div class="mb-2">
																				<label class="form-label fs-6 fw-semibold">Company</label>
																				<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true"  name="company_id" id="company_id">	
																			...
																			<div class="mb-2">
																				...
																				<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true"  name="supplier_name" id="supplier_name">	
																					<option value="" selected>All</option>
																			...
																			<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="dt_fill_select" id="dt_fill_select" onchange="date_fill_list();">	
														...
														<div class="row mt-4">
															<table  class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 " id="kt_datatable_non_tagged_list">
																	<thead>
                                  	...
                                  	<?php $i=1; foreach($Lotentry_list as $llist){ ?>
									            ...
									            <td><?php
                                                 ...
                                                 echo date("$format", strtotime($llist['lot_date']));
                                                 ?></td>
									            <td class="ple1"><?php 
                                                $company  = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='". $llist['company_id']."' ")->row();
                                               if(isset($company)) echo $company->COMPANYNAME;
									            ...
									            <td>
													...
													if(@getimagesize($image_url)){ ?>
												        ...
												        <a class="d-block overlay"  href="<?php echo base_url(); ?>lot_img/<?php echo $llist['img']; ?> " data-fslightbox="lightbox-basic">
														    <!--begin::Image-->
														    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded w-45px h-45px"
														    style="background-image:url('<?php echo base_url(); ?>lot_img/<?php echo $llist['img']; ?>')">
														    </div>
														    <!--end::Image-->
														    <!--begin::Action-->
													...
													<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
										            	<div class="image-input" data-kt-image-input="true">
															<div class="image-input-wrapper w-40px h-40px" style="background-image: url(<?php echo base_url() ?>assets/media/svg/avatars/blank_jwl.svg)">
															</div>
														</div>
													</a>
													<?php } ?>	
									            </td>
									            <td class="ple1"><?php echo $llist['supplier']; ?></td>
									            <!--<td class="ple1">Chain,Ring,Valayal,Kolusu,kammal,Aaram,Neckless,Mookuthi,Kaapu,otiyanam</td>-->
									            <td><?php
                                                $no_items=$this->db->query("SELECT count(lot_id) as count FROM lot_entry_detail WHERE lot_id='".$llist['lot_id']."'  ")->row();
                                                echo $no_items->count;
                                               // echo $llist['item_count']; ?></td>
									            <td><?php echo $llist['item_count']; ?></td>
												<td><?php echo number_format($llist['item_weight'],3); ?></td>
									            <td>
																<span class="text-end">
	...
	$(document).ready(function() {
        ...
        $(".move_to").on("click", function () {
			value=$(this).val();
			// alert(value);
            $('#filter_form').attr('action', "<?php echo base_url(); ?>Nontag_entry?page="+value);
            $("#filter_form").submit();
            e.preventDefault();
        });
    });
	...
	<script>
	      $("#kt_datatable_non_tagged_list").kendoTooltip({
	        filter: "td",
	        show: function(e){
		...
		<script>
				function date_fill_list()
				{
					var dt_fill_select = document.getElementById('dt_fill_select').value;
					...
					else if (dt_fill_select == "monthly")
					{
						today_dt_nontag_list.style.display = "none";
					...
					else if (dt_fill_select == "custom Date")
					{
						today_dt_nontag_list.style.display = "none";
						monthly_dt_nontag_list.style.display = "none";
		...
		<script>
			      $("#kt_datatable_tagged_list").kendoTooltip({
			        filter: "td",
			        show: function(e){
			          if(this.content.text() !=""){
			            $('[role="tooltip"]').css("visibility", "visible");
		...
		<script>
			...
			$("#kt_datatable_tagged_list").DataTable({
