											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link  active btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" data-bs-toggle="tab" href="#kt_tab_pane_1">Current Wallet</a>
															</li>
															<li class="nav-item">
																<a class="nav-link  btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" href="<?php echo base_url(); ?>Nontag_entry/nontag_wallet_history/<?php echo $item_name; ?>">Wallet History</a>
															</li>
														</ul>
													</div>
												</div>
												<div class="tab-content" id="myTabContent">
													<div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
														...
														<div class="row">
															<table id="kt_datatable_non_tagged_wallet_current" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
																...
																<?php $i=1;  foreach($get_lot_no as $get_lot){
																 ...
																 ?> 
																	<tr>
																		<td><?php echo $i; ?></td>
												            <td><?php echo date('d-m-Y',strtotime($get_status->lot_date)); ?></td>
												            <td class="ple1"><?php
												            ...
												            <td><?php echo number_format($get_lot['non_tagged_weight'],3); ?></td>
												       	  </tr>
														  <?php $i++; } } } ?>
													...
													<div class="tab-pane fade <?php  if($show=='1'){ echo "show active";  } ?>" id="kt_tab_pane_2" role="tabpanel">
														<div class="row">
															<div class="col-lg-8">
																<div class="row">
																	<div class="col-lg-4">
																	...
																	<div class="col-lg-4">
																		...
																		<div class="text-center">
																			<label class="text-success fs-2 fw-bold"><?php if(isset($item->weight)){ echo $item->weight; }else{ echo "0"; }; ?></label>
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															...
															//echo $nhlist['date'];	 ?></td>
												            <td class="ple1"><?php  echo $nhlist['company'];	 ?></td>
												            <td><?php  echo $nhlist['type'];	 ?></td>
												            <td><?php  echo $nhlist['id_no'];	 ?></td>
												            <td><?php  echo $nhlist['count'];	 ?></td>
												            <td><?php  echo $nhlist['purity'];	 ?></td>
												            <td><?php  echo $nhlist['weight'];	 ?></td>
												            <td><?php  echo $nhlist['stone_weight'];	 ?></td>
												            <td><?php  echo $nhlist['net_weight'];	 ?></td>
