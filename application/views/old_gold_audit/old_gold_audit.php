						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Audit - Old Gold
									<!--begin::Separator-->
											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link active btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" data-bs-toggle="tab" href="#kt_tab_pane_1">Audit</a>
															</li>
															<li class="nav-item">
																<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" href="<?php echo base_url(); ?>Old_gold_audit/audit_history">History</a>
															</li>
														</ul>
													</div>
												</div>
												<div class="tab-content" id="myTabContent">
													<div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
														<div class="row">
															...
															<div class="col-lg-3">
																<select class="form-select form-select-solid" data-control="select2"  data-hide-search="true" name="audit_item" id="audit_item">
																	<option value="">Select Item</option>
																	<?php foreach($item_list as $ilist){ ?>
																		<option value="<?php echo $ilist['SNO']; ?>"><?php echo $ilist['ITEMNAME']; ?></option>
																	<?php } ?>
																</select>
																<span class="fv-plugins-message-container invalid-feedback text-danger" id="audit_item_err"></span>
															</div>
															<label class="col-lg-1 col-form-label fw-semibold fs-6">Count</label>
															<div class="col-lg-1 fv-row fv-plugins-icon-container">
																<input type="text" name="audit_count" id="audit_count" class="form-control form-control-lg form-control-solid">
																<div class="fv-plugins-message-container invalid-feedback"></div>
																<span class="fv-plugins-message-container invalid-feedback text-danger" id="audit_count_err"></span>
															</div>
															<label class="col-lg-2 col-form-label fw-semibold fs-6">Weight(gms)</label>
															<div class="col-lg-2 fv-row fv-plugins-icon-container">
																<input type="text" name="audit_weight" id="audit_weight" class="form-control form-control-lg form-control-solid">
																<div class="fv-plugins-message-container invalid-feedback"></div>
																<span class="fv-plugins-message-container invalid-feedback text-danger" id="audit_weight_err"></span>
															</div>
															<div class="col-lg-1">
																<button class="btn btn-sm btn-primary me-2" onclick="audit_validation();">Audit</button>
															</div>
														</div>
														<form method="POST" action="<?php echo base_url(); ?>Old_gold_audit/update_description" enctype="multipart/form-data"  >
														<div id="description">
																  ...
																  <tr class="text-start text-muted fw-bold fs-7 gs-0">
																  	<th class="min-w-25px">Sno</th>
																   	...
																   	<th class="min-w-100px">User</th>
																		...
																		<th class="min-w-100px">Additional Status</th>
		...
		<div class="modal fade" id="kt_modal_tagged_audit_history_view" tabindex="-1" aria-hidden="true">
				...
				<div class="modal-dialog modal-md">
					...
					<div class="modal-content rounded">
						...
						<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
							<div class="mb-3 text-center">
								<h1 class="mb-3">Audit Old Gold History</h1>	
							</div>
							<div class="row">
								<label class="col-lg-6 col-form-label fw-semibold fs-6">Items</label>
								<label class="col-lg-6 col-form-label fw-bold fs-5">Chain</label>
								<label class="col-lg-6 col-form-label fw-semibold fs-6">Count</label>
								<label class="col-lg-6 col-form-label fw-bold fs-5">2</label>
								<label class="col-lg-6 col-form-label fw-semibold fs-6">Weight(gms)</label>
								<label class="col-lg-6 col-form-label fw-bold fs-5">3.600</label>
							</div>
							<div class="row mt-4">
							...
							<div class="row mt-4">
								<div class="d-flex justify-content-center align-items-center">
									<label class="col-lg-4 col-form-label fw-semibold fs-6">Descrption</label>
									<div class="col-lg-8 fv-row fv-plugins-icon-container">
										<textarea class="form-control form-control-solid" rows="4" placeholder="" name="" id=""></textarea>
									</div>
								</div>
								<div class="d-flex justify-content-end mt-4">
									<button class="btn btn-sm btn-primary me-2">Notify</button>
								</div>
							</div>
						</div>									
						<!--end::Modal body-->
...
var item=$("#audit_item").val();
var count=$("#audit_count").val();
var weight=$("#audit_weight").val();
// alert(item);
if(item.trim()==''){

                $('#audit_item_err').html('Item is required!');
                err++;
            }else{
                $('#audit_item_err').html('');
            }
...
$('#audit_count_err').html('Count is required!');
err++;
}else{
$('#audit_count_err').html('');
}
if(weight.trim()==''){

$('#audit_weight_err').html('Weight is required!');
err++;
}else{
$('#audit_weight_err').html('');
}

if(err==0){
	$.ajax({
				type: "POST",
				url: baseurl+'Old_gold_audit/audit_check?',
				async: false,
				type: "POST",
				data: "id="+item+"&count="+count+"&weight="+weight,
				dataType: "html",
				success: function(response)
				{
					if(response==''){
						window.open(baseurl+"Old_gold_audit/audit_history");
					}else{
					$('#description').empty().append(response);
					}
				}
				});
