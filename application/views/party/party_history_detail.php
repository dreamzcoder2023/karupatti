				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-13 text-center">
							<h1 class="mb-3"> Party History Details</h1>
						</div>
						<!--end::Heading-->
						<div class="row mb-6">
							<!--begin::Label-->
						...
						<div class="rounded border p-10">
													<div class="mb-5 hover-scroll-x">
														<div class="d-grid">
															<ul class="nav nav-tabs flex-nowrap text-nowrap">
																...
																<li class="nav-item">
																	<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" data-bs-toggle="tab" href="#kt_tab_pane_4">Receipts</a>
																</li>
																<!--<li class="nav-item">
													...
													?>
														...
														<div class="tab-pane fade " id="kt_tab_pane_4" role="tabpanel">
															<div class="row fixTableHead_party dataTables_scroll">
																<table class="table table-striped border rounded table-hover fs-7 gs-2 gy-1" id="kt_datatable_sidebar_paryloanhistory_receipt">
																    <thead>
																        <tr class="fw-bold fs-7 text-gray-800">
