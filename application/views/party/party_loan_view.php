  ...
  .dataTables_scroll_nomiee_bank thead
  {
   ...
   background-color: #ec9629;
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
								...
								<div class="card-body py-4">	
													<div class="mb-5 hover-scroll-x">
														<div class="d-grid">
															<ul class="nav nav-tabs flex-nowrap text-nowrap" role="tablist">
																...
																<li class="nav-item" role="presentation">
																	<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6 active"  data-bs-toggle="tab" href="#kt_tab_pane_all_loans" aria-selected="false" role="tab" tabindex="-1">Loans</a>
																</li>
																<li class="nav-item" role="presentation">
													...
													<div class="tab-content" id="myTabContent">
														...
														<div class="tab-pane fade active show" id="kt_tab_pane_all_loans" role="tabpanel">
															<div class="row">
																<div class="col-lg-8">
																	<form id="frm_loan_type" action="<?php echo base_url();?>party/party_loan_view/<?php echo $party_details->PID;?>" method="post">
																	<div class="row">
																		<div class="col-lg-3">
																			<input type="hidden" name="pid" id="pid" value="<?php echo $party_details->PID;?>">
																			<label class="required fw-semibold fs-6">Type</label>
																				<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" id="sel_loan_type" name="sel_loan_type">	
																...
																<div class="col-lg-4  mt-7" style="display: none;">
																...
																<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="party_loan">
																	...
																	<tbody class="text-gray-600 fw-semibold">
																		...
																		foreach ($loan_details as $llist) {
																			...
																			<td class="ple1" ><i class="fa fa-copy" onclick="copy_text(<?php echo $i; ?>)" style="font-size: 14px;"></i>&emsp;<span id="td_bno_<?php echo $i;?>"><?php echo $llist['BILLNO'];?> </span> </td>
																			...
																			<td>
																				<?php  $res=$this->db->query("SELECT * from loan_status where id=".$llist['LOAN_STATUS'])->row();?>
																				<label class="col-form-label fw-semibold fs-7" name="" id="" ><span style="background-color:<?php echo $res->color_code; ?>;border-radius: 8px;padding: 5px 15px 5px 15px;"><?php echo $res->loan_stage; ?></span>
																				</label>
																			</td>
																			<td>
																				<span class="text-end">
		...
		<!--Begin::Modal - view party Redemption-->
		<div class="modal fade" id="kt_modal_view_party_loan_redemption" tabindex="-1" aria-hidden="true">
		
		</div>
		<!--End::Modal - view party Redemption-->
	...
	var title = $('title').text() + ' | ' + 'Party Loans View';
	...
	<script>
		...
		<script >
			function loan_type_fetch_details()
			{
				var lt=$('#sel_loan_type').val();
		...
		function redemption_view(val)
			{
				...
				$.ajax({
				type: "POST",
				url: baseurl+'Party_search/redemption_view',
				async: false,
				type: "POST",
				data: "bno="+str,
				dataType: "html",
