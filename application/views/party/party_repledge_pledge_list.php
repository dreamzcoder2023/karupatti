							...
							<div class="col-lg-12">
								<div class="row">
									...
									<label class="col-lg-1 col-form-label fw-bold fs-6">
										<span><?php echo $loan_details->INTERESTTYPE;?></span>
										<span>/</span>
										<span><?php echo $loan_details->INTEREST;?></span>
									<span>&nbsp;%</span>
									</label>
									<label class="col-lg-1 col-form-label fw-semibold fs-6">Company</label>
									<label class="col-lg-3 col-form-label fw-bold fs-6"><?php echo $loan_details->COMPANYNAME; ?></label>
								</div>
							</div>
							...
							<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-3 gs-2" id="individual_loan_pledge_item">
								...
								<tbody class="text-gray-600 fw-semibold">
				        			...
				        			<?php 
				        				...
				        				//print_r($totalnetweightval);exit;
				        			?>
							   </tbody>
							   <tfoot>
