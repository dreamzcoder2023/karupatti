				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-7 text-center">
							<h1>Update Payment Entry [Spend Money,Expenses]</h1>
						</div>
						<!--end::Heading-->
						<form id="general_validate" style="width: 100%;" method="POST" action="<?php echo base_url(); ?>payment/payment_update" enctype="multipart/form-data" onsubmit="return payment_edit_validation();">
									...
									<div class="row">
										...
										<div class="col-lg-3 fv-row">
											<div class="d-flex align-items-center">
												<input type="date" class="form-control form-control-solid" name="add_date_payments" placeholder="Select Date" id="add_date_payments_edit" value="<?php echo $voucher_master_details->TRANSDATE;?>" />
											</div>
											<div class="fv-plugins-message-container invalid-feedback" id="add_date_payments_edit_err"></div>
										</div>
								...
								<div class="col-lg-12">
									<div id="kt_docs_repeater_basic_add">
										<div class="form-group">
											<div id="mcontent_edit10">
												...
												<div class="row" id="mid_edit<?php echo $i;?>">
													...
													<div class="col-lg-3 fv-row">
														<input type="text" class="form-control mb-2 mb-md-0" placeholder="Enter Amount" name="add_amt_payments[]" id="add_amt_payments_edit<?php echo $i;?>" style="font-size: 17px !important;font-weight: 600 !important;" onkeyup="getPaymentAmountEdit(<?php echo $i;?>)" onkeypress="return isNumberKey(event,this);" value="<?php echo $vdet['DEBIT'];?>"/>
														<div class="fv-plugins-message-container invalid-feedback" id="add_amt_payments_edit_err<?php echo $i;?>"></div>
													</div>
													<?php if($i!=0){?>
													<div class="col-lg-2 fv-row">
														<a href="javascript:;" onclick="delete_payment_edit(<?php echo $i;?>)" class="btn btn-sm btn-danger mt-md-3"><i class="la la-trash-o fs-3"></i>Delete</a>
													</div>
													<?php }?>
												</div>
												<?php $i++;}
										...
										<div class="col-lg-2 form-group fv-row">
											<a href="javascript:;" onclick="add_payment_edit()" class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2">
											Add</a>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-lg-3 fv-row">
									<input type="text" class="form-control mb-2 mb-md-0" id="add_tota_payments_edit" name="add_tota_payments" style="font-size: 17px !important;font-weight: 600 !important;" value="<?php echo $voucher_master_details->AMOUNT;?>" readonly/>
								</div>
