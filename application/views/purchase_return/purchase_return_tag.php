...
<style>
  ...
  .dataTables_scroll thead{
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Purchase Return - Tagged
									<!--begin::Separator-->
											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															...
															<li class="nav-item">
																<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6"  href="<?php echo base_url(); ?>Purchase_return/tag_return_history">History</a>
															</li>
														</ul>
													</div>
												</div>
													...
													<div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
														<div class="row">
															...
															<div class="col-lg-3 fv-row fv-plugins-icon-container">
																<input type="text" name="tag_id" id="tag_id" class="form-control form-control-lg form-control-solid" placeholder="Scan Here" >
																<div class="fv-plugins-message-container invalid-feedback"></div>
															</div>
															<div class="col-lg-2">
																<button class="btn btn-sm btn-primary me-2" id="add_tag" name="add_tag" onclick="add_tag_row()"  >Add</button>
															</div>
														</div>
														<div class="row mt-2">
															<table id="kt_datatable_purchase_return_tagged" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
																<thead>
																  <tr class="text-start text-muted fw-bold fs-7 gs-0">
																    ...
																    <th class="min-w-80px">Weight(gms)</th>
																   	<th class="min-w-100px">Stone Weight(gms)</th>
																		<th class="min-w-100px">Net Wgt(gms)</th>
																  </tr>
																</thead>
																<tbody class="text-gray-600 fw-semibold" name="table_rows" id="table_rows">
														...
														<div class="row">
															<div class="d-flex justify-content-center align-items-center">
																<div class="col-lg-2">
																	...
																	<label class="col-form-label fw-bold fs-4" name="item_count" id="item_count" >0</label>
																</div>
																<div class="col-lg-3">
																	<label class="col-form-label fw-bold fs-4">Net Weight(gms) &emsp;</label>
																	<label class="col-form-label fw-bold fs-4"  name="item_weight" id="item_weight">0.000</label>
																</div>
															</div>
														</div>
														<div class="d-flex justify-content-end">
															<button class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_convert_old_to_pure_gold">Return</button>
														</div>
													</div>
																	...
																	<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
																		<div class="px-7 py-5" data-kt-user-table-filter="form">
																			<div class="mb-2">
																				...
																				<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true" data-allow-clear="true" multiple="multiple" id="username" name="username">	
																  ...
																  <tr class="text-start text-muted fw-bold fs-7 gs-0">
																  	<th class="min-w-25px">Sno</th>
																   	...
																   	<th class="min-w-100px">User</th>
																		...
																		<th class="min-w-80px">Net Weight(gms)</th>
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-5 px-5 px-xl-20">
						...
						<div class="mb-7 text-center">
							<h1>Tagged History View</h1>
						</div>
						<!--end::Heading-->
						<div class="row">
							<label class="col-lg-1 col-form-label fw-semibold fs-6">Date</label>
							<label class="col-lg-2 col-form-label fw-bold fs-6">02-03-2023</label>
							<label class="col-lg-1 col-form-label fw-semibold fs-6">Company</label>
							<label class="col-lg-4 col-form-label fw-bold fs-6">AGB - Main Branch Sayalkudi</label>
							<label class="col-lg-1 col-form-label fw-semibold fs-6">User</label>
							<label class="col-lg-3 col-form-label fw-bold fs-6">Roshan</label>
							...
							<label class="col-lg-2 col-form-label fw-bold fs-6">8.000</label>

							<table id="kt_datatable_purchase_return_tagged_history_view_table" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
								<thead>
								  <tr class="text-start text-muted fw-bold fs-7 gs-0">
								  	<th class="min-w-25px">Sno</th>
								   	<th class="min-w-100px">Company</th>
				            ...
				            <td class="ple1">Chain - Baby Chain</td>
				            <td>1.600</td>
				            <td>0.200</td>
				            <td>1.800</td>
				       	  </tr>
				            ...
				            <td class="ple1">Ring - Baby Ring</td>
				            <td>2.200</td>
				            <td>0.200</td>
				            <td>2.400</td>
				       	  </tr>
			...
			<div class="modal-dialog modal-xl">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-5 px-5 px-xl-20">
						...
						<form method="POST" action="<?php echo base_url(); ?>Purchase_return/return_tag_save" enctype="multipart/form-data" >
						<div class="row">
						<span id="data" name="data" > </span>
						
							<label class="col-lg-1 col-form-label fw-semibold fs-6">Count</label>
							<label class="col-lg-1 col-form-label fw-bold fs-4" id="old_gold_lot_convert_count" name="old_gold_lot_convert_count">0</label>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Weight(gms)</label>
							<label class="col-lg-1 col-form-label fw-bold fs-4" id="old_gold_lot_convert_weight" name="old_gold_lot_convert_weight">0.000</label>
							...
							<input type="hidden" name="convert_count" id="convert_count">
							<input type="hidden" name="convert_weight" id="convert_weight">
							<div class="col-lg-3">
						...
						<div class="row">
							...
							<div class="col-lg-2 fv-row">
								<div class="d-flex align-items-center">
									...
									<!--end::Svg Icon-->
									<input class="form-control form-control-solid ps-12" name="date" placeholder="Date" id="pur_rtn_tag_date" name="pur_rtn_tag_date" value="<?php echo date("d-m-Y"); ?>" />
								</div>
							</div>
		...
		<script>
			$("#pur_rtn_tag_date").flatpickr({
								dateFormat: "d-m-Y",
							});
		</script>
		<!-- non tag wallet history day fillter start -->
        <script>
function purchase_return_tag_convert(){
//  alert(val);
...
function old_gold_lot_convert_weight_less(){
    ...
    var lesss=parseFloat(weight)-parseFloat(after_weight);
    var finalvalless = lesss ? lesss : '0.0';
	$('#old_gold_lot_convert_weight_less').html(parseFloat(finalvalless).toFixed(3));
	$('#old_gold_lot_convert_weight_less1').val(parseFloat(finalvalless).toFixed(3));
...
var lessss=parseFloat(weight)-parseFloat(after_weight);
var finalimpless = lessss ? lessss :"0.0";
$('#old_gold_lot_convert_weight_less').html(parseFloat(finalimpless).toFixed(3));

if(convertion=='convertion_radio_val'){
	var metal_weight=parseFloat(after_weight) *parseFloat(based_purity)/100;
	var finalmetalwight = metal_weight ? metal_weight : '0.0';
	$('#old_gold_lot_convert_pure_metal').html(parseFloat(finalmetalwight).toFixed(3));
	var actual_pure=parseFloat(metal_weight) *parseFloat(pure_metal_purity)/100;
	
	
	$('#old_gold_lot_convert_purity1').val(based_purity);
	$('#old_gold_lot_convert_metal_weight1').val(parseFloat(finalmetalwight).toFixed(3));
...
var less=parseFloat(weight)-parseFloat(after_weight);
var finalless = less ? less : '0.0';
$('#old_gold_lot_convert_weight_less').html(parseFloat(finalless).toFixed(3));
...
var pure_metal_purity= $("#old_gold_lot_convert_pure_metal_purity").val();
	...
	var actual_pure=parseFloat(pure_metal_purity)*based_metal_weight/100;
		var finalactual_pure =  actual_pure ?? '0.00';
	// alert(actual_pure);
	$('#old_gold_lot_convert_actual_pure').html(finalactual_pure);
	$('#old_gold_lot_convert_actual_pure1').val(parseFloat(finalactual_pure).toFixed(3));
...
function add_tag_row(){
    ...
    var baseurl= $("#baseurl").val();
				...
				$.ajax({
				type: "POST",
				url: baseurl+'Purchase_return/tag_item_add',
				async: false,
				type: "POST",
				data: "id="+val,
				dataType: "html",
				success: function(response)
				{
                   ...
                   if(count==0){
					$('#table_rows').empty().append(res[1]);
				   }
				   else{
					  $('#table_rows').append(res[1]);
				   }
				var tag='<input type="hidden" name="tag_id_array[]" id="tag_id_array'+count+'" value="'+res[3]+'" >';
				$('#data').append(tag);
// alert(tag);
				 pre_weight = $("#item_weight").text();
				 tot_weight=parseFloat(pre_weight)+parseFloat(res[2]);
				var finaltotweight =  tot_weight ?? '0';
				//  alert(tot_weight);
				 $('#old_gold_lot_convert_count').html(count+1);
				 $('#old_gold_lot_convert_weight').html(finaltotweight);
				 $('#old_gold_lot_convert_count1').val(count+1);
				 $('#old_gold_lot_convert_weight1').val(finaltotweight);
				   $('#item_count').html(count+1);
				   $('#item_weight').html(finaltotweight);
				   $('#convert_count').val(count+1);
				   $('#convert_weight').val(finaltotweight);
		...
		<script>
			      $("#kt_datatable_purchase_return_tagged").kendoTooltip({
			        filter: "td",
			        show: function(e){
		...
		<script>
			$("#kt_datatable_purchase_return_tagged").DataTable({
				"aaSorting":[],
				// "sorting":false,
				// "paging": false,
				// "responsive": true,
				"iDisplayLength": "25",
		 		...
		 		$('#kt_datatable_purchase_return_tagged').wrap('<div class="dataTables_scroll" />');
