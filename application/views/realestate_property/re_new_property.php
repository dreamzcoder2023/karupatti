	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">New Property
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Realestateproperty/property_save" enctype="multipart/form-data" onsubmit="return property_validation()">
											<!--begin::Table-->
											<div class="row">
												<div class="col-lg-12">
													<div class="row">
		...
		<script>
	        ...
	        $("#prop_party").autocomplete({ 
	                valueKey:'title',
	                source:[{
	                url:baseurl+'Realestateproperty/userList?query=%QUERY%',
	                type:'remote',
	                ajax:{
	                  dataType : 'json',
	                }
		  ...
		  // alert(pid);
	            $.ajax({
							type: "POST",
							url: baseurl+'Realestateproperty/get_photo',
							async: false,
							type: "POST",
							data: "id="+pid,
							dataType: "html",
	    ...
	    $(document).ready(function () {
	        $('#base_mul_img').fileinput({
	            uploadUrl: '#',
	            showUpload: false,
	            // allowedFileTypes: ['image', 'pdf', 'excel'],
