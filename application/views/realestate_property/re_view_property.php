						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">View Property <span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>&nbsp;
										...
										<div class="card-body py-4">
															...
															<div class="row">
																...
																<div class="col-lg-6" title="Party Address">
																	<div class="row">
																		...
																		<div class="col-lg-10 fv-row mt-1">
																			<label class="col-form-label fw-bold fs-6"><?php if(isset($party_details->NAME)){
											...
											<div class="row">
												<div class="col-lg-4" title="Plot Area">
													...
													<label class="col-form-label fw-bold fs-6" title="Per Price of Plot Area">
														<?php $price_per_ploat = $property_view->price_per_ploat; echo number_format($price_per_ploat,2,'.',',');?>
													</label>
												</div>
												<div class="col-lg-4" title="Sale Plot Area">
													...
													<label class="col-form-label fw-bold fs-6" title="Sale Per Price of Plot Area"><?php $tot_amt = $total_amount; echo number_format($tot_amt,2,'.',',');?></label>
												</div>
											...
											<div class="row">
												...
												<div class="col-lg-4" title="Property Amount">
													...
													<label class="col-form-label fw-bold fs-6">
														<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $prop_amt = $property_view->pro_amount; echo number_format($prop_amt,2,'.',',');?>
												...
												<div class="col-lg-4" title="Property Total Amount">
													...
													<label class="col-form-label fw-bold fs-6">
														<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $prop_tot_amt = $property_view->total_property_amount; echo number_format($prop_tot_amt,2,'.',',');?>
													 		...
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			...
																			<?php $stamp_paper_charges = $property_view->stamp_paper_charges; echo number_format($stamp_paper_charges,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
													 <div class="col-lg-6">
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
																			<?php $actual_stamp_paper_charges = $property_view->actual_stamp_paper_charges; echo number_format($actual_stamp_paper_charges,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
													 ...
													 <div class="col-lg-6">
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
																			<?php $duty_charges = $property_view->duty_charges; echo number_format($duty_charges,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
													 <div class="col-lg-6">
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
																			<?php $actual_duty_charges = $property_view->actual_duty_charges; echo number_format($actual_duty_charges,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
													 ...
													 <div class="col-lg-6">
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
																			<?php $vendor_charges = $property_view->vendor_charges; echo number_format($vendor_charges,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
													 <div class="col-lg-6">
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
																			<?php $actual_vendor_charges = $property_view->actual_vendor_charges; echo number_format($actual_vendor_charges,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
													 ...
													 <div class="col-lg-6">
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
																			<?php $process_fees = $property_view->process_fees; echo number_format($process_fees,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
													 <div class="col-lg-6">
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
																			<?php $actual_process_fees = $property_view->actual_process_fees; echo number_format($actual_process_fees,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
													 ...
													 <div class="col-lg-6">
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
																			<?php $by_buying_rate = $property_view->by_buying_rate; echo number_format($by_buying_rate,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
													 <div class="col-lg-6">
													 		<div class="row">
													 			...
													 			<div class="col-lg-7">
													 					<label class="col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
																			<?php $actual_buying_rate = $property_view->actual_buying_rate; echo number_format($actual_buying_rate,2,'.',',');?>
																		</label>
													 			</div>
													 		</div>
													 </div>
											...
											<div class="row mt-2">
												<div class="col-lg-6">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															<label class="col-lg-12 col-form-label fw-bold fs-4">Base Document</label>
															<?php	
													 				$files = directory_map('./assets/images/realestate_property/base_document/'.$property_view->document_images.'/', FALSE, TRUE); 
																	 if (is_dir('./assets/images/realestate_property/base_document/'.$property_view->document_images.'/')) {
																			foreach($files as $file){
																		if(is_string($file)){
																			// echo $file;  ?>
															<div class="col-lg-2 mt-4 " >
																<!--begin::Overlay-->
																		<a class="d-block overlay" href="<?php echo base_url(); ?>assets/images/realestate_property/base_document/<?php echo $property_view->document_images; ?>/<?php echo $file ?>" target="_blank" style="width: 50px !important;" download>
																    <!--begin::Image-->
																    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-50px w-50px">
																        <?php  $url = base_url('assets/images/realestate_property/base_document/'.$property_view->document_images.'/'.$file);
												...
												<div class="col-lg-6">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															...
															<?php	
													 $files = directory_map('./assets/images/realestate_property/layout/'.$property_view->document_images.'/', FALSE, TRUE); 
													 if (is_dir('./assets/images/realestate_property/layout/'.$property_view->document_images.'/')) {
														...
														if(is_string($file)){
															...
															<div class="col-lg-2 mt-4">
																<!--begin::Overlay-->
																<a class="d-block overlay" href="<?php echo base_url(); ?>assets/images/realestate_property/layout/<?php echo $property_view->document_images; ?>/<?php echo $file ?>" target="_blank" style="width: 50px !important;" download>
																    <!--begin::Image-->
																    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-50px w-50px">
																        
																        <?php 
																        	$url = base_url('assets/images/realestate_property/layout/'.$property_view->document_images.'/'.$file);
																			    $html = '<iframe src="'.$url.'" style="border:solid black 1px; width: 100%; height: 100%;overflow: hidden; border-radius: 7px;"  scrolling="no"></iframe>';
																			    echo $html;
																         ?>
																    </div>
												...
												<div class="col-lg-6">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															...
															<?php	
													 $files = directory_map('./assets/images/realestate_property/ec/'.$property_view->document_images.'/', FALSE, TRUE); 
													 if (is_dir('./assets/images/realestate_property/ec/'.$property_view->document_images.'/')) {
														...
														if(is_string($file)){
															...
															<div class="col-lg-2 mt-4">
																<!--begin::Overlay-->
																<a class="d-block overlay" href="<?php echo base_url(); ?>assets/images/realestate_property/ec/<?php echo $property_view->document_images; ?>/<?php echo $file ?>" target="_blank" style="width: 50px !important;" download>
																    <!--begin::Image-->
																    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-50px w-50px">
																        
																        <?php 
																        	$url = base_url('assets/images/realestate_property/ec/'.$property_view->document_images.'/'.$file);
																			    $html = '<iframe src="'.$url.'" style="border:solid black 1px; width: 100%; height: 100%;overflow: hidden; border-radius: 7px;"  scrolling="no"></iframe>';
																			    echo $html;
																         ?>
																    </div>
												...
												<div class="col-lg-6">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															...
															<?php	
													 $files = directory_map('./assets/images/realestate_property/property/'.$property_view->document_images.'/', FALSE, TRUE); 
													 if (is_dir('./assets/images/realestate_property/property/'.$property_view->document_images.'/')) {
														...
														if(is_string($file)){
															...
															<div class="col-lg-2 mt-4">
																<!--begin::Overlay-->
																<a class="d-block overlay" href="<?php echo base_url(); ?>assets/images/realestate_property/property/<?php echo $property_view->document_images; ?>/<?php echo $file ?>" target="_blank" style="width: 50px !important;" download>
																    <!--begin::Image-->
																    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-50px w-50px">
																        
																        <?php 
																        	$url = base_url('assets/images/realestate_property/property/'.$property_view->document_images.'/'.$file);
																			    $html = '<iframe src="'.$url.'" style="border:solid black 1px; width: 100%; height: 100%;overflow: hidden; border-radius: 7px;"  scrolling="no"></iframe>';
																			    echo $html;
																         ?>
																    </div>
												...
												<div class="col-lg-6">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															...
															<?php	
													 $files = directory_map('./assets/images/realestate_property/others/'.$property_view->document_images.'/', FALSE, TRUE); 
													 if (is_dir('./assets/images/realestate_property/others/'.$property_view->document_images.'/')) {
														...
														if(is_string($file)){
															...
															<div class="col-lg-2 mt-4">
																<!--begin::Overlay-->
																<a class="d-block overlay" href="<?php echo base_url(); ?>assets/images/realestate_property/others/<?php echo $property_view->document_images; ?>/<?php echo $file ?>" target="_blank" style="width: 50px !important;" download>
																    <!--begin::Image-->
																    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-50px w-50px">
																        
																        <?php 
																        	$url = base_url('assets/images/realestate_property/others/'.$property_view->document_images.'/'.$file);
																			    $html = '<iframe src="'.$url.'" style="border:solid black 1px; width: 100%; height: 100%;overflow: hidden; border-radius: 7px;"  scrolling="no"></iframe>';
																			    echo $html;
																         ?>
																    </div>
											...
											<div class="row mt-2 text-center">
												...
												<?php if(isset($property_view->agent_name1)){ ?>

										    	<label class="col-lg-2 col-form-label fw-bold fs-3 "><?php echo $property_view->agent_name1; ?></label>
										    	<?php } ?>
                                                <label class="col-lg-3 col-form-label fw-semibold fs-6">Agent Amounts</label>

                                                <?php if(isset($property_view->agent_amt1)){ ?>
											    <label class="col-lg-2 col-form-label fw-bold fs-3 " >
											    	<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
											    	<?php $agent_amt1 = $property_view->agent_amt1; echo number_format($agent_amt1,2,'.',',');?>
											    </label>
											    <?php } ?>
										 	</div>		
									    	...
									    	<!-- var_dump(isset($expected_array_got_string['some_key'])); -->
									                    ...
									                    <label class="col-form-label fw-bold fs-2 text-start">Sale Information</label>
															...
															<table id="add_agent_table_view" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
																...
																<tr>
																	...
																	<td>
																		<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
									    								<?php $pro_amount = $sview['pro_amount']; echo number_format($pro_amount,2,'.',',');?>
																	</td>
																	<?php
												...
												<div class="row">
													...
													<label class="col-lg-2 col-form-label fw-bold fs-4"><?php echo $cashpay->amount; ?></label>
												...
												<div class="row">
													...
													<label class="col-lg-2 col-form-label fw-bold fs-4"><?php echo $upipay->amount; ?></label>
												...
												<label class="col-lg-2 col-form-label fw-bold fs-4" id="">
													<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
														<?php $total_property_amount = $property_view->total_property_amount; echo number_format($total_property_amount,2,'.',',');?>
												</label>
												<label class="col-lg-2 col-form-label fw-bold fs-6">Paid Amount</label>
												<label class="col-lg-2 col-form-label fw-bold fs-4" id="">
													<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
														<?php $paid_amount = $property_view->paid_amount; echo number_format($paid_amount,2,'.',',');?></label>
												<label class="col-lg-2 col-form-label fw-bold fs-6">Balance Amount</label>
												<label class="col-lg-2 col-form-label fw-bold fs-4" id="">
													<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;
														<?php $balance_amount = $property_view->balance_amount; echo number_format($balance_amount,2,'.',',');?></label>
												</div>
