								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Realestatepurchase/property_edit_save" enctype="multipart/form-data" onsubmit="return property_validation()">
											<!--begin::Table-->
											<div class="row">
												<div class="col-lg-12">
													<div class="row">
												...
												<div class="col-lg-4">
													...
													<div class="row">
														<div class="col-lg-5">
														 	<div class="row">
																...
																<div class="col-lg-4 fv-row fv-plugins-icon-container">
																		<input type="text" name="prop_ppa_no" id="prop_ppa_no" maxlength="8" class="form-control form-control-lg form-control-solid" placeholder="Plot Area No" value="<?php echo $edit_details->ploat_no; ?>" title="Enter Your Number of Count" onkeyup="pay_to_property_calc()" oninput="this.value = this.value.replace(/[^/0-9.]/g, '').replace(/(\..*)\./g, '$1');">
														...
														<div class="col-lg-5 fv-row fv-plugins-icon-container">
															<input type="text" name="prop_price_ppa" id="prop_price_ppa" class="form-control form-control-lg form-control-solid" placeholder="Price" value="<?php echo $edit_details->price_per_ploat ; ?>" title="Enter Your Per Plot Area Amount"  onkeyup="pay_to_property_calc(0)" oninput="this.value = this.value.replace(/[^/0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="11">
