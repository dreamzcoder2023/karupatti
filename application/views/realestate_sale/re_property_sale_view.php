	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				<?php $this->load->view("sidebar");?>				<!--begin::Wrapper-->
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">View Sale
									<!--begin::Separator-->
									<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<!--end::Separator-->
									<!--begin::Description-->
									<!--end::Description--></h1>
										<?php if (isset($prop_sale_view)) { ?>
										<?php if($prop_sale_view->balance_amount !='0'){ ?>
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="row">
												<div class="col-lg-10">
													<div class="row">
														...
														<div class="col-lg-3 fv-row">
															<div class="row">
																<div class="col-lg-5 fv-row">
																	<label class="col-form-label fw-bold fs-6">Property ID
																	</label>
																</div>
																<div class="col-lg-7 fv-row">
																	<label class="col-form-label fw-bold fs-5" title="Property ID"><?php  echo $prop_sale_view->property_id;?></label>
															     </div>
															</div>
														</div>
														<div class="col-lg-4 fv-row">
															<div class="row">
																<div class="col-lg-5 fv-row">
																	<label class="col-form-label fw-bold fs-6">Sale ID
																	</label>
																</div>
																<div class="col-lg-7 fv-row">
																	<label class="col-form-label fw-bold fs-5" title="Sale ID"><?php  echo $prop_sale_view->sale_id;?></label>
																</div>
															</div>
														</div>
														<div class="row">
															...
															<div class="col-lg-6" title="Party Address">
																<div class="row">
																	...
																	<div class="col-lg-11 fv-row mt-1">
																		<label class="col-form-label fw-bold fs-6"><?php if(isset($party_details->ADDRESS1)){
													...
													<div class="row">
														<div class="col-lg-3">
															...
															<label class="col-form-label fw-bold fs-6" title="Property Type"><?php echo $prop_sale_view->property_type; ?></label>
														</div>
														<div class="col-lg-3">
															<i class="fas fa-search-location fs-3" title="Reference Name"></i>
															<!-- <i class="fas fa-file-invoice fs-6" title="Reference Name"></i> -->
															<label class="col-form-label fw-bold fs-6 ms-5" title="Reference Name"><?php echo $prop_sale_view->ref_name; ?></label>
														</div>
														...
														<!-- <label class="col-lg-2 col-form-label fs-6 fw-semibold">Plot Area</label> -->
															...
															<label class="col-form-label fs-6 fw-bold" title="Number of Plot Area"><?php echo $prop_sale_view->ploat_no; ?></label>&nbsp;
															<i 	class="fas fa-layer-group fs-6" title="Type of Plot Area"></i>&nbsp;
															<label class="col-form-label fw-bold fs-6" title="Type of Plot Area"><?php echo $prop_sale_view->ploat_type; ?></label>&nbsp;
															<i class="fas fa-money-bill-wave fs-6" title="Per Price of Plot Area"></i>&nbsp;
															<label class="col-form-label fw-bold fs-6" title="Per Price of Plot Area"><?php echo $prop_sale_view->price_per_ploat; ?></label>
														</div>
													</div>
											     </div>
												<div class="col-lg-2">
												...
												<div class="col-lg-10">
													<div class="row">
														<div class="col-lg-3" title="Latitude Longitude">
															<i class="bi bi-geo-alt-fill fs-4"></i>
															<label class="col-form-label fw-bold fs-6"><?php echo $prop_sale_view->lattitude; ?></label>&nbsp;- 
															<label class="col-form-label fw-bold fs-6"><?php echo $prop_sale_view->longtitude; ?></label>
														</div>
															...
															<div class="row">
																<div class="col-lg-2">
																	<label class="col-form-label fw-semibold fs-6">
																		<svg width="22px" height="22px" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" xml:space="preserve"><title>Amenitites</title><style type="text/css">.st0{color:#3A3A5D;fill:none;stroke:#3A3A5D;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}</style><polyline class="st0" points="11,31 11,10 21,10 21,31 "/><polyline class="st0" points="21,31 21,16 30,16 30,31 "/><polyline class="st0" points="2,31 2,21 11,21 11,31 "/><rect x="12" y="7" class="st0" width="8" height="3"/><rect x="14" y="4" class="st0" width="4" height="3"/><line class="st0" x1="16" y1="1" x2="16" y2="4"/><line class="st0" x1="14" y1="14" x2="18" y2="14"/><line class="st0" x1="3" y1="25" x2="7" y2="25"/><line class="st0" x1="3" y1="29" x2="7" y2="29"/><line class="st0" x1="14" y1="18" x2="18" y2="18"/><line class="st0" x1="14" y1="22" x2="18" y2="22"/><line class="st0" x1="14" y1="26" x2="18" y2="26"/><line class="st0" x1="14" y1="30" x2="18" y2="30"/><line class="st0" x1="24" y1="20" x2="24" y2="21"/><line class="st0" x1="27" y1="20" x2="27" y2="21"/><line class="st0" x1="24" y1="24" x2="24" y2="25"/><line class="st0" x1="27" y1="24" x2="27" y2="25"/><line class="st0" x1="24" y1="28" x2="24" y2="29"/><line class="st0" x1="27" y1="28" x2="27" y2="29"/></svg>&emsp;
																	</label>
																</div>
																...
																<div class="col-lg-10">
															 		<label class="col-form-label fw-bold fs-6">
															 			...
															 			<?php if(isset($prop_sale_view->amenities)){ 
															 				if($prop_sale_view->amenities!=['']){ 
															 					$values= json_decode($prop_sale_view->amenities);													 					
														...
														<div class="col-lg-6 col-form-label" title="Address">
															<div class="row">
																<div class="col-lg-1">
																	<span class="fs-4">
																		<svg width="28px" height="28px" class="fw-bold" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
																...
																<div class="col-lg-10">
																	<label class="fw-bold fs-6"><?php echo $prop_sale_view->street; ?>,</label>
																	<label class="fw-bold fs-6">&nbsp;<?php echo $prop_sale_view->area;   ?>,</label>
																	<label class="fw-bold fs-6">&nbsp;<?php echo $prop_sale_view->city;   ?>,</label>
																	<label class="fw-bold fs-6">&nbsp;<?php echo $prop_sale_view->pincode;   ?>,</label>
																	<label class="fw-bold fs-6">&nbsp;<?php echo $prop_sale_view->state; ?>.</label>
																</div>
															</div>
														</div>
											...
											<div class="row">
												...
												<div class="col-lg-10">
													<div class="row">
														<div class="col-lg-3 fv-row" title="Sale Amount">
															<div class="row">
																<div class="col-lg-2" >
																<label>
																	<i class="fas fa-money-bill-alt fs-2 mt-4"></i>
																</label>
																</div>
																<div class="col-lg-10" >
																	<label class="col-form-label fw-bold fs-6">
																		<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $prop_amt = $prop_sale_view->pro_amount; echo number_format($prop_amt,2,'.',',');?> </label>
																</div>
															</div>
														</div>

														<div class="col-lg-3 fv-row" title="Total sale Amount">
															<div class="row">
																<div class="col-lg-2" >
																<label>
																	<i class="fas fa-money-bill-alt fs-2 mt-4"></i>
																...
																<div class="col-lg-10" >
																	<label class="col-form-label fw-bold fs-6">
																		<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $tot_prop_amt = $prop_sale_view->total_property_amount; echo number_format($tot_prop_amt,2,'.',',');?>		
																	</label>
																</div>
															</div>
														</div>
														<div class="col-lg-3 fv-row" title="Actual Buying Rate">
															<div class="row">
																<div class="col-lg-6" >
																	<label class="mt-4">
																		<b>Act.Buy Rate</b>
																...
																<div class="col-lg-6" >
																	<label class="col-form-label fw-bold fs-6">
																		<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $act_tot_prop_amt = $prop_sale_view->actual_buying_rate; echo number_format($act_tot_prop_amt,2,'.',',');?>
																	</label>
																</div>
															</div>
														</div>
														<div class="col-lg-3 fv-row" title="By Buying Rate">
															<div class="row">
																<div class="col-lg-6" >
																<label class="mt-4">
																	<b>By.Buy Rate</b>
																...
																<div class="col-lg-6" >
																	<label class="col-form-label fw-bold fs-6">
																		<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $by_amt = $prop_sale_view->by_buying_rate; echo number_format($by_amt,2,'.',',');?>
																	</label>
																</div>
															</div>
														</div>
												...
												<div class="col-lg-8">
													<div class="row">
														...
														<div class="col-lg-12">
															...
															<label class="col-form-label fw-bold fs-6 ms-3" title="Description"><?php echo $prop_sale_view->description; ?></label>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="row mt-4">
												<div class="col-lg-6">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															<label class="col-lg-12 col-form-label fw-bold fs-4">KYC</label>
															<?php 
															   $files = directory_map('./assets/images/realestate_sale/kyc/'.$prop_sale_view->document_images.'/', FALSE, TRUE); 
													 			if (is_dir('./assets/images/realestate_sale/kyc/'.$prop_sale_view->document_images.'/')) {
																	foreach($files as $file){
																if(is_string($file)){ ?>
															<div class="col-lg-2 mt-4" >
																<!--begin::Overlay-->
																<a class="d-block overlay" href="<?php echo base_url(); ?>assets/images/realestate_sale/kyc/<?php echo $prop_sale_view->document_images; ?>/<?php echo $file ?>" target="_blank" style="width: 50px !important;border:1px solid #a1a5b7;  border-radius: 10px;">
																    <!--begin::Image-->
																    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-50px w-48px">
																        <?php $url = base_url('assets/images/realestate_sale/kyc/'.$prop_sale_view->document_images.'/'.$file);
												...
												<div class="col-lg-6">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															<label class="col-lg-12 col-form-label fw-bold fs-4">Registeration Document</label>
															<?php	
													 $files = directory_map('./assets/images/realestate_sale/registration_document/'.$prop_sale_view->document_images.'/', FALSE, TRUE); 
													 if (is_dir('./assets/images/realestate_sale/registration_document/'.$prop_sale_view->document_images.'/')) {
														...
														if(is_string($file)){
															...
															<div class="col-lg-2 mt-4">
																<!--begin::Overlay-->
																<a class="d-block overlay"  href="<?php echo base_url(); ?>assets/images/realestate_sale/registration_document/<?php echo $prop_sale_view->document_images; ?>/<?php echo $file ?>" target="_blank" style="width: 50px !important;border:1px solid #a1a5b7; border-radius: 10px;" >
																    <!--begin::Image-->
																    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-50px w-48px">
																       
																        <?php 
																        	$url = base_url('assets/images/realestate_sale/others/'.$prop_sale_view->document_images.'/'.$file);
																			    $html = '<iframe src="'.$url.'" style="border:solid black 1px; width: 100%; height: 100%;overflow: hidden; border-radius: 7px;"  scrolling="no"></iframe>';
																			    echo $html;
																         ?>
																    </div>
												...
												<div class="col-lg-6">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															...
															<?php	
													 $files = directory_map('./assets/images/realestate_sale/others/'.$prop_sale_view->document_images.'/', FALSE, TRUE); 
													 if (is_dir('./assets/images/realestate_sale/others/'.$prop_sale_view->document_images.'/')) {
														...
														if(is_string($file)){
															...
															<div class="col-lg-2 mt-4">
																<!--begin::Overlay-->
																<a class="d-block overlay" href="<?php echo base_url(); ?>assets/images/realestate_sale/others/<?php echo $prop_sale_view->document_images; ?>/<?php echo $file ?>" target="_blank" style="width: 50px !important; border:1px solid #a1a5b7;border-radius: 10px;">
																    <!--begin::Image-->
																    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-50px w-48px">
											...
											<div class="row mt-2 text-center">
													...
													<span class="text-end">
													    	...
													    	<label class="col-lg-2 col-form-label fw-bold fs-3 "><?php echo count($Agent_view); ?></label>
													    	
	                              <label class="col-lg-3 col-form-label fw-semibold fs-6">Agent Amounts</label>

	                              <?php if(isset($prop_sale_view->agent_amt1)){ ?>
														    <label class="col-lg-2 col-form-label fw-bold fs-3 " >
														    	<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $agent_cash = $prop_sale_view->agent_amt1; echo number_format($agent_cash,2,'.',',');?>
														    </label>
														    <?php } ?>
											 </div>	
                                 	  ...
                                 	  <?php foreach($sales_payment_view as $i=> $slist){ 
											...
											<div class="row">
												...
												<label class="col-lg-2 col-form-label fw-bold fs-4" id="">
													<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $tot_amt = $prop_sale_view->total_property_amount; echo number_format($tot_amt,2,'.',',');?>											
												</label>
												<label class="col-lg-2 col-form-label fw-bold fs-6">Paid Amount</label>
												<label class="col-lg-2 col-form-label fw-bold fs-4" id="">
													<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $tot_amt_paid = $prop_sale_view->paid_amount; echo number_format($tot_amt_paid,2,'.',',');?></label>
												<label class="col-lg-2 col-form-label fw-bold fs-6">Balance Amount</label>
												<label class="col-lg-2 col-form-label fw-bold fs-4" id="">
													<i class="fa-solid fa-indian-rupee-sign fs-6 text-dark"></i>&nbsp;<?php $tot_amt_bal = $prop_sale_view->balance_amount; echo number_format($tot_amt_bal,2,'.',',');?>
												</label>
