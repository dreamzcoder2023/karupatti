...
<style>
  ...
  .dataTables_scroll thead{
   ...
   background-color: #ec9629;
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Realestate Sale Receipt List
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
													...
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
															<div class="px-7 py-5" data-kt-user-table-filter="form">
																<form action="<?php echo base_url(); ?>Realestatesalereceipt" method="POST" id="fill_form">
														...
														<a href="<?php echo base_url(); ?>Realestatesalereceipt/new_re_prop_sale_receipt" target="_blank">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<table id="realestate_sale_receipts_table" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
												<thead>
												...
												<?php $i=1; foreach($re_sale_receipt_list as $slist){ 
												 ...
												 <tr>
												 	...
												 	<td>
												 		<i class="fa fa-copy fs-4" title="Copy Bill No" style="cursor: pointer;" onclick="copiedclipboardagno('<?php echo $slist['recepit_id'];?>', '<?php echo $i; ?>');"></i>													

															<?php echo $slist['recepit_id'];?>
															
															<span style="display: none;" class="ms-2 tooltipcopie" id="tooltipcopie<?php echo $i;?>"></span>
												 		</td>
												 	<td>
												 		<i class="fa fa-copy fs-4" title="Copy Bill No" style="cursor: pointer;" onclick="copiedclipboardagno('<?php echo $slist['property_id'];?>', '<?php echo $i; ?>');"></i>													

															<?php echo $slist['property_id'];?>
															
															<span style="display: none;" class="ms-2 tooltipcopie" id="tooltipcopie<?php echo $i;?>"></span>

												 		</td>
												 	<td>
											 			<span><i class="fa-solid fa-indian-rupee-sign fs-7 text-dark"></i>&nbsp;<?php $net_amt = $slist['net_amount']; echo number_format($net_amt,2,'.',',');?>
														</span>
												   </td>
												 	<td>
												 			<span><i class="fa-solid fa-indian-rupee-sign fs-7 text-dark"></i>&nbsp;<?php $paid_amt = $slist['cr_paid_amount']; echo number_format($paid_amt,2,'.',',');?>
															</span>
									 		 		</td>
												 	<td>
												 			<span><i class="fa-solid fa-indian-rupee-sign fs-7 text-dark"></i>&nbsp;<?php $bal_amt = $slist['cr_balance_amount']; echo number_format($bal_amt,2,'.',',');?>
															</span>
												 	...
												 	<!--begin::Action=-->
														...
														<span class="text-end">
															 <?php if(isset($_SESSION['Sale ReceiptView'])){ if($_SESSION['Sale ReceiptView']==1){?>
															<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_sale_receipt_view" title="View Payment History"  onclick="view_sale_receipts('<?php echo $slist['id'];?>')">
																<i class="bi bi-eye-fill eyc"></i>
															</a>
														<?php }} ?>
														</span>
														<!-- <span class="text-end">
															<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"  title="Print Invoice">
	...
	<div class="modal fade" id="kt_modal_sale_receipt_view" tabindex="-1" aria-hidden="true">
		<!--begin::Modal dialog-->
					...
					<div class="row">
					    <div class="col-lg-12">
						     <div class="row">
							  ...
							  <label class="text-center col-lg-3 col-form-label fw-semibold fs-6">Property Sale Id</label>
								<div class="text-center col-lg-2 fv-row fv-plugins-icon-container">
									<label class=" col-form-label fw-bold fs-5"><sapn id="sale_pro_recp_id"></sapn></label>
								</div>
							...
							<div class="row mt-4">
			   				...
			   				<div class="row">
			   					<div class="col-lg-4 text-start">
										...
										<label class="col-form-label fw-bold fs-4" id="net_amount"></label>
									</div>
	...
	<!--begin::Modal - New 	purchase-->
		...
		<script type="text/javascript">
			...
			function export_list() {
			    ...
			    var value = <?php echo $exportresalereceipt; ?>;
			    var values = [];
			    // console.log(value[0]);
			    value.map((data, i) => {	
			    ...
			    var filename = 'RESaleReceiptList.xlsx';
		...
		<script>
	      $("#realestate_sale_receipts_table").kendoTooltip({
	        filter: "td",
	        show: function(e){
		...
		<script>
			$("#realestate_sale_receipts_table").DataTable({
			    "sorting":false,
			    // "info":true,
			    "responsive": true,
		...
		<script>
			...
			$(document).ready(function() {
			    ...
			    $(".move_to").on("click", function () {
			        value=$(this).val();
			        // alert(value);
			        $('#filter_form').attr('action', "<?php echo base_url(); ?>Realestatesalereceipt?page="+value);
			        $("#filter_form").submit();
			        e.preventDefault();
			    });
			});
		...
		<script>
			function view_sale_receipts(val)
			{
				var baseurl= $("#baseurl").val();
				$.ajax({
				type: "GET",
				url: baseurl+'Realestatesalereceipt/realestate_sale_receipt_view',
				async: false,
				type: "GET",
				data: "id="+val,
				dataType: "json",
				success: function(response)
				{
					...
					$('#sale_pro_recp_id').html(response.property_id);
				...
				$.ajax({
				type: "POST",
				url: baseurl+'Realestatesalereceipt/payment_details',
				async: false,
				data: "id="+val,
				dataType: "html",
				success: function(response)
		...
		<!-- Sales  recipts list day fillter start -->
		<script>
		...
		<!-- Sales recipts list day fillter end -->
	</body>
	<!--end::Body-->
</html>