						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Realestate Purchase Receipt Entry
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<div class="row">
												<div class="col-lg-9">
													<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Realestatepurchasereceipt/purchase_receipt_save" enctype="multipart/form-data" onsubmit="return purchase_recipt_validation();">
												 <!-- <form method="POST" action="<?php echo base_url(); ?>Realestatepurchasereceipt/purchase_receipt_save" > -->
													<div class="row">
														...
														<label class="col-lg-2 col-form-label required fw-semibold fs-6">Purchase ID <i class="fa-solid fa-circle-info fs-7 ms-2"  title="AutoComplete Select Purchase ID"></i></label>
														<div class="col-lg-5 fv-row fv-plugins-icon-container">
															<input type="text" name="pur_id_rec" id="pur_id_rec" class="form-control form-control-lg form-control-solid" placeholder="Select Purchase ID" >
															<div class="fv-plugins-message-container invalid-feedback" id="pur_id_rec_err"></div>
															<div class="fv-plugins-message-container invalid-feedback" id="vpur_id_rec_err"></div>
														</div>
												...
												<div class="row">
														...
														<div class="col-lg-4" title="Plot Area">
															...
															<!-- <label class="col-lg-2 col-form-label fs-6 fw-semibold">Plot Area</label> -->
																...
																<i 	class="fas fa-layer-group fs-3" title="Type of Plot Area"></i>&nbsp;
																<label class="col-form-label fw-bold fs-6" title="Type of Plot Area" id="ploat_type_lab">-</label>&nbsp;
																<i class="fas fa-money-bill-wave fs-3" title="Per Price of Plot Area"></i>&nbsp;
														...
														<div class="row">
															...
															<div class="col-lg-8 col-form-label fs-3" title="Address">
																...
																<label class="fw-bold fs-6" id="address_lab">-----</label>
															</div>
											...
											<div class="d-flex justify-content-center mt-6">
												...
												<input type="hidden" name="net_payable_amount_lab_hidden" id="net_payable_amount_lab_hidden">
											</div>
											<div class="row">
...
<script>
	...
	$("#pur_id_rec").autocomplete({ 
		// alert(1);
		                valueKey:'title',
		                source:[{
		                url:baseurl+'Realestatepurchasereceipt/idList?query=%QUERY%',
		                type:'remote',
		                ajax:{
		                dataType : 'json',
		                }
...
<script>
	function purchase_recipt_validation(){

		var err = 0;
				var dateval       = $('#kt_daterangepicker_pur_rec_entry_add_date').val();
				var pur_id         = $('#pur_id_rec').val();
			    ...
			    if(pur_id.trim()=='')
			    {
			        $('#pur_id_rec_err').html('Enter Purchase ID !');
			        err++;
			    }
			    else
			    {
			    ...
			    {
			        $('#vpur_id_rec_err').html('Enter Valid Purchase ID !');
			        err++;
			    }
			    else
			    {
			       
					$('#vpur_id_rec_err').html('');
