			...
			<?php $this->load->view("sidebar");?>
				...
				<!--begin::Toolbar-->
					...
					<?php
  					...
  					if($receipts[0]['REVISED_AMOUNT'] > $receipts[0]['PAID_TOTAL'])
					{

						$lablestatus ='<span style="background-color:#5aad52;border-radius: 8px;padding: 5px 15px 5px 15px;">Active</span>';
					}
					else
					{
						$lablestatus ='<span style="background-color:red;border-radius: 8px;padding: 5px 15px 5px 15px;">Close</span>';
												...
												<div class="col-lg-4">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 1px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															...
															<label class="col-lg-9 col-form-label fw-bold fs-5"><?php 
																//print_r($receipts[0]);exit;
															echo $receipts[0]['REVISED_AMOUNT']; ?></label>
												...
												<div class="col-lg-4">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 23px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															...
															<label class="col-lg-9 col-form-label fw-bold fs-5"><?php echo $receipts[0]['VERIFIED_USER']; ?></label>
														</div>
													</div>
												</div>
												<div class="col-lg-4">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 23px;box-shadow: 0 5px 10px #00002947;">
														...
														<div class="row mt-12">
															<div class="col-lg-10 d-flex justify-content-center align-items-center">
																...
																<label class="col-form-label fw-bold fs-2"><?php echo $receipts[0]['TOTAL']; ?></label>
															</div>
														</div>
													</div>
												</div>
