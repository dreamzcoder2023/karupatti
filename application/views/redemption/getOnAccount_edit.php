...
<div class="modal-dialog modal-lg">
			...
			<div class="modal-content rounded">
				...
				<div class="modal-header justify-content-end border-0 pb-0">
					<!--begin::Close-->
					<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal" onclick="closeOnAccountModal_edit('<?php echo $val; ?>');">
				...
				<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
					...
					<div style="padding:10px 10px 10px 10px !important;box-shadow: 0 3px 6px #00002947; border-radius: 5px; background-color: #f5f5f1 !important;">
						<table class="table table-striped table-hover table-row-bordered fs-7 gy-1 gs-2" id="kt_datatable_dom_positioning_view_loan_particular_party">
						    ...
						    <tr>
						    	...
						    	<?php if($ledger_dr_total < $ledger_cr_total){ 
						    		$val1=number_format(($ledger_cr_total-$ledger_dr_total),2);
						    		$val=$val1."  Cr."; ?>
						    	<td>Balance...Cr.</td>
						    	<td></td>
						    	<td><?php echo number_format(($ledger_cr_total-$ledger_dr_total),2);?></td>
						    	<?php }else{
						    		$val1=number_format(($ledger_dr_total-$ledger_cr_total),2);
						    		$val=$val1."  Dr.";
						    		?>
						    	<td>Balance...Dr.</td>
						...
						<div class="card-footer d-flex justify-content-end py-6 px-9">
							<button class="btn btn-secondary" id="btn_cancel" name="btn_cancel" tabindex="0" data-bs-dismiss="modal" onclick="closeOnAccountModal_edit('<?php echo $val; ?>');">Cancel</button>
						</div>
					</div>
				</div>
			</div>
