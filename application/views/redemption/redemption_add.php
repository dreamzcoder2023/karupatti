											...
											<div class="card-body py-4">
														...
														<!-- <div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;"> -->
															<div class="row">
																...
																<div class="col-lg-2 fv-row fv-plugins-icon-container">
																	<input type="text" name="redemp_bill_no" id="redemp_bill_no" class="form-control form-control-lg1 form-control-solid" placeholder="Enter Loan No" oninput="this.value = this.value.replace(/[^A-Za-z0-9/-]/g, '').replace(/(\..*)\./g, '$1');" tabindex="1">
																...
																<div class="col-lg-2 fv-row">
																	<div class="d-flex align-items-center">
																		...
																		<input class="form-control form-control-solid ps-12" name="r_date" id="r_date" placeholder="Date" id="kt_datepicker_new_loan_date" value="<?php echo date("d-m-Y"); ?>" oninput="this.value = this.value.replace(/[^0-9-/]/g, '').replace(/(\..*)\./g, '$1');" tabindex="2" />
																	</div>
																</div>
																<div class="col-lg-1">
																...
																<div class="col-lg-2 fv-row fv-plugins-icon-container">
																	<select class="form-select form-select-solid" name="r_company_select" id="r_company_select" data-control="select2" data-hide-search="true" tabindex="3">	
																	...
																	<div class="row">
																		<label class="col-lg-12 col-form-label fw-bold fs-6" id="r_no_card" name="r_no_card" style="display: none"><i class="fa fa-address-card fs-6" aria-hidden="true" title="Card No"></i>&emsp;<a href="<?php echo base_url();?>/membershipcard" target="_blank"><span style="color: red" >Click Here for<br> <b>New Membership Card</b></span></a>
																				...
																				<div class="col-lg-4" id="r_lbl_mem_verify">
																					<p class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_verify_membership_card" id="btn_verify_popup" name="btn_verify_popup" tabindex="4">Verify</p>
																				</div>
																...
																<div class="col-lg-6">
																	<div class="row">
																		<label class="col-lg-12 col-form-label fw-bold fs-6" >
																			<i class="fa fa-user fs-6" aria-hidden="true" title="Last Name"></i>&emsp;<span name="r_firstname" id="r_firstname">-</span></label>
																			<input type="hidden" name="r_pid" id="r_pid">
																		<label class="col-lg-12 col-form-label fw-bold fs-6">
																			<i class="fa-solid fa-location-dot fs-6" aria-hidden="true" title="Address"></i>
																		&emsp;<span  name="r_address" id="r_address"></span></label>
																		<label class="col-lg-12 col-form-label fw-bold fs-6">
																				<i class="fas fa-mobile-android-alt fs-6" aria-hidden="true" title="Mobile"></i>
																			&emsp;<span  name="r_phone_no" id="r_phone_no">-</span>
																			<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#kt_modal_verify_mobile_no" title="Verify Mobile No" tabindex="5"><!-- <i class="fas fa-square-check" data-bs-toggle="modal" data-bs-target="#kt_modal_verify_mobile_no" ></i> --><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 505 505" xml:space="preserve" height="35" width="35">
																		...
																		<div class="col-lg-12">
																			...
																			<label class="col-form-label fw-bold fs-2" style="color: #1a21e3 !important;font-weight: 600 !important;" id="lbl_hl_bal_rem">-</label>
																		</div>
																	</div>
																</div>
															</div>
													...
													<div class="col-lg-6">
														<div class="px-4" style="border-radius: 10px;padding-bottom: 20px;box-shadow: 0 5px 10px #00002947;">
															<div class="row">
																...
																<label class="col-lg-5 col-form-label text-center fw-semibold fs-6" id="r_loan_status" name="r_loan_status"><span style="background-color:#5aad52;border-radius: 8px;padding: 5px 15px 5px 15px;">-</span>
																</label>
															</div>
															<div class="row">
																<label class="col-lg-2 col-form-label fw-semibold fs-6">Company</label>
																<label class="col-lg-10 col-form-label fw-bold fs-6" id="r_company_name" name="r_company_name">-</label>
																<label class="col-lg-2 col-form-label fw-semibold fs-6">Int Type</label>
																<label class="col-lg-4 col-form-label fw-bold fs-6" id="r_interest_type" name="r_interest_type">-</label>
																<div class="col-lg-2" id="r_due_status">
																	<label class="col-form-label fw-bold fs-5 bg-success" style="border-radius: 8px;padding: 5px 10px 5px 10px;" ><?php echo isset($due_status) ? $due_status : "-"; ?></label>
																</div>
																<div class="col-lg-4">
																	<label class="col-form-label fw-bold fs-6" id="r_period">-</label>
																</div>
																...
																<div class="col-lg-6" title="Principal Amount">
																	...
																	<label class="col-form-label fw-bold fs-2" id="r_loan_amount">0</label>
																</div>
																<div class="col-lg-2" title="Pledge Items Count">
																	<a href="javascript:;" tabindex="6"><i class="fas fa-list-ol fa-spin fs-4" title="Pledge Items Count" data-bs-toggle="modal" data-bs-target="#kt_modal_pledge_items"></i></a>
																	
																	<label class="col-form-label fw-bold fs-4" id="r_pledge_count">0</label>
																</div>
																<div class="col-lg-4" title="Weight">
																	<label class="col-form-label"><span><i class="fas fa-balance-scale fs-4"></i></span>&emsp;</label>
																	<label class="col-form-label fw-bold fs-4" id="r_net_weight">0.00</label>
																</div>
																...
																<div class="col-lg-8">
																	...
																	<div class="row">
																		...
																		<label class="col-lg-2 col-form-label fw-bold fs-6" id="r_receipt_count">0</label>
																		<label class="col-lg-4 col-form-label fw-bold fs-6" id="r_receipt_date">-</label>
																	</div>
																	<div class="row">
																		<table>
																			<thead class="fw-bold fs-6 text-center">
																				...
																				<td class="col-lg-4">Paid
																					<a href="javascript:;" tabindex="7"><i class="fas fa-receipt fa-spin fs-4" title="Payment History" data-bs-toggle="modal" data-bs-target="#kt_modal_receipt_amount_history"></i></a></td>
																			...
																			<tbody class="fw-semibold fs-6 text-center">
																				<tr>
																					<td class="col-lg-4">
																						<span>Pri : </span>
																						<span id="r_loan_principal">0.00</span>
																						<input type="hidden" name="txt_hidden_loan_principal" id="txt_hidden_loan_principal" value="0">
																					</td>
																					<td class="col-lg-4" id="r_paid_principal">0.00</td><input type="hidden" name="txt_hidden_paid_principal" id="txt_hidden_paid_principal" value="0">

																					<td class="col-lg-4" id="r_bal_principal">0.00</td>
																					<input type="hidden" name="txt_hidden_bal_principal" id="txt_hidden_bal_principal" value="0">
																				</tr>
																				<tr>
																					<td class="col-lg-4">
																						<span>Int : </span>
																						<span id="r_loan_interest">0.00</span>
																					...
																					<td class="col-lg-4" id="r_bal_interest">0.00</td>
																					<input type="hidden" name="txt_hidden_bal_interest" id="txt_hidden_bal_interest" value="0">
																				</tr>
																				<tr>
																					<td class="col-lg-4 fw-bold fs-5">
																						<span>Tot : </span>
																						<span id="r_actual_total">0.00</span>
																						<input type="hidden" name="txt_hidden_actual_total" id="txt_hidden_actual_total" value="0">
																					</td>
																					<td class="col-lg-4 fw-bold fs-5" id="r_paid_total">0.00</td><input type="hidden" name="txt_hidden_paid_total" id="txt_hidden_paid_total" value="0">
																					<td class="col-lg-4 fw-bold fs-5" id="r_bal_total">0.00</td><input type="hidden" name="txt_hidden_bal_total" id="txt_hidden_bal_total" value="0">
																				</tr>
																			</tbody>
																		</table>
																	</div>
												...
												<div class="row mt-4">
												    ...
												    <div class="accordion-item">
												        <h2 class="accordion-header" id="kt_accordion_item_receipt_pending_list_header_1">
												            ...
												            Pending Payment Details &emsp; - &emsp; Total Amount &emsp; <span id="span_acc_total_amount">0.00</span> &emsp;
												            </button>
												        </h2>
													...
													<div class="row mt-4">
														<div class="col-lg-2">
															<div class="d-flex align-items-center mt-1">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class=" form-check-input" name="redemp_radio" type="radio" value="redp_cus_c_radio_val" id="redp_cus_c_radio_val" tabindex="8">
																</label>
														...
														<div class="col-lg-3">
															<div class="d-flex align-items-center mt-1 ms-6">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class=" form-check-input" name="redemp_radio" type="radio" value="redp_cus_t_radio_val" id="redp_cus_t_radio_val" tabindex="9">
																</label>
														...
														<div class="col-lg-2">
															<div class="d-flex align-items-center mt-1">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class=" form-check-input" name="redemp_radio" type="radio" value="redp_cmy_c_radio_val" id="redp_cmy_c_radio_val" tabindex="10">
																</label>
														...
														<div class="col-lg-3">
															<div class="d-flex align-items-center mt-1 ms-6">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class=" form-check-input" name="redemp_radio" type="radio" value="redp_cmy_sl_radio_val" id="redp_cmy_sl_radio_val" tabindex="11">
																</label>
														...
														<div class="col-lg-2">
															<div class="d-flex align-items-center mt-1">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class=" form-check-input" name="redemp_radio" type="radio" value="redp_mul_jl_radio_val" id="redp_mul_jl_radio_val" tabindex="12">
																</label>
												...
												<div class="px-4" id="cus_close_tbox" style="display: none;">
													<div class="row mt-4">
														...
														<div class="col-lg-10">
															...
															<label class="col-form-label fw-bold fs-3"><span id="cust_cls_total_amount">0.00</span></label>
															<span class="fw-bold fs-3">&emsp;(&nbsp;</span>
															<label class="col-form-label fw-bold fs-3" >Principal &emsp;</label>
															<label class="col-form-label fw-bold fs-3"><span id="cust_cls_total_principal">0.00</span></label>&emsp;
															<label class="col-form-label fw-bold fs-3">Interest &emsp;</label>
															<label class="col-form-label fw-bold fs-3"><span id="cust_cls_total_interest"> 0.00</span></label>
														...
														<div class="col-lg-4">
															<div class="row">
																...
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_cls_pap_act_chg" id="cust_cls_pap_act_chg" onkeyup="cust_close_calc();"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="13">
																...
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_cls_not_chg" id="cust_cls_not_chg" onkeyup="cust_close_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="14">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<div class="col-lg-6">
																	<div class="d-flex align-items-center">
																		<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																			<input class="form-check-input" name="cus_cl_form_missing" type="checkbox" value="1" id="cus_cl_form_missing" onclick="cus_cl_frm_missing()" tabindex="15">
																		</label>
																...
																<div class="col-lg-6" id="cus_cl_form_miss_print_but" style="display: none;">
																	...
																	<a class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-1" id="cust_cls_btn_print1" target="_blank" tabindex="16">Print 1</a>
																	<a class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-1" id="cust_cls_btn_print2" target="_blank" tabindex="17">Print 2</a>
																	<a  id="cust_cls_btn_print3" target="_blank" tabindex="18"><i class="fa fa-print" title ="Legal Print" aria-hidden="true" ></i></a>
																</div>
														...
														<div class="col-lg-4">
															<div class="row">
																...
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" style="background-color: #ff5b5b; color: white" name="cust_cls_on_acc_chg" id="cust_cls_on_acc_chg" onkeyup="cust_close_calc();"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="19"> 
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Discount</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_cls_disc_chg" id="cust_cls_disc_chg" onkeyup="cust_close_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="20">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<div class="col-lg-2" id="cus_cl_upload_doc" style="display: block;">
																	<div class="image-input image-input-outline " data-kt-image-input="true" style="background-image: url(assets/images/Document.jpg)">
																		...
																		<label class="btn btn-icon btn-circle btn-active-color-primary w-20px h-20px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-kt-initialized="1">
																			<i class="bi bi-pencil-fill fs-8" tabindex="18"></i>
																			<input type="file" name="cust_cls_form_miss_doc" accept=".png, .jpg, .jpeg">
																			<input type="hidden" name="cust_cls_form_miss_doc_remove">
																		</label>
														...
														<div class="col-lg-4">
															<div class="row">
																...
																<div class="col-lg-6 fv-row fv-plugins-icon-container">
																	<select class="form-select form-select-solid" name="cus_close_closed_by" id="cus_close_closed_by" data-control="select2" data-hide-search="true" onchange="cus_cl_cls_by();" tabindex="21">	
																		<!-- <option value="">Select</option> -->
																...
																<div class="col-lg-6" id="cus_cl_closed_by_name_tbox" style="display:none;">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="" name="cust_cls_by_others" id="cust_cls_by_others" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="22">
													...
													<div class="row">
														<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
															<div class="d-flex align-items-center mt-1">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class="form-check-input" name="cash_cus_close_paid_from_party_add_radio" type="checkbox" value="1" id="cash_cus_close_paid_from_party_add_radio" onclick="cash_cus_cl_pdfrm_party_add_radio()"  tabindex="23" >
																</label>
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
															<div class="d-flex align-items-center mt-1">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class="form-check-input" name="cheque_cus_close_paid_from_party_add_radio" type="checkbox" value="1" id="cheque_cus_close_paid_from_party_add_radio" onclick="cheque_cus_cl_pdfrm_party_add_radio()" tabindex="24">
																</label>
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
															<div class="d-flex align-items-center mt-1">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class="form-check-input" name="rtgs_cus_close_paid_from_party_add_radio" type="checkbox" value="1" id="rtgs_cus_close_paid_from_party_add_radio" onclick="rtgs_cus_cl_pdfrm_party_add_radio()" tabindex="25">
																</label>
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
															<div class="d-flex align-items-center mt-1">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class="form-check-input" name="upi_cus_close_paid_from_party_add_radio" type="checkbox" value="1" id="upi_cus_close_paid_from_party_add_radio" onclick="upi_cus_cl_pdfrm_party_add_radio()" tabindex="26">
																</label>
																<label class="col-form-label fw-semibold fs-6">UPI</label>
															</div>
														</div>
														<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid" id="membership_card_chk_div">
															<div class="d-flex align-items-center mt-1">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class="form-check-input" name="mcard_cus_close_paid_from_party_add_radio" type="checkbox" value="1" id="mcard_cus_close_paid_from_party_add_radio" onclick="mcard_cus_cl_pdfrm_party_add_radio()" tabindex="27">
																</label>
																<label class="col-form-label fw-semibold fs-6">Membership Card</label>
															</div>
														</div>
														<div class="col-lg-2 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid" id="chit_chk_div">
															<div class="d-flex align-items-center mt-1">
																<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																	<input class="form-check-input" name="chit_cus_close_paid_from_party_add_radio" type="checkbox" value="1" id="chit_cus_close_paid_from_party_add_radio" onclick="chit_cus_cl_pdfrm_party_add_radio()" tabindex="28">
																</label>
													...
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_cl_cash_party_label_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="cust_cls_ppcash_amt" id="cust_cls_ppcash_amt" onkeyup="cust_close_party_payment_calc();" value="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="29">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_cash_party_detail_tbox" style="display:none;">
															<textarea class="form-control form-control-solid" rows="1" placeholder="Details"  name="cust_cls_ppcash_details" id="cust_cls_ppcash_details" tabindex="30"></textarea>
													...
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_cl_cheque_party_amt_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="cust_cls_ppchq_amt" id="cust_cls_ppchq_amt" onkeyup="cust_close_party_payment_calc();" value="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="31">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container"  id="cus_cl_cheque_party_bank_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Party Bank" name="cust_cls_ppchq_party_bank" id="cust_cls_ppchq_party_bank" tabindex="32">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_cheque_party_chq_no_tbox" style="display:none;">
															<input type="text" name="cust_cls_ppchq_ref_no" id="cust_cls_ppchq_ref_no" class="form-control form-control-lg form-control-solid" placeholder="Cheque/Ref Number" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.-]/g, '').replace(/(\..*)\./g, '$1');" tabindex="33">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_cheque_party_detail_tbox" style="display:none;">
															<textarea class="form-control form-control-solid" rows="1" placeholder="Details" name="cust_cls_ppchq_details" id="cust_cls_ppchq_details" tabindex="34"></textarea>
													...
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_cl_rtgs_party_amt_tbox" style="display:none;">
															<input type="text" name="cust_cls_pprtgs_amount" id="cust_cls_pprtgs_amount" class="form-control form-control-lg form-control-solid" placeholder="Amount" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeyup="cust_close_party_payment_calc();" value="0" tabindex="35">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_rtgs_party_no_tbox" style="display:none;">
															<input type="text" name="cust_cls_pprtgs_ref_no" id="cust_cls_pprtgs_ref_no" class="form-control form-control-lg form-control-solid" placeholder="Trans/Ref Number" oninput="this.value = this.value.replace(/[^A-Za-z/0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="36">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_rtgs_party_bank_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Company Bank" data-hide-search="true" name="cust_cls_pprtgs_company_bank" id="cust_cls_pprtgs_company_bank" tabindex="37">
																<option value="">Select</option>
																<?php
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_rtgs_party_detail_tbox" style="display:none;">
															<textarea class="form-control form-control-solid" rows="1" placeholder="Details" name="cust_cls_pprtgs_details" id="cust_cls_pprtgs_details" tabindex="38"></textarea>
													...
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_cl_upi_party_amt_tbox" style="display:none;">
															<input type="text" name="cust_cls_ppupi_amount" id="cust_cls_ppupi_amount"class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="cust_close_party_payment_calc();" value="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="39">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_upi_party_trans_no_tbox" style="display:none;">
															<input type="text" name="cust_cls_ppupi_ref_no" id="cust_cls_ppupi_ref_no" class="form-control form-control-lg form-control-solid" placeholder="Trans/Ref Number" oninput="this.value = this.value.replace(/[^a-zA-Z 0-9/-]/g, '').replace(/(\..*)\./g, '$1');" tabindex="40">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_upi_party_bank_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Company Bank" data-hide-search="true" name="cust_cls_ppupi_company_bank" id="cust_cls_ppupi_company_bank" tabindex="41">
																<option value="">Select</option>
																<?php
																	$bnk_det=$this->db->query("select * from BANKS where ACTIVE='Y'")->result_array();
																	foreach ($bnk_det as $blist) 
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_upi_party_detail_tbox" style="display:none;">
															<textarea class="form-control form-control-solid" rows="1" placeholder="Details" name="cust_cls_ppupi_details" id="cust_cls_ppupi_details" tabindex="42"></textarea>
													...
													<div class="row">
														...
														<div class="col-lg-2" id="cus_cl_card_no_paid_from_pty_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Membership Card No" name="cust_cls_ppmem_card" id="cust_cls_ppmem_card" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="43" readonly>
															<div class="fv-plugins-message-container invalid-feedback"></div>
														</div>
														...
														<div class="col-lg-2" id="cus_cl_redeem_paid_from_pty_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Redeem Points" name="cust_cls_ppmem_red_points" id="cust_cls_ppmem_red_points"  onkeyup="cust_close_party_payment_calc();" value="0" tabindex="44">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_cl_mcard_detail_paid_from_pty_tbox" style="display:none;">
															<textarea class="form-control form-control-solid" rows="1" placeholder="Details" name="cust_cls_ppmem_details" id="cust_cls_ppmem_details" tabindex="45"></textarea>
													...
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_cl_sch_paid_from_pty_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Scheme" id="cust_cls_ppchit_scheme" name="cust_cls_ppchit_scheme" data-hide-search="true" tabindex="46">
																<option value="">Select</option>
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_cl_avai_bal_paid_from_pty" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Chit ID" data-hide-search="true" name="cust_cls_ppchit_number" id="cust_cls_ppchit_number" tabindex="47">
														...
														<div class="col-lg-2" id="cus_cl_redeem_amt_paid_from_pty_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Redeem Amount" name="cust_cls_ppchit_red_amount" id="cust_cls_ppchit_red_amount"  onkeyup="cust_close_party_payment_calc();" value="0" tabindex="48">
															<div class="fv-plugins-message-container invalid-feedback"></div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-6 text-center">
															...
															<label class="col-form-label fw-bold fs-2"><span id="span_cust_cls_paid_amt">0.00</span><input type="hidden" name="txt_hidden_cust_cls_paid_amount" id="txt_hidden_cust_cls_paid_amount"></label>
														</div>
													</div>
												</div>
												<!-- Customer Close end -->
												...
												<div class="px-4" id="cus_trans_tbox" style="display: none;">
													<div class="row mt-4">
														...
														<div class="col-lg-4">
															<div class="row">
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Paper Action Charge</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_trans_pap_act_chg" id="cust_trans_pap_act_chg" onkeyup="cust_trans_calc();" tabindex="13" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Notice Charge</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_trans_not_chg" id="cust_trans_not_chg" onkeyup="cust_trans_calc();" tabindex="14" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<div class="col-lg-6">
																<div class="d-flex align-items-center">
																	<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																		<input class="form-check-input" name="cus_tr_form_missing" type="checkbox" value="1" id="cus_tr_form_missing" onclick="cus_tr_frm_missing()" tabindex="15">
																	</label>
																	<label class="col-form-label fw-semibold fs-6 me-5">Form Missing</label>
																</div>
															</div>
															<div class="col-lg-6" id="cus_tr_form_miss_print_but" style="display:none;">
																<a class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-1" target="_blank" id="cust_trans_btn_print1" tabindex="16"> Print 1</a>
																<a class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-1" target="_blank" id="cust_trans_btn_print2" tabindex="17">Print 2</a>
																<a id="cust_trans_btn_print3" target="_blank"><i class="fa fa-print" title="Legal Print" aria-hidden="true"  tabindex="18"></i></a>
															</div>
																<!-- <label class="col-lg-6 col-form-label fw-semibold fs-6">Form Missing</label> -->
																<!-- <div class="col-lg-6"> -->
														...
														<div class="col-lg-4">
															<div class="row">
																<label class="col-lg-6 col-form-label fw-semibold fs-6">On Account</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" style="background-color: #ff5b5b; color: white" name="cust_trans_on_acc_chg" id="cust_trans_on_acc_chg" onkeyup="cust_trans_calc();"  tabindex="20" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Discount</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_trans_disc_chg" id="cust_trans_disc_chg" onkeyup="cust_trans_calc();"  tabindex="21" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																...
																<div class="image-input image-input-outline " data-kt-image-input="true" style="background-image: url(assets/images/Document.jpg)">
																	<div class="image-input-wrapper w-50px h-50px" style="background-image: url(assets/images/Document.jpg)"></div>
																	<label class="btn btn-icon btn-circle btn-active-color-primary w-20px h-20px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-kt-initialized="1">
																		<i class="bi bi-pencil-fill fs-8"  tabindex="19"></i>
																		<input type="file" name="cust_trans_form_miss_doc" accept=".png, .jpg, .jpeg">
																		<input type="hidden" name="cust_trans_form_miss_doc_remove">
																	</label>
																	<span class="btn btn-icon btn-circle btn-active-color-primary w-20px h-20px bg-body shadow" data-kt-image-input-action="cancel" data-bs-toggle="tooltip" data-kt-initialized="1">
																		<i class="bi bi-x fs-4"></i>
																	</span>
														...
														<div class="col-lg-4">
															<div class="row">
																<label class="col-lg-6 col-form-label required fw-semibold fs-6">Closed By</label>
																<div class="col-lg-6 fv-row fv-plugins-icon-container">
																	<select class="form-select form-select-solid" name="cus_trans_closed_by" id="cus_trans_closed_by" data-control="select2" data-hide-search="true" onchange="cus_tr_cls_by();" tabindex="23">	
																		<option value="">Select</option>
																		<option value="party" selected>Party</option>
																		<option value="nominee">Nominee</option>
																		<option value="others">Others</option>
																...
																<div class="col-lg-6" id="cus_trans_closed_by_name_tbox" style="display:none;">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="Selvam" name="cust_trans_by_others" id="cust_trans_by_others" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="24">
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-2">
															<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_trans_payable_amount" id="cust_trans_payable_amount" onkeyup="cust_trans_calc()" tabindex="25" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
															<div class="fv-plugins-message-container invalid-feedback" id="cust_trans_payable_amount_err"></div>
														</div>
														<div class="col-lg-2">
															<div class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_view_payment_pay_now_party" tabindex="26" id="div_pay_now_party_btn">Pay Now Party</div>
														</div>
													</div>
													<div class="row">
														<label class="col-lg-2 col-form-label fw-semibold fs-6">Balance in Current Loan</label>
														<div class="col-lg-2">
															<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_trans_bal_in_loan" id="cust_trans_bal_in_loan" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="27">
														...
														<div class="col-lg-2">
															<input type="text"class="form-control form-control-lg form-control-solid fw-bold fs-4" placeholder="" value="0" name="cust_trans_req_frm_new_loan" id="cust_trans_req_frm_new_loan" onkeyup="cust_trans_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="28">
													        ...
													        <div id="kt_accordion_item_redemption_new_loan_body_1" class="accordion-collapse collapse show" aria-labelledby="kt_accordion_item_redemption_new_loan_header_1" data-bs-parent="#kt_accordion_item_redemption_new_loan">
													            <div class="accordion-body">
													            	<div class="row">
																		...
																		<div class="col-lg-2 fv-row fv-plugins-icon-container">
																			<select class="form-select form-select-solid" name="cust_trans_new_ln_jewel_type" id="cust_trans_new_ln_jewel_type" data-control="select2" data-hide-search="true" tabindex="29">	
																				<option value="">Select</option>
																				<?php 
																		...
																		<div class="col-lg-2 fv-row fv-plugins-icon-container">
																			<select class="form-select form-select-solid" name="cust_trans_new_ln_scheme" id="cust_trans_new_ln_scheme" data-control="select2" data-hide-search="true" onchange="loan_interest();" tabindex="30">	
																				<option value="">Select</option>
																				<?php 
																		...
																		<div class="col-lg-2 fv-row fv-plugins-icon-container">
																			<select class="form-select form-select-solid" name="cust_trans_new_ln_int_type" id="cust_trans_new_ln_int_type" data-control="select2" data-hide-search="true" onchange="get_exp_int_amt();" tabindex="31">	
																				<option value="">Select</option>
																		...
																		<div class="col-lg-4">
																			<div class="px-4" style="border-radius: 10px;padding-bottom: 10px;box-shadow: 0 5px 10px #00002947;">
																				...
																				<div class="row">
																					...
																					<!--begin::Col-->
																					<div class="col-lg-6 fv-row fv-plugins-icon-container">
																						<input type="text" name="cust_trans_new_ln_loan_amount" id="cust_trans_new_ln_loan_amount" class="form-control form-control-lg1 form-control-solid" value="16977.01" style="font-size: 18px !important;font-weight: 700 !important;color: #1B439E !important;" onkeyup="cust_trans_calc();" tabindex="32" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
																				...
																				<div class="row">
																					...
																					<div class="col-lg-3 fv-row fv-plugins-icon-container">
																						<input type="text" name="cust_trans_new_ln_redemption_period" id="cust_trans_new_ln_redemption_period" class="form-control form-control-lg1 form-control-solid" value="30" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" tabindex="33">
																		...
																		<div class="col-lg-4">
																			<div class="px-4" style="border-radius: 10px;padding-bottom: 8px;box-shadow: 0 5px 10px #00002947;">
																				...
																				<div class="row">
																					...
																					<div class="col-lg-6 fv-row fv-plugins-icon-container">
																						<input type="text" name="cust_trans_new_ln_process_chg" id="cust_trans_new_ln_process_chg" class="form-control form-control-lg1 form-control-solid" placeholder="Processing Charge" value="50" onkeyup="cust_trans_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="34">
																						<div class="fv-plugins-message-container invalid-feedback"></div>
																					</div>
																		...
																		<div class="col-lg-4">
																			<div class="px-4" style="padding-bottom: 5px;border-radius: 10px;box-shadow: 0 5px 10px #00002947;">
																				...
																				<div class="row">
																					...
																					<div class="col-lg-4">
																						<div class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_view_payment_cus_trans" tabindex="35">Pay Now</div>
																					</div>
																				</div>
																				<div class="row">
																				...
																				<div class="row mb-2">
																					<div class="col-lg-12 fv-row fv-plugins-icon-container">
																						<textarea class="form-control form-select-solid fw-semibold fs-5" rows="3" id="cust_trans_new_ln_topay_remarks" name="cust_trans_new_ln_topay_remarks" tabindex="36"></textarea>
																						<div class="fv-plugins-message-container invalid-feedback"></div>
																					</div>
																				</div>
																			</div>
												...
												<div class="px-4" id="cus_sale_tbox" style="display: none;">
													<div class="row mt-4">
														...
														<div class="col-lg-4">
															<div class="row">
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Paper Action Charge</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_sale_pap_act_chg" id="cust_sale_pap_act_chg" onkeyup="cust_sale_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="13">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Notice Charge</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_sale_not_chg" id="cust_sale_not_chg" onkeyup="cust_sale_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="14">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<!-- <label class="col-lg-6 col-form-label fw-semibold fs-6">Form Missing</label> -->
																<!-- <div class="col-lg-6"> -->
																...
																<div class="col-lg-6">
																	<div class="d-flex align-items-center">
																		<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																			<input class="form-check-input" name="cus_sl_form_missing" type="checkbox" value="1" id="cus_sl_form_missing" onclick="cus_sl_frm_missing()" tabindex="15">
																		</label>
																		<label class="col-form-label fw-semibold fs-6 me-5">Form Missing</label>
																	</div>
																</div>
																<div class="col-lg-6" id="cus_sl_form_miss_print_but" style="display:none;">
																	<a class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-1" target="_blank" id="cust_sal_btn_print1" tabindex="16">Print 1</a>
																	<a class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-1" target="_blank" id="cust_sal_btn_print2" tabindex="17">Print 2</a>
																	<a id="cust_sal_btn_print3" target="_blank" ><i class="fa fa-print" title="Legal Print" aria-hidden="true" tabindex="18"></i></a>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="row">
																<label class="col-lg-6 col-form-label fw-semibold fs-6">On Account</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" style="background-color: #ff5b5b; color: white" name="cust_sale_on_acc_chg" id="cust_sale_on_acc_chg" onkeyup="cust_sale_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="20">
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Discount</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="cust_sale_disc_chg" id="cust_sale_disc_chg" onkeyup="cust_sale_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="21">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<div class="col-lg-2" id="cus_sl_upload_doc" style="display:none;">
																	<div class="image-input image-input-outline " data-kt-image-input="true" style="background-image: url(assets/images/Document.jpg)">
																		...
																		<label class="btn btn-icon btn-circle btn-active-color-primary w-20px h-20px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-kt-initialized="1">
																			<i class="bi bi-pencil-fill fs-8" tabindex="19"></i>
																			<input type="file" name="cust_sale_form_miss_doc" accept=".png, .jpg, .jpeg">
																			<input type="hidden" name="cust_sale_form_miss_doc_remove">
																		</label>
																		<span class="btn btn-icon btn-circle btn-active-color-primary w-20px h-20px bg-body shadow" data-kt-image-input-action="cancel" data-bs-toggle="tooltip" data-kt-initialized="1">
																			<i class="bi bi-x fs-4"></i>
																		</span>
														...
														<div class="col-lg-4">
															<div class="row">
																<label class="col-lg-6 col-form-label required fw-semibold fs-6">Closed By</label>
																<div class="col-lg-6 fv-row fv-plugins-icon-container">
																	<select class="form-select form-select-solid" name="cus_sale_closed_by" id="cus_sale_closed_by" data-control="select2" data-hide-search="true" onchange="cus_sl_cls_by();"   tabindex="22">	
																		<option value="">Select</option>
																		<option value="party" selected>Party</option>
																		<option value="nominee">Nominee</option>
																		<option value="others">Others</option>
																...
																<div class="col-lg-6" id="cus_sale_closed_by_name_tbox" style="display:none;">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="Selvam" name="cust_sale_by_others" id="cust_sale_by_others"  oninput="this.value = this.value.replace(/[^a-zA-Z .]/g, '').replace(/(\..*)\./g, '$1');" tabindex="23">
													...
													<div class="row mt-4">
														<div class="col-lg-7">
															<div class="row">
																...
																<div class="col-lg-3">
																	<input type="text"class="form-control form-control-lg form-control-solid fw-bold fs-4" placeholder="Pur. Amount" value="0" name="r_purhcase_amount" id="r_purhcase_amount" onkeyup="cust_sale_calc_remaining_amount();"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="24">
																...
																<div class="col-lg-4">
																	<input type="text"class="form-control form-control-lg form-control-solid fw-bold fs-4" placeholder="Bal. Amount" value="0" name="r_remaining_amount" id="r_remaining_amount" onkeyup="cust_sale_check_remaining_amount();"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="25">
																...
																<div class="col-lg-3 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
																	<div class="d-flex align-items-center mt-1">
																		<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																			<input class="form-check-input" name="cash_cus_sale_paid_from_company_add_radio" type="checkbox" value="1" id="cash_cus_sale_paid_from_company_add_radio" onclick="cash_cus_sl_pdfrm_cmy_add_radio()" tabindex="26">
																		</label>
																		<label class="col-form-label fw-semibold fs-6 me-5">Cash</label>
																	</div>
																</div>
																<div class="col-lg-3 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
																	<div class="d-flex align-items-center mt-1">
																		<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																			<input class="form-check-input" name="cheque_cus_sale_paid_from_company_add_radio" type="checkbox" value="1" id="cheque_cus_sale_paid_from_company_add_radio" onclick="cheque_cus_sl_pdfrm_cmy_add_radio()" tabindex="27">
																		</label>
																		<label class="col-form-label fw-semibold fs-6">Cheque</label>
																	</div>
																</div>
																<div class="col-lg-3 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
																	<div class="d-flex align-items-center mt-1">
																		<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																			<input class="form-check-input" name="rtgs_cus_sale_paid_from_company_add_radio" type="checkbox" value="1" id="rtgs_cus_sale_paid_from_company_add_radio" onclick="rtgs_cus_sl_pdfrm_cmy_add_radio()" tabindex="28">
																		</label>
																		<label class="col-form-label fw-semibold fs-6">RTGS</label>
																	</div>
																</div>
																<div class="col-lg-3 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
																	<div class="d-flex align-items-center mt-1">
																		<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																			<input class="form-check-input" name="upi_cus_sale_paid_from_company_add_radio" type="checkbox" value="1" id="upi_cus_sale_paid_from_company_add_radio" onclick="upi_cus_sl_pdfrm_cmy_add_radio()" tabindex="29">
																		</label>
																		<label class="col-form-label fw-semibold fs-6">UPI</label>
																	</div>
																</div>
																		...
																		<tr>
																			<td>
																				<div style="width:100px !important;">
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7" id="w_name1" name="w_name[]" tabindex="47" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');" >
																				</div>
																			</td>
																			<td>
																				<div style="width:120px !important;">
																					<select class="form-select form-select-solid fs-7" data-control="select2"  id="w_relation1" name="w_relation[]" tabindex="48">	
																						<option value="">Select</option>
																			...
																			<td>
																				<div style="width:85px !important;">
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7" id="w_phone1" name="w_phone[]" tabindex="49" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"  >
																				</div>
																			</td>
																			<td>
																				<div style="width:85px !important;">
																					<textarea class="form-control form-control-solid fs-7" id="w_remarks1" name="w_remarks[]" tabindex="50"></textarea>
																				</div>
																			</td>
																		</tr>
																		<tr>
																			<td>
																				<div style="width:100px !important;">
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7" id="w_name2" name="w_name[]" tabindex="51" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');">
																				</div>
																			</td>
																			<td>
																				<div style="width:120px !important;">
																					<select class="form-select form-select-solid fs-7" data-control="select2" id="w_relation2" name="w_relation[]" tabindex="52">	
																						<option value="">Select</option>
																						<option value="Mother">Mother</option>
																						<option value="Father">Father</option>				
																						<option value="Brother">Brother</option>
																			...
																			<td>
																				<div style="width:85px !important;">
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7" id="w_phone2" name="w_phone[]" tabindex="53" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
																				</div>
																			</td>
																			<td>
																				<div style="width:85px !important;">
																					<textarea class="form-control form-control-solid fs-7" name="w_remarks[]" id="w_remarks2" tabindex="54"></textarea>
																				</div>
																			</td>
																		</tr>
																		<tr>
																			<td>
																				<div style="width:100px !important;">
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7" id="w_name3" name="w_name[]" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');" tabindex="55">
																				</div>
																			</td>
																			<td>
																				<div style="width:120px !important;">
																					<select class="form-select form-select-solid fs-7" data-control="select2" id="w_relation3" name="w_relation[]" tabindex="56">	
																						<option value="">Select</option>
																						<option value="Mother">Mother</option>
																						<option value="Father">Father</option>				
																						<option value="Brother">Brother</option>
																			...
																			<td>
																				<div style="width:85px !important;">
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7" id="w_phone3" name="w_phone[]" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" tabindex="57">
																				</div>
																			</td>
																			<td>
																				<div style="width:85px !important;">
																					<textarea class="form-control form-control-solid fs-7" name="w_remarks[]" id="w_remarks3" tabindex="58"></textarea>
																				</div>
																			</td>
																		</tr>
																		<tr>
																			<td>
																				<div style="width:100px !important;">
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7" id="w_name4" name="w_name[]" tabindex="59" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');">
																				</div>
																			</td>
																			<td>
																				<div style="width:120px !important;">
																					<select class="form-select form-select-solid fs-7" data-control="select2" id="w_relation4" name="w_relation[]" tabindex="60">	
																						<option value="">Select</option>
																						<option value="Mother">Mother</option>
																						<option value="Father">Father</option>				
																						<option value="Brother">Brother</option>
																			...
																			<td>
																				<div style="width:85px !important;"> 
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7"  id="w_phone4" name="w_phone[]" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" tabindex="61">
																				</div>
																			</td>
																			<td>
																				<div style="width:85px !important;">
																					<textarea class="form-control form-control-solid fs-7" name="w_remarks[]" id="w_remarks4" tabindex="62"> </textarea>
																				</div>
																			</td>
																		</tr>
																		<tr>
																			<td>
																				<div style="width:100px !important;">
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7" id="w_name5" name="w_name[]" tabindex="63" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');">
																				</div>
																			</td>
																			<td>
																				<div style="width:120px !important;">
																					<select class="form-select form-select-solid fs-7" data-control="select2" id="w_relation5" name="w_relation[]" tabindex="64">	
																						<option value="">Select</option>
																						<option value="Mother">Mother</option>
																						<option value="Father">Father</option>				
																						<option value="Brother">Brother</option>
																			...
																			<td>
																				<div style="width:85px !important;">
																					<input type="text" class="form-control form-control-lg form-control-solid fs-7" id="w_phone5" name="w_phone[]" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" tabindex="65">
																				</div>
																			</td>
																			<td>
																				<div style="width:85px !important;">
																					<textarea class="form-control form-control-solid fs-7" name="w_remarks[]" id="w_remarks5" tabindex="66"></textarea>
																				</div>
																			</td>
																		</tr>
																	</tbody>
													...
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_cash_paid_from_cmy_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" name="cust_sale_cpcash_amt" id="cust_sale_cpcash_amt"  onkeyup="cust_sale_company_payment_calc();" value="0"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="30">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_cash_paid_from_detail_cmy_tbox" style="display:none;">
															<textarea class="form-control form-control-solid" rows="1" placeholder="Details" name="cust_sale_cpcash_details" id="cust_sale_cpcash_details" tabindex="31"></textarea>
													...
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container"id="cus_sl_cheque_amt_paid_from_cmy_tbox" style="display:none;" >
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" name="cust_sale_cpchq_amt" id="cust_sale_cpchq_amt"  onkeyup="cust_sale_company_payment_calc();" value="0"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="32" >
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_cheque_no_paid_from_cmy_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Cheque No"  name="cust_sale_cpchq_no" id="cust_sale_cpchq_no"  oninput="this.value = this.value.replace(/[^a-zA-Z 0-9./-]/g, '').replace(/(\..*)\./g, '$1');" tabindex="33">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_sl_cheque_com_bank_paid_from_cmy_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="cust_sale_cpchq_comp_bank" id="cust_sale_cpchq_comp_bank" data-placeholder="Company Bank" tabindex="34">
																<option value="">Select</option>
																<?php
																	$bnk_det=$this->db->query("select * from BANKS where ACTIVE='Y'")->result_array();
																	foreach ($bnk_det as $blist) 
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_cheque_par_bank_paid_from_cmy_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Party Bank" data-hide-search="true" name="cust_sale_cpchq_party_bank" id="cust_sale_cpchq_party_bank" tabindex="35">
																<option value="">Select</option>
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container"  id="cus_sl_cheque_detail_paid_from_cmy_tbox" style="display:none;">
															<textarea class="form-control form-control-solid" rows="1" placeholder="Details" name="cust_sale_cpchq_details" id="cust_sale_cpchq_details"tabindex="36"></textarea>
													...
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_rtgs_amt_paid_from_cmy_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" name="cust_sale_cprtgs_amount" id="cust_sale_cprtgs_amount"  onkeyup="cust_sale_company_payment_calc();" value="0"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="37">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_rtgs_ref_paid_from_cmy_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Reference No" name="cust_sale_cprtgs_ref_no" id="cust_sale_cprtgs_ref_no"  oninput="this.value = this.value.replace(/[^a-zA-Z0-9./]/g, '').replace(/(\..*)\./g, '$1');" tabindex="38">
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_sl_rtgs_com_bank_paid_from_cmy_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Company Bank" data-hide-search="true" name="cust_sale_cprtgs_comp_bank" id="cust_sale_cprtgs_comp_bank" tabindex="39">
																<option value="">Select</option>
																<?php
																	$bnk_det=$this->db->query("select * from BANKS where ACTIVE='Y'")->result_array();
																	foreach ($bnk_det as $blist) 
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_rtgs_par_bank_paid_from_cmy_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Party Bank" data-hide-search="true" name="cust_sale_cprtgs_party_bank" id="cust_sale_cprtgs_party_bank" tabindex="40">
																<option value="">Select</option>
																<option value="1">UPI-12546875-kumar</option>				
																<option value="2">Bank-1254867-Kumar</option>
															</select>
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_rtgs_detail_paid_from_cmy_tbox" style="display:none;">
															<textarea class="form-control form-control-solid" rows="1" placeholder="Details"name="cust_sale_cprtgs_details" id="cust_sale_cprtgs_details" tabindex="41"></textarea>
													...
													<div class="row">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_upi_amt_paid_from_cmy_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" name="cust_sale_cpupi_amount" id="cust_sale_cpupi_amount"  onkeyup="cust_sale_company_payment_calc();" value="0"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="42">
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_upi_ref_paid_from_cmy_tbox" style="display:none;">
															<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Reference No" name="cust_sale_cpupi_ref_no" id="cust_sale_cpupi_ref_no" tabindex="43"  oninput="this.value = this.value.replace(/[^a-zA-Z0-9./-]/g, '').replace(/(\..*)\./g, '$1');" >
														...
														<div class="col-lg-3 fv-row fv-plugins-icon-container" id="cus_sl_upi_com_bank_paid_from_cmy_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Company Bank" data-hide-search="true" name="cust_sale_cpupi_comp_bank" id="cust_sale_cpupi_comp_bank" tabindex="44">
																<option value="">Select</option>
																<?php
																	$bnk_det=$this->db->query("select * from BANKS where ACTIVE='Y'")->result_array();
																	foreach ($bnk_det as $blist) 
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_upi_par_bank_paid_from_cmy_tbox" style="display:none;">
															<select class="form-select form-select-solid" data-control="select2" data-placeholder="Party Bank" data-hide-search="true" name="cust_sale_cpupi_party_bank" id="cust_sale_cpupi_party_bank" tabindex="45">
																<option value="">Select</option>
																<option value="1">UPI-12546875-kumar</option>				
																<option value="2">Bank-1254867-Kumar</option>
															</select>
														...
														<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cus_sl_upi_detail_paid_from_cmy_tbox" style="display:none;">
															<textarea class="form-control form-control-solid" rows="1" placeholder="Details" name="cust_sale_cpupi_details" id="cust_sale_cpupi_details" tabindex="46"></textarea>
													...
													<div class="row mt-4">
														...
														<div class="col-lg-4">
															<div class="row">
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Paper Action Charge</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="mul_jwl_pap_act_chg" id="mul_jwl_pap_act_chg" onkeyup="multi_jewel_charges_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="13">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Notice Charge</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="mul_jwl_not_chg" id="mul_jwl_not_chg" onkeyup="multi_jewel_charges_calc();" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" tabindex="14">
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<div class="col-lg-6">
																	<div class="d-flex align-items-center">
																		<label class="form-check form-check-inline form-check-solid me-5 is-invalid">
																			<input class="form-check-input" name="mul_jwl_form_missing" type="checkbox" value="1" id="mul_jwl_form_missing" onclick="mul_jwl_frm_missing()" tabindex="15">
																		</label>
																		<label class="col-form-label fw-semibold fs-6 me-5">Form Missing</label>
																	</div>
																</div>
																<div class="col-lg-6" id="mul_jwl_form_miss_print_but" style="display:none;">
																	<a class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-1" target="_blank" id="mul_jwl_btn_print1" tabindex="16">Print 1</a>
																	<a class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-1" target="_blank" id="mul_jwl_btn_print2" tabindex="17">Print 2</a>
																	<a id="mul_jwl_btn_print3" target="_blank" ><i class="fa fa-print" title="Legal Print" aria-hidden="true" tabindex="18"></i></a>
																</div>
																<!-- <label class="col-lg-6 col-form-label fw-semibold fs-6">Form Missing</label> -->
																<!-- <div class="col-lg-6"> -->
														...
														<div class="col-lg-4">
															<div class="row">
																<label class="col-lg-6 col-form-label fw-semibold fs-6">On Account</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" style="background-color: #ff5b5b; color: white" name="mul_jwl_on_acc_chg" id="mul_jwl_on_acc_chg" onkeyup="multi_jewel_charges_calc();" tabindex="20" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
																<label class="col-lg-6 col-form-label fw-semibold fs-6">Discount</label>
																<div class="col-lg-6">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="0" name="mul_jwl_disc_chg" id="mul_jwl_disc_chg" onkeyup="multi_jewel_charges_calc();" tabindex="21" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"> 
																	<div class="fv-plugins-message-container invalid-feedback" id=""></div>
																</div>
																<div class="col-lg-2" id="mul_jwl_upload_doc" style="display:none;">
																	<div class="image-input image-input-outline " data-kt-image-input="true" style="background-image: url(assets/images/Document.jpg)">
																		...
																		<label class="btn btn-icon btn-circle btn-active-color-primary w-20px h-20px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-kt-initialized="1">
																			<i class="bi bi-pencil-fill fs-8" tabindex="19"></i>
																			<input type="file" name="mul_jwl_form_miss_doc" accept=".png, .jpg, .jpeg">
																			<input type="hidden" name="mul_jwl_form_miss_doc_remove">
																		</label>
																		<span class="btn btn-icon btn-circle btn-active-color-primary w-20px h-20px bg-body shadow" data-kt-image-input-action="cancel" data-bs-toggle="tooltip" data-kt-initialized="1">
																			<i class="bi bi-x fs-4"></i>
																		</span>
														...
														<div class="col-lg-4">
															<div class="row">
																<label class="col-lg-6 col-form-label required fw-semibold fs-6">Closed By</label>
																<div class="col-lg-6 fv-row fv-plugins-icon-container">
																	<select class="form-select form-select-solid" name="mul_jewel_closed_by" id="mul_jewel_closed_by" data-control="select2" data-hide-search="true" onchange="mul_jwl_cls_by();" tabindex="22">	
																		<option value="">Select</option>
																		<option value="party" selected>Party</option>
																		<option value="nominee">Nominee</option>
																		<option value="others">Others</option>
																...
																<div class="col-lg-6" id="mul_jewel_closed_by_name_tbox" style="display:none;">
																	<input type="text"class="form-control form-control-lg form-control-solid" placeholder="" value="Selvam" name="mul_jwl_others" id="mul_jwl_others" tabindex="23">
																	<div class="fv-plugins-message-container invalid-feedback"></div>
																</div>
															</div>
														</div>
																		...
																		<div class="col-lg-4">
																			<div class="px-4" style="padding-bottom: 5px;border-radius: 10px;box-shadow: 0 5px 10px #00002947;">
																				...
																				<div class="row">
																					...
																					<div class="col-lg-4">
																						<div class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_view_payment_multi_jwl" onclick="mul_jwl_pay_to_party();">Pay Now</div>
																					</div>
																				</div>
																				<div class="row">
																					<label class="col-lg-4 col-form-label fw-semibold fs-6">Remarks</label>
			...
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="row">
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Loan Date</label>
							<label class="col-lg-2 col-form-label fw-bold fs-4" id="r_pop_loan_date">-</label>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Loan Amount</label>
							<label class="col-lg-2 col-form-label fw-bold fs-4" id="r_pop_loan_amount">-</label>
							<label class="col-lg-2 col-form-label fw-semibold fs-6">Int Type</label>
							<label class="col-lg-2 col-form-label fw-bold fs-4" id="r_pop_interest">-</label>
						...
						<!--end::Heading-->
							<!-- <div style="padding: 10px 10px 10px 10px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color:#f5f5f1 !important;"> -->
								...
								<div class="d-flex justify-content-end mt-6 px-9">
									...
									<div type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_view_payment_cus_trans" onclick="cust_trans_pay_to_party();">Pay</div>
								</div>
							<!-- </div> -->
							<!--end::Modal body-->
					</div>
							...
							<!-- <div style="padding: 10px 10px 10px 10px !important;box-shadow: 0 3px 6px #00002947;border-radius: 5px;background-color:#f5f5f1 !important;"> -->
								...
								<div class="row">
									...
									<div class="col-lg-2 fv-row fv-plugins-icon-container" id="mj_cheque_no_ln_pay_tbox" style="display:none;">
										<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Cheque No" name="mul_jwl_ptp_chq_no" id="mul_jwl_ptp_chq_no">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
			...
			<div class="modal-dialog modal-md">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<!--end::Heading-->					
						<div class="row">
							<label class="col-lg-12 col-form-label fw-bold fs-5" id="" name=""><i class="fa fa-address-card fs-5" aria-hidden="true" title="Card No"></i>&emsp;<span id="pop_member_card"></span>
							</label>
	...
	<script >
		var baseurl="<?php echo base_url();?>";
		 $("#redemp_bill_no").autocomplete({ 
					...
					$("#r_address").html(suggestion.address1);
	    ...
	    //             // $("#nominee_icon_txt").html($nic);
	                ...
	                if(suggestion.member_points==0)
	                {
						...
						document.getElementById('membership_card_chk_div').style.display="none";
	                }
	            	else
	            	{
	            		document.getElementById('r_no_card').style.display="none";
						document.getElementById('membership_card_chk_div').style.display="block";
					...
					if(suggestion.chit_count==0){
						document.getElementById('chit_chk_div').style.display="none";
					}
					else{
						document.getElementById('chit_chk_div').style.display="block";
					}
  ...
  var bill_no= $("#redemp_bill_no").val();
  		...
  		$.ajax({
                ...
                $('#txt_hidden_paid_principal').val(res[3]);
						...
						$('#lbl_cust_trans_net_pay').html(bal);
						$('#mul_jwl_total_amount').html(bal);
						$('#txt_hidden_bal_total').html(bal.toFixed(2));
						$('#r_mul_jwl_tbody_pending_payment').html(res[8]);
						$('#lbl_mul_jwl_net_pay').html(bal.toFixed(2));
						$('#lbl_cust_cls_net_pay').html(bal.toFixed(2));
						$('#span_cust_cls_net_pay').html(bal.toFixed(2));
...
$('#r_address').on('DOMSubtreeModified',function(){
	...
	<script >
		function cust_trans_pay_to_party()
		{
			...
			if(cash_status==1 || chq_status==1 || rtgs_status==1 || upi_status==1)
			{
				...
				if(bal==0)
				{
					...
					$('#kt_modal_view_payment_cus_trans').hide();
					$('.modal-backdrop').hide();
		...
		function cust_trans_payment_from_party()
		{
			...
			var tot_to_rec=parseFloat($('#cust_trans_ppnetpay_amt').html());
			// alert(tot_to_rec);
			var cash_status=0;
			var chq_status=0;
			var rtgs_status=0;
			...
			else
			{
				...
				if(cash_loan_paynow_add_radio.checked)
				{
	     			...
	     			else
	     			{
						$.ajax({
							type: "POST",
							url: baseurl+'redemption/party_payment?',
							async: false,
							type: "POST",
							data: datastring,
							dataType: "html",
			...
			if(cash_status==1 || chq_status==1 || rtgs_status==1 || upi_status==1)
			{
				...
				if(bal==0)
				{
					...
					document.getElementById('btn_pay').style.display="none";	
					// document.getElementById('btn_pay_now').style.display="none";
					document.getElementById('div_pay_now_party_btn').style.display="none";
					$('#kt_modal_view_payment_pay_now_party').removeClass('show');
					$('.modal-backdrop').removeClass('show');
		...
		function cust_close_party_payment_calc()
		{
			...
			if(fbal < 0){
				alert("Paid Amount is greater than Net Amount");
				var cash=$('#cust_cls_ppcash_amt').val('0');
				var chq=$('#cust_cls_ppchq_amt').val('0');
				var rtgs=$('#cust_cls_pprtgs_amount').val('0');
				var upi=$('#cust_cls_ppupi_amount').val('0');
				var mc=$('#cust_cls_ppmem_red_points').val('0');
				var ct=$('#cust_cls_ppchit_red_amount').val('0');
				$('#span_cust_cls_paid_amt').html('0.00');
			}
			else{
		...
		function cust_trans_calc()
		{
			...
			$('#cust_trans_ppnetpay_amt').html(pamt);
	...
	<script >
		function mul_jwl_pay_to_party()
		{
			...
			var tot_to_rec=parseFloat($('#mul_jwl_ptp_net_pay').html());
			// alert(tot_to_rec);
			var cash_status=0;
			var chq_status=0;
			var rtgs_status=0;
			...
			var bal=parseFloat($('#mul_jwl_ptp_bal_amount').html());
			if(bal!=0)
			{
				alert("Still balance amount exists");
				document.getElementById('btn_pay').style.display="block";
			...
			else
			{
				...
				if(cash_loan_paynow_add_radio.checked)
				{
					var module_name='New Redemption - Multi Jewel - Pay to Party';
					var pay_type='Cash';
					var pay_amt=parseFloat($('#mul_jwl_ptp_cash_amt').val());
					var pay_amt1=parseFloat($('#mul_jwl_ptp_chq_amt').val());
					var pay_amt2=parseFloat($('#mul_jwl_ptp_rtgs_amt').val());
					var pay_amt3=parseFloat($('#mul_jwl_ptp_upi_amt').val());
					var pay_details=$('#mul_jwl_ptp_cash_details').val();
					var p_bank='';
					var ref_no='';
					var c_bank='';
					var p_bill_no=$('#redemp_bill_no').val();
					var p_pid=$('#r_pid').val();
	     			...
	     			var tot=pay_amt+pay_amt1+pay_amt2+pay_amt3;
	     			if(tot==tot_to_rec)
						$('#mul_jwl_ptp_bal_amount').html("0");
	     			if(tot>tot_to_rec)
	     			{
	     				alert("Enter value less than total amount");
	     				document.getElementById('mul_jwl_ptp_cash_amt').focus();
	     			}
	     			else
	     			{
						$.ajax({
				...
				if(cheque_loan_paynow_add_radio.checked)
				{
					var module_name='New Redemption - Multi Jewel - Pay to Party';
					var pay_type='Cheque';
					var pay_amt1=parseFloat($('#mul_jwl_ptp_cash_amt').val());
					var pay_amt=parseFloat($('#mul_jwl_ptp_chq_amt').val());
					var pay_amt2=parseFloat($('#mul_jwl_ptp_rtgs_amt').val());
					var pay_amt3=parseFloat($('#mul_jwl_ptp_upi_amt').val());
					var pay_details=$('#mul_jwl_ptp_chq_details').val();
					var p_bank=$('#mul_jwl_ptp_chq_party_bank').val();
					var ref_no=$('#mul_jwl_ptp_chq_no').val();
					var c_bank=$('#mul_jwl_ptp_chq_comp_bank').val();
					var p_bill_no=$('#redemp_bill_no').val();
					var p_pid=$('#r_pid').val();
	     			...
	     			{
	     				alert("Enter value less than total amount");
	     				document.getElementById('mul_jwl_ptp_chq_amt').focus();
	     			}
	     			else
	     			{
						$.ajax({
				...
				if(rtgs_loan_paynow_add_radio.checked)
				{
					...
					var pay_type='RTGS';
					var pay_amt1=parseFloat($('#mul_jwl_ptp_cash_amt').val());
					var pay_amt2=parseFloat($('#mul_jwl_ptp_chq_amt').val());
					var pay_amt=parseFloat($('#mul_jwl_ptp_rtgs_amt').val());
					var pay_amt3=parseFloat($('#mul_jwl_ptp_upi_amt').val());
					var pay_details=$('#mul_jwl_ptp_rtgs_details').val();
					var p_bank=$('#mul_jwl_ptp_rtgs_party_bank').val();
					var ref_no=$('#mul_jwl_ptp_rtgs_ref_no').val();
					var c_bank=$('#mul_jwl_ptp_rtgs_comp_bank').val();
					var p_bill_no=$('#redemp_bill_no').val();
					var p_pid=$('#r_pid').val();
	     			...
	     			{
	     				alert("Enter value less than total amount");
	     				document.getElementById('mul_jwl_ptp_rtgs_amt').focus();
	     			}
	     			else
	     			{
						$.ajax({
				...
				if(upi_loan_paynow_add_radio.checked)
				{
					...
					var pay_amt1=parseFloat($('#mul_jwl_ptp_cash_amt').val());
					var pay_amt2=parseFloat($('#mul_jwl_ptp_chq_amt').val());
					var pay_amt3=parseFloat($('#mul_jwl_ptp_rtgs_amt').val());
					var pay_amt=parseFloat($('#mul_jwl_ptp_upi_amt').val());
					var pay_details=$('#mul_jwl_ptp_upi_details').val();
					var p_bank=$('#mul_jwl_ptp_upi_party_bank').val();
					var ref_no=$('#mul_jwl_ptp_upi_ref_no').val();
					var c_bank=$('#mul_jwl_ptp_upi_comp_bank').val();
					var p_bill_no=$('#redemp_bill_no').val();
					var p_pid=$('#r_pid').val();
	     			...
	     			{
	     				alert("Enter value less than total amount");
	     				document.getElementById('mul_jwl_ptp_upi_amt').focus();
	     			}
	     			else
	     			{
						$.ajax({
	...
	<script >
		...
		function calc_val_adjustment(rno)
		{
				...
				$('#old_ln_pl_val'+rno).val(redeem_actl_val);
	...
	function redemption_validation()
	{
		...
		else
		{
			...
			if(cus_cls.checked==true)
			{
				...
				var paid_amount=$('#span_cust_cls_paid_amt').html();
				var net_amount2=$('#span_cust_cls_net_pay').html();


				var net_amount  = net_amount2.toLocaleString('en-IN', {
						    maximumFractionDigits: 2
						});

			
				if(net_amount != paid_amount){
					alert("Net Amount is not equal to Paid Amount")
						err++;
				}
				// if(net_amount < paid_amount){
				// 	alert("Paid Amount is greater than Net Amount")
