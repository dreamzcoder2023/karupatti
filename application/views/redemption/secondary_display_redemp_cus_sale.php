...
<style>
	.dataTables_scroll
    {
        ...
        max-height: 290px !important;/*the maximum height you want to achieve*/
        width: 100%;
    }
  .dataTables_scroll thead{
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
									  ...
									  <!-- style="background: url('assets/images/Notification.jpg');"> -->
										<div class="card-body" style="padding: 0.5rem 0.5rem !important;height: 620px;">
											<div class="row">
												...
												<div class="col-lg-6 d-flex align-items-center">
													<label class="col-form-label fw-bold" style="font-size: 30px !important;">
														<span>Redemption [Customer Sale] &nbsp;</span>
													</label>
													<label class="top-0 start-75 animation-blink col-form-label fw-bold" style="font-size: 24px !important;">
														<span><?php echo $party['BILLNO'];?></span>
														<input type="hidden" name="bill_no" id="bill_no" value="<?php echo $party['BILLNO'];?>">
													</label>
												</div>
											</div>
											<div class="row px-3">
													...
													<div class="row">
														<div class="col-lg-6 fv-row">
															<div class="image-input image-input-outline" data-kt-image-input="true">
																<div class="image-input-wrapper w-150px h-150px" style="background-image: url(assets/images/staff_1.png);background-color:white;">
											...
											<div class="row px-3">
												<div class="col-lg-8">
													<div class="row">
														<table id="pledge_item_sd" class="table align-middle fw-bold fs-1 gy-1 gs-2">
															...
															<tbody id="tbody_paid_history">
																<?php $i=0; foreach($arr['actual'] as $a) { ?>
																	<tr>
																		<td>
																		...
																		<td>
																			<label class="fw-bold fs-1">
																				<span><?php echo $arr['paidamt'][$i];?></span>
																			</label>
																		</td>
																		<td>
																			<label class="fw-bold fs-1">
																				<span><?php echo $arr['balance'][$i];?></span>
																			</label>
																		</td>
																	</tr>
																<?php $i++; } ?>
												...
												<div class="col-lg-4">
													<div class="row">
														<label class="col-lg-6 fw-bold mt-2" style="font-size: 28px !important;">Net Payable</label>
														<label class="col-lg-6 fw-bold mt-2" style="font-size: 28px !important;"><?php if(isset($redemp['NETPAYABLE'])){ echo $redemp['NETPAYABLE']; } else{ echo '0'; } ?></label>
														<label class="col-lg-6 fw-bold mt-2" style="font-size: 28px !important;">Purchase Amt</label>
														<label class="col-lg-6 fw-bold mt-2" style="font-size: 28px !important;"><?php if(isset($redemp['SELLINGAMOUNT'])){ echo $redemp['SELLINGAMOUNT']; } else{ echo '0'; } ?></label>
														<label class="col-lg-6 fw-bold mt-2" style="font-size: 28px !important;">Balance Amt</label>
														<label class="col-lg-6 fw-bold mt-2" style="font-size: 28px !important;"><?php echo $redemp['NETPAYABLE']-$redemp['SELLINGAMOUNT']; ?></label>
		...
		var bill_no= $("#bill_no").val();
			$.ajax({
						type: "POST",
						url: baseurl+'redemption/sd_sale_view',
						async: false,
						type: "POST",
						...
						{	
							...
							$('#tbody_paid_history').append(response);
						}
					});
					</script>
					<script>
