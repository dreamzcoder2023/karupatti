					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="row">
							<div class="col-lg-8">
								<div class="row">
									<?php 
										//print_r($loan_details[0]['ENDATE']);exit;
									?>
									<label class="col-lg-2 col-form-label fw-semibold fs-6">Date</label>
									<label class="col-lg-4 col-form-label fw-bold fs-5"><?php echo $loan_details[0]['ENDATE']; ?></label>
									<label class="col-lg-2 col-form-label fw-semibold fs-6">Loan No</label>
									<label class="col-lg-4 col-form-label fw-bold fs-5"><?php echo $loan_details[0]['BILLNO']; ?><input type="hidden" name="sel_ple_bill_no" id="sel_ple_bill_no"></label>
									<label class="col-lg-2 col-form-label fw-semibold fs-6">Company</label>
									<label class="col-lg-10 col-form-label fw-bold fs-5"><?php 
									$clist=$this->db->query("select * from COMPANY where COMPANYCODE='".$loan_details[0]['COMPANYCODE']."'")->row();
									echo $clist->COMPANYNAME; ?></label>
									<label class="col-lg-2 col-form-label fw-semibold fs-6">Party</label>
									<label class="col-lg-10 col-form-label fw-bold fs-5"><?php echo $loan_details[0]['NAME']; ?></label>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="row">
									<div class="col-lg-6 fv-row mt-2">
										<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(<?php echo base_url();?>assets/images/Party.jpg)">
											<?php
											$plist=$this->db->query("select * from PARTIES where PID='".$loan_details[0]['PID']."'")->row();
