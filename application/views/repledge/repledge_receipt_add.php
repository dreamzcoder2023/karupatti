	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<div class="row">
												...
												<div class="col-lg-2 fv-row">
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="false" id="selectcompany">
												...
												<div class="col-lg-4">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 1px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															...
															<label class="col-lg-9 col-form-label fw-bold fs-5" id="totintamount" name="totintamount">0.00</label>
												...
												<div class="col-lg-4">
													<div class="px-4" style="border-radius: 10px;padding-bottom: 23px;box-shadow: 0 5px 10px #00002947;">
														<div class="row">
															...
															<div class="col-lg-6">
																<input type="text" class="form-control form-control-lg form-control-solid" id="principalamt" name="principalamt" placeholder="Enter Principal" value="0.00" onKeyPress="principalValueKeyPress()" onKeyUp="principalValueKeyPress()">
																<div class="fv-plugins-message-container invalid-feedback"></div>
															</div>
														</div>
														<div class="row">
															...
															<div class="col-lg-6">
																<input type="text" class="form-control form-control-lg form-control-solid" id="interstamtval" name="interstamtval"  placeholder="Enter Interest" value="0.00" onKeyPress="principalValueKeyPress()" onKeyUp="principalValueKeyPress()">
																<div class="fv-plugins-message-container invalid-feedback"></div>
															</div>
														</div>
														<div class="row mt-12">
															<div class="col-lg-10 d-flex justify-content-center align-items-center">
																...
																<label class="col-form-label fw-bold fs-2" id="totalprincipalcal">0.oo</label>
											...
											<div class="row mt-4">
												...
												<table id="rp_rcpt_entry_table" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 ">
													...
													<tbody class="text-gray-600 fw-semibold" id="testmodel">
											...
											<div class="d-flex justify-content-end mt-6">
												...
												<button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#save_repledge">Save Changes</button>
											</div>
										</div>
										<!--end::Card body-->
									</div>
			...
			<div class="modal-dialog modal-m">
				...
				<div class="modal-content rounded">
					<div class="swal2-icon swal2-warning swal2-icon-show" style="display: flex;">
						...
						<div class="swal2-html-container" id="swal2-html-container" style="display: block;">Are you sure you want to Repledge Receipt?</div>
						<div class="d-flex flex-center flex-row-fluid pt-12">
							<button type="submit" class="btn btn-primary me-3" data-bs-dismiss="modal" onclick="saverepledgereceipt();">Yes</button>
		...
		<script>
			...
			function principalValueKeyPress() {
				...
				$('#finaltotalval').val(parseFloat(principalamtval) + parseFloat(interstamtvaldata));
			}
			...
			function savafunction()
			{
				...
				totalweightval  = $('#totalweightval').val();
				
				if(loanamtvalue != paidamtval)
				{
					statusactive = '1';
				...
				formData.append('totalweightval', totalweightval);
  			...
  			function getrepledgedata($billno)
			{
				...
				$.ajax(
				{
					...
					{
						var returnedData = JSON.parse(response);
						console.log(returnedData.repledge_data);
						if(returnedData.return_code == 0)
						{
							//console.log(returnedData.loan_data[0].LOANDATE);
							$("#loandate").html(returnedData.loan_data[0].LOANDATE);
							...
							$("#loandateval").val(returnedData.loan_data[0].LOANDATE);
							...
							if(returnedData.repledgetotalpayamt !="")
							{
								...
								$("#paidamt").html(returnedData.repledgetotalpayamt[0].TOTALPAY);
								$("#paidamtval").val(returnedData.repledgetotalpayamt[0].TOTALPAY);
							...
							var totweightval = 0;
							// The HTML table.
							var tbl = document.querySelector('#rp_rcpt_entry_table');
							...
							var template = function template(d,index) 
							{
								...
								+ '</td>'
								+'<td class="classfontwight">' 
								+ '<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-model="#view_pledge_info"><i class="fas fa-eye fs-4"></i></a>' 
								+ '</td>'
								+ '</tr>';
							};
							...
							$('#totalqtyval').html(totqryval);
							$('#totalweightval').html(totweightval);
							$('#totalamtvalue').html(totalamtval);
