						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Repledge Return List
									<!--begin::Separator-->
											...
											<div class="row">
												...
												<div class="col-lg-4">
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<form action="<?php echo base_url();?>repledge/repledge_return" method="POST" >
															<div class="px-7 py-5" data-kt-user-table-filter="form">
																<div class="mb-2" style="display:none;">
																	<label class="form-label fs-6 fw-semibold">Company</label>
																	<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true" name="company_filter" id="company_filter"data-allow-clear="true" multiple="multiple" style="display:none;">	
																...
																<div class="mb-2" style="display:none;">
																	...
																	id="receipttypefilter" name="receipttypefilter"  data-allow-clear="true" multiple="multiple">	
																		<option value="all" selected>All</option>
																...
																<div class="mb-2" style="display:none;">
																	...
																	<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true" id="banknamefilter" name="banknamefilter" data-allow-clear="true" multiple="multiple">	
																		<option value="all" selected>All</option>
																...
																<div class="mb-2">
																	...
																	id="dt_fill_loan_list"  name ="dt_fill_loan_list" onchange="date_fill_loan_list();">	
														...
														<button type="button" class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-3" data-bs-toggle="modal" data-bs-target="#" style="display:none;">
															Export</button>
														<a href="<?php echo base_url();?>repledge/rp_return_add" target="_blank">
											...
											<table id="kt_datatable_responsive" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
												...
												<tbody class="text-gray-600 fw-semibold">
												    <?php 
													    ...
													    foreach($repledge_returndata as $returnlist)
													    { 
															if($returnlist['CLOSING_TYPE'] ='NORMAL')
															{
																$label = '<label class="col-form-label fw-semibold fs-7" name="" id="">
																<span style="background-color:#ffc700;border-radius: 8px;padding: 5px 15px 5px 15px;">Normal</span>
																</label>';
															}
															else
															{
																$label = '<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="background-color:#b0dfff;border-radius: 8px;padding: 5px 15px 5px 15px;">Transfer</span></label>';

															}
													?>
															<tr>
																<td class="ple1"><?php echo $returnlist['ENDATE']; ?></td>
																<td class="ple1"><?php echo $returnlist['COMPANYNAME']; ?></td>
																<td class="ple1" ><?php echo $returnlist['RP_BILLNO']; ?>&nbsp;<i class="fa fa-copy" style="    font-size: 14px;cursor: pointer;" onclick="myFunction('<?php echo  $returnlist['RP_BILLNO'];?>');"></i>
															&nbsp;<div id="copied-success" class="copied" ><span  style="display:none;">Copied !</span></div></span><span ></td>
																<td class="ple1"><?php echo $returnlist['BANK']; ?></td>
																<td class="ple1"><?php echo $returnlist['BANKNO']; ?></td>
																<td><?php echo $returnlist['BANKNO']; ?></td>
																<td><?php echo $returnlist['NETWEIGHT']; ?> </td>
																<td><?php echo $returnlist['LOANAMOUNT']; ?> </td>
																<td><?php echo $returnlist['INTEREST']; ?> </td>
																<td>
																	<?php echo $label; ?>
																</td>
																<td>
																<span class="text-end">
																	<?php  $rno=str_replace('/', '_', $returnlist['RP_BILLNO']); 
																		//print_r($rno);exit;
																	
																	?>
																
																	<a href="<?php echo base_url();?>repledge/rp_return_view/<?php echo $rno;?>" target="_blank" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
