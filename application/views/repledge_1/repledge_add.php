   ...
   background-color: #ec9629;
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<div class="row">
												...
												<div class="col-lg-2 fv-row">
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="company" id="company">
												...
												<div class="col-lg-2 fv-row">
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="type" id="type">
												...
												<div class="col-lg-2 fv-row">
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="bank_name" id="bank_name">
											...
											<div class="row mt-2">
												...
												<div class="col-lg-1">
													<button type="button" class="btn btn-sm btn-primary" onclick="return pledge_view()">Add</button>
												</div>
											...
											<div class="row">
												...
												<div class="col-lg-2">
													<input type="text" name="add_amount_repledge" class="form-control form-control-lg form-control-solid" placeholder="Amount" value="0.00" id="add_amount_repledge"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="row">
														...
														<div class="col-lg-3">
															<input type="text" name="add_intpercentage_repledge" class="form-control form-control-lg form-control-solid" placeholder="Interest%"  id="add_intpercentage_repledge_err"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
															<div class="fv-plugins-message-container invalid-feedback"></div>
														</div>
														<label class="col-lg-3 col-form-label required fw-semibold fs-6">Months</label>
														<div class="col-lg-3">
															<input type="text" name="add_months_repledge" class="form-control form-control-lg form-control-solid" placeholder="Months"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="add_months_repledge_err">
															<div class="fv-plugins-message-container invalid-feedback"></div>
														</div>
													</div>
													<div class="row">
														...
														<div class="col-lg-3">
															<input type="text" name="add_iterationmonths_repledge" class="form-control form-control-lg form-control-solid" placeholder="Iteration Months"  id="add_iterationmonths_repledge" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
															<div class="fv-plugins-message-container invalid-feedback" id="add_iterationmonths_repledge_err"></div>
														</div>
														<label class="col-lg-3 col-form-label required fw-semibold fs-6">(+)Int</label>
														<div class="col-lg-3">
															<input type="text" name="add_plusinterest_repledge" class="form-control form-control-lg form-control-solid" placeholder="Plus Int"  id="add_plusinterest_repledge" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
						...
						if(chk==0)
						{
								$.ajax({
									...
									success: function(response)
									{
										...
										{
											$('#err_msg').html('This bill no Already in Bank');
												document.getElementById("pop_up_success").click();

												// alert("This bill no does not exists");
												return false;
										}
										else if(response.trim()=='err1')
										{
	...
	<script >
		function push_selected_pledge()
		{
			...
			for (i=0;i<tbodyRowCount;i++)
			{
					tot_weight+=parseFloat($('#td_pl_weight'+i).text());
					tot_qty+=parseFloat($('#td_pl_qty'+i).text());
					tot_amt+=parseFloat($('#td_loan_amt'+i).text());
			}
