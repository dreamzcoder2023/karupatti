...
<style>
  ...
  .dataTables_scroll thead{
   ...
   background-color: #ec9629;
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										...
										<span>&emsp;<?php if($company_fill==''){ echo "All"; }else{  $company  = $this->db->query("SELECT * FROM COMPANY WHERE ACTIVE='Y' AND COMPANYCODE='". $company_fill."' ")->row();
																			 echo $company->COMPANYNAME?$company->COMPANYNAME:'-';  } ?></span>
									</label>
									<span class="h-20px border-gray-400 border-start ms-3 mx-2"></span>
									<label class="d-flex align-items-center text-primary fw-bold my-1 fs-5">
										<span>Date &emsp;-</span>
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-header1 border-0 pt-6">
											<div class="row">
												<div class="col-lg-8">
													<div class="row">
														<label class="col-lg-3 form-label text-center fs-4 fw-bold">Total Sales</label>
														<label class="col-lg-3 form-label text-center fs-4 fw-bold">Total Weight(gms)</label>
														<label class="col-lg-3 form-label text-center fs-4 fw-bold">Total Sales Amount</label>
														<label class="col-lg-3 form-label text-center fs-4 fw-bold">Total Received Amt</label>
													</div>
													<div class="row">
														<label class="col-lg-3 text-success text-center fs-4 fw-bold">
														<?php echo $sales_entry_list1->count1+$sales_entry_list1->count2; ?>
														</label>
														<label class="col-lg-3 text-success text-center fs-4 fw-bold"><?php echo $sales_entry_list1->weight1+$sales_entry_list1->weight2;  ?></label>
														<label class="col-lg-3 text-success text-center fs-4 fw-bold"><?php echo number_format($sales_entry_list1->sales?$sales_entry_list1->sales:0,2,'.',','); ?></label>
														<label class="col-lg-3 text-success text-center fs-4 fw-bold"><?php echo number_format($sales_entry_list1->paid1?$sales_entry_list1->paid1:0,2,'.',','); ?> </label>
													</div>
												</div>
												<div class="col-lg-4">
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
															...
															<form method="POST" action="<?php echo base_url(); ?>Sales_entry">	
											...
											<table  class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="sale_entry_table">
												<thead>
												   <tr class="text-start text-muted fw-bold fs-7 gs-0">
													...
													<th class="min-w-80px">Bill type</th>
												...
												<?php $i=1; foreach($sales_entry_list as $slist){  ?>
													<tr>
														...
														<td class="ple1">
																	...
																	<?php	if(isset($party_detail->RATING))if($party_detail->RATING==1){ ?>
										              ...
										              <?php } ?>
																	<span class="align-items-center"><?php echo $party_detail?$party_detail->NAME:'-'; ?></span>
														</td>
														<td class="ple1"><?php 
														...
														?></td>
														<td class="ple1"><?php foreach($sales_detail as $Slist){
														...
														<td><?php echo number_format($slist['paid_amount']?$slist['paid_amount']:0,2,'.',','); ?></td>
														<td><?php echo number_format($slist['balance_amount']?$slist['balance_amount']:0,2,'.',','); ?></td>
														<td>
														<?php 
														if($slist['balance_amount']>0){
															echo '<label class="col-form-label fw-semibold fs-7"><span style="background-color:#46dcf9;border-radius: 8px;padding: 5px 15px 5px 15px;" data-bs-toggle="modal"  data-bs-target="#kt_modal_update_tag_entry_view"  >Credit Bill</span></label>';
														}
														else{
															echo '<label class="col-form-label fw-semibold fs-7"><span style="background-color:#50cd89;border-radius: 8px;padding: 5px 15px 5px 15px;">Cash Bill</span></label>';
														}
														?>
														</td>
														<td>
	...
	<div class="modal fade" id="kt_modal_view_sales_entry" tabindex="-1" aria-hidden="true"></div>
	...
	$(document).ready(function() {
        ...
        $(".move_to").on("click", function () {
			value=$(this).val();
			// alert(value);
            $('#filter_form').attr('action', "<?php echo base_url(); ?>Sales_entry?page="+value);
            $("#filter_form").submit();
            e.preventDefault();
        });
    });
		...
		<script>
		function sales_entry_view(val)
			{
				var baseurl= $("#baseurl").val();
				//alert(1);
				$.ajax({
				type: "POST",
				url: baseurl+'Sales_entry/sales_entry_view',
				async: false,
				type: "POST",
				data: "id="+val,
				dataType: "html",
				...
				$('#kt_modal_view_sales_entry').empty().append(response);
				$('#kt_modal_view_sales_entry').addClass('show');
			...
			{
				var baseurl= $("#baseurl").val();
				$('#kt_modal_view_sales_entry').removeClass('show');
				//$("#kt_modal_update_role").css("display", "none");
				$('.modal-backdrop').removeClass('show');
				window.location.href = baseurl+'sales_entry';
			}
