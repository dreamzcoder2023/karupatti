...
<!--begin::Card body-->
										<div class="card-body py-4">
													...
													<div class="row">
														...
														<div class="col-lg-4 fv-row">
															<div class="d-flex align-items-center">
																...
																<!--end::Svg Icon-->
																<input class="form-control form-control-solid ps-12"  name="date" placeholder="Date" id="date" value="<?php echo date('d-m-Y'); ?>" readonly  />
															</div>
														</div>
														...
														<option value="<?php echo $company_list['COMPANYCODE'] ;?>"><?php echo $company_list['COMPANYNAME'];?></option><?php
															...
															<label class="col-lg-5 col-form-label fw-bold fs-6" id="lbl_mem_card_no"><i class="fa fa-address-card fs-6" aria-hidden="true" title="Card No"></i>&emsp;<span id="membership_card_no" name="membership_card_no">xxxx-xxxx-xxxx-xxxx</span>
														...
														<label class="col-lg-3 col-form-label fw-bold fs-6" name="card_type" id="card_type" ><span style="background-color:#FFAA00;border-radius: 8px;padding: 5px 15px 5px 15px;">Gold</span></label>
											            ...
											            <div class="accordion-body">
											           	  <table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable" id="add_salesentry_table">
																...
																<tr>
														    		<!-- <td><?php //echo $i+1; ?></td> -->
														            <td>
														            	<select class="form-select form-select-solid fs-7" data-width="130px" data-control="select2" data-hide-search="false" name="tag_no[]" id="tag_no<?php echo $i; ?>" onchange="get_tag_detail(<?php echo $i; ?>);">	
																			<option value="">Select</option>
															        ...
															        <td class="ple1">
																		...
																		<input type="hidden" name="pure_gold_rate" id="pure_gold_rate" value="<?php echo $current_rate->GOLDRATE; ?>">
												                    	<input type="hidden" name="pure_silver_rate" id="pure_silver_rate" value="<?php echo $current_rate->SILVERRATE; ?>">
																	</td>
															        <td class="ple1">
															        	<input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="" name="subitem1[]" id="subitem1<?php echo $i ?>" readonly>
															        </td>
																	...
																	<input type="hidden" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="" name="item[]" id="item<?php echo $i ?>" >
															            ...
															            <td><input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0" name="quality1[]" id="quality1<?php echo $i ?>"  readonly></td>
																		<td><input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0" name="purity[]" id="purity<?php echo $i ?>" readonly></td>
															            <td><input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0" name="weight[]" id="weight<?php echo $i ?>" readonly></td>
																		<td><input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0" name="st_wgt[]" id="st_wgt<?php echo $i ?>" readonly></td>
																		<td><input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0" name="net_wgt[]" id="net_wgt<?php echo $i ?>" readonly></td>
															            <td>
															            	<input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0" name="hc_amt[]" id="hc_amt<?php echo $i ?>" readonly>
															            </td>
																		<td>
															            	<input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0" name="mc_amt[]" id="mc_amt<?php echo $i ?>" readonly>
															            </td>
																		<td>
															            	<input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0" name="wc_amt[]" id="wc_amt<?php echo $i ?>" onkeyup="sales_total()">
															            </td>
																		<td>
															            	<input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0" name="metal_weight[]" id="metal_weight<?php echo $i ?>" readonly>
															            </td>
															            <td><input type="text" class="form-control_tex form-control-lg_tex form-control-solid fs-7" value="0.00" name="sales_amt[]" id="sales_amt<?php echo $i ?>" onkeyup="sales_total()" readonly></td>
															    	</tr>
																	<?php } ?>
											...
											<div class="accordion" id="kt_accordion_non_tagged_item_list_view">
											    <div class="accordion-item">
											        <h2 class="accordion-header" id="kt_accordion_non_tagged_item_list_view_header_1">
											            <button class="accordion-button fw-bold fs-6 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#kt_accordion_non_tagged_item_list_view_body_1" aria-expanded="false" aria-controls="kt_accordion_non_tagged_item_list_view_body_1">
											            Non Tagged Item &emsp; - &emsp; Count &emsp;<span id="nt_count"> 0</span> &emsp; - &emsp; Total Amount &emsp;<span id="nt_tot_amt"> 0.00</span>
														<input type="hidden" name="nt_count1" id="nt_count1">
														<input type="hidden" name="nt_tot_amt1" id="nt_tot_amt1">
											            </button>
											        </h2>
											        <div id="kt_accordion_non_tagged_item_list_view_body_1" class="accordion-collapse collapse" aria-labelledby="kt_accordion_non_tagged_item_list_view_header_1" data-bs-parent="#kt_accordion_non_tagged_item_list_view">
											            <div class="accordion-body">
											           	  	<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable" id="add_salesentry_nontag_table">
															    <thead>
															    	<tr class="text-start text-muted fw-bold fs-7 gs-0">
															            <!-- <th class="min-w-25px">Sno</th> -->
																...
																<?php  for($i=0;$i<10;$i++){  ?> 
															    	<tr>
															    		<!-- <td> <?php// echo $i+1; ?></td> -->
																		<td> 
																		<select data-width="100px" class="form-select form-select-solid fs-7" data-control="select2" data-hide-search="false" id="nt_item_type<?php echo $i; ?>" name="nt_item_type[]" onchange="get_item_nt(<?php echo $i; ?>)">	
																			<option value="">Select</option>
														...
														<option value="<?php echo $mtlist['jewel_type_id'] ;?>"><?php echo $mtlist['jewel_type'];?></option><?php
															    		...
															    		<td>
															            	<select  data-width="180px" class="form-select form-select-solid fs-7" data-control="select2" data-hide-search="false" id="nt_item<?php echo $i; ?>" name="nt_item[]" onchange="get_subitem_nt(<?php echo $i; ?>)" >	
																				<option value="">Select</option>
																	...
																	<?php } ?>
																		...
																		<td>
																		<select  data-width="150px"  class="form-select form-select-solid fs-7" data-control="select2" data-hide-search="false" id="nt_subitem<?php echo $i; ?>" name="nt_subitem[]">	
																				<option value="">Select</option>
															            ...
															            <td>
																			...
																			<select  data-width="100px"  class="form-select form-select-solid fs-7" data-control="select2" data-hide-search="false" id="nt_quality<?php echo $i; ?>" name="nt_quality[]"  onchange="nt_item_purity(<?php echo $i;?>);">	
																	<option value="">Select</option>
											            ...
											            <div class="accordion-body">
											           	  <table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable" id="add_oldjewel_entry_table">
																...
																<tr>
															    		<!-- <td><?php// echo $j+1;?> </td> -->
															            <td>
															            	<select  data-width="100px" class="form-select form-select-solid fs-7" data-control="select2" data-hide-search="false" id="oge_item_type<?php echo $j; ?>" name="oge_item_type[]" onchange="get_item_old(<?php echo $j; ?>)">	
																			<option value="">Select</option>
														<?php foreach($metal_type_list as $mtlist)
														{?>
														<option value="<?php echo $mtlist['jewel_type_id'] ;?>"><?php echo $mtlist['jewel_type'];?></option><?php
															            ...
															            <td>
															            	<select  data-width="190px" class="form-select form-select-solid fs-7" data-control="select2" data-hide-search="false" id="oge_item<?php echo $j; ?>" name="oge_item[]" >	
																				<option value="">Select</option>
															            ...
															            <td>
															            	...
															            	<select  data-width="100px" class="form-select form-select-solid fs-7" data-control="select2" data-hide-search="false" id="oge_quality<?php echo $j; ?>" name="oge_quality[]" onchange="item_purity(<?php echo $j;?>);">	
																				<option value="">Select</option>
																				<?php foreach($purity_list as $plist){   ?>			
																					<option value="<?php echo $plist['ITEMPURITYID'];  ?>"><?php echo $plist['ITEMPURITYNAME'] ; ?></option>
																					<?php  } ?>
											...
											<div class="row">
												...
												<div class="col-lg-3">
													<label class="form-check form-check-inline form-check-solid is-invalid py-5">
														...
														<span class="m-form__help text-danger" id="credit_balance_err"></span>
														</label>
												</div>
												<div class="row">
...
var net_pay_amt_ind = final_pay.toLocaleString('en-IN', {
				    	maximumFractionDigits: 2,
					    style: 'currency',
					    currency: 'INR'
					});
 $('#net_payable').html(net_pay_amt_ind);
...
var metal_weight=parseFloat(net_weight)+parseFloat(net_weight)*parseFloat(wc)/100;
 ...
 $('#nt_amount'+i).val(parseFloat(nt_amount).toFixed(2));
var nt_count=0;
var nt_tot_amt=0;
 for(j=0;j<10;j++){
...
// alert(nt_count);
$('#nt_count').html(parseFloat(nt_count));
$('#nt_tot_amt').html(parseFloat(nt_tot_amt).toFixed(3));
$('#nt_count1').val(parseFloat(nt_count));
...
var gold_amt=0; var silver_amt=0;
	 	for( var i=0;i<20;i++){
			...
			if(aid=='1' || aid=='2' ){
				if(aid=='1'){
gold++;
gold_weight=parseFloat(gold_weight)+parseFloat(weight);
gold_amt=parseFloat(gold_amt)+parseFloat(amount);

				}
				else{
silver++;
silver_weight=parseFloat(silver_weight)+parseFloat(weight);
silver_amt=parseFloat(silver_amt)+parseFloat(amount);
				}
		j++;
			}
	 }
	 
	 $('#sales_total1').html((parseFloat(gold_amt)+parseFloat(silver_amt)).toFixed(2));
	 for( var i=0;i<10;i++){
...
silver_amt=parseFloat(silver_amt)+parseFloat(amount);
	...
	$('#sales_total').html(parseFloat(gold_amt)+parseFloat(silver_amt));
	...
	$('#sales_gold_amount').html(parseFloat(gold_amt));
	$('#sales_silver_amount').html(parseFloat(silver_amt));
	...
	$('#sales_gold_amount_1').val(parseFloat(gold_amt));
	$('#sales_silver_amount_1').val(parseFloat(silver_amt));

	var total=0;var total1=0;var total2=0;
		for( var i=0;i<20;i++){
			var aid = $('#sales_amt'+i).val();
			
total=parseFloat(total)+parseFloat(aid);

		}
		$('#sales_total1').html(total.toFixed(2));
		for( var i=0;i<10;i++){
		
		var aid1 = $('#oge_est_amount'+i).val();
			var aid2 = $('#nt_amount'+i).val();
			total1=parseFloat(total1)+parseFloat(aid1);
total=parseFloat(total)+parseFloat(aid2);
	}
	// alert(total);
...
var netpay=parseFloat(total)-parseFloat(total1)+parseFloat(total2);
...
$('#nt_count').html(parseFloat(nt_count));
$('#nt_tot_amt').html(parseFloat(nt_tot_amt).toFixed(3));
$('#nt_count1').html(parseFloat(nt_count));
...
silver_amt=parseFloat(silver_amt)+parseFloat(amount);
	...
	$('#sales_item_count').html(j);
	// $('#sales_total1').html(parseFloat(gold_amt)+parseFloat(silver_amt));
	$('#sales_total').html(parseFloat(gold_amt)+parseFloat(silver_amt));
	$('#sales_gold_count').html(gold);
	$('#sales_silver_count').html(silver);
	$('#sales_gold_weight').html(gold_weight);
...
function oge_net_weight(i){
	...
	var current_gold_rate = $('#pure_gold_rate').val();
        var current_silver_rate = $('#pure_silver_rate').val();
...
for(i=0;i<10;i++){
	...
	if(aid!=''){
				if(aid=='1'){
					$('#oge_est_amount'+i).val((parseFloat(net_weight)*parseFloat(current_gold_rate)*parseFloat(purity/100)).toFixed(2));	
					oge_gold_amount+=parseFloat(net_weight)*parseFloat(current_gold_rate)*parseFloat(purity/100);
					oge_gold_weight+=parseFloat(net_weight);
				}
				else{
					$('#oge_est_amount'+i).val((parseFloat(net_weight)*parseFloat(current_silver_rate)*parseFloat(purity/100)).toFixed(2));	
					oge_silver_amount+=parseFloat(net_weight)*parseFloat(current_silver_rate)*parseFloat(purity/100);
					oge_silver_weight+=parseFloat(net_weight);
				}
		
			}
		}
		$('#oge_total1').html(((parseFloat(oge_gold_amount)+parseFloat(oge_silver_amount))).toFixed(2));
...
total=parseFloat(total)+parseFloat(aid);
	...
	for( var i=0;i<10;i++){
		...
		var aid1 = $('#oge_est_amount'+i).val();
			var aid2 = $('#nt_amount'+i).val();
			total1=parseFloat(total1)+parseFloat(aid1);
total2=parseFloat(total2)+parseFloat(aid2);
	}
		$('#oge_total').html(total1.toFixed(2));
		var current_amt = total1.toLocaleString('en-IN', {
				    	maximumFractionDigits: 2,
					    style: 'currency',
					    currency: 'INR'
					});
		$('#oge_total1').html(current_amt);
		// $('#oge_total1').html(total1.toFixed(2));
		$('#oge_total_1').val(total1.toFixed(2));
...
$('#net_payable').html(final_pay);
       ...
       function salesentry_validation(){
		   ...
		   var balance_amount = $('#balance_amount_1').val();
		   if ($("#credit_balance").is(":checked")) {
				if(balance_amount<=0){
					$('#credit_balance_err').html('Credit balance is checked!');
					err++;
				}
				else{
					$('#credit_balance_err').html('');
				}
			} else {
				if(balance_amount>0){
					$('#credit_balance_err').html('Credit balance is not checked!');
					err++;
				}
				else{
					$('#credit_balance_err').html('');
...
var j=0;var gold_tot=0; var silver_tot=0;
	 	for( var i=0;i<10;i++){
			...
			if(aid!=''){
				if(aid=='1'){
gold_tot=parseFloat(gold_tot)+parseFloat(oge_amount);
				}
				else{
					silver_tot=parseFloat(silver_tot)+parseFloat(oge_amount);
				}
		j++;
			}
	 }
...
var j=0;var gold_tot=0; var silver_tot=0;
	 	for( var i=0;i<10;i++){
			...
			if(aid!=''){
				if(aid=='Gold'){
gold_tot=parseFloat(gold_tot)+parseFloat(pge_amount);
				}
				else{
					silver_tot=parseFloat(silver_tot)+parseFloat(pge_amount);
				}
		j++;
			}
	 }
	...
	function pge_weight(){
		...
		var gold_tot=0; var silver_tot=0;
	 	for( var i=0;i<10;i++){
			...
			if(aid!=''){
				if(aid=='Gold'){
gold_tot=parseFloat(gold_tot)+parseFloat(pge_weight);
				}
				else{
					silver_tot=parseFloat(silver_tot)+parseFloat(pge_weight);
				}
	...
	function oge_weight(){
		...
		var gold_tot=0; var silver_tot=0;
	 	for( var i=0;i<10;i++){
			...
			if(aid!=''){
				if(aid=='1'){
gold_tot=parseFloat(gold_tot)+parseFloat(oge_weight);
				}
				else{
					silver_tot=parseFloat(silver_tot)+parseFloat(oge_weight);
				}
...
<script>
	      $("#add_salesentry_table").kendoTooltip({
	        filter: "td",
	        show: function(e){
...
var paid_amt_tot = tot_amt.toLocaleString('en-IN', {
				    	maximumFractionDigits: 2,
					    style: 'currency',
					    currency: 'INR'
					});
 $('#paid_amount').html(paid_amt_tot);

$('#paid_amount_1').val(tot_amt);
var current_amt_bal = bal_amt.toLocaleString('en-IN', {
				    	maximumFractionDigits: 2,
					    style: 'currency',
					    currency: 'INR'
					});
$('#balance_amount').html(current_amt_bal);
