							...
							<div class="row gy-5 g-xl-8">
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<form action="<?php echo base_url(); ?>Sales_order/sales_order_tagged/<?php echo $sales_order->id; ?>" method="POST"  enctype="multipart/form-data" >
											<div class="row">
											            ...
											            <div class="accordion-body">
											           	  <table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-2 gs-2 dataTable" id="add_salesentry_table">
																		...
																		foreach($sales_order_tagged as $slist){ ?>
																	    	<tr>
																	    		<td><?php echo $i; ?><input  type="hidden" name="tag_row_id[]" id=""  value="<?php echo $slist['id']; ?>"></td>
...
if(@getimagesize($image_url)){  ?>
															            ...
															            <td><select class="form-select form-select-solid fs-7" data-control="select2" data-hide-search="false" name="tag_no[]" id="tag_no<?php echo $i; ?>" onchange="get_tag_detail(<?php echo $i; ?>);">	
															            ...
															            <td>	<input type="text" class="form-control form-control-lg form-control-solid fs-7" name="metal_weight_tag[]" id="metal_weight_tag<?php echo $i; ?>" value="0" ></td>
															            <td><input type="text" class="form-control form-control-lg form-control-solid fs-7" name="sales_amt_tag[]" id="sales_amt_tag<?php echo $i; ?>" value="0" ></td>
																	    	</tr>
																			<?php $tag_no++; $i++; } ?>
																	    </tbody>
																		</table>
											...
											<!--	<button type="reset" class="btn btn-secondary me-3" data-bs-dismiss="modal">Cancel</button>-->
												<button type="submit" class="btn btn-primary" id="">Tagged</button>
											</div>
											<!--end::Actions-->
										</div>
										<!--end::Card body-->
...
function get_tag_detail(val){
	...
	$('#metal_weight_tag'+val).val(res[14]);
...
$('#sales_amt_tag'+val).val(parseFloat(amt).toFixed(2));
	}
});
}
</script>
