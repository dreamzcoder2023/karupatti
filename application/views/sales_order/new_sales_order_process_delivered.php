							...
							<div class="row gy-5 g-xl-8">
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<form action="<?php echo base_url(); ?>Sales_order/sales_order_delivered/<?php echo $sales_order->id; ?>" method="POST"  enctype="multipart/form-data" >
											<div class="row">
...
if(@getimagesize($image_url)){  ?>
															            ...
															            <td>
																		<?php $tag_img=$this->db->query("SELECT * FROM tag_entry WHERE tag_id='".$slist['tag_id']."'")  ?>
															            <div class="image-input mt-2" data-kt-image-input="true">
											...
											<!--	<button type="reset" class="btn btn-secondary me-3" data-bs-dismiss="modal">Cancel</button>-->
												<button type="submit" class="btn btn-primary" id="">Delivered</button>
											</div>
											<!--end::Actions-->
										</div>
										<!--end::Card body-->
