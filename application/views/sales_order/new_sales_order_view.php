											            ...
											            <div class="accordion-body">
											           	  <table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-2 gs-2 dataTable" id="add_salesentry_table">
																	    <thead>
																			...
																			<?php if($sales_order->status=='D' || $sales_order->status=='T' ){ ?>
																		...
																		<?php $i=1; foreach($sales_order_tagged as $slist){ ?>
																	    	<tr>
																			<td><?php echo $i; ?></td>
...
if(@getimagesize($image_url)){  ?>
																		...
																		<?php if($sales_order->status=='D' || $sales_order->status=='T' ){ ?>
															            <td>
															            <?php $tag_img=$this->db->query("SELECT * FROM tag_entry WHERE tag_id='".$slist['tag_id']."'")->row();  ?>
																		<div class="image-input mt-2" data-kt-image-input="true">
								<?php 											$image_url =  base_url().'tag_img/'.$tag_img->img; 
if(@getimagesize($image_url)){  ?>
																							<div class="image-input-wrapper w-40px h-40px" style="background-image: url(<?php echo base_url(); ?>tag_img/<?php echo $tag_img->img; ?>)"></div>
																							<!--end::Preview existing avatar-->
																					<?php }  else {   ?>
																		...
																		<!--<div class="image-input mt-2" data-kt-image-input="true">
																							<div class="image-input-wrapper w-40px h-40px" style="background-image: url(tag_img/<?php echo $tag_img->img; ?>)"></div>
															            ...
															            <td><?php echo $slist['tag_id']; ?></td>
															            <td><?php echo $slist['tag_weight']; ?></td>
															            <td><?php echo $slist['tag_amount']; ?></td>
																		<?php } ?>
																	    	</tr>
																			<?php } ?>
																	    </tbody>
											...
											<div class="d-flex justify-content-center">
												...
												<label class="col-form-label fw-bold fs-1">&emsp;<?php echo $sales_order->total_amount; ?></label>
											</div>
											<div class="row">
												...
												<label class="col-form-label fw-bold fs-2" id="total_amount_ad" name="total_amount_ad"><?php echo $sales_order->discount; ?></label>
													<div class="fv-plugins-message-container invalid-feedback"></div>
												</div>
												<div class="col-lg-4 text-center">
													<label class="col-form-label fw-bold fs-2">Total Amount &emsp;</label>
													<label class="col-form-label fw-bold fs-2" id="total_amount_ad" name="total_amount_ad"><?php  echo $sales_order->net_payable; ?></label>
												</div>
											...
											if(isset($cash_detail)){ ?>
												...
												<div class="row">
												<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cheque_lt_ey_label">RTGS</label>
													...
													<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cheque_lt_ey_label">RTGS no</label>
												...
												if(isset($upi_detail)){ ?>
												<div class="row">
												<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cheque_lt_ey_label">UPI</label>
													<label class="col-lg-2 col-form-label fw-bold fs-4"><?php echo $upi_detail->amount; ?></label>
													
													<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cheque_lt_ey_label">UPI no</label>
												...
												<?php } ?>
												<?php $mp_detail=$this->db->query("SELECT * FROM payment_inward_outward WHERE bill_no='".$sales_order->sales_order_id."' AND type_of_payment='Membership Points' ")->row();
												if(isset($mp_detail)){ ?>
												<div class="row">
												<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cheque_lt_ey_label">Membership Points</label>
													<label class="col-lg-2 col-form-label fw-bold fs-4"><?php echo $mp_detail->amount; ?></label>
													
													
													<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cheque_lt_ey_label">Details</label>
													<label class="col-lg-2 col-form-label fw-bold fs-4"><?php echo $mp_detail->remarks; ?></label>
												</div>
												<?php } ?>
											<div class="row">
