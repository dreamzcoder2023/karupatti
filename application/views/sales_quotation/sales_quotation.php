...
<style>
							...
							<div class="row gy-5 g-xl-8">
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<form method="POST" id="fill_form" action="<?php echo base_url(); ?>Sales_quotation">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="row">
															...
															<div class="col-lg-6">
																...
																<div class="text-center">
																	<label class="text-success fs-2 fw-bold"><?php echo $convert_sale_count; ?>  </label>
																</div>
															</div>
													...
													<div class="col-lg-4">
														<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
																...
																<div class="scroll-y mh-300px my-5 px-5" data-kt-user-table-filter="form">
																	<div class="px-2 py-2">
																		<div class="mb-2">
																			...
																			<select class="form-select form-select-solid fw-semibold" data-control="select2" data-hide-search="true" name="company_fill">	
																				<option value="">All</option>
																				
																				<?php  foreach($company_list as $clist) {?>
																					<option value="<?php echo $clist['COMPANYCODE']?>" <?php echo ($clist['COMPANYCODE'] == $company_fill)?'selected':''; ?>><?php echo $clist['COMPANYNAME'];?></option>
																				<?php }?>
																			</select>
																		</div>
																		<div class="mb-2">
																			<label class="form-label fs-6 fw-semibold">Party</label>
																			<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Enter Party Name" >
																		</div>
																		<div class="mb-2">
																			<label class="form-label fs-6 fw-semibold">Suppliers</label>
																			<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Enter Suppliers Name" >
																		</div>
																		<div class="mb-2">
																			<label class="form-label">Date</label>
																			<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" id="dt_fill_sales_list" 
																			name="dt_fill_sales_list"
																			onchange="date_fill_sales_list();">	
																				...
																				<option value="custom_date"  <?php echo $dt_fill =="custom_date" ? "selected":''?>>Custom Date</option>
																			</select>
																		</div>
																		...
																		<div class="mb-2 fv-row" id="from_dt_sales_list" style="display:none;">
																			...
																			<div class="d-flex align-items-center">
																				...
																				<!--end::Svg Icon-->
																				<input class="form-control form-control-solid ps-12" name="" placeholder="From Date" 
																				name="from_date_fillter_sales_list"
																				id="from_date_fillter_sales_list" 
																		...
																		<div class="mb-2 fv-row" id="to_dt_sales_list" style="display:none;">
																			...
																			<div class="d-flex align-items-center">
																				...
																				<!--end::Svg Icon-->
																				<input class="form-control form-control-solid ps-12" name="" placeholder="To Date" 
																				name="to_date_fillter_sales_list" id="to_date_fillter_sales_list" value="<?php echo date("d-m-Y"); ?>"/>
																			</div>
																		</div>
																		<div class="d-flex justify-content-end">
																			<a href="<?php echo base_url(); ?>Sales_quotation"  class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="reset">Reset</a>
															...
															<a href="<?php echo base_url();?>Sales_quotation/add_sales_quotation" target="_blank">
											...
											<div class="card-body py-4">
												...
												<table id="kt_datatable_responsive" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2">
													...
													<tr class="text-start text-muted fw-bold fs-7 gs-0">
														...
														<th class="min-w-80px">Quote ID</th>
														<th class="min-w-100px">Date</th>
														<th class="min-w-175px">Company</th>
															<th class="min-w-150px">Party / Supplier</th>
															<th class="min-w-50px">Count</th>
															<th class="min-w-100px">Est.Amt</th>
													...
													<tbody class="text-gray-600 fw-semibold">
														...
														<?php foreach($sales_quotation_list as $key=> $sql){ ?>
															<tr>
																<td><?php echo $key+1; ?></td>
																<td><?php echo $sql['QUOT_ID']; ?></td>
																<td><?php echo $sql['QUOT_DATE']; ?></td>
																<td class="ple1"><?php echo  $sql['COMPANY_NAME'];  ?></td>
																<td class="ple1">

																	<?php if($sql['PARTY_NAME']){ ?>

																		<span><i class="fa-solid fa-star fs-7" style="color:#50cd89;"></i></span>
																		<span class="align-items-center"><?php echo $sql['PARTY_NAME'];  ?></span>

																	<?php }else{?>

																		<span class="align-items-center"><?php echo $sql['SUPPLIER_NAME'];  ?></span>
																...
																<td class="ple1"><?php echo  $sql['COUNT'];  ?></td>
																<td><?php echo  $sql['EST_AMOUNT'];  ?></td>
																<td>


																<?php if($sql['IS_SALE'] == 'N'){ ?>

																	<label class="col-form-label fw-semibold fs-7" name="" id=""><span style="background-color:#ffc700;border-radius: 8px;padding: 5px 15px 5px 15px;">Quotation</span>
																	</label>
																...
																<td>
																	...
																	<?php if($sql['IS_SALE'] == 'N'){ ?>
																		...
																		<span class="text-end">
																			...
																			<a href="<?php echo base_url(); ?>Sales_quotation/sales_quotation_view/<?php echo $sql['ID']; ?>"  target="_blank" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"  ><i class="bi bi-eye-fill eyc"></i></a>
																			<a href="<?php echo base_url(); ?>Sales_quotation/sales_quotation_edit/<?php echo $sql['ID']; ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" title="Edit">
																			...
																			<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" title="Delete"  data-bs-toggle="modal" data-bs-target="#kt_modal_delete_quotation" onclick="open_delete_popup('<?php echo $sql['ID']; ?>')">
																	...
																	<?php }else{?>
																		...
																		<a href="<?php echo base_url(); ?>Sales_quotation/sales_quotation_view/<?php echo $sql['ID']; ?>"  target="_blank" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"  >
	...
	<div class="modal fade" id="kt_modal_delete_quotation" tabindex="-1" aria-hidden="true">
		<!--begin::Modal dialog-->
		<div class="modal-dialog modal-m">
			<!--begin::Modal content-->
			<div class="modal-content rounded">
				<div class="swal2-icon swal2-warning swal2-icon-show" style="display: flex;">
					...
					<input type="hidden" name="quitation_id" id="quotation_id" />
					<div class="swal2-html-container" id="swal2-html-container" style="display: block;">Are you sure you want to delete?</div>
					<div class="d-flex flex-center flex-row-fluid pt-12">
						<button type="submit" class="btn btn-danger me-3" data-bs-dismiss="modal"  id="quotation_delete" >Yes, delete!</button>
	...
	<!--end::Modal - delete Lot Entry-->
		...
		<script>
			...
			$('#quotation_delete').click(function(){

				var id = $('#quotation_id').val();

				$.ajax({
								type: "POST",
								url: baseurl+'Sales_quotation/sales_quotation_delete',
								async: false,
								type: "POST",
