			...
			<?php $this->load->view("sidebar");?>
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Credit Sales Receipts List
									<!--begin::Separator-->
												...
												<div class="col-lg-8">
													<div class="row">
														<div class="col-lg-6">
															...
															<div class="text-center">
																<label class="text-success fs-2 fw-bold"><?php echo  $sales_receipt_total->total_paid; ?></label>
															</div>
														</div>
													<!--	<div class="col-lg-6">
															<div class="text-center">
															...
															<div class="text-center">
																<label class="text-success fs-2 fw-bold">20000.00</label>
															</div>
														</div>-->
														<!-- <div class="col-lg-3">
															<div class="text-center">
												...
												<div class="col-lg-4">
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
															...
															<form action="<?php echo base_url(); ?>Sales_receipt " method="POST" >
																<div class="mb-2">
																	<label class="form-label fs-6 fw-semibold">Company</label>
																	<select class="form-select form-select-solid fw-semibold" data-control="select2" data-hide-search="true" name="company_id" id="company_id">	
																		<option value="">All</option>
																		<?php foreach($company_list as $clist){ ?>
																			<option value="<?php echo $clist['COMPANYCODE'] ?>" <?php if($clist['COMPANYCODE']==$company_id){ echo "selected"; }  ?>><?php echo $clist['COMPANYNAME'] ?></option>
																		<?php } ?>
														...
														<a href="<?php echo base_url(); ?>Sales_receipt/sales_receipt_entry">
															...
															</span>New  Sales Receipts</button>
														</a>
														<?php }} ?>
													</div>
												</div>
	           ...
	           <?php      } ?>
														...
														<!--<span><i class="fa-solid fa-star fs-7" style="color:#50cd89;"></i></span>-->
															...
															<!--<span><i class="fa-solid fa-star fs-7" style="color:#50cd89;"></i></span>
															<span class="align-items-center"><?php echo $slist['party_id']; ?></span>-->
														</td>
														<td>
												 			<span><i class="fa-solid fa-indian-rupee-sign fs-7 text-dark"></i>&nbsp;<?php $net_amt = $slist['paid_amount']; echo number_format($net_amt,2,'.',',');?>
															</span>
													   </td>
														...
														<td>
															<span class="text-end">
																...
																<a href="<?php echo base_url(); ?>Sales_receipt/sales_receipt_print/<?php echo $slist['id'] ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
$(document).ready(function() {
    ...
    $(".move_to").on("click", function () {
        value=$(this).val();
        // alert(value);
        $('#filter_form').attr('action', "<?php echo base_url(); ?>Sales_receipt?page="+value);
        $("#filter_form").submit();
        e.preventDefault();
    });
});
