						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Staff List
									<!--begin::Separator-->
                        ...
                        <div class="alert alert-danger alert-dismissible" style="display:none;" id="deactive_staff" role="alert">
                            ...
                            Staff has been deactivated successfully
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
											<!--begin::Add user-->
											<a href="<?php echo base_url();?>staff/staff_add" target="_blank">
											...
											<!--end::Svg Icon-->New Staff</button></a>
											<!--end::Add user-->
										</div>
										<!--end::Toolbar-->
										<!--begin::Group actions-->
								...
								<div class="card-body py-4">
									<!--begin::Table-->
									<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="kt_datatable_dom_positioning_stafflist">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
											<tr class="text-start text-muted fw-bold fs-7 gs-0">
												...
												<th class="min-w-125px">Releived Date</th>
										...
										<tbody class="text-gray-600 fw-semibold">
											<!--begin::Table row-->
											<?php $i=1; foreach($staff_list as $stafflist){?>
											<tr>
												<!--begin::User=-->
												<td>
													<!--begin:: Avatar -->
													...
													<!--end::Avatar-->
												<?php echo $stafflist['STAFFNAME'];?>
												</td>
												<!--end::User=-->
												<!--begin::Role=-->
												<td><?php echo $stafflist['DESIGNATION'];?></td>
												<!--end::Role=-->
												<td><?php echo $stafflist['PHONE'];?></td>
												<!--begin::Last login=-->
												<td><?php echo $stafflist['Department'];?>
												</td>
												<!--end::Last login=-->
												<!--begin::Two step=-->
												<td><?php echo $stafflist['JoinedDate'];?></td>
												<!--end::Two step=-->
												<td><?php echo $stafflist['ReleivedDate'];?></td>
												<!--begin::Joined-->
												<td>
													<label class="form-check form-switch form-check-custom form-check-solid">
															<!-- <input class="form-check-input" type="checkbox" value="1" checked="checked"> -->
															<input class="form-check-input w-35px h-20px" type="checkbox" <?php if($stafflist['Status']=='Y'){echo "checked";} ?> id="activeunactive_staff_<?php echo $i;?>" name="activeunactive_staff_<?php echo $i;?>" onchange="activeunactive_staff('<?php echo $stafflist['SNO']; ?>',<?php echo $i;?>)" value="<?php echo $stafflist['Status'];?>">
													</label>
												</td>
												...
												<td>
													<span class="text-end">
													<a href="" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_view_staff" onclick="staff_view('<?php echo $stafflist['SNO']; ?>')">
														<i class="bi bi-eye-fill eyc"></i>
													</a>
													<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_staff" onclick="staff_edit('<?php echo $stafflist['SNO'];?>')">
													...
													<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_staff" onclick="staff_delete('<?php echo $stafflist['SNO'];?>')">
					...
					<div class="modal-content rounded">
						...
						<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
							...
							<div class="row mb-6">
								...
								<!--begin::Select-->
									<select class="form-select form-select-solid" data-control="select2" name="company_list_new"  id="company_list_new" data-hide-search="true" onclick="staffid_inc();">
								...
								<!--end::Col-->
								<!--begin::Label-->
								<label class="col-lg-1 col-form-label required fw-semibold fs-6">Designtn</label>
								<!--end::Label-->
								<!--begin::Col-->
								<div class="col-lg-2 fv-row fv-plugins-icon-container">
								...
								<div class="btn btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-10" id="take_party_photo" onclick="take_staff()" > Take Photo </div>
								<div class="btn btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-10" id="p_snap" onclick="staff_snapshot()" style="display: none;"> Capture </div>
								<textarea hidden="hidden" id="staff_photo_data" name="staff_photo_data"></textarea>
...
function select_permission(id)
{
	...
	$.ajax({
		type:"POST",
		url:baseurl+'staff/fetch_sub_menu_details1',
		data:{'value':res[1]},
		cache: false,
		dataType: "html",
			success: function(result){
				...
				for (i=0;i<count;i++)
				{
					$.ajax({
		type:"POST",
		url:baseurl+'staff/fetch_child_menu_details',
		data:{'value':sm_id[i]},
		cache: false,
		dataType: "html",
			success: function(result){
...
<script>
function select_child_permission(id)
{
	// alert("submenu");
	var baseurl= $("#baseurl").val();
	var menu_id=id;
	...
	if(document.getElementById(id).checked==true)
	{
		...
		$.ajax({
		type:"POST",
		url:baseurl+'staff/select_child_permission',
		data:{'value':res[0]},
		cache: false,
		dataType: "html",
			success: function(result){
				...
				{
					// alert(sm_perm[i]);
					document.getElementById('menuid'+'_'+sm_perm[i]).checked=true;
					document.getElementById('menuid'+'_'+sm_perm[i]).value='1';
				}
