        ...
        <div id="kt_accordion_1_body_1" class="accordion-collapse collapse show" aria-labelledby="kt_accordion_1_header_1" data-bs-parent="#kt_accordion_1" style="overflow: scroll !important;">
			...
			<div class="row">
				<div class="col-lg-3 fv-row fv-plugins-icon-container">
					<div class="form-check">
	                    ...
	                    <input class="form-check-input mt-3" type="checkbox" value="<?php echo (isset($role_per_list)>0)?'1':'0';?>" id="<?php echo 'menuid_'.$mlist['MENU_ID'];?>" name="menu_id[<?php echo $mlist['MENU_ID']; ?>]" <?php echo (isset($role_per_list)>0)?'checked':''; ?> onclick="select_permission(this.id);">
	                    <h4><label class="col-form-label fw-bold fs-5" for="flexCheckChecked" style="">
				...
				<div class="col-lg-1 fv-row fv-plugins-icon-container">
					...
					<input class="form-check-input mt-3" type="checkbox" value="<?php echo (isset($role_per_list)>0)?'1':'0';?>" id="<?php echo $mlist['MENU_ID'].'_'.$permission[$i];?>" name="<?php echo $permission[$i];?>permission[<?php echo $mlist['MENU_ID']; ?>]" <?php echo (isset($role_per_list)>0)?'checked':''; ?>>
	                    <label class="col-form-label fw-semibold fs-6" for="flexCheckChecked" >
				...
				<?php
					...
					else
					{
						...
						<div class="col-lg-1 fv-row fv-plugins-icon-container">
					<!-- <input type="hidden" id="permission" name="permission[]" value="<?php echo $mlist['MENU_ID'];?>"> -->
					<input class="form-check-input mt-3" type="checkbox" value="<?php echo (isset($role_per_list)>0)?'1':'0';?>" id="<?php echo $mlist['MENU_ID'].'_'.$permission[$i];?>" name="<?php echo $permission[$i];?>permission[<?php echo $mlist['MENU_ID']; ?>]" <?php echo (isset($role_per_list)>0)?'checked':''; ?> style="display: none;">
	                    <label class="col-form-label fw-semibold fs-6" for="flexCheckChecked" style="display: none" >
	                        <?php echo $permission[$i];?>
	                    </label>
				</div>		
					<?php }}
			...
			<div class="row">
				<div class="col-lg-3 fv-row fv-plugins-icon-container">
					...
					<input class="form-check-input mt-3" type="checkbox" value="<?php echo (isset($role_per_list)>0)?'1':'0';?>" id="<?php echo 'menuid_'.$smlist['MENU_ID'];?>" name="menu_id[<?php echo $smlist['MENU_ID']; ?>]" <?php echo (isset($role_per_list)>0)?'checked':''; ?> onclick="select_single_permission(this.id);">
	                    <label class="col-form-label fw-semibold fs-5" for="flexCheckChecked">
				...
				<div class="col-lg-1 fv-row fv-plugins-icon-container">
					...
					<input class="form-check-input mt-3" type="checkbox" value="<?php if(isset($role_per_list->VALUE))
