									...
									<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable" id="kt_datatable_dom_positioning">
										...
										<thead>
											...
											<tr class="text-start text-muted fw-bold fs-7  gs-0">
												...
												<th class="min-w-125px" style="width: 30%;" >Item Type</th>
										...
										<tbody class="text-gray-600 fw-semibold">
											...
											<td><?php echo $i; ?> </td>
											<td><?php 
											//echo $sublist['jewel_type_id'];
											$item_type=$this->db->query("SELECT * FROM jewel_type WHERE jewel_type_id='".$sublist['jewel_type_id'] ."' ")->row();
											echo $item_type->jewel_type;?></td>
												<td><?php
												$item=str_pad($sublist['item_id'], 3, '0', STR_PAD_LEFT);
												
												$item_type=$this->db->query("SELECT * FROM ITEMS WHERE SNO='".$item."' ")->row();
												echo $item_type->ITEMNAME;
												//echo $sublist['item_id'];?></td>
			...
			<div class="modal-dialog modal-xl">
				...
				<div class="modal-content rounded">
					...
					<form name="Subitem_add_form" id="Subitem_add_form" method="POST" action="<?php echo base_url(); ?>Subitem/Subitem_save" enctype="multipart/form-data" onsubmit="return new_subitem_validation();">
						...
						<div class="repeater">
								    <div class="row">
									<label class="col-lg-2 col-form-label required fw-semibold fs-6 data-fields" data-parent="question_type" data-sub="">Item Type</label>
										...
										<div class="col-lg-2 data-fields" data-parent="question_type" data-sub="CASH">
											<select class="form-select form-select-solid" data-control="select2" name="itemname_sub"  id="itemname_sub" data-hide-search="true">
												<option value="">Select</option>
													...
													{?>
													<option value="<?php echo $itemnamelist['SNO'];?>"><?php echo $itemnamelist['ITEMNAME'];?></option><?php
													 }?>
											</select>
											<div class="fv-plugins-message-container invalid-feedback" id="itemname_sub_err"></div>
										</div>
...
<script>
	...
	$.ajax({
		type:"POST",
		url:baseurl+'Subitem/Subitem_active',
		data:datastring,
		cache: false,
		dataType: "html",
		success: function(result){
            ...
            setTimeout(function() {
	         window.location = baseurl+"Subitem";
	        }, 3000);
		},
