<?php $this->load->view("common");?>
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Tag Entry
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
				                        ...
				                        <?php } ?>
				                         ...
				                         <div class="alert alert-success alert-dismissible" style="display:none;" id="active_tag" role="alert">
			                            <!-- <button type="button" class="close" data-dismiss="alert" aria-label="Close">
			                            </button> -->
			                           		Tag fixed successfully
			                        	</div>
				                        <div class="alert alert-danger alert-dismissible" style="display:none;" id="deactive_tag" role="alert">
				                            <!-- <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				                            </button> -->
				                            Tag not fixed
				                        </div>
										...
										<form method="POST" action="<?php echo base_url();?>Tagentry" enctype="multipart/form-data">
													<div class="row">
														<!--begin::Col-->
														<div class="col-lg-2 fv-row">
															...
															<div class="d-flex align-items-center">
																...
																<!--end::Svg Icon-->
																<input class="form-control form-control-solid ps-12" name="from_date" placeholder="From Date" id="kt_daterangepicker_lot_entry_from" value="<?php if(isset($_POST['from_date']) && $_POST['from_date']!="") echo ($_POST['from_date']);?>"/>
															</div>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col-lg-2 fv-row">
															...
															<div class="d-flex align-items-center">
																...
																<!--end::Svg Icon-->
																<input class="form-control form-control-solid ps-12" name="to_date" placeholder="To Date" id="kt_daterangepicker_lot_entry_to"  value="<?php if(isset($_POST['to_date']) && $_POST['to_date']!="") echo ($_POST['to_date']);?>" />
														...
														<div class="col-lg-2 fv-row">
															...
															<div class="d-flex align-items-center">
																...
																<select class="form-select form-select-solid" data-control="select2" name="metal_tag"  id="metal_tag" data-hide-search="true">
															<option value="">Select Metal</option>
																	<?php foreach($metal_name as $metalname)
																	{?>
																	<option value="<?php echo $metalname['METAL_TYPE'];?>" 
													<?php if(isset($_POST['metal_tag']) && $_POST['metal_tag'] == $metalname['METAL_TYPE']) echo "selected";?>><?php echo $metalname['METAL_TYPE'];?></option><?php
																	}?>
																</select>
															</div>	
														</div>
														...
														<div class="col-lg-2 fv-row">
															...
															<div class="d-flex align-items-center">
																...
																<select class="form-select form-select-solid" data-control="select2" name="item_Tag"  id="item_Tag" data-hide-search="true">
																	<option value="">Select Item</option>
																	
																	<?php foreach($item_name as $itemname)
																	{?>
																	<option value="<?php echo $itemname['ITEM_NAME'];?>" 
													<?php if(isset($_POST['item_Tag']) && $_POST['item_Tag'] == $itemname['ITEM_NAME']) echo "selected";?>><?php echo $itemname['ITEM_NAME'];?></option>
										...
										<div class="col-lg-2">
											<div class="d-flex flex-center flex-row-fluid pt-12">
												<button type="submit" class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary" id="">Apply Tag</button>
											</div>
										</div>
									</div>
									</form>
	...
	<div class="modal fade" id="kt_modal_upload_jwl" tabindex="-1" aria-hidden="true">
		<!--begin::Modal dialog-->
		<div class="modal-dialog modal-m">
			...
			<div class="modal-content rounded">
				<div class="swal2-icon swal2-warning swal2-icon-show" style="display: flex;">
					...
					<div class="swal2-html-container" id="swal2-html-container" style="display: block;">Upload Jewel Image?</div>
					<div class="d-flex flex-center flex-row-fluid pt-12">
						<button type="submit" class="btn btn-danger me-3" data-bs-dismiss="modal">Upload</button>
...
<!-- 		<script>
		...
		<script>
			...
			$("#kt_datatable_responsive_tagentry").DataTable({
...
<script>
	...
	function activeunactive_tagentrylist(val,ival) {

	  var check = $("#activeunactive_tagentrylist_"+ival).is(':checked');

	  //alert(check);

	  if (check) {

	  	var check_value = $("#activeunactive_tagentrylist_"+ival).val();

	  	//alert("Yes");
	    //$("#active_tag").css('display','block');
		// $("#active_tag").addClass('response');
	    
	  } else {

	  	$("#activeunactive_tagentrylist_"+ival).val('');
	    //$("#deactive_tag").css('display','block');
		// $("#deactive_tag").addClass('response');
