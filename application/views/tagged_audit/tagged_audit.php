						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Audit - Tagged
									<!--begin::Separator-->
											...
											<div class="mb-5 hover-scroll-x">
													<div class="d-grid">
														<ul class="nav nav-tabs flex-nowrap text-nowrap">
															<li class="nav-item">
																<a class="nav-link active btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" >Audit</a>
															</li>
															<li class="nav-item">
																<a class="nav-link btn btn-active-light btn-color-black-800 btn-active-color-primary rounded-bottom-0 fw-bold fs-6" href="<?php echo base_url(); ?>Tagged_audit/audit_history">History</a>
															</li>
														</ul>
													</div>
												</div>
													...
													<div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
														...
														<div class="row">
															...
															<div class="col-lg-3 fv-row fv-plugins-icon-container">
																<input type="text" name="audit_id" id="audit_id" class="form-control form-control-lg form-control-solid" placeholder="Scan Here" >
																<div class="fv-plugins-message-container invalid-feedback"></div>
																<span class="fv-plugins-message-container invalid-feedback text-danger" id="audit_id_err"></span>
															</div>
															<div class="col-lg-2">
																<button class="btn btn-sm btn-primary me-2" onclick="audit_validation();">Audit</button>
															</div>
														</div>
														<div class="row">
															<div class="col-lg-6">
																<div class="row">
																	<div class="px-4" style="border:1.9px solid black;border-radius: 10px;">
																		...
																		<table id="kt_datatable_audit_tagged_entry" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-4 gs-2">
																			<thead>
																			  <tr class="text-start text-muted fw-bold fs-7 gs-0">
																			  <!--	<th class="min-w-25px">Sno</th>-->
																			   	<th class="min-w-80px">Tag ID</th>
																			...
																			<?php foreach($tagentry_list as $tlist){  ?>
																				...
																				<tr id="tr<?php 
																					$str_arr = explode ("/", $tlist['tag_id']); 
																					echo $str_arr[0];?>">
																					<!--<td>1</td>-->
															            <td><?php echo $tlist['tag_id'];  ?></td>
																		<input type="hidden" name="tag_id_form[]" value="<?php echo $tlist['tag_id'];?>">

															            <td class="ple1"><?php
																		  $item_name  = $this->db->query("SELECT * FROM ITEMS WHERE  SNO='". $tlist['item_name']."' ")->row();
	
																		 // echo $item_name->ITEMNAME;
																		// echo $tlist['item_name'];  ?> </td>
																		<td class="ple1"><?php
																		$item_name  = $this->db->query("SELECT * FROM SUBITEM_LIST WHERE  SUB_ID='". $tlist['subitem_name']."' ")->row();
																		echo $item_name->SUBITEM_NAME;
																		//  echo $tlist['subitem_name'];  ?></td>
																		<td><?php //echo $tlist['img'];  ?>
																		<?php	$image_url =  base_url().'assets/images/sales_non_tag_img/'. $tlist['img']; 
if(@getimagesize($image_url)){
?>
<a href="<?php echo $image_url; ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-fslightbox="lightbox-basic<?php echo $tlist['tag_id']; ?>" data-bs-toggle="modal">
...
<?php
																...
																<div class="d-flex justify-content-end mt-4">
																	<button class="btn btn-sm btn-primary me-2 " data-bs-toggle="modal" data-bs-target="#kt_modal_tagged_audit_notify">Notify</button>
																	<button class="btn btn-sm btn-primary me-2 form_submit">Complete</button>
																</div>
															</div>
															<div class="col-lg-6">
																<div class="row">
																	<div class="px-4" style="border:1.9px solid black;border-radius: 10px;">
																		...
																		<table id="kt_datatable_audit_tagged_entry_scanned" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-4 gs-2">
																			<thead>
																			<tr class="text-start text-muted fw-bold fs-7 gs-0">
																			  <!--	<th class="min-w-25px">Sno</th>-->
																			   	<th class="min-w-80px">Tag ID</th>
																			...
																			<input type="hidden" name="audit_description" id="audit_description">
													...
													<div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
														...
														<div class="row">
																  ...
																  <tr class="text-start text-muted fw-bold fs-7 gs-0">
																  	<th class="min-w-25px">Sno</th>
																   	...
																   	<th class="min-w-100px">User</th>
																		<th class="min-w-80px">Scanned Item Count</th>
																		<th class="min-w-80px">Scanned Item Wgt(gms)</th>
																		<th class="min-w-50px">Baln.Item Count</th>
																		<th class="min-w-80px">Baln.Item Wgt(gms)</th>
												            ...
												            <td>
																		...
																		<td>
																			<span class="text-end">
																				<a href="tagged_audit_view.php" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
				...
				<div class="modal-content rounded">
					<div class="swal2-icon swal2-warning swal2-icon-show" style="display: flex;">
						...
						<div class="modal-body">
							<div class="row">
								...
								<div class="col-lg-10 fv-row fv-plugins-icon-container">
									<textarea class="form-control form-control-solid" rows="2" placeholder="" name="desc_submit" id="desc_submit" onkeyup="desc()"></textarea>
								</div>
							</div>
						</div>
						<div class="d-flex flex-center flex-row-fluid">
							...
							<button type="submit" class="btn btn-primary form_submit" data-bs-dismiss="modal">Yes</button>
						</div><br><br>
				</div>
				<!--end::Modal content-->
			</div>
...
<script>
function desc(){
	var desc= $("#desc_submit").val();
	
	$('#audit_description').val(desc);
...
$('#audit_id_err').html('ID is required!');
err++;
}else{
$('#audit_id_err').html('');
}
 var tr1=id.split('/');
// alert(tr1[0]);
var tr = $('#tr'+tr1[0]).closest("tr").remove().clone();
