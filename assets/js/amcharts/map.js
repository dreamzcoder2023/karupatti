		...
		6970: function(t, e, n) {
			...
			var L, z, Y, R, X = {
					...
					FeatureCollection: function(t, e) {
						for (var n = t.features, i = -1, r = n.length; ++i < r;) T(n[i].geometry, e)
					}
				},
				I = {
					Sphere: function(t, e) {
					...
					GeometryCollection: function(t, e) {
						for (var n = t.geometries, i = -1, r = n.length; ++i < r;) T(n[i], e)
					}
				};
			...
			function Z(t, e) {
				t && X.hasOwnProperty(t.type) ? X[t.type](t, e) : T(t, e)
			}
			var A = {
				sphere: k,
				point: k,
			...
			function J(t, e) {
				...
				var n = M(e *= y),
					...
					l = R * n - Y * i * o,
					u = Y * n + R * i * o;
				L.add(_(D(a * a + l * l), u)), z = t, Y = n, R = i
			}
									...
									for (var c = 0; c < s.length; c++) {
										...
										if (f.length > 1) {
											for (var p = 1; p < f.length; p++)
												if (r = i / n, o = (i += U(a = f[p - 1], l = f[p])) / n, r <= t && o > t) {
													c = s.length;
													break
												}
							...
							polygonEnd: function() {
								...
								var t = function(t, e) {
									...
									for (var f = 0, v = t.length; f < v; ++f)
										if (b = (y = t[f]).length)
											for (var y, b, m = y[b - 1], P = Mt(m), j = m[1] / 2 + g, O = M(j), S = w(j), x = 0; x < b; ++x, P = E, O = k, S = T, m = D) {
												var D = y[x],
													E = Mt(D),
													C = D[1] / 2 + g,
													k = M(C),
													...
													R = Y > p,
													X = O * k;
												if (u.add(_(X * z * M(Y), S * T + X * w(Y))), a += R ? L + z * d : L, R ^ P >= n ^ E >= n) {
													var I = Pt(_t(m), _t(D));
													St(I);
													var G = Pt(o, I);
													St(G);
													var B = (R ^ L >= 0 ? -1 : 1) * N(G[2]);
													(i > B || i === B && (I[0] || I[1])) && (l += R ^ L >= 0 ? 1 : -1)
												}
											}
				...
				return function(a) {
					...
					function j(o, a) {
						...
						if (s && c.push([o, a]), y) f = o, p = a, h = l, y = !1, l && (m.lineStart(), m.point(o, a));
							...
							var u = [g = Math.max(Rt, Math.min(Yt, g)), d = Math.max(Rt, Math.min(Yt, d))],
								_ = [o = Math.max(Rt, Math.min(Yt, o)), a = Math.max(Rt, Math.min(Yt, a))];
			...
			function Ht(t, e, n) {
				...
				return t.scale(150).translate([0, 0]), null != i && t.clipExtent(null), Z(n, t.stream(Vt)), e(Vt.result()), null != i && t.clipExtent(i), t
			}
					...
					function n(i, r, o, a, l, u, s, f, p, h, g, d, v, y) {
						...
						if (P > 4 * e && v--) {
							var j = a + h,
								...
								z = T - r,
								Y = w * L - m * z;
							(Y * Y / P > e || b((m * L + w * z) / P - .5) > .3 || a * h + l * g + u * d < $t) && (n(i, r, o, a, l, u, k, T, E, j /= M, O /= M, S, v, y), y.point(k, T), n(k, T, E, j, O, S, s, f, p, h, g, d, v, y))
						}
					}
					return function(e) {
			...
			function re(t) {
				...
				function k() {
					...
					return n = ct(b, m, _), l = ut(e, i), u = ut(n, l), a = te(l, E), T()
				}
				...
				return N.stream = function(t) {
						...
						return arguments.length ? (S = t, O = void 0, T()) : S
					}, N.postclip = function(t) {
						return arguments.length ? (x = t, M = i = r = o = null, T()) : x
					}, N.clipAngle = function(t) {
						return arguments.length ? (S = +t ? zt(O = t * y) : (O = null, Ct), T()) : O * v
					}, N.clipExtent = function(t) {
						return arguments.length ? (x = null == t ? (M = i = r = o = null, It) : Xt(M = +t[0][0], i = +t[0][1], r = +t[1][0], o = +t[1][1]), T()) : null == M ? null : [
							[M, i],
							[r, o]
						]
					}, N.scale = function(t) {
						...
						return arguments.length ? (a = te(l, E = t * t), T()) : D(E)
			...
			var Pe, je, Oe, Se, Me = ye,
				...
				Ye = {
					...
					lineEnd: Be,
					polygonStart: function() {
						Ye.lineStart = Ze, Ye.lineEnd = Ae
					},
					polygonEnd: function() {
						Ye.point = Re, Ye.lineStart = Xe, Ye.lineEnd = Be
					},
					result: function() {
						var t = ze ? [Te / ze, Le / ze] : ke ? [Ne / ke, Ce / ke] : Ee ? [xe / Ee, De / Ee] : [NaN, NaN];
						return xe = De = Ee = Ne = Ce = ke = Te = Le = ze = 0, t
					}
				};
			...
			function Ge(t, e) {
				var n = t - Oe,
					i = e - Se,
					r = D(n * n + i * i);
				Ne += r * (Oe + t) / 2, Ce += r * (Se + e) / 2, ke += r, Re(Oe = t, Se = e)
			}
			...
			function We(t, e) {
				Ye.point = Fe, Re(Pe = Oe = t, je = Se = e)
			}
			...
			function Fe(t, e) {
				var n = t - Oe,
					i = e - Se,
					r = D(n * n + i * i);
				Ne += r * (Oe + t) / 2, Ce += r * (Se + e) / 2, ke += r, Te += (r = Se * t - Oe * e) * (Oe + t), Le += r * (Se + e), ze += 3 * r, Re(Oe = t, Se = e)
			}
			var Je = Ye;
			...
			function zn() {
				Rn(bn, mn), xn.point = Dn
			}

			function Yn(t, e) {
				bn = t, mn = e, t *= y, e *= y, xn.point = Rn;
				var n = w(e);
			...
			var Xn, In, Gn, Bn, Zn, An, Wn, Fn, Jn, Vn, Hn, Qn, Un, qn, Kn, $n, ti = new s,
				ei = new s,
				ni = {
					point: k,
					lineStart: k,
			...
			var ui = {
				...
				polygonEnd: function() {
					ni.polygonEnd(), ui.point = si, ui.lineStart = fi, ui.lineEnd = pi, ti < 0 ? (An = -(Fn = 180), Wn = -(Jn = 90)) : qn > c ? Jn = 90 : qn < -c && (Wn = -90), $n[0] = An, $n[1] = Fn
				},
				sphere: function() {
					An = -(Fn = 180), Wn = -(Jn = 90)
				}
			...
			function si(t, e) {
				Kn.push($n = [An = t, Fn = t]), e < Wn && (Wn = e), e > Jn && (Jn = e)
			}
			...
			function ci(t, e) {
				...
				if (Un) {
					...
					var o, a = t - Vn,
						...
						u = r[0] * v * l,
						s = b(a) > 180;
					s ^ (l * Vn < u && u < l * t) ? (o = r[1] * v) > Jn && (Jn = o) : s ^ (l * Vn < (u = (u + 360) % 360 - 180) && u < l * t) ? (o = -r[1] * v) < Wn && (Wn = o) : (e < Wn && (Wn = e), e > Jn && (Jn = e)), s ? t < Vn ? vi(An, t) > vi(An, Fn) && (Fn = t) : vi(t, Fn) > vi(An, Fn) && (An = t) : Fn >= An ? (t < An && (An = t), t > Fn && (Fn = t)) : t > Vn ? vi(An, t) > vi(An, Fn) && (Fn = t) : vi(t, Fn) > vi(An, Fn) && (An = t)
				} else Kn.push($n = [An = t, Fn = t]);
				e < Wn && (Wn = e), e > Jn && (Jn = e), Un = n, Vn = t
			}
			...
			function mi(t, e) {
				return function() {
					...
					function a() {
						...
						return t = [], e = ct(-a[0] * y, -a[1] * y, 0).invert, Tt(o, l, u, 1), a = {
							type: "Polygon",
							coordinates: [t]
						}, t = e = null, a
					}
			...
			function wi(t) {
				var e = function(t) {
					var e, n, i, r, o, a, l;
					if (Jn = Fn = -(An = Wn = 1 / 0), Kn = [], Z(t, ui), n = Kn.length) {
							...
							var t = this.get("projection"),
								e = function(t, e) {
									...
									return o.area = function(t) {
										...
										return Z(t, n(Vt)), Vt.result()
									}, o.centroid = function(t) {
										return Z(t, n(Je)), Je.result()
									}, o.projection = function(e) {
										return arguments.length ? (n = null == e ? (t = null, It) : (t = e).stream, o) : t
									}, o.context = function(t) {
										return arguments.length ? (i = null == t ? (e = null, new on) : new Ve(e = t), "function" != typeof r && i.pointRadius(r), o) : e
				...
				zi = function(t) {
					function e() {
						...
						return Object.defineProperty(e, "plusButton", {
							...
							configurable: !0,
							writable: !0,
							value: e.children.push(Ti.z.new(e._root, {
								width: 36,
								height: 36,
								themeTags: ["plus"]
							}))
			...
			function Ri() {
				return ie(Yi).scale(249.5).clipAngle(90.000001)
			}
			...
			function Hi(t, e) {
				var n = N(Vi * M(e)),
					i = n * n,
					r = i * i * i;
				return [t * w(n) / (Vi * (Ai + 3 * Wi * i + r * (7 * Fi + 9 * Ji * i))), n * (Ai + Wi * i + r * (Fi + Ji * i))]
			}
			...
			Hi.invert = function(t, e) {
				for (var n, i = e, r = i * i, o = r * r * r, a = 0; a < 12 && (o = (r = (i -= n = (i * (Ai + Wi * r + o * (Fi + Ji * r)) - e) / (Ai + 3 * Wi * r + o * (7 * Fi + 9 * Ji * r))) * i) * r * r, !(b(n) < f)); ++a);
				return [Vi * t * (Ai + 3 * Wi * r + o * (7 * Fi + 9 * Ji * r)) / w(i), N(M(i) / Vi)]
