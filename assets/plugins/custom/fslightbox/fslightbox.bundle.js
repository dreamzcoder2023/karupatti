! function(e, t) {
	...
	return function(e) {
		...
		function R(e) {
			...
			o.className = "".concat(r, "nav"), n.appendChild(o),
				function(e, t) {
					var n = document.createElement("div");
			...
			n = (t = e).core.classFacade, o = t.elements, n.removeFromEachElementClassIfContains = function(e, t) {
				...
				function(e) {
					...
					c.changeTo = function(e) {
						...
						var t = p.current;
						c.changeTo(e), s.removeFromEachElementClassIfContains("sourceMainWrappers", u), B(d[t], g), B(d[t], h), d[t].classList.add(m), B(d[e], g), B(d[e], m), d[e].classList.add(h), f(), o[e].zero(), setTimeout((function() {
